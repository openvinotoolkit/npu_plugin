...
if(ENABLE_HDDL2)
    if(UNIX)
        ...
        set(HDDLUNITE_KMB_ARCHIVE_VERSION RELEASE_ww52)
        set(HDDLUNITE_KMB_ARCHIVE_HASH "e3ffc6c76f525af8d40c83706df97fb64b850cc1feb1a858f85694881cf26105")
        set(HDDLUNITE_VPUX_4_ARCHIVE_VERSION RELEASE_VPUX_4_ww52)
        set(HDDLUNITE_VPUX_4_ARCHIVE_HASH "8037d94aba5f3e2d3d9873a2db7f05a41259b877c8b53600846f68fa16667a13")
        set(ARCH_FORMAT ".tgz")
    else()
