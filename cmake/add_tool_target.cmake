...
function(add_tool_target)
    ...
    addIeTarget(TYPE EXECUTABLE NAME ${ARG_NAME} ROOT ${ARG_ROOT} LINK_LIBRARIES ${ARG_LINK_LIBRARIES} ${ARG_UNPARSED_ARGUMENTS})
    set_target_properties(${ARG_NAME} PROPERTIES FOLDER ${ARG_ROOT})
