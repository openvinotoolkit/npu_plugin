...
#define RESMGR_IOCTL_CM_ALLOC_CHANNEL             _IOWR(RESMGR_MAGIC, 0, struct resmgr_args_cm_ctx)

#define RESMGR_IOCTL_CM_FREE_CHANNEL              _IOWR(RESMGR_MAGIC, 1, struct resmgr_args_cm_ctx)

#define RESMGR_IOCTL_END                   		 _IO(RESMGR_MAGIC, 2)


#endif /* __RESMGR_LH_UAPI_H */
