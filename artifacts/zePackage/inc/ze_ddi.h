...
///////////////////////////////////////////////////////////////////////////////
/// @brief Function-pointer for zeCommandListAppendGraphInitialize
typedef ze_result_t (__zecall *ze_pfnCommandListAppendGraphInitialize_t)(
    ze_command_list_handle_t,
    ze_graph_handle_t
    );

///////////////////////////////////////////////////////////////////////////////
/// @brief Function-pointer for zeCommandListAppendGraphExecute
typedef ze_result_t (__zecall *ze_pfnCommandListAppendGraphExecute_t)(
    ze_command_list_handle_t,
    ze_graph_handle_t
    );
...
typedef struct _ze_command_list_dditable_t
{
    ...
    ze_pfnCommandListAppendGraphInitialize_t                    pfnAppendGraphInitialize;
    ze_pfnCommandListAppendGraphExecute_t                       pfnAppendGraphExecute;
...
///////////////////////////////////////////////////////////////////////////////
/// @brief Function-pointer for zeGraphCreate 
typedef ze_result_t (__zecall *ze_pfnGraphCreate_t)(
    ze_device_handle_t,
    const ze_graph_desc_t*,
    ze_graph_handle_t*
    );

///////////////////////////////////////////////////////////////////////////////
/// @brief Function-pointer for zeGraphDestroy 
typedef ze_result_t (__zecall *ze_pfnGraphDestroy_t)(
    ze_graph_handle_t
    );

///////////////////////////////////////////////////////////////////////////////
/// @brief Function-pointer for zeGraphGetNativeBinary 
typedef ze_result_t(__zecall* ze_pfnGraphGetNativeBinary_t)(
    ze_graph_handle_t,
    size_t*,
    uint8_t*
    );
...
///////////////////////////////////////////////////////////////////////////////
/// @brief Function-pointer for zeGraphSetArgumentValue 
typedef ze_result_t (__zecall *ze_pfnGraphSetArgumentValue_t)(
    ze_graph_handle_t,
    uint32_t,
    const void*
    );
...
///////////////////////////////////////////////////////////////////////////////
/// @brief Function-pointer for zeGraphGetProperties 
typedef ze_result_t (__zecall *ze_pfnGraphGetProperties_t)(
    ze_graph_handle_t,
    ze_graph_properties_t*
    );

///////////////////////////////////////////////////////////////////////////////
/// @brief Function-pointer for zeGraphGetArgumentProperties 
typedef ze_result_t(__zecall* ze_pfnGraphGetArgumentProperties_t)(
    ze_graph_handle_t,
    uint32_t,
...
typedef struct _ze_graph_dditable_t
{
    ...
    ze_pfnGraphGetNativeBinary_t                                pfnGetNativeBinary;
...
typedef ze_result_t (__zecall *ze_pfnGetGraphProcAddrTable_t)(
    ze_api_version_t,
    ze_graph_dditable_t*
    );
