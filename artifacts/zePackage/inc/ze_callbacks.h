...
///////////////////////////////////////////////////////////////////////////////
typedef struct _ze_command_list_append_graph_initialize_params_t
{
    ze_command_list_handle_t hCommandList;
    ze_graph_handle_t hGraph;
} ze_command_list_append_graph_initialize_params_t;

///////////////////////////////////////////////////////////////////////////////
typedef void (__zecall *ze_pfnCommandListAppendGraphInitializeCb_t)(
    ze_command_list_append_graph_initialize_params_t* params,
    ze_result_t result,
    void* pTracerUserData,
    void** ppTracerInstanceUserData
    );
...
///////////////////////////////////////////////////////////////////////////////
typedef struct _ze_command_list_append_graph_execute_params_t
{
    ze_command_list_handle_t hCommandList;
    ze_graph_handle_t hGraph;
} ze_command_list_append_graph_execute_params_t;

///////////////////////////////////////////////////////////////////////////////
typedef void (__zecall *ze_pfnCommandListAppendGraphExecuteCb_t)(
    ze_command_list_append_graph_execute_params_t* params,
    ze_result_t result,
    void* pTracerUserData,
    void** ppTracerInstanceUserData
    );
...
typedef struct _ze_command_list_callbacks_t
{
    ...
    ze_pfnCommandListAppendGraphInitializeCb_t                      pfnAppendGraphInitializeCb;
    ze_pfnCommandListAppendGraphExecuteCb_t                         pfnAppendGraphExecuteCb;
...
///////////////////////////////////////////////////////////////////////////////
typedef struct _ze_graph_create_params_t
{
    ze_device_handle_t hDevice;
    ze_graph_desc_t* pGraphDesc;
    ze_graph_handle_t* phGraph;
} ze_graph_create_params_t;

typedef void (__zecall *ze_pfnGraphCreateCb_t)(
    ze_graph_create_params_t* params,
    ze_result_t result,
    void* pTracerUserData,
    void** ppTracerInstanceUserData
    );
...
///////////////////////////////////////////////////////////////////////////////
typedef struct _ze_graph_destroy_params_t
{
    ze_graph_handle_t hGraph;
} ze_graph_destroy_params_t;

typedef void (__zecall *ze_pfnGraphDestroyCb_t)(
    ze_graph_destroy_params_t* params,
    ze_result_t result,
    void* pTracerUserData,
    void** ppTracerInstanceUserData
    );
...
///////////////////////////////////////////////////////////////////////////////
typedef struct _ze_graph_get_native_binary_t
{
    ze_graph_handle_t hGraph;
    size_t* pSize;
    uint8_t* pGraphNativeBinary;
} ze_graph_get_native_binary_params_t;

typedef void (__zecall *ze_pfnGraphGetNativeBinaryCb_t)(
    ze_graph_get_native_binary_params_t* params,
    ze_result_t result,
    void* pTracerUserData,
    void** ppTracerInstanceUserData
    );
...
///////////////////////////////////////////////////////////////////////////////
typedef struct _ze_graph_get_properties_params_t
{
    ze_graph_handle_t hGraph;
    ze_graph_properties_t* pGraphProperties;
} ze_graph_get_properties_params_t;

typedef void (__zecall *ze_pfnGraphGetPropertiesCb_t)(
    ze_graph_get_properties_params_t* params,
    ze_result_t result,
    void* pTracerUserData,
    void** ppTracerInstanceUserData
    );
...
///////////////////////////////////////////////////////////////////////////////
typedef struct _ze_graph_get_arg_properties_params_t
{
    ze_graph_handle_t hGraph;
    uint32_t argIndex;
    ze_graph_argument_properties_t* pGraphArgumentProperties;
} ze_graph_get_arg_properties_params_t;

typedef void (__zecall *ze_pfnGraphGetArgumentPropertiesCb_t)(
    ze_graph_get_arg_properties_params_t* params,
    ze_result_t result,
    void* pTracerUserData,
    void** ppTracerInstanceUserData
    );
...
///////////////////////////////////////////////////////////////////////////////
typedef struct _ze_graph_set_arg_value_params_t
{
    ze_graph_handle_t hGraph;
    uint32_t argIndex;
    size_t argSize;
    const void* pArgValue;
} ze_graph_set_arg_value_params_t;

typedef void (__zecall *ze_pfnGraphSetArgumentValueCb_t)(
    ze_graph_set_arg_value_params_t* params,
    ze_result_t result,
    void* pTracerUserData,
    void** ppTracerInstanceUserData
    );
...
{
    ze_pfnGraphCreateCb_t                               pfnCreateGraphCb;
    ze_pfnGraphDestroyCb_t                              pfnDestroyGraphCb;
    ze_pfnGraphGetNativeBinaryCb_t                      pfnGetNativeBinary;
    ze_pfnGraphGetPropertiesCb_t                        pfnGetPropertiesCb;
    ze_pfnGraphGetArgumentPropertiesCb_t                pfnGetArgumentPropertiesCb;
    ze_pfnGraphSetArgumentValueCb_t                     pfnSetGraphArgumentValueCb;
