...
void single_shave_convert_color_nv12_to_rgb_single_plane(const struct ConvertColorNV12ToRGBSinglePlaneParams* lParams) {
    ...
    int32_t stride_uv = stride_y;

    image_h = image_h * 2 / 3;
    uv_values = y_values + image_w * image_h;
