...
extern "C" {
void single_shave_convert_color_i420_to_rgb_single_plane(const struct ConvertColorI420ToRGBParams* params) {
    ...
    auto u_src = y_src + image_w * image_h;
    auto v_src = u_src + image_w / 2 * image_h / 2;
