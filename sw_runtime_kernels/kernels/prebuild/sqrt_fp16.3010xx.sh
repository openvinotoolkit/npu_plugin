...
rm -f "${KERNEL_DIR}/prebuild/sqrt_fp16_${cpu}.o" "${KERNEL_DIR}/prebuild/sqrt_fp16_${cpu}.elf" "${KERNEL_DIR}/prebuild/act_shave_bin/sk.sqrt_fp16.${cpu}.text" "${KERNEL_DIR}/prebuild/act_shave_bin/sk.sqrt_fp16.${cpu}.data"

"${MV_TOOLS_DIR}/${MV_TOOLS_VERSION}/linux64/bin/moviCompile" -mcpu=${cpu} ${optimization} \
 -c "${KERNEL_DIR}/sqrt_fp16.cpp" -o "${KERNEL_DIR}/prebuild/sqrt_fp16_${cpu}.o" \
