...
extern unsigned char __attribute__((section(".data"), aligned(64))) sData[SHAVE_LIB_DATA_SIZE];

using namespace nn;
using namespace shave_lib;

namespace {
uint32_t cmxSliceAddr(uint64_t shaveID ) { return CMX_SLICE_0_BASE_ADR + (CMX_SLICE_SIZE * shaveID); }
