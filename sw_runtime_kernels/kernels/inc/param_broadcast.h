...
struct __attribute__ ((packed)) BroadcastParams {
    struct MemRefData input;
    struct MemRefData targetShape;
    struct MemRefData axesMapping;
...
inline struct BaseKernelParams ToBaseKernelParams(struct BroadcastParams * params) {
