...
struct ConvertColorNV12ToRGBParams {
    struct MemRefData y_input;
    struct MemRefData uv_input;
...
inline struct BaseKernelParams ToBaseKernelParams(ConvertColorNV12ToRGBParams* params) {
...
#else
    result.inputsOffset = (uint8_t*)(&(params->y_input)) - (uint8_t*)(params);
