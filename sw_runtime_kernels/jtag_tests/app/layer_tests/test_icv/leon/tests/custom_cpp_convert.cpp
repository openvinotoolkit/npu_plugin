...
namespace
{
    ...
    static constexpr std::initializer_list<SingleTest> convert_test_list{
            {{1, 1, 7}, {1, 1, 7}, orderZYX, FPE("convert.elf"), {sw_params::Location::NN_CMX}},
            {{1, 1, 20}, {1, 1, 20}, orderZYX, FPE("convert.elf"), {sw_params::Location::NN_CMX}},
            {{1000, 1, 1}, {1000, 1, 1}, orderZYX, FPE("convert.elf"), {sw_params::Location::NN_CMX}}};
    ...
    protected:
        ...
        void initData() override {
            ...
            *m_convertParams = sw_params::ConvertParams();
            ...
            m_params.kernel = reinterpret_cast<uint64_t>(sk_single_shave_convert_3720xx_text);
        }
