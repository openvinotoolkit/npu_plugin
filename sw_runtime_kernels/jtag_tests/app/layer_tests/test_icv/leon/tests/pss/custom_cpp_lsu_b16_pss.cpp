...
namespace ICV_TESTS_NAMESPACE(ICV_TESTS_PASTE2(ICV_TEST_SUITE_NAME, B16_pss)) {
    static constexpr std::initializer_list<SingleTest> b16_test_list{
            {{1, 1, 8}, {1, 1, 8}, orderZYX, FPE("lsu_b16.3720xx.elf"), {sw_params::Location::NN_CMX}},
            {{1, 2, 8}, {1, 2, 8}, orderZYX, FPE("lsu_b16.3720xx.elf"), {sw_params::Location::NN_CMX}},
            {{1, 1, 1000}, {1, 1, 1000}, orderZYX, FPE("lsu_b16.3720xx.elf"), {sw_params::Location::NN_CMX}},
    };
    ...
    protected:
        ...
        void initData() override {
            ...
            *m_lsuB16Params = sw_params::LsuB16Params();
            ...
            m_params.kernel = reinterpret_cast<uint64_t>(sk_lsu_b16_3720xx_text);
        }
