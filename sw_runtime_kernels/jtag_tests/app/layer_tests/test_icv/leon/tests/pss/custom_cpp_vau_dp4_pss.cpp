...
namespace ICV_TESTS_NAMESPACE(ICV_TESTS_PASTE2(ICV_TEST_SUITE_NAME, VauDp4_pss)) {
    ...
    static constexpr std::initializer_list<SingleTest> dp4_test_list{
            {{16, 1, 1}, {4, 1, 1}, orderZYX, FPE("vau_dp4.3720xx.elf"), {sw_params::Location::NN_CMX}},
            {{32, 1, 1}, {8, 1, 1}, orderZYX, FPE("vau_dp4.3720xx.elf"), {sw_params::Location::NN_CMX}},
            {{1008, 1, 1}, {252, 1, 1}, orderZYX, FPE("vau_dp4.3720xx.elf"), {sw_params::Location::NN_CMX}},
    };
    ...
    protected:
        ...
        void initData() override {
            ...
            *m_vauDp4Params = sw_params::VauDp4Params();
            ...
            m_params.kernel = reinterpret_cast<uint64_t>(sk_vau_dp4_3720xx_text);
        }
