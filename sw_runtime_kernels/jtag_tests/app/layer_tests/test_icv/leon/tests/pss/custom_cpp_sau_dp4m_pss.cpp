...
namespace ICV_TESTS_NAMESPACE(ICV_TESTS_PASTE2(ICV_TEST_SUITE_NAME, SauDp4M_pss)) {
    static constexpr std::initializer_list<SingleTest> dp4_test_list{
            {{16, 1, 1}, {16, 1, 1}, orderZYX, FPE("sau_dp4m.3720xx.elf"), {sw_params::Location::NN_CMX}},
            {{32, 1, 1}, {32, 1, 1}, orderZYX, FPE("sau_dp4m.3720xx.elf"), {sw_params::Location::NN_CMX}},
            {{1000, 1, 1}, {1000, 1, 1}, orderZYX, FPE("sau_dp4m.3720xx.elf"), {sw_params::Location::NN_CMX}},
    };
    ...
    protected:
        ...
        void initData() override {
            ...
            *m_sauDp4mParams = sw_params::SauDp4mParams();
            ...
            m_params.kernel = reinterpret_cast<uint64_t>(sk_sau_dp4m_3720xx_text);
        }
