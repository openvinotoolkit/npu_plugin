...
#include "sk.single_shave_convert_color_i420_to_rgb_single_plane.3720xx.text.xdat"

#include "param_convert_color_i420_to_rgb_single_plane.h"
...
struct I420ToRGBSinglePlaneTestParams {
    RgbFormat color_format;
    int32_t layerParams[MAX_LOCAL_PARAMS];
};

struct I420ToRGBSinglePlaneTest {
    Dims inputDims;
    Dims outputDims;
    StorageOrder storageOrder;
    I420ToRGBSinglePlaneTestParams customLayerParams;
};
...
static std::initializer_list<I420ToRGBSinglePlaneTest> i420torgb_test_list{
        {{1, 4, 6, 1}, {3, 4, 4, 1}, FULL_ORDER, {RgbFormat::RGB, {sw_params::Location::NN_CMX}}},
        {{1, 4, 6, 1}, {3, 4, 4, 1}, FULL_ORDER, {RgbFormat::BGR, {sw_params::Location::NN_CMX}}},
};

class CustomCppI420ToRGBSinglePlaneTest : public CustomCppTests<fp16, I420ToRGBSinglePlaneTest> {
public:
    explicit CustomCppI420ToRGBSinglePlaneTest(): m_testsLoop(i420torgb_test_list, "test") {
    }
    virtual ~CustomCppI420ToRGBSinglePlaneTest() {
    }

protected:
    const char* suiteName() const override {
        return "CustomCppI420ToRGBSinglePlaneTest";
    }
    ...
    void initData() override {
        ...
        CustomCppTests<fp16, I420ToRGBSinglePlaneTest>::initData();
        const I420ToRGBSinglePlaneTest* test = m_currentTest;
        ...
        mvTensorAssert(y_inputDimsArr[H_DIM] % 3 == 0, "I420 image height shall be divisible by 3.");
        ...
        *m_i420torgbParams = sw_params::ConvertColorI420ToRGBParams();
        ...
        m_params.kernel =
                reinterpret_cast<uint64_t>(sk_single_shave_convert_color_i420_to_rgb_single_plane_3720xx_text);
    }
    ...
    void generateReferenceData() override {
        ...
        u_src = y_src + image_w * image_h;
        v_src = u_src + image_w / 2 * image_h / 2;
...
private:
    ListIterator<I420ToRGBSinglePlaneTest> m_testsLoop;
...
ICV_TESTS_REGISTER_SUITE(CustomCppI420ToRGBSinglePlaneTest)
}  // namespace NAMESPACE
