...
namespace ICV_TESTS_NAMESPACE(ICV_TESTS_PASTE2(ICV_TEST_SUITE_NAME, Gather)) {
    ...
    static constexpr std::initializer_list<GatherTest> gather_test_list {
            {{4, 3, 2}, {2}, {2, 3, 2}, orderCHW, FPE("gather.elf"), {0/*axis*/, 0/*batch dims*/, sw_params::Location::NN_CMX/*mem type*/}},
            {{4, 3, 2}, {2}, {4, 2, 2}, orderCHW, FPE("gather.elf"), {1/*axis*/, 0/*batch dims*/, sw_params::Location::NN_CMX/*mem type*/}},
            {{4, 3, 2}, {2}, {4, 3, 2}, orderCHW, FPE("gather.elf"), {2/*axis*/, 0/*batch dims*/, sw_params::Location::NN_CMX/*mem type*/}},
            {{4, 3, 2}, {2, 3}, {4, 2, 3, 2}, orderNCHW, FPE("gather.elf"), {1/*axis*/, 0/*batch dims*/, sw_params::Location::NN_CMX/*mem type*/}},
            {{4, 3, 2}, {2}, {2, 3, 2}, orderHWC, FPE("gather.elf"), {0/*axis*/, 0/*batch dims*/, sw_params::Location::NN_CMX/*mem type*/}},
            {{4, 3, 2}, {2}, {4, 2, 2}, orderHWC, FPE("gather.elf"), {1/*axis*/, 0/*batch dims*/, sw_params::Location::NN_CMX/*mem type*/}},
            {{4, 3, 2}, {2}, {4, 3, 2}, orderHWC, FPE("gather.elf"), {2/*axis*/, 0/*batch dims*/, sw_params::Location::NN_CMX/*mem type*/}},
            {{4, 3, 2}, {2, 3}, {4, 2, 3, 2}, orderNHWC, FPE("gather.elf"), {1/*axis*/, 0/*batch dims*/, sw_params::Location::NN_CMX/*mem type*/}},
            {{5, 2}, {3, 2}, {3, 2}, orderNCHW, FPE("gather.elf"), {0/*axis*/, 1/*batch dims*/, sw_params::Location::NN_CMX/*mem type*/}},
            {{5, 2, 2}, {3, 2, 2}, {3, 2, 2}, orderNCHW, FPE("gather.elf"), {2/*axis*/, 2/*batch dims*/, sw_params::Location::NN_CMX/*mem type*/}},
    };
    ...
    protected:
        ...
        void initData() override {
            ...
            *m_gatherParams = sw_params::GatherParams();
            ...
            m_params.kernel = reinterpret_cast<uint64_t>(sk_single_shave_gather_3720xx_text);
        }
