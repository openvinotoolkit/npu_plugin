...
namespace ICV_TESTS_NAMESPACE(ICV_TESTS_PASTE2(ICV_TEST_SUITE_NAME, Pad))
{
    ...
    {                //W H C                              //N1 N2 C1 C2 H1 H2 W1 W2
        {{1, 2, 3}, {1, 2, 3}, orderZYX, FPE("pad.elf"), {{0, 0, 1, 1, 1, 0, 0, 0, CONSTANT, sw_params::Location::NN_CMX,}}},
        {{2, 32, 4}, {2, 32, 4}, orderZYX, FPE("pad.elf"), {{0, 0, 11, 1, 1, 12, 1, 1, CONSTANT, sw_params::Location::NN_CMX,}}},

        {{2, 3, 4}, {2, 3, 4}, orderZYX, FPE("pad.elf"), {{0, 0, 2, 2, 1, 1, 1, 1, EDGE, sw_params::Location::NN_CMX,}}},
        {{2, 3, 4}, {2, 3, 4}, orderZYX, FPE("pad.elf"), {{0, 0, 0, 0, 0, 0, 0, 0, EDGE, sw_params::Location::NN_CMX,}}},
        {{2, 3, 14}, {2, 3, 14}, orderZYX, FPE("pad.elf"), {{0, 0, 2, 23, 1, 1, 1, 1, EDGE, sw_params::Location::NN_CMX,}}},
        {{20, 3, 4}, {20, 3, 4}, orderZYX, FPE("pad.elf"), {{0, 0, 0, 0, 6, 7, 1, 0, EDGE, sw_params::Location::NN_CMX,}}},
        {{2, 2, 2}, {2, 2, 2}, orderZYX, FPE("pad.elf"), {{0, 0, 1, 1, 0, 6, 0, 0, EDGE, sw_params::Location::NN_CMX,}}},

        {{2, 3, 4}, {2, 3, 4}, orderZYX, FPE("pad.elf"), {{0, 0, 2, 2, 1, 1, 1, 1, REFLECT, sw_params::Location::NN_CMX,}}},
        {{21, 3, 4}, {21, 3, 4}, orderZYX, FPE("pad.elf"), {{0, 0, 2, 2, 1, 1, 1, 1, REFLECT, sw_params::Location::NN_CMX,}}},
        {{2, 3, 14}, {2, 3, 14}, orderZYX, FPE("pad.elf"), {{0, 0, 2, 2, 1, 1, 0, 1, REFLECT, sw_params::Location::NN_CMX,}}},
        {{2, 13, 4}, {2, 13, 4}, orderZYX, FPE("pad.elf"), {{0, 0, 0, 0, 1, 1, 0, 0, REFLECT, sw_params::Location::NN_CMX,}}},

        {{2, 3, 41}, {2, 3, 41}, orderZYX, FPE("pad.elf"), {{0, 0, 2, 2, 1, 1, 1, 1, SYMMETRIC, sw_params::Location::NN_CMX,}}},
        {{2, 31, 4}, {2, 31, 4}, orderZYX, FPE("pad.elf"), {{0, 0, 2, 2, 3, 1, 1, 1, SYMMETRIC, sw_params::Location::NN_CMX,}}},
        {{2, 3, 4}, {2, 3, 4}, orderZYX, FPE("pad.elf"), {{0, 0, 2, 0, 1, 1, 0, 0, SYMMETRIC, sw_params::Location::NN_CMX,}}},
    };
    ...
    protected:
        ...
        void initData() override {
            ...
            *m_padParams = sw_params::PadParams();
            ...
            m_params.kernel = reinterpret_cast<uint64_t>(sk_single_shave_pad_3720xx_text);
        }
