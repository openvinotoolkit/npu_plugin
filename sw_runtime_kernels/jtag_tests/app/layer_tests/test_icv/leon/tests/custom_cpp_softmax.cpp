...
{
    {{2, 2, 2}, {2, 2, 2}, orderZYX, {/*{{224, 1, 1}, {1, 128, 1}, {0, 0, 0}, 3, 0}, */{0 /*axis*/, sw_params::Location::UPA_CMX /*mem type*/,}}},
    {{2, 2, 2}, {2, 2, 2}, orderZYX, {/*{{224, 1, 1}, {1, 128, 1}, {0, 0, 0}, 3, 0}, */{1 /*axis*/, sw_params::Location::UPA_CMX /*mem type*/,}}},
    {{4, 4, 4}, {4, 4, 4}, orderZYX, {/*{{224, 1, 1}, {1, 128, 1}, {0, 0, 0}, 3, 0}, */{0 /*axis*/, sw_params::Location::NN_CMX/*mem type*/,}}},
    {{1, 4, 4}, {1, 4, 4}, orderZYX, {/*{{224, 1, 1}, {1, 128, 1}, {0, 0, 0}, 3, 0}, */{0 /*axis*/, sw_params::Location::NN_CMX/*mem type*/,}}},
    {{4, 4, 4}, {4, 4, 4}, orderZYX, {/*{{224, 1, 1}, {1, 128, 1}, {0, 0, 0}, 3, 0}, */{1 /*axis*/, sw_params::Location::NN_CMX/*mem type*/,}}},
    {{4, 4, 4}, {4, 4, 4}, orderZYX, {/*{{224, 1, 1}, {1, 128, 1}, {0, 0, 0}, 3, 0}, */{2 /*axis*/, sw_params::Location::NN_CMX/*mem type*/,}}},
//    {{3, 4, 5}, {3, 4, 5}, orderZYX, {/*{{224, 1, 1}, {1, 128, 1}, {0, 0, 0}, 3, 0}, */{2 /*axis*/, sw_params::Location::DDR/*mem type*/,}}},
//    {{8, 8, 8}, {8, 8, 8}, orderZYX, {/*{{224, 1, 1}, {1, 128, 1}, {0, 0, 0}, 3, 0}, */nn::shave_lib::SOFTMAX, {2 /*axis*/,}}},
//    {{224, 128, 24}, {224, 128, 24}, orderZYX, {/*{{224, 1, 1}, {1, 128, 1}, {0, 0, 0}, 3, 0}, */nn::shave_lib::SOFTMAX, {0 /*axis*/,}}},
//    {{224, 128, 24}, {224, 128, 24}, orderZYX, {/*{{224, 1, 1}, {1, 128, 1}, {0, 0, 0}, 3, 0}, */nn::shave_lib::SOFTMAX, {1 /*axis*/,}}},
};
...
//        allocBuffer(m_refInputTensor);
    ...
    void generateInputData() override {
        ...
        m_params.kernel  = reinterpret_cast<uint32_t>(sk_singleShaveSoftmax_3720xx_text);
