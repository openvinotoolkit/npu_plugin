...
namespace ICV_TESTS_NAMESPACE(ICV_TESTS_PASTE2(ICV_TEST_SUITE_NAME, TopK)) {
    ...
    static constexpr std::initializer_list<SingleTest> topk_test_list{
            {{4, 4, 4}, {4, 4, 2}, orderZYX, FPE("topk.elf"), {{2, 2, 0, 2, sw_params::Location::NN_CMX}}},
            {{2, 3, 2}, {1, 3, 2}, orderZYX, FPE("topk.elf"), {{1, 0, 0, 2, sw_params::Location::NN_CMX}}},
            {{2, 3, 2}, {2, 3, 1}, orderZYX, FPE("topk.elf"), {{1, 2, 0, 2, sw_params::Location::NN_CMX}}},
            {{2, 3, 2}, {1, 3, 2}, orderZYX, FPE("topk.elf"), {{1, 0, 1, 2, sw_params::Location::NN_CMX}}},
            {{2, 3, 2}, {2, 3, 1}, orderZYX, FPE("topk.elf"), {{1, 2, 1, 2, sw_params::Location::NN_CMX}}},
            {{3, 3, 2}, {1, 3, 2}, orderZYX, FPE("topk.elf"), {{1, 0, 1, 2, sw_params::Location::NN_CMX}}},
            {{2, 3, 2}, {2, 2, 2}, orderZYX, FPE("topk.elf"), {{2, 1, 1, 2, sw_params::Location::NN_CMX}}},
            {{11, 10, 10}, {11, 10, 1}, orderZYX, FPE("topk.elf"), {{1, 2, 0, 2, sw_params::Location::NN_CMX}}},
            {{11, 10, 10}, {2, 10, 10}, orderZYX, FPE("topk.elf"), {{2, 0, 0, 2, sw_params::Location::NN_CMX}}},
            {{11, 20, 10}, {11, 2, 10}, orderZYX, FPE("topk.elf"), {{2, 1, 0, 2, sw_params::Location::NN_CMX}}},
            {{11, 20, 10}, {11, 20, 2}, orderZYX, FPE("topk.elf"), {{2, 2, 0, 2, sw_params::Location::NN_CMX}}},
            {{21, 40, 10}, {21, 1, 10}, orderZYX, FPE("topk.elf"), {{1, 1, 0, 2, sw_params::Location::NN_CMX}}},
            {{21, 80, 10}, {21, 1, 10}, orderZYX, FPE("topk.elf"), {{1, 1, 0, 2, sw_params::Location::NN_CMX}}},
            {{21, 120, 10}, {21, 1, 10}, orderZYX, FPE("topk.elf"), {{1, 1, 0, 2, sw_params::Location::NN_CMX}}},
            {{21, 160, 10}, {21, 1, 10}, orderZYX, FPE("topk.elf"), {{1, 1, 0, 2, sw_params::Location::NN_CMX}}},
            {{21, 240, 10}, {21, 1, 10}, orderZYX, FPE("topk.elf"), {{1, 1, 0, 2, sw_params::Location::NN_CMX}}},
            {{21, 300, 10}, {21, 1, 10}, orderZYX, FPE("topk.elf"), {{1, 1, 0, 2, sw_params::Location::NN_CMX}}},
            {{21, 320, 10}, {21, 1, 10}, orderZYX, FPE("topk.elf"), {{1, 1, 0, 2, sw_params::Location::NN_CMX}}},
            {{21, 513, 10}, {21, 1, 10}, orderZYX, FPE("topk.elf"), {{1, 1, 0, 2, sw_params::Location::NN_CMX}}},
            {{21, 513, 20}, {21, 1, 20}, orderZYX, FPE("topk.elf"), {{1, 1, 0, 2, sw_params::Location::NN_CMX}}},
            // {{21, 513, 80}, {21, 1, 80}, orderZYX, FPE("topk.elf"), {{1, 1, 0, 2,sw_params::Location::NN_CMX}}}, //FAILED, CMX:1737120 Byte, sizes are too large for moviSim
    };
    ...
    protected:
        ...
        void generateInputData() override {
            m_params.kernel = reinterpret_cast<uint64_t>(sk_single_shave_topk_3720xx_text);
