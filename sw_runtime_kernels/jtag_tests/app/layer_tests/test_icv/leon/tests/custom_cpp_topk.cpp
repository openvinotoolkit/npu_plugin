...
//    }
    ...
    void generateReferenceData() override {
        ...
        const int32_t refValuesAxisStep = m_referenceValueTensor.memorySteps().dims[axis];
        const int32_t refIndicesAxisStep = m_referenceIndexTensor.memorySteps().dims[axis];
...
//        m_inputTensor.forEach(true, [this, &test_failed](const MemoryDims& indices){
//            float input_value = f16Tof32(m_inputTensor.at(indices));
//            printf("m_inputTensor value = %f\n", input_value);
//        });
