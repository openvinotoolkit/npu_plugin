...
namespace ICV_TESTS_NAMESPACE(ICV_TESTS_PASTE2(ICV_TEST_SUITE_NAME, HardSigmoid)) {    
    static constexpr std::initializer_list<HardSigmoidTest> hardsigmoid_test_list{
            {{1, 1, 20}, {1, 1, 20}, orderZYX, {0.2f, 0.5f, {sw_params::Location::NN_CMX}}},
            {{100, 1, 1}, {100, 1, 1}, orderZYX, {0.2f, 0.5f, {sw_params::Location::NN_CMX}}},
            {{1, 111, 1}, {1, 111, 1}, orderZYX, {0.2f, 0.5f, {sw_params::Location::NN_CMX}}},
#ifdef CONFIG_RUN_LARGE_TESTS
            {{1000, 1, 1}, {1000, 1, 1}, orderZYX, {0.2f, 0.5f, {sw_params::Location::NN_CMX}}}
#endif
    };
    ...
    protected:
        ...
        void initData() override {
            ...
            *m_hardsigmoidParams = sw_params::HardSigmoidParams();
            ...
            m_params.kernel = reinterpret_cast<uint32_t>(sk_hardsigmoid_fp16_3720xx_text);
        }
