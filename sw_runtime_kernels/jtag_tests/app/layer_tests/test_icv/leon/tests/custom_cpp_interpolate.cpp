...
// #define ALL_PARAMS_SET
    ...
    static constexpr std::initializer_list<SingleTest> interpolate_test_list{
        ...
        {{64, 32, 4}, {16, 16, 4}, orderCHW, {DNEAREST,     DASYMMETRIC,    DFLOOR,              false, sw_params::Location::NN_CMX}},
        {{16, 16, 4}, {64, 32, 4}, orderHWC, {DNEAREST,     DALIGN_CORNERS, DROUND_PREFER_FLOOR, false, sw_params::Location::NN_CMX}},
        {{64, 32, 4}, {16, 16, 4}, orderHWC, {DBILINEAR,    DALIGN_CORNERS, 0,                   false, sw_params::Location::NN_CMX}},
        {{16, 16, 4}, {64, 32, 4}, orderCHW, {DBILINEAR,    DALIGN_CORNERS, 0,                   false, sw_params::Location::NN_CMX}},
        {{64, 32, 4}, {16, 16, 4}, orderCHW, {DLINEAR_ONNX, DALIGN_CORNERS, 0,                   false, sw_params::Location::NN_CMX}},
        {{16, 16, 4}, {64, 32, 4}, orderHWC, {DLINEAR_ONNX, DALIGN_CORNERS, 0,                   false, sw_params::Location::NN_CMX}},
#ifdef ALL_PARAMS_SET
        {{16, 16, 4}, {64, 32, 4}, orderCHW, {DNEAREST,     DASYMMETRIC,           DFLOOR,              false, sw_params::Location::NN_CMX}},
        {{64, 32, 4}, {16, 16, 4}, orderCHW, {DNEAREST,     DALIGN_CORNERS,        DROUND_PREFER_FLOOR, false, sw_params::Location::NN_CMX}},
        {{64, 32, 4}, {16, 16, 4}, orderHWC, {DNEAREST,     DHALF_PIXEL,           DSIMPLE,             false, sw_params::Location::NN_CMX}},
        {{16, 16, 4}, {64, 32, 4}, orderCHW, {DNEAREST,     DHALF_PIXEL,           DROUND_PREFER_CEIL,  false, sw_params::Location::NN_CMX}},
        {{64, 32, 4}, {16, 16, 4}, orderHWC, {DNEAREST,     DPYTORCH_HALF_PIXEL,   DROUND_PREFER_CEIL,  false, sw_params::Location::NN_CMX}},
        {{16, 16, 4}, {64, 32, 4}, orderCHW, {DNEAREST,     DPYTORCH_HALF_PIXEL,   DROUND_PREFER_CEIL,  false, sw_params::Location::NN_CMX}},
        {{64, 32, 4}, {16, 16, 4}, orderCHW, {DNEAREST,     DTF_HALF_PIXEL_FOR_NN, DCEIL,               false, sw_params::Location::NN_CMX}},
        {{16, 16, 4}, {64, 32, 4}, orderHWC, {DNEAREST,     DTF_HALF_PIXEL_FOR_NN, DROUND_PREFER_CEIL,  false, sw_params::Location::NN_CMX}},
        {{64, 32, 4}, {16, 16, 4}, orderHWC, {DLINEAR_ONNX, DASYMMETRIC,           0, false, sw_params::Location::NN_CMX}},
        {{16, 16, 4}, {64, 32, 4}, orderCHW, {DLINEAR_ONNX, DASYMMETRIC,           0, false, sw_params::Location::NN_CMX}},
        {{64, 32, 4}, {16, 16, 4}, orderCHW, {DLINEAR_ONNX, DHALF_PIXEL,           0, false, sw_params::Location::NN_CMX}},
        {{64, 32, 4}, {16, 16, 4}, orderCHW, {DLINEAR_ONNX, DPYTORCH_HALF_PIXEL,   0, false, sw_params::Location::NN_CMX}},
        {{64, 32, 4}, {16, 16, 4}, orderCHW, {DLINEAR_ONNX, DTF_HALF_PIXEL_FOR_NN, 0, false, sw_params::Location::NN_CMX}},
        {{16, 16, 4}, {64, 32, 4}, orderHWC, {DLINEAR_ONNX, DTF_HALF_PIXEL_FOR_NN, 0, false, sw_params::Location::NN_CMX}},
        {{64, 32, 4}, {16, 16, 4}, orderHWC, {DBILINEAR,    DHALF_PIXEL,           0, false, sw_params::Location::NN_CMX}},
        {{16, 16, 4}, {64, 32, 4}, orderCHW, {DBILINEAR,    DHALF_PIXEL,           0, false, sw_params::Location::NN_CMX}},
        {{64, 32, 4}, {16, 16, 4}, orderHWC, {DBILINEAR,    DASYMMETRIC,           0, false, sw_params::Location::NN_CMX}},
        {{16, 16, 4}, {64, 32, 4}, orderHWC, {DBILINEAR,    DASYMMETRIC,           0, false, sw_params::Location::NN_CMX}},
        {{64, 32, 4}, {16, 16, 4}, orderCHW, {DBILINEAR,    DPYTORCH_HALF_PIXEL,   0, false, sw_params::Location::NN_CMX}},
        {{16, 16, 4}, {64, 32, 4}, orderHWC, {DBILINEAR,    DPYTORCH_HALF_PIXEL,   0, false, sw_params::Location::NN_CMX}},
        {{64, 32, 4}, {16, 16, 4}, orderHWC, {DBILINEAR,    DTF_HALF_PIXEL_FOR_NN, 0, false, sw_params::Location::NN_CMX}},
        {{16, 16, 4}, {64, 32, 4}, orderCHW, {DBILINEAR,    DTF_HALF_PIXEL_FOR_NN, 0, false, sw_params::Location::NN_CMX}},
#endif
    };
    ...
    protected:
        ...
        void initData() override {
            ...
            *m_interpolateParams = sw_params::InterpolateParams();
            ...
            m_params.kernel = reinterpret_cast<uint32_t>(sk_singleShaveInterpolate_3720xx_text);
        }
