...
// Some tests are disabeled due to incompatibility with newer shave driver, will be enabeled when
// proper management for newer shave driver is implemented
const std::initializer_list<ScatterNDUpdateTestParams> scatterNDUpdate_test_list = {
//      input,             indices
//      1D input Tensor
        {{1}, {1, 1}, {}, FULL_ORDER, FPE("convert.elf"), {sw_params::Location::NN_CMX}},
        {{8}, {1, 4}, {}, FULL_ORDER, FPE("convert.elf"), {sw_params::Location::NN_CMX}},
        {{100}, {1, 6}, {}, FULL_ORDER, FPE("convert.elf"), {sw_params::Location::NN_CMX}},
        {{1000}, {1, 3, 4}, {}, FULL_ORDER, FPE("convert.elf"), {sw_params::Location::NN_CMX}},
        {{2560}, {1, 6, 6}, {}, FULL_ORDER, FPE("convert.elf"), {sw_params::Location::NN_CMX}},
//      2D input Tensor
        {{2, 2}, {1, 2}, {}, FULL_ORDER, FPE("convert.elf"), {sw_params::Location::NN_CMX}},
        {{4, 2}, {1, 3}, {}, FULL_ORDER, FPE("convert.elf"), {sw_params::Location::NN_CMX}},
        // {{100, 70}, {2, 9}, {}, FULL_ORDER, FPE("convert.elf"), {sw_params::Location::NN_CMX}},
        // {{1000, 5}, {2, 2}, {}, FULL_ORDER, FPE("convert.elf"), {sw_params::Location::NN_CMX}},
//      3D input Tensor
        {{3, 3, 3}, {3, 2, 2}, {}, FULL_ORDER, FPE("convert.elf"), {sw_params::Location::NN_CMX}},
        {{8, 3, 3}, {2, 2}, {}, FULL_ORDER, FPE("convert.elf"), {sw_params::Location::NN_CMX}},
//      4D input Tensor
        {{7, 5, 3, 2}, {2, 2}, {}, FULL_ORDER, FPE("convert.elf"), {sw_params::Location::NN_CMX}},
        // {{24, 8, 8, 8}, {3, 2, 1}, {}, FULL_ORDER, FPE("convert.elf"), {sw_params::Location::NN_CMX}},
};
...
protected:
    ...
    void initData() override {
        ...
        *m_scatterNDUpdateParams = sw_params::ScatterNDUpdateParams();
        ...
        m_params.kernel = reinterpret_cast<uint64_t>(sk_single_shave_scatterNDUpdate_3720xx_text);
    }
