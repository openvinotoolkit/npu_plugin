...
namespace ICV_TESTS_NAMESPACE(ICV_TESTS_PASTE2(ICV_TEST_SUITE_NAME, Sigmoid)) {
    static constexpr std::initializer_list<SingleTest> sigmoid_test_list{
            ...
            {{100, 1, 1}, {100, 1, 1}, orderZYX, {sw_params::Location::NN_CMX}},
            {{1, 111, 1}, {1, 111, 1}, orderZYX, {sw_params::Location::NN_CMX}},
    ...
    protected:
        ...
        void generateInputData() override {
            m_params.kernel = reinterpret_cast<uint32_t>(sk_sigmoid_fp16_3720xx_text);
