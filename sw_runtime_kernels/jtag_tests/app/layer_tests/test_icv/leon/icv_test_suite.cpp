...
int GlobalData::numShavesToBegin = CONFIG_MIN_SHAVES;
int GlobalData::numShavesToEnd   = CONFIG_MAX_SHAVES;

int GlobalData::numRepeats = CONFIG_REPEAT_COUNT;
...
char GlobalData::testFilter[ICV_TEST_TEST_FILTER_STR_MAXSIZE] = CONFIG_TEST_FILTER;

void GlobalData::init()
{
#ifdef CONFIG_PRINT_DIFFS
    GlobalData::doPrintDiffs = true;
#endif

#ifndef CONFIG_CALL_ONCE
    GlobalData::doCallOnce = false;
#endif

#ifdef CONFIG_PRINT_PERF_COUNTERS
    GlobalData::doPrintPerfCounters = true;
#endif

#ifdef CONFIG_TEST_MODE_FULL
    GlobalData::doPrintName    = true;
    GlobalData::doPrintTime    = true;
    GlobalData::doPrintParams  = true;
    GlobalData::checkMode = CheckMode::Success;
#endif
