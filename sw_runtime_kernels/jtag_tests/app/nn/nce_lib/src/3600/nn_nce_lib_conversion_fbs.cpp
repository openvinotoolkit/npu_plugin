    ...
    namespace nce_lib
    {
        ...
        uint8_t ConfigDtype(const MVCNN::DType dtype)
        {
            ...
            switch (dtype)
            {
                ...
                // TODO: current schema does not support U4
                case MVCNN::DType_BFP16:  itype = InputTensorDType::BF16;  break;
                // case MVCNN::DType_U4:  itype = InputTensorDType::U4;  break;
                case MVCNN::DType_FP8:  itype = InputTensorDType::FP8;  break;
        ...
        uint8_t ConfigOutputDtype(const MVCNN::DType dtype)
        {
            ...
            switch (dtype)
            {
                ...
                case MVCNN::DType_FP32: otype = OutputTensorDType::FP32; break;
                case MVCNN::DType_BFP16: otype = OutputTensorDType::FP16; break; // Difference is in PPE settings
