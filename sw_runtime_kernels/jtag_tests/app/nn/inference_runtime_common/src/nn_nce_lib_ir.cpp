...
namespace nn
{
    namespace nce_lib
    {
        ...
        void DebugPrintRegister(const dpu_runtime::DPUVariant& variant)
        {
            ...
            PRINTF("NCE_DPU_SPARSITY_ADDR[0x%x]:0x%x",NCE_DPU_SPARSITY_ADDR_OFFSET,variant.invariant_->registers_.se_sp_addr[0].sparsity_addr);
            PRINTF("    -> sparsity_addr: 0x%x",variant.invariant_->registers_.se_sp_addr[0].sparsity_addr);
            PRINTF("NCE_DPU_SE_ADDR1[0x%x]:0x%x",NCE_DPU_SE_ADDR1_OFFSET,variant.invariant_->registers_.se_sp_addr[1].se_addr);
            PRINTF("    -> se_addr1: 0x%x",variant.invariant_->registers_.se_sp_addr[1].se_addr);
            PRINTF("NCE_DPU_SPARSITY_ADDR1[0x%x]:0x%x",NCE_DPU_SPARSITY_ADDR1_OFFSET,variant.invariant_->registers_.se_sp_addr[1].sparsity_addr);
            PRINTF("    -> sparsity_addr1: 0x%x",variant.invariant_->registers_.se_sp_addr[1].sparsity_addr);
            PRINTF("NCE_DPU_SE_ADDR2[0x%x]:0x%x",NCE_DPU_SE_ADDR2_OFFSET,variant.invariant_->registers_.se_sp_addr[2].se_addr);
            PRINTF("    -> se_addr2: 0x%x",variant.invariant_->registers_.se_sp_addr[2].se_addr);
            PRINTF("NCE_DPU_SPARSITY_ADDR2[0x%x]:0x%x",NCE_DPU_SPARSITY_ADDR2_OFFSET,variant.invariant_->registers_.se_sp_addr[2].sparsity_addr);
            PRINTF("    -> sparsity_addr2: 0x%x",variant.invariant_->registers_.se_sp_addr[2].sparsity_addr);
            PRINTF("NCE_DPU_SE_ADDR3[0x%x]:0x%x",NCE_DPU_SE_ADDR3_OFFSET,variant.invariant_->registers_.se_sp_addr[3].se_addr);
            PRINTF("    -> se_addr3: 0x%x",variant.invariant_->registers_.se_sp_addr[3].se_addr);
            PRINTF("NCE_DPU_SPARSITY_ADDR3[0x%x]:0x%x",NCE_DPU_SPARSITY_ADDR3_OFFSET,variant.invariant_->registers_.se_sp_addr[3].sparsity_addr);
            PRINTF("    -> sparsity_addr3: 0x%x",variant.invariant_->registers_.se_sp_addr[3].sparsity_addr);
            PRINTF("NCE_DPU_SE_SP_SIZE[0x%x]:0x%x",NCE_DPU_SE_SP_SIZE_OFFSET,variant.invariant_->registers_.se_sp_size[0].se_sp_size);
            ...
            PRINTF("NCE_DPU_SE_SP_SIZE1[0x%x]:0x%x",NCE_DPU_SE_SP_SIZE1_OFFSET,variant.invariant_->registers_.se_sp_size[1].se_sp_size);
            ...
            PRINTF("NCE_DPU_SE_SP_SIZE2[0x%x]:0x%x",NCE_DPU_SE_SP_SIZE2_OFFSET,variant.invariant_->registers_.se_sp_size[2].se_sp_size);
            ...
            PRINTF("NCE_DPU_KERNAL_PAD_CFG[0x%x]:0x%x",NCE_DPU_KERNAL_PAD_CFG_OFFSET,variant.invariant_->registers_.kernel_pad_cfg.kernel_pad_cfg);
#ifdef CONFIG_TARGET_SOC_3720
            PRINTF("    -> rst_ctxt: 0x%x", variant.invariant_->registers_.kernel_pad_cfg.kernel_pad_cfg_bf.rst_ctxt);
            PRINTF("    -> sp_se_tbl_segment: 0x%x", variant.invariant_->registers_.kernel_pad_cfg.kernel_pad_cfg_bf.sp_se_tbl_segment);
            ...
            PRINTF("    -> layer1_wt_sp_ins: 0x%x", variant.invariant_->registers_.kernel_pad_cfg.kernel_pad_cfg_bf.layer1_wt_sp_ins);
            ...
            PRINTF("NCE_DPU_TENSOR_SIZE0[0x%x]:0x%x",NCE_DPU_TENSOR_SIZE0_OFFSET,variant.invariant_->registers_.tensor_size0.tensor_size0);
            ...
            PRINTF("NCE_DPU_TENSOR_SIZE1[0x%x]:0x%x",NCE_DPU_TENSOR_SIZE1_OFFSET,variant.invariant_->registers_.tensor_size1.tensor_size1);
            ...
            PRINTF("NCE_DPU_TENSOR_MODE[0x%x]:0x%x",NCE_DPU_TENSOR_MODE_OFFSET,variant.invariant_->registers_.tensor_mode.tensor_mode);
            PRINTF("    -> pad_value: 0x%x",variant.invariant_->registers_.tensor_mode.tensor_mode_bf.pad_value);
            PRINTF("    -> workload_operation: 0x%x",variant.invariant_->registers_.tensor_mode.tensor_mode_bf.workload_operation);
            ...
            PRINTF("NCE_DPU_ELOPS_SPARSITY_ADDR[0x%x]:0x%x",NCE_DPU_ELOPS_SPARSITY_ADDR_OFFSET,variant.invariant_->registers_.elop_sparsity_addr);
            PRINTF("    -> elop_sparsity_addr :0x%x",variant.invariant_->registers_.elop_sparsity_addr);
            PRINTF("NCE_DPU_ELOPS_SE_ADDR[0x%x]:0x%x",NCE_DPU_ELOPS_SE_ADDR_OFFSET,variant.invariant_->registers_.elop_se_addr);
            PRINTF("    -> elop_se_addr :0x%x",variant.invariant_->registers_.elop_se_addr);

            PRINTF("NCE_DPU_ELOPS_WLOAD[0x%x]:0x%x",NCE_DPU_ELOPS_WLOAD_OFFSET,variant.invariant_->registers_.elops_wload.elops_wload);
#ifdef CONFIG_TARGET_SOC_3720
            ...
            PRINTF("NCE_DPU_BASE_OFFSETA[0x%x]:0x%x",NCE_DPU_BASE_OFFSETA_OFFSET,variant.invariant_->registers_.base_offset_a);
            PRINTF("NCE_DPU_BASE_OFFSETB[0x%x]:0x%x",NCE_DPU_BASE_OFFSETB_OFFSET,variant.invariant_->registers_.base_offset_b);
            ...
            PRINTF("NCE_DPU_ODU_CTX_THRESHOLD[0x%x]:0x%x",NCE_DPU_ODU_BE_CNT_OFFSET,variant.invariant_->registers_.odu_be_cnt);
            ...
            PRINTF("NCE_DPU_ODU_TE_DIM_0[0x%x]:0x%x",NCE_DPU_ODU_TE_DIM_0_OFFSET,variant.invariant_->registers_.te_dim0.te_dim0);
            ...
            PRINTF("NCE_DPU_ODU_TE_DIM_1[0x%x]:0x%x",NCE_DPU_ODU_TE_DIM_1_OFFSET,variant.invariant_->registers_.te_dim1.te_dim1);
            ...
            PRINTF("NCE_DPU_ODU_BASE_PTR_A[0x%x]:0x%x",NCE_DPU_ODU_BASE_PTR_A_OFFSET,variant.invariant_->registers_.base_ptr_a);
            PRINTF("NCE_DPU_ODU_BASE_PTR_B[0x%x]:0x%x",NCE_DPU_ODU_BASE_PTR_B_OFFSET,variant.invariant_->registers_.base_ptr_b);
            leonPipePrintFlushBuffer();
            PRINTF("NCE_DPU_ODU_BASE_ADR_0[0x%x]:0x%x",NCE_DPU_ODU_BASE_ADR_0_OFFSET,variant.invariant_->registers_.base_adr[0]);
            PRINTF("    -> base_adr_0: 0x%x",variant.invariant_->registers_.base_adr[0]);
            PRINTF("NCE_DPU_ODU_BASE_ADR_1[0x%x]:0x%x",NCE_DPU_ODU_BASE_ADR_1_OFFSET,variant.invariant_->registers_.base_adr[1]);
            PRINTF("    -> base_adr_1: 0x%x",variant.invariant_->registers_.base_adr[1]);
            PRINTF("NCE_DPU_ODU_BASE_ADR_2[0x%x]:0x%x",NCE_DPU_ODU_BASE_ADR_2_OFFSET,variant.invariant_->registers_.base_adr[2]);
            PRINTF("    -> base_adr_2: 0x%x",variant.invariant_->registers_.base_adr[2]);
            PRINTF("NCE_DPU_ODU_BASE_ADR_3[0x%x]:0x%x",NCE_DPU_ODU_BASE_ADR_3_OFFSET,variant.invariant_->registers_.base_adr[3]);
            PRINTF("    -> base_adr_3: 0x%x",variant.invariant_->registers_.base_adr[3]);
            PRINTF("NCE_DPU_ODU_CAST_0[0x%x]:0x%x",NCE_DPU_ODU_CAST_0_OFFSET,variant.invariant_->registers_.odu_cast[0].odu_cast);
            ...
            PRINTF("NCE_DPU_ODU_CAST_1[0x%x]:0x%x",NCE_DPU_ODU_CAST_1_OFFSET,variant.invariant_->registers_.odu_cast[1].odu_cast);
            ...
            PRINTF("NCE_DPU_ODU_CAST_2[0x%x]:0x%x",NCE_DPU_ODU_CAST_2_OFFSET,variant.invariant_->registers_.odu_cast[2].odu_cast);
            ...
            PRINTF("NCE_DPU_MPE_BUS_DATA_SEL[0x%x]:0x%x",NCE_DPU_MPE_BUS_DATA_SEL_OFFSET,variant.invariant_->registers_.mpe_bus_data_sel);

#ifdef CONFIG_TARGET_SOC_3720
            PRINTF("NCE_DPU_ELOP_SCALE[0x%x]:0x%x",NCE_DPU_ELOP_SCALE_OFFSET,variant.invariant_->registers_.elop_scale.elop_scale);
            ...
            PRINTF("NCE_DPU_PPE_SCALE[0x%x]:0x%x",NCE_DPU_PPE_SCALE_OFFSET,variant.invariant_->registers_.ppe_scale.ppe_scale);
            ...
            PRINTF("NCE_DPU_PPE_SCALE_CTRL[0x%x]:0x%x",NCE_DPU_PPE_SCALE_CTRL_OFFSET,variant.invariant_->registers_.ppe_scale_ctrl.ppe_scale_ctrl);
#ifdef CONFIG_TARGET_SOC_3720
            PRINTF("    -> ppe_fp_scale_override: 0x%x",variant.invariant_->registers_.ppe_scale_ctrl.ppe_scale_ctrl_bf.ppe_fp_scale_override);
            PRINTF("    -> ppe_scale_override: 0x%x",variant.invariant_->registers_.ppe_scale_ctrl.ppe_scale_ctrl_bf.ppe_scale_override);
#endif

#ifdef CONFIG_TARGET_SOC_3720
            PRINTF("NCE_DPU_PPE_PRELU[0x%x]:0x%x",NCE_DPU_PPE_PRELU_OFFSET,variant.invariant_->registers_.ppe_prelu.ppe_prelu);
            ...
            PRINTF("NCE_DPU_PPE_SCALE_HCLAMP[0x%x]:0x%x",NCE_DPU_PPE_SCALE_HCLAMP_OFFSET,variant.invariant_->registers_.ppe_scale_hclamp);
            PRINTF("    -> ppe_scale_hclamp: 0x%x",variant.invariant_->registers_.ppe_scale_hclamp);
            PRINTF("NCE_DPU_PPE_SCALE_LCLAMP[0x%x]:0x%x",NCE_DPU_PPE_SCALE_LCLAMP_OFFSET,variant.invariant_->registers_.ppe_scale_lclamp);
            ...
            PRINTF("NCE_DPU_PPE_FP_CFG[0x%x]:0x%x",NCE_DPU_PPE_FP_CFG_OFFSET,variant.invariant_->registers_.ppe_fp_cfg.ppe_fp_cfg);
            ...
            PRINTF("NCE_DPU_WORKLOAD_SIZE0[0x%x]:0x%x",NCE_DPU_WORKLOAD_SIZE0_OFFSET,variant.registers_.workload_size0.workload_size0);
            ...
            leonPipePrintFlushBuffer();
            PRINTF("NCE_DPU_WORKLOAD_SIZE1[0x%x]:0x%x",NCE_DPU_WORKLOAD_SIZE1_OFFSET,variant.registers_.workload_size1.workload_size1);
            ...
            PRINTF("NCE_DPU_WORKLOAD_START0[0x%x]:0x%x",NCE_DPU_WORKLOAD_START0_OFFSET,variant.registers_.workload_start0.workload_start0);
            ...
            PRINTF("NCE_DPU_WORKLOAD_START1[0x%x]:0x%x",NCE_DPU_WORKLOAD_START1_OFFSET,variant.registers_.workload_start1.workload_start1);
        ...
        void decompressAndCopyData(uint8_t *dstDataPtr, uint8_t *srcDataPtr,
                uint32_t seSize, uint8_t *srcSparsPtr, uint8_t sparsePoint) {
        ...
        uint32_t reconstructData(nn::memory::cache_aligned_vector<uint8_t> *out_buf_decompressed,
            ...
            uint32_t numSE = (invariant.registers_.te_dim0.te_dim0_bf.te_dim_y + 1) *
                             (invariant.registers_.te_dim1.te_dim1_bf.te_dim_x + 1) *
                             seDepth;
            ...
            for (uint32_t seIdx = 0; seIdx < numSE; seIdx++) {
                ...
                decompressAndCopyData(dstDataPtr, srcDataPtr, seSize, srcSparsPtr,
                        sparsePoint);
