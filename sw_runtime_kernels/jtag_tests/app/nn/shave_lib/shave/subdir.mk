...
shavelib-preserved-symbols-y := mvSigmoid
...
shavelib-preserved-symbols-y += preSoftmax singleShaveSoftmax preSigmoid sigmoid_fp16 preCorrelation preROIPooling preCTCDecoder preReorgYolo preRegionYolo prePermute prePermute1D eltwisePreamble cleanEltwise argmaxPreamble preAvgPooling
