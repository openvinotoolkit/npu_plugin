...
shavelib-preserved-symbols-y += single_shave_gather
shavelib-preserved-symbols-y += singleShaveInterpolate
shavelib-preserved-symbols-y += single_shave_scatterNDUpdate
shavelib-preserved-symbols-$(CONFIG_TARGET_SOC_MA2490) += elu_fp16
shavelib-preserved-symbols-$(CONFIG_TARGET_SOC_MA2490) += selu_fp16
...
shavelib-preserved-symbols-$(CONFIG_TARGET_SOC_MA2490) += single_shave_LRN
shavelib-preserved-symbols-$(CONFIG_TARGET_SOC_MA2490) += tanh_fp16
shavelib-preserved-symbols-$(CONFIG_TARGET_SOC_MA2490) += mish_fp16
shavelib-preserved-symbols-$(CONFIG_TARGET_SOC_MA2490) += relu_fp16
shavelib-preserved-symbols-$(CONFIG_TARGET_SOC_MA2490) += eltwise_power_fp16
shavelib-preserved-symbols-$(CONFIG_TARGET_SOC_MA2490) += eltwise_add_fp16
shavelib-preserved-symbols-$(CONFIG_TARGET_SOC_MA2490) += eltwise_sub_fp16
shavelib-preserved-symbols-$(CONFIG_TARGET_SOC_MA2490) += eltwise_min_fp16
shavelib-preserved-symbols-$(CONFIG_TARGET_SOC_MA2490) += eltwise_max_fp16
shavelib-preserved-symbols-$(CONFIG_TARGET_SOC_MA2490) += eltwise_mul_fp16
shavelib-preserved-symbols-$(CONFIG_TARGET_SOC_MA2490) += eltwise_div_fp16
shavelib-preserved-symbols-$(CONFIG_TARGET_SOC_MA2490) += dummy
shavelib-preserved-symbols-$(CONFIG_TARGET_SOC_MA2490) += single_shave_convert
shavelib-preserved-symbols-$(CONFIG_TARGET_SOC_MA2490) += single_shave_topk
shavelib-preserved-symbols-$(CONFIG_TARGET_SOC_MA2490) += hardsigmoid_fp16
shavelib-preserved-symbols-$(CONFIG_TARGET_SOC_MA2490) += single_shave_pad
