...
.salign 16
//------------------------------------------------------------------------------------------------------------
//void gemm_hhhh_nnn_k8(const half *A, const half *B, half *C, int m, int k, int n, int wA, int wB, int wC)//
...
.nowarn
  ...
  LSU0.LDI.64 b1.0, pB0, wB     || LSU1.LDI.64 b1.1, pB1, wB    || IAU.ADD col_out, incr, 0          || SAU.SHL.X32 temp, wB, 3
  ...
  LSU0.LDI.64 b6.0, pB0, wB     || LSU1.LDI.64 b6.1, pB1, wB    || IAU.ADD pC, pC, wC          || CMU.VILV.X16 a0, a4, a_rd, a_rd
  LSU0.LD.64 b7.0, pB0          || LSU1.LD.64 b7.1, pB1         || IAU.SHL n_x_2, n, 1         || CMU.VILV.X32 a0, a2, a0, a0
  LSU0.LD.64 a_rd.0, A          || LSU1.LDO.64 a_rd.1, A, 8     || IAU.ADDSU pB0, B, col_out   || CMU.VILV.X32 a0, a1, a0, a0            || VAU.MACPZ.F16 zero  v23 V_ACC1
  LSU1.LDIH wB_goback, 0                                        || IAU.ADDSU pB1, pB0, 8       || CMU.CP.128.16.r v_max_fp16, max_fp16.0 || VAU.MACPZ.F16 c_half8  v23 V_ACC0


// _matmul_hhhh_k8_asm_loop labels (1) _matmul_hhhh_k8_asm_loop_col_out, (2) _matmul_hhhh_k8_asm_loop_common_dim and (3)_matmul_hhhh_k8_asm_loop_row_out
.lalign
_matmul_hhhh_k8_asm_loop:
  ...
  LSU0.LDI.64 b7.0, pB0, wB_goback || LSU1.LDI.64 b7.1, pB1, wB_goback || CMU.VILV.X32 a0, a2, a0, a0             || VAU.MACPw.F16 aux1 a7, b7 V_ACC0
  LSU0.LD.64 a_rd.0, A         || LSU1.LDO.64 a_rd.1, A, 8             || CMU.VILV.X32 a0, a1, a0, a0             || VAU.MACPW.F16 half8_out, zero, zero V_ACC1
// ~_matmul_hhhh_k8_asm_loop_common_dim
  ...
  LSU0.LDI.64 c_half8.0, C, incr  || LSU1.LDO.64 c_half8.1, C, 8      || IAU.SUBSU  temp, n_x_2, col_out || CMU.CLAMPAB.F16 half8_out, v_min_fp16, v_max_fp16
                                                                        IAU.SUB temp, col_out, incr      || PEU.PCIX NEQ 0x00 || BRU.BRA _matmul_hhhh_k8_asm_loop
...
// ~_matmul_hhhh_k8_asm_loop_col_out
  ...
  LSU0.LDI.64 b3.0, pB0, wB     || LSU1.LDI.64 b3.1, pB1, wB         || IAU.ADDSU pA0, A, incr  || BRU.BRA _matmul_hhhh_k8_asm_loop || PEU.PCIX NEQ 0x0
  ...
  LSU0.LDI.64 b7.0, pB0, wB_goback || LSU1.LDI.64 b7.1, pB1, wB_goback || CMU.VILV.X32 a0, a2, a0, a0 || IAU.ADD row_out, row_out, 1
  ...
  LSU0.LD.64 a_rd.0, A            || LSU1.LDO.64 a_rd.1, A, 8        || IAU.ADD C, C, incr || VAU.MACPZ.F16 c_half8  v23 V_ACC0
// _matmul_hhhh_k8_asm_loop_row_out
.nowarnend
