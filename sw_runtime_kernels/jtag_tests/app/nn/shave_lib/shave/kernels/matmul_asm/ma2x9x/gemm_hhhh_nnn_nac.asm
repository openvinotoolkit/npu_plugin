...
//
// @file
// Code for mvtMulAB kernel (C = A * B)
...
.salign 16
//------------------------------------------------------------------------------------------------------------
//void gemm_hhhh_nnn_nac(const half *A, const half *B, half *C, int m, int k, int n, int wA, int wB, int wC)//
...
.nowarn
  ...
  LSU0.LDIL max_fp16, PLUS_INF_FP16 || LSU1.LDIL min_fp16, MINUS_INF_FP16 || CMU.CPZV zero, 0
  LSU0.LDIL incr, 16            || LSU1.LD.32 wC, i19          || IAU.XOR row_out, row_out, row_out  || CMU.CP.128.16.r v_min_fp16, min_fp16.0
  IAU.SHL wB, wB, 1                                                                                  || CMU.CP.128.16.r v_max_fp16, max_fp16.0
  ...
  LSU0.LDI.64 b1.0, pB0, wB     || LSU1.LDI.64 b1.1, pB1, wB   || IAU.ADD col_out, incr, 0    || CMU.CPZV c_half8, 0
  ...
  LSU0.LDI.64 b5.0, pB0, wB     || LSU1.LDI.64 b5.1, pB1, wB   || IAU.ADD common_dim, k, 0
  LSU0.LDI.64 b6.0, pB0, wB     || LSU1.LDI.64 b6.1, pB1, wB   || IAU.ADD pC, C, wC   || CMU.VILV.X16 a0, a4, a0, a0
  LSU0.LDI.64 b7.0, pB0, wB     || LSU1.LDI.64 b7.1, pB1, wB   || IAU.SHL n_x_2, n, 1 || CMU.VILV.X32 a0, a2, a0, a0 || VAU.MACPZ.F16 v21  v23 V_ACC1
  LSU0.LDI.64 a0.0, pA0, incr   || LSU1.LDO.64 a0.1, pA0, 8    || CMU.VILV.X32 a0, a1, a0, a0                        || VAU.MACPZ.F16 c_half8  v23 V_ACC0
  NOP


// _gemm_hhhh_nnn_nac_loop labels (1) _gemm_hhhh_nnn_nac_loop_col_out, (2) _gemm_hhhh_nnn_nac_loop_common_dim and (3)_gemm_hhhh_nnn_nac_loop_row_out
.lalign
_gemm_hhhh_nnn_nac_loop:
  LSU0.LDI.64 b0.0, pB0, wB     || LSU1.LDI.64 b0.1, pB1, wB   || CMU.VILV.X32 a2, a3, a2, a2     || VAU.MACP.F16 a0, b0 V_ACC1
  LSU0.LDI.64 b1.0, pB0, wB     || LSU1.LDI.64 b1.1, pB1, wB   || CMU.VILV.X32 a4, a6, a4, a4     || VAU.MACP.F16 a1, b1 V_ACC0 || IAU.SUBSU common_dim, common_dim, 8
  LSU0.LDI.64 b2.0, pB0, wB     || LSU1.LDI.64 b2.1, pB1, wB   || BRU.BRA _gemm_hhhh_nnn_nac_loop || VAU.MACP.F16 a2, b2 V_ACC1 || PEU.PCIX NEQ 0x00
  ...
  LSU0.LDI.64 b5.0, pB0, wB     || LSU1.LDI.64 b5.1, pB1, wB   || CMU.VILV.X32 a6, a7, a6, a6     || VAU.MACP.F16 a5, b5 V_ACC0
...
// ~_gemm_hhhh_nnn_nac_loop_common_dim
  LSU0.LD.64 a0.0, A            || LSU1.LDO.64 a0.1, A, 8         || IAU.ADDSU pB0, B, col_out
  CMU.CPZV c_half8, 0   || IAU.ADDSU pB1, pB0, 8
  ...
  LSU0.LDI.64 b3.0, pB0, wB     || LSU1.LDI.64 b3.1, pB1, wB   || BRU.BRA _gemm_hhhh_nnn_nac_loop || PEU.PCIX NEQ 0x00
  LSU0.LDI.64 b4.0, pB0, wB     || LSU1.LDI.64 b4.1, pB1, wB   || IAU.ADDSU pA0, A, 16
  LSU0.LDI.64 b5.0, pB0, wB     || LSU1.LDI.64 b5.1, pB1, wB   || CMU.VILV.X16 a0, a4, a0, a0   || IAU.ADD common_dim, k, 0
  LSU0.LDI.64 b6.0, pB0, wB     || LSU1.LDI.64 b6.1, pB1, wB   || CMU.VILV.X32 a0, a2, a0, a0
  LSU0.LDI.64 b7.0, pB0, wB     || LSU1.LDI.64 b7.1, pB1, wB   || IAU.ADD col_out, col_out, 16  || CMU.CLAMPAB.F16 half8_out, v_min_fp16, v_max_fp16
...
// ~_gemm_hhhh_nnn_nac_loop_col_out
  CMU.CP.32 pB0, B              || IAU.ADDSU A, A, wA
  LSU0.LD.64 a0.0, A            || LSU1.LDO.64 a0.1, A, 8           || IAU.ADDSU pB1, B, 8  || CMU.CP.32 C, pC
  LSU0.LDI.64 b0.0, pB0, wB     || LSU1.LDI.64 b0.1, pB1, wB        || IAU.ADD col_out, incr, 0  || CMU.CPZV c_half8, 0
  LSU0.LDI.64 b1.0, pB0, wB     || LSU1.LDI.64 b1.1, pB1, wB        || IAU.SUBSU temp, m, row_out
  LSU0.LDI.64 b2.0, pB0, wB     || LSU1.LDI.64 b2.1, pB1, wB        || IAU.ADDSU pC, pC, wC || BRU.BRA _gemm_hhhh_nnn_nac_loop || PEU.PCIX NEQ 0x0
  LSU0.LDI.64 b3.0, pB0, wB     || LSU1.LDI.64 b3.1, pB1, wB        || IAU.ADD row_out, row_out, 1
  ...
  LSU0.LDI.64 a0.0, pA0, incr      || LSU1.LDO.64 a0.1, pA0, 8          || CMU.VILV.X32 a0, a1, a0, a0 || VAU.MACPZ.F16 c_half8  v23 V_ACC0
// _gemm_hhhh_nnn_nac_loop_row_out
.nowarnend
