...
extern uint32_t SLK_single_shave_gather;
extern uint32_t SLK_singleShaveInterpolate;
extern uint32_t SLK_single_shave_scatterNDUpdate;
extern uint32_t SLK_single_shave_LRN;
extern uint32_t SLK_elu_fp16;
extern uint32_t SLK_selu_fp16;
extern uint32_t SLK_exp_fp16;
extern uint32_t SLK_dummy;
extern uint32_t SLK_sqrt_fp16;
extern uint32_t SLK_tanh_fp16;
extern uint32_t SLK_mish_fp16;
extern uint32_t SLK_relu_fp16;
extern uint32_t SLK_single_shave_convert;
extern uint32_t SLK_single_shave_topk;
extern uint32_t SLK_eltwise_power_fp16;
extern uint32_t SLK_eltwise_add_fp16;
extern uint32_t SLK_eltwise_sub_fp16;
extern uint32_t SLK_eltwise_min_fp16;
extern uint32_t SLK_eltwise_max_fp16;
extern uint32_t SLK_eltwise_mul_fp16;
extern uint32_t SLK_eltwise_div_fp16;
extern uint32_t SLK_hardsigmoid_fp16;
extern uint32_t SLK_single_shave_pad;
