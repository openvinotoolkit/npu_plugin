...
int main()
{
    ...
    */
    auto input = compModel.input({128, 128, 3}, mv::DType::Float, mv::Order::ColumnMajor);
    ...
    /*
        ...
        additionally it requires a vector of double values to be passed. The length of this vector has to match the total
    ...
    */
    mv::Data::TensorIterator weights1 = compModel.constant(weights1Data, {3, 3, 3, 8}, mv::DType::Float, mv::Order::ColumnMajor);
    ...
    */
    ...
    auto weights2 = compModel.constant(weights2Data, {5, 5, 8, 16}, mv::DType::Float, mv::Order::ColumnMajor);
    ...
    auto weights3 = compModel.constant(weights3Data, {4, 4, 16, 32}, mv::DType::Float, mv::Order::ColumnMajor);
