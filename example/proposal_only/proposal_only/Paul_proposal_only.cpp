...
int main()
{
    ...
    int post_nms_topn = 200;
    double nms_thresh = 0.6;
    int feat_stride = 16;
    int min_size = 16;
    ...
    // Build Model
    auto proposal0 = om.proposal(inputs, pre_nms_topn, post_nms_topn, nms_thresh, feat_stride, min_size, mv::DType("Float64"), {{0},{1.0},{-inf},{inf}}, "proposal0");
    om.output(proposal0);
