...
/// @brief message for model argument
static const char head_message[] = "Required. Path to a preprocessing layers.";

/// @brief message for model argument
static const char tail_message[] = "Required. Path to a postprocessing layers.";
...
/// @brief Define parameter for set model file <br>
/// It is a required parameter
DEFINE_string(head, "", head_message);

/// @brief Define parameter for set model file <br>
/// It is a required parameter
DEFINE_string(tail, "", tail_message);
...
static void showUsage() {
    ...
    std::cout << "    -head \"<path>\"           " << head_message << std::endl;
    std::cout << "    -tail \"<path>\"           " << tail_message << std::endl;
