...
/**
 * @class ClassificationResultO
 * @brief A ClassificationResultO creates an output table with results
 */
template <class strType = std::string>
class ClassificationResultOT {
private:
...
public:
    explicit ClassificationResultOT(InferenceEngine::Blob::Ptr output_blob, std::vector<strType> image_names = {}, size_t batch_size = 1, size_t num_of_top = 10,
...
using ClassificationResultO = ClassificationResultOT<>;
using ClassificationResultOW = ClassificationResultOT<std::wstring>;
