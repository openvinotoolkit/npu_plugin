 ...
 * @param platform MYRIAD_2, MYRIAD_X or ANY_PLATFORM for any device
 * @param protocol USB, PCIE or ANY_PROTOCOL for any protocol
...
MVNC_EXPORT_API ncStatus_t ncDeviceOpen(struct ncDeviceHandle_t **deviceHandlePtr,
        ncDevicePlatform_t platform, ncDeviceProtocol_t protocol, int watchdogInterval,
