...
int main()
{
    ...
    mv::ComputationModel cm(mv::Logger::VerboseDebug);

    auto inIt = cm.input(mv::Shape(1, 32, 32, 1), mv::Tensor::Float, mv::Tensor::NWHC);
    ...
    mv::ConstantTensor weights(mv::Shape(1, 3, 3, 3), mv::Tensor::Float, mv::Tensor::NWHC, weightsData);
