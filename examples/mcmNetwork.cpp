...
int main()
{
    ...
    auto weights0 = om.constantInt(weightsData0,{3,3,3,64}, mv::DType("UInt8"), mv::Order::getZMajorID(4), {{135},{0.0025439101736992598},{-0.3435550332069397},{0.3051420748233795}}, "conv#0_weights#1");
    ...
    auto biasWeights0 = om.constantInt(biasWeightsData0,{64}, mv::DType("UInt8"), mv::Order::getColMajorID(1), {{0},{1.9952236470999196e-05},{-inf},{inf}}, "conv#0_bias#2");
    ...
    auto weights1 = om.constantInt(weightsData1,{3,3,64,128}, mv::DType("UInt8"), mv::Order::getZMajorID(4), {{125},{0.003295167814940214},{-0.41293057799339294},{0.4273372292518616}}, "conv_1#3_weights#4");
    ...
    auto biasWeights1 = om.constantInt(biasWeightsData1,{128}, mv::DType("UInt8"), mv::Order::getColMajorID(1), {{0},{1.292222714255331e-05},{-inf},{inf}}, "conv_1#3_bias#5");
    ...
    auto weights2 = om.constantInt(weightsData2,{3,3,128,128}, mv::DType("UInt8"), mv::Order::getZMajorID(4), {{118},{0.0037134578451514244},{-0.44002026319503784},{0.5069115161895752}}, "output#6_weights#7");
    ...
    auto biasWeights2 = om.constantInt(biasWeightsData2,{128}, mv::DType("UInt8"), mv::Order::getColMajorID(1), {{0},{1.4562579963239841e-05},{-inf},{inf}}, "output#6_bias#8");
    auto bias_c2 = om.bias(conv2, biasWeights2, {{0},{0.003921568859368563},{0.0},{1.0}});

    om.output(bias_c2);

    std::string compDescPath = "/home/vamsikku/work/mcmCompilerUsage/debug_kmb_MC-Prefetch2.json";
