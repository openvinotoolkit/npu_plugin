...
int main()
{
    ...
    auto input = cm.input({224, 224, 3}, mv::DType::Float, mv::Order::RowMajorPlanar);
    ...
    auto weights = cm.constant(weightsData, {pool5->getShape().totalSize(), 1000}, mv::DType::Float, mv::Order::RowMajorPlanar);
