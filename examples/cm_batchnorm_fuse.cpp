...
int main()
{
    ...
    auto bnmean = om.constant(meanData, conv->getShape(), mv::DType::Float, mv::Order::NWHC, "mean");
    auto bnvariance = om.constant(varianceData, conv->getShape(), mv::DType::Float, mv::Order::NWHC, "variance");
    auto bnoffset = om.constant(offsetData, conv->getShape(), mv::DType::Float, mv::Order::NWHC, "offset");
    auto bnscale = om.constant(scaleData, conv->getShape(), mv::DType::Float, mv::Order::NWHC, "scale");
