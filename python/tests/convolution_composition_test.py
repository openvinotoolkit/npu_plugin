...
class TestComposition(unittest.TestCase):
    ...
    def test_convolution(self):
        ...
        weightData = ca.getData(np.arange(3 * 3 * 3 * 3).astype(np.double32))
    ...
    def test_concat(self):
        ...
        k1blurData = ca.getData(np.array(k1data).astype(np.double32))
        ...
        k2edgeData = ca.getData(np.array(k2data).astype(np.double32))
    ...
    def test_matMul(self):
        ...
        in_ = ca.input(om, shape)
        weightData = ca.getData(np.arange(100 * 100).astype(np.double32))
    ...
    def test_batchNorm(self):
        ...
        in_ = ca.input(om, shape)
        meanData = ca.getData(np.arange(28 * 28 * 4).astype(np.double32))
        mean_ = ca.constant(om, meanData, ca.getShape(28, 28, 4))

        varData = ca.getData(np.arange(28 * 28 * 4).astype(np.double32))
        variance_ = ca.constant(om, varData, ca.getShape(28, 28, 4))

        offsetData = ca.getData(np.arange(28 * 28 * 4).astype(np.double32))
        offset_ = ca.constant(om, offsetData, ca.getShape(28, 28, 4))

        scaleData = ca.getData(np.arange(28 * 28 * 4).astype(np.double32))
    ...
    def test_scale(self):
        ...
        in_ = ca.input(om, shape)
        weightData = ca.getData(np.arange(32 * 32 * 3).astype(np.double32))
    ...
    def test_bias(self):
        ...
        data = ca.getData(np.arange(3).astype(np.double32))
    ...
    def test_compile_convolution_01(self):
        ...
        weightData = ca.getData(np.array(arr).astype(np.double32))
    ...
    def test_compile_convolution_02(self):
        ...
        weightData = ca.getData(np.linspace(0.101, 0.101 + (3 * 3 * 3 * 3 - 1) * 0.001, 3 * 3 * 3 * 3).astype(np.double32))
    ...
    def test_compile_convolution_04(self):
        ...
        weightData = ca.getData(np.linspace(0.101, 0.101 + (5 * 5 * 3 * 3 - 1) * 0.001, 5 * 5 * 3 * 3).astype(np.double32))
