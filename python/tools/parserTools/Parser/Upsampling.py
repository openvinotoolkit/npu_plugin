...
class Upsampling(Layer):
    ...
    def __compute_output_shape(self):
        ...
        out_batch = in_batch
        out_channels = self.output_pad_C[0] + self.output_pad_C[1] + in_channels + \
                       (in_channels - 1) * (self.upsampling_factor_C - 1)
        ...
        self.outputTensorSizes = [[out_batch, out_channels, out_height, out_width]]
