...
from parserTools.TensorFlowLiteParser.tflite.MulOptions import MulOptions
from parserTools.TensorFlowLiteParser.tflite.SubOptions import SubOptions
from parserTools.TensorFlowLiteParser.tflite.AddOptions import AddOptions
...
def load(obj, op_type, tensors, buffers):
    ...
    x = Eltwise(out.Name(), [activation1.Name(), activation2.Name()], [out.Name()])
