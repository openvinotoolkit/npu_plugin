...
from parserTools.TensorFlowLiteParser.tflite.ConcatenationOptions import ConcatenationOptions
...
def load(obj, op_type, tensors, buffers):
    ...
    x = Concat(out.Name(), [activation.Name() for activation in activations], [out.Name()])
