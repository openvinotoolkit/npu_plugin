...
static Etalon etalon06 = {{112, 28, 64, 1}, mv::Order("NCHW"), dpu_mode_poc, 2, true, true,
                          {{0, 56, 0, 28}, {56, 112, 0, 28}}};

static Etalon etalon07 = {{112, 28, 64, 1}, mv::Order("NCHW"), dpu_mode_poc, 4, true, true,
                          {{0, 28, 0, 28}, {28, 56, 0, 28}, {56, 84, 0, 28}, {84, 112, 0, 28}}};

static Etalon etalon08 = {{112, 28, 64, 1}, mv::Order("NCHW"), dpu_mode_poc, 5, true, true,
...
// FIXME: POC seems to mess tensor layout - shape must be {1, 1, 1000, 1}
static Etalon etalon12 = {{1000, 1, 1, 1}, mv::Order("NCHW"), dpu_mode_poc, 4, false, true,
...
INSTANTIATE_TEST_CASE_P(combi, workloads_rect_resnet50,
                        Values(etalon01, etalon02, etalon03, etalon04, etalon05,
                               ...
                               etalon09, etalon10, etalon11, etalon12));
