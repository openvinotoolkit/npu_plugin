...
INSTANTIATE_TEST_CASE_P(BehaviorTest, LayoutTestCanLoadPower, ::testing::ValuesIn(power_test_cases), getTestName);
...
INSTANTIATE_TEST_CASE_P(BehaviorTest, LayoutTestCanNotLoadConv, ::testing::ValuesIn(conv_neg_test_cases), getTestName);

layout_test_params conv_test_cases[] = {
    layout_test_params("kmbPlugin", "FP16", Layout::CHW, power_params({{3, 32, 16}}, 2, 2, 2)),
    layout_test_params("kmbPlugin", "FP16", Layout::NCHW, power_params({{1, 3, 16, 16}}, 2, 2, 2)),
};
INSTANTIATE_TEST_CASE_P(BehaviorTest, LayoutTestCanLoadConv, ::testing::ValuesIn(conv_test_cases), getTestName);
#endif
