...
//auto weights0 = om.constantInt(weightsData0,{1,1,16,1}, mv::DType("Int8"), mv::Order::getZMajorID(4), {{0},{1.0},{},{}});//
    auto weights0 = om.constantInt(weightsData0,{3,3,16,16}, mv::DType("Int8"), mv::Order::getZMajorID(4), {{0},{1.0},{},{}});
    //the 2 is dilation factor
    //auto conv0 = om.conv(input0, weights0, {1, 1}, {0, 0, 0, 0}, 2, 1,  mv::DType("Int8"),{{0},{1},{},{}} , "conv");
    //dilation 1
