...
int main()
{
    ...
    // Identity MaxPools
    auto identity_maxPool0 = om.maxPool(input0, {1,1}, {1,1}, {0,0,0,0}, true, "", "floor", mv::DType("Default"), in_qp0, "identity_maxpool0");
    auto identity_maxPool1 = om.maxPool(input0, {1,1}, {1,1}, {0,0,0,0}, true, "", "floor", mv::DType("Default"), in_qp1, "identity_maxpool1");

    // Eltwise, to be replaced with eltwiseFP16 in replacement pass
    auto eltwise0 = om.eltwise({identity_maxPool0, identity_maxPool1}, "Add", mv::DType("Default"), out_qp, "eltwise0");

    // Re-quantize output
    auto outputMaxPool0 = om.maxPool(eltwise0, {1,1}, {1,1}, {0,0,0,0}, true, "", "floor", mv::DType("Default"), out_qp, "requantize_output");
