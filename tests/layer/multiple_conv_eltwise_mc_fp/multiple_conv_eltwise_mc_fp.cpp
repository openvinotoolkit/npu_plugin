...
{
    std::string filePath = mv::utils::projectRootPath() + "/tests/layer/multiple_conv_eltwise_mc_fp/" + input_file;
...
int main()
{
    ...
    auto input = om.input({16,40,784,1}, mv::DType("Float16"), mv::Order::getZMajorID(4), {{0},{1.0},{-inf},{inf}}, "input");
    ...
    std::string compDescPath = mv::utils::projectRootPath() +
        "/tests/layer/multiple_conv_eltwise_mc_fp/release_kmb_multiple_conv_eltwise_mc_fp.json";
