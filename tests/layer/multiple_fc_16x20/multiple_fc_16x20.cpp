...
{
    std::string filePath = mv::utils::projectRootPath() + "/tests/layer/multiple_fc_16x20/" + input_file;
...
int main()
{
    ...
    std::string compDescPath = mv::utils::projectRootPath() +
        "/tests/layer/multiple_fc_16x20/release_kmb_SC-Prefetch2_manual_streamK_16x20.json";
