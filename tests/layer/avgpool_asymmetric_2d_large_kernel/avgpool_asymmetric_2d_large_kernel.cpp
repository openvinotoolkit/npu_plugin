...
void build_pySwigCU(mv::OpModel& model)
{
    ...
    const auto icnet_features_conv5_3_pool2_1_AvgPool_AvgPool_2_0 = model.averagePool(input_1_0, {30, 23}, {30, 23}, {0, 0, 0, 0}, false, mv::DType("UInt8"), {{128},{0.007843137718737},{-1.003921627998352},{0.996078431606293},{0},{1}}, "icnet_features/conv5_3_pool2_1/AvgPool/AvgPool#2");
