...
int main()
{
    ...
    auto d_weights0 = om.constantInt(weightsData0,kernel, mv::DType("UInt8"), mv::Order::getZMajorID(4), {{zeroPointWt},{1.0/zeroPointWt},{-1.000000000000000},{1.000000000000000}}, "dwconv0#0_weights#1");
    auto depthConv0 = om.depthwiseConv(data_0, d_weights0, stride, {0, 0, 0, 0}, 1, mv::DType("UInt8"), {{32},{4},{-inf},{inf}}, "dwconv0#4");
