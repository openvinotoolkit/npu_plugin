...
int main()
{
    ...
    std::vector<double> weightsData0 = mv::utils::generateSequence<double> (32*16*3*3, 1.0, 0.0); 
    //Wights first input channel of output channel full of 1s
    auto weights0 = om.constant(weightsData0,{3,3,16,32}, mv::DType("Float16"), mv::Order::getZMajorID(4), {{0},{1.0},{},{}});
