...
public:
    ...
    void set_xmin(const float& v) {
        _xmin = v;
    }
    void set_ymin(const float& v) {
        _ymin = v;
    }
    void set_xmax(const float& v) {
        _xmax = v;
    }
    void set_ymax(const float& v) {
        _ymax = v;
    }

    void set_size(const float& v) {
        _size = v;
    }
...
struct BBox {
    ...
    const Dtype& xmin() const {
        return data[0];
    }
    const Dtype& ymin() const {
        return data[1];
    }
    const Dtype& xmax() const {
        return data[2];
    }
    const Dtype& ymax() const {
        return data[3];
    }

    void set_xmin(const Dtype& v) {
        xmin() = v;
    }
    void set_ymin(const Dtype& v) {
        ymin() = v;
    }
    void set_xmax(const Dtype& v) {
        xmax() = v;
    }
    void set_ymax(const Dtype& v) {
        ymax() = v;
    }
};
...
template <typename Dtype>
Dtype JaccardOverlap(const BBox<Dtype>& bbox1, const BBox<Dtype>& bbox2, const bool normalized = true);
...
void DecodeBBoxesAll(const std::vector<LabelBBox>& all_loc_pred, const std::vector<NormalizedBBox>& prior_bboxes,
