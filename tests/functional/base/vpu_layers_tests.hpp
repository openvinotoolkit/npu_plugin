...
protected:
    ...
    std::string genPorts(const IN_OUT_desc& tensors,
                         size_t* inoutIndex,
                         const std::string& bracketName);

    void genLayer(std::string layer_type,
    ...
    void genWeights(int weights_size,
                    int biases_size,
                    size_t* inoutIndex,
                    std::string& out);
    ...
    void genXML(const std::string& layer_type,
                std::map<std::string, std::string>* params,
                int weights_size,
                int biases_size,
                std::string& model
...
protected:
    ...
    struct ObjectToGen {
        ObjectToGen(const std::string& layer,
                    const std::map<std::string, std::string>* inparams,
                    size_t w_size,
                    size_t b_size,
                    calcWeights Weights,
