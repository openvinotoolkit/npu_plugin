...
TEST_F(KmbNetworkTest, DISABLED_ResNet_50_v1_tf_int8_sparse) {
...
TEST_F(KmbNetworkTest, DISABLED_ResNet_50_v1_onnx_int8_sparse) {
    runClassifyNetworkTest(
...
TEST_F(KmbNetworkTest, DISABLED_MobileNet_v2_onnx_int8_sparse) {
    runClassifyNetworkTest(
...
TEST_F(KmbNetworkTest, MobileNet_v2_tf_int8_sparse) {
    runClassifyNetworkTest(
