...
std::vector<TestingNetworkParameters> vpuInferAndCompareTestsNQA = {
        ...
        TestingNetworkParameters{"GoogLeNet_v1_tf_int8",
                        ...
                        "/224x224/cat3.bmp"},
        TestingNetworkParameters{"MobileNet_v2_tf_int8-dense",
                        "/KMB_models/NQA/MoblieNet-v2-tf/mobilenetv2-int8.xml",
                        "/KMB_models/NQA/MoblieNet-v2-tf/mobilenetv2-int8.bin",
                        "/224x224/cat3.bmp"},
        TestingNetworkParameters{"MobileNet_v2_tf_int8-sparse",
