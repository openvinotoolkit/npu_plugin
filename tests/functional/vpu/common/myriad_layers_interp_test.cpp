...
typedef myriadLayerTestBaseWithParam<tuple<interp_test_params, layout, align_corners>> myriadLayersTestsInterp_nightly;
...
TEST_P(myriadLayersTestsInterp_nightly, Interp)
{
    ...
    const char* layout = get<1>(GetParam());
    ...
    ASSERT_NO_FATAL_FAILURE(NetworkInit("Interp",
                &params,
                0,
                0,
                nullptr,
