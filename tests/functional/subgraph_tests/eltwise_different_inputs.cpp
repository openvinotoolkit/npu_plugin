...
class EltwiseAddQuantizedSubGraphTest_VPU3720 :
    ...
    void SetUp() override {
        ...
        const auto dataFq = ngraph::builder::makeFakeQuantize(paramOuts[0], ngraph::element::f16, dataLevels, {},
                                                         {0.0}, {12.583984375}, {0.0}, {12.583984375});
        ...
        const auto outputFq = ngraph::builder::makeFakeQuantize(addOp, ngraph::element::f16, outLevels, {},
                                                         {0.0}, {13.583984375}, {0.0}, {13.583984375});
