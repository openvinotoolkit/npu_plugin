...
class KmbQuantizedAveragePoolSubGraphTest :
    ...
    void SetUp() override {
        ...
        function = std::make_shared<ngraph::Function>(results, params, "KmbQuantizedAveragePool");
...
TEST_P(KmbQuantizedAveragePoolSubGraphTest, CompareWithRefs_MLIR_HW) {
    //useCompilerMLIR(); //Use MCM
    //setDefaultHardwareModeMLIR();
    Run();
}

INSTANTIATE_TEST_CASE_P(smoke, KmbQuantizedAveragePoolSubGraphTest,
