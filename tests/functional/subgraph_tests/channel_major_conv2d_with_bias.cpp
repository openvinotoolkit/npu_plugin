...
class KmbChannelMajorConv2dWithBiasTest :
    ...
    void SetUp() override {
        ...
        function = std::make_shared<ngraph::Function>(results, params, "KmbChannelMajorConv2dWithBiasTest");

        threshold = 0.5f;
    }
};

// TEST_P(KmbChannelMajorConv2dWithBiasTest, CompareWithRefs_MCM) {
//     Run();
// }

// TEST_P(KmbChannelMajorConv2dWithBiasTest, CompareWithRefs_MLIR_SW) {
//     useCompilerMLIR();
...
INSTANTIATE_TEST_CASE_P(channel_major_conv2d_with_act, KmbChannelMajorConv2dWithBiasTest,
