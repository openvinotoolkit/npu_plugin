...
const auto genParams(const  std::vector<std::vector<size_t>> inShapes,const  std::vector<std::vector<size_t>> coordShapes, const size_t output_dim, 
                     const float spatial_scale, const size_t group_size, const size_t spatial_bins_x, const size_t spatial_bins_y,
                     const std::string mode)
{
    ...
    return ::testing::Combine(
        ...
        ::testing::Values(spatial_scale),  ::testing::Values(group_size),    ::testing::Values(spatial_bins_x),
        ::testing::Values(spatial_bins_y), ::testing::Values(mode),          ::testing::ValuesIn(netPRCs),
        ::testing::Values(LayerTestsUtils::testPlatformTargetDevice));
}

#define GEN_TEST(no,inShapes,coordShapes,output_dim,spatial_scale,group_size,spatial_bins_x,spatial_bins_y,mode)\
INSTANTIATE_TEST_CASE_P( \
        smoke_TestsPSROIPooling_Case ## no, \
        KmbPSROIPoolingLayerTest, \
        genParams(inShapes,coordShapes,output_dim,spatial_scale,group_size,spatial_bins_x,spatial_bins_y,mode),\
