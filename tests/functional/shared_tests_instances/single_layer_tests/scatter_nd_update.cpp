...
class KmbScatterNDUpdateLayerTest_VPU3720 : public ScatterNDUpdateLayerTest, virtual public LayerTestsUtils::KmbLayerTestsCommon {};
...
std::map<std::vector<size_t>, std::map<std::vector<size_t>, std::vector<size_t>>> sliceSelectInShape {
    ...
    {{3, 3, 3}, {{{2, 1}, {0, 2}}, {{2, 2, 3}, {0, 0, 0, 2, 2, 2, 1, 0, 0, 1, 2, 2}}, {{2, 2}, {0, 0, 2, 2}}, {{2, 3}, {0, 0, 0, 2, 2, 2}}}}
};
...
INSTANTIATE_TEST_SUITE_P(
        smoke_ScatterNDUpdate_VPU3720,
        KmbScatterNDUpdateLayerTest_VPU3720,
        testing::Combine(
           testing::ValuesIn(ScatterNDUpdateLayerTest::combineShapes(sliceSelectInShape)),
           testing::Values(InferenceEngine::Precision::FP16), // network
           testing::Values(InferenceEngine::Precision::I32),  // indices
...
INSTANTIATE_TEST_SUITE_P(
        smoke_precommit_ScatterNDUpdate_VPU3720,
        KmbScatterNDUpdateLayerTest_VPU3720,
        testing::Combine(
           testing::ValuesIn(ScatterNDUpdateLayerTest::combineShapes(precommit_sliceSelectInShape)),
           testing::Values(InferenceEngine::Precision::FP16), // network
           testing::Values(InferenceEngine::Precision::I32),  // indices
           testing::Values(LayerTestsUtils::testPlatformTargetDevice)),
        KmbScatterNDUpdateLayerTest::getTestCaseName
