...
class KmbPriorBoxClusteredLayerTest: public PriorBoxClusteredLayerTest, virtual public LayerTestsUtils::KmbLayerTestsCommon {
};
...
INSTANTIATE_TEST_CASE_P(
        smoke_PriorBoxClustered,
        KmbPriorBoxClusteredLayerTest,
        testing::Combine(
           layerSpeficParams,
