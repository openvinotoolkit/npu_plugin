...
class KmbBucketizeLayerTest : public BucketizeLayerTest, virtual public LayerTestsUtils::KmbLayerTestsCommon {
    void SetUp() override {
        std::tie(
            std::ignore /*Data shape*/,
            std::ignore /*Buckets shape*/,
            std::ignore /*Right edge of interval*/, 
            std::ignore /*Data input precision*/,
            std::ignore /*Buckets input precision*/, 
            outPrc,
...
const auto testBucketizeParams = ::testing::Combine(
        ...
        ::testing::ValuesIn(dataInputPrecisions),
        ::testing::ValuesIn(bucketsInputPrecisions),
        ::testing::Values(outputPrecisions[0]),
        ::testing::Values(LayerTestsUtils::testPlatformTargetDevice)
);

INSTANTIATE_TEST_CASE_P(smoke_BucketizeTest,
                        KmbBucketizeLayerTest,
                        testBucketizeParams,
...
const auto testBucketizeParamsI64 = ::testing::Combine(
        ...
        ::testing::ValuesIn(bucketsShapes),
        ::testing::ValuesIn(with_right_bound),
        ::testing::Values(dataInputPrecisions[0]),
        ::testing::Values(bucketsInputPrecisions[0]),
        ::testing::Values(outputPrecisions[1]),
        ::testing::Values(LayerTestsUtils::testPlatformTargetDevice)
);

INSTANTIATE_TEST_CASE_P(smoke_BucketizeTestI64,
                        KmbBucketizeLayerTest,
                        testBucketizeParamsI64,
                        KmbBucketizeLayerTest::getTestCaseName);
