...
TEST_P(VPUXDftLayerTest, VPU3720_SW) {
    setPlatformVPU3720();
    setReferenceSoftwareModeMLIR();
    Run();
}

TEST_P(VPUXDftLayerTest, VPU3720_HW) {
    setPlatformVPU3720();
...
INSTANTIATE_TEST_SUITE_P(smoke_precommit_DFT_3d, VPUXDftLayerTest,
...
INSTANTIATE_TEST_SUITE_P(smoke_DFT_4d_single_axis, VPUXDftLayerTest,
                         combine({{10, 4, 8, 2}},        // input shapes
                                 {{0}, {1}, {2}},        // axes
                                 {{}, {1}, {5}, {20}}),  // signal sizes
                         DFTLayerTest::getTestCaseName);

INSTANTIATE_TEST_SUITE_P(smoke_precommit_DFT_5d, VPUXDftLayerTest,
