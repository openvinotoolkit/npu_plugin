...
INSTANTIATE_TEST_CASE_P(smoke_TestsSelect_none, KmbSelectLayerTest, noneCases, KmbSelectLayerTest::getTestCaseName);

INSTANTIATE_TEST_CASE_P(smoke_TestsSelect_numpy, KmbSelectLayerTest, numpyCases, KmbSelectLayerTest::getTestCaseName);
