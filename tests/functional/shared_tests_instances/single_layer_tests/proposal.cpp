...
protected:
    ...
    // LayerTestsCommon
    //  Please check base on reference from:
    //  openvino/src/tests_deprecated/functional/vpu/common/layers/myriad_layers_proposal_test.cpp
    // I consider to extend this verification base on: the output can have less that 20 ROI,
...
INSTANTIATE_TEST_SUITE_P(smoke_Proposal_tests_108377, KmbProposalLayerTest,
                        ::testing::Combine(
                            ::testing::Combine(
                                ::testing::ValuesIn(std::vector<base_size_type>{32}),
...
INSTANTIATE_TEST_SUITE_P(smoke_Proposal_tests_129693, KmbProposalLayerTest,
                        ::testing::Combine(
                            ::testing::Combine(
                                ::testing::ValuesIn(std::vector<base_size_type>{16}),
