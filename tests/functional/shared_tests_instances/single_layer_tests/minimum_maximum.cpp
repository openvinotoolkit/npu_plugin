...
INSTANTIATE_TEST_CASE_P(smoke_maximum_4D, KmbMaxMinLayerTest_MLIR,
                        ::testing::Combine(
...
INSTANTIATE_TEST_CASE_P(smoke_maximum_3D, KmbMaxMinLayerTest_MLIR,
                        ::testing::Combine(
...
INSTANTIATE_TEST_CASE_P(smoke_maximum_scalar, KmbMaxMinLayerTest_MCM,
                        ::testing::Combine(
