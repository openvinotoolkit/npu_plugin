...
class VPUXRangeLayerTest_VPU3720 : public RangeLayerTest, virtual public LayerTestsUtils::KmbLayerTestsCommon {
...
INSTANTIATE_TEST_SUITE_P(smoke_precommit_Range, VPUXRangeLayerTest_VPU3720,
                         testing::Combine(testing::ValuesIn(start),  // start
                                          testing::ValuesIn(stop),   // stop
                                          testing::ValuesIn(step),   // positive step
                                          testing::ValuesIn(netPrecisions), testing::ValuesIn(InputPrecisions),
...
INSTANTIATE_TEST_SUITE_P(smoke_precommit_negative_Range, VPUXRangeLayerTest_VPU3720,
