...
using InferRequestCallbackTestsVpux = BehaviorTestsUtils::InferRequestTestsVpux;

TEST_P(InferRequestCallbackTestsVpux, canCallAsyncWithCompletionCallback) {
    // Create InferRequest
...
TEST_P(InferRequestCallbackTestsVpux, syncInferDoesNotCallCompletionCallback) {
    InferenceEngine::InferRequest req = execNet.CreateInferRequest();
    bool isCalled = false;
...
TEST_P(InferRequestCallbackTestsVpux, canStartSeveralAsyncInsideCompletionCallbackWithSafeDtor) {
...
TEST_P(InferRequestCallbackTestsVpux, returnGeneralErrorIfCallbackThrowException) {
    // Create InferRequest
...
TEST_P(InferRequestCallbackTestsVpux, LegacyCastAndSetuserDataGetUserData) {
    // Create InferRequest
    InferenceEngine::InferRequest req = execNet.CreateInferRequest();
    int userData = 0;
    {
        ...
        ASSERT_EQ(InferenceEngine::OK, ireq->SetCompletionCallback([](InferenceEngine::IInferRequest::Ptr request,
...
TEST_P(InferRequestCallbackTestsVpux, ReturnResultNotReadyFromWaitInAsyncModeForTooSmallTimeout) {
...
TEST_P(InferRequestCallbackTestsVpux, ImplDoseNotCopyCallback) {
