...
using InferRequestMultithreadingTestsVpux = BehaviorTestsUtils::InferRequestTestsVpux;

TEST_P(InferRequestMultithreadingTestsVpux, canRun3SyncRequestsConsistentlyFromThreads) {
    // Create InferRequest
...
TEST_P(InferRequestMultithreadingTestsVpux, canRun3AsyncRequestsConsistentlyFromThreadsWithoutWait) {
    // Create InferRequest
    auto req1 = execNet.CreateInferRequest();
    auto req2 = execNet.CreateInferRequest();
    auto req3 = execNet.CreateInferRequest();
...
TEST_P(InferRequestMultithreadingTestsVpux, canRun3AsyncRequestsConsistentlyWithWait) {
    // Create InferRequest
    auto req1 = execNet.CreateInferRequest();
    auto req2 = execNet.CreateInferRequest();
    auto req3 = execNet.CreateInferRequest();
