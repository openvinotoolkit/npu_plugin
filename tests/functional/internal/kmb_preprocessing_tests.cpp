...
TEST_F(VpuPreprocessingStressTests, DISABLED_detectClassify4Threads) {
    ...
    std::string detectNetworkPath =
            getTestModelsPath() + "/KMB_models/BLOBS/tiny-yolo-v2/schema-3.24.3/tiny-yolo-v2.blob";
    InferenceEngine::ExecutableNetwork detectionNetwork = ie.ImportNetwork(detectNetworkPath, DEVICE_NAME, {});

    std::string classifyNetworkPath =
            getTestModelsPath() + "/KMB_models/BLOBS/mobilenet-v2/schema-3.24.3/mobilenet-v2.blob";
    ...
    std::string detectInputPath =
            getTestModelsPath() + "/KMB_models/BLOBS/tiny-yolo-v2/cars-frame-1-1920x1080-nv12.bin";
    std::string classifyInputName = classifyInputInfo.begin()->first;
    std::string classifyInputPath =
            getTestModelsPath() + "/KMB_models/BLOBS/tiny-yolo-v2/cars-frame-2-1920x1080-nv12.bin";
