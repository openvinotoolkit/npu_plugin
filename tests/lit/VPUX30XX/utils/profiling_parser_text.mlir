...
// CHECK: Task(DMA): conv1/WithoutBiases?t_Convolution/output tile [0, 0, 0, 0]  	Time(us): 2.58    	Start(us): 228.86  
// CHECK: Task(DMA): conv1/WithoutBiases?t_Convolution/output tile [0, 0, 0, 0]  	Time(us): 2.85    	Start(us): 231.59  
// CHECK: Task(DMA): conv1/WithoutBiases?t_Convolution/output tile [0, 0, 0, 0]  	Time(us): 2.72    	Start(us): 234.59  
// CHECK: Task(DMA): conv1/WithoutBiases?t_Convolution/output tile [0, 0, 0, 0]  	Time(us): 2.45    	Start(us): 237.46  
// CHECK: Task(DPU): conv1/WithoutBiases?t_Convolution/output tile [0, 0, 0, 0]  	Time(us): 49.26   	Start(us): 239.92  
...
// CHECK: Task(DPU): pool1?t_MaxPool                                             	Time(us): 8.90    	Start(us): 289.56  
...
// CHECK: Task(DMA): pool1?t_MaxPool                                             	Time(us): 2.02    	Start(us): 299.67  
// CHECK: Task(DMA): pool1?t_MaxPool                                             	Time(us): 2.02    	Start(us): 301.90  
// CHECK: Task(DMA): pool1?t_MaxPool                                             	Time(us): 2.15    	Start(us): 304.28  
// CHECK: Task(DMA): pool1?t_MaxPool                                             	Time(us): 1.45    	Start(us): 306.67  
...
// CHECK: Task(UPA): output                                                      	Time(us): 63.48   	Cycles:186916(229204)	Start(us): 454.15  
// CHECK: Layer: conv1/WithoutBiases                      Type: Convolution          DPU: 49.26    SW: 192.17   DMA: 33.49   	Start: 0.00
// CHECK: Layer: pool1                                    Type: MaxPool              DPU: 8.90     SW: 0.00     DMA: 149.84  	Start: 240.06
// CHECK: Layer: output                                   Type: Convert              DPU: 0.00     SW: 63.48    DMA: 0.00    	Start: 454.15
// CHECK: Total time: 497.15us, Real: 517.64us
