...
func @ConvLeakyRelu01ToNCE(%arg0: tensor<1x16x16x16x!qElemType0, {order = #NHWC}>) -> tensor<1x16x16x16x!qElemType0, {order = #NHWC}> {
    %weights = const.Declare tensor<16x16x1x1x!qElemType0, {order = #NHWC}> = #const.Content<dense<1.0> : tensor<16x16x1x1xf32>, [#const.ConvertElemType<f16>, #const.ConvertElemType<ui8>, #const.QuantCast<!qElemType0>, #const.Reorder<#NHWC>]>
