...
!qElemType0 = !quant.uniform<u8:f16, 0.0024088541666666668:128>

// CHECK-LABEL: @ConvLeakyRelu01ToNCE
func.func @ConvLeakyRelu01ToNCE(%arg0: tensor<1x16x16x16x!qElemType0, {order = #NHWC}>) -> tensor<1x16x16x16x!qElemType0, {order = #NHWC}> {
...
#NHWC = affine_map<(d0, d1, d2, d3) -> (d0, d2, d3, d1)>
!qElemType0 = !quant.uniform<u8:f16, 0.0024088541666666668:45>

// CHECK-LABEL: @ConvLeakyRelu02ToNCE
func.func @ConvLeakyRelu02ToNCE(%arg0: tensor<1x16x16x16x!qElemType0, {order = #NHWC}>) -> tensor<1x16x16x16x!qElemType0, {order = #NHWC}> {
    %weights = const.Declare tensor<16x16x1x1x!qElemType0, {order = #NHWC}> = dense<1.0> : tensor<16x16x1x1xf32>, [#const.ConvertElemType<f16>, #const.ConvertElemType<ui8>, #const.QuantCast<!qElemType0>, #const.Reorder<#NHWC>]
...
func.func @ConvLeakyRelu025ToNCE(%arg0: tensor<1x16x16x16x!qElemType0, {order = #NHWC}>) -> tensor<1x16x16x16x!qElemType0, {order = #NHWC}> {
    %weights = const.Declare tensor<16x16x1x1x!qElemType0, {order = #NHWC}> = dense<1.0> : tensor<16x16x1x1xf32>, [#const.ConvertElemType<f16>, #const.ConvertElemType<ui8>, #const.QuantCast<!qElemType0>, #const.Reorder<#NHWC>]
...
#NHWC = affine_map<(d0, d1, d2, d3) -> (d0, d2, d3, d1)>
!qElemType0 = !quant.uniform<u8:f16, 0.0024088541666666668:0>

// CHECK-LABEL: @ConvLeakyRelu020ToNCE
func.func @ConvLeakyRelu020ToNCE(%arg0: tensor<1x16x16x16x!qElemType0, {order = #NHWC}>) -> tensor<1x16x16x16x!qElemType0, {order = #NHWC}> {
    %weights = const.Declare tensor<16x16x1x1x!qElemType0, {order = #NHWC}> = dense<1.0> : tensor<16x16x1x1xf32>, [#const.ConvertElemType<f16>, #const.ConvertElemType<ui8>, #const.QuantCast<!qElemType0>, #const.Reorder<#NHWC>]
