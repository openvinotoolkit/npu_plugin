...
func @NotConvertScaleShiftToEnableCMajorWithoutConvert(%arg0: tensor<1x3x512x512xf16>) -> tensor<1x32x256x256xf16> {
    ...
    // CHECK:       %[[BIAS_0:.*]] = const.Declare tensor<1x32x1x1xf16> = dense<-1.000000e+00> : tensor<1x32x1x1xf16>
    // CHECK:       %[[WEIGHTS_0:.*]] = const.Declare tensor<32x3x3x3xf16> = dense<7.843020e-03> : tensor<32x3x3x3xf16>
    // CHECK:       %[[BIAS_1:.*]] = const.Declare tensor<1x3x1x1xf16> = dense<7.843020e-03> : tensor<1x3x1x1xf16>
    // CHECK:       %[[WEIGHTS_1:.*]] = const.Declare tensor<1x3x1x1xf16> = dense<-1.000000e+00> : tensor<1x3x1x1xf16>
...
func @ConvertScaleShiftAndDisableCMajorWithNCELayer(%arg0: tensor<1x32x512x512xf16>) -> tensor<1x32x256x256xf16> {
    ...
    // CHECK:       %[[BIAS_0:.*]] = const.Declare tensor<1x32x1x1xf16> = dense<-1.000000e+00> : tensor<1x32x1x1xf16>
    // CHECK:       %[[WEIGHTS_0:.*]] = const.Declare tensor<32x3x3x3xf16> = dense<7.843020e-03> : tensor<32x3x3x3xf16>
    // CHECK:       %[[WEIGHTS_1:.*]] = const.Declare tensor<3x1x1x1xf16> = dense<-1.000000e+00> : tensor<1x3x1x1xf16>, [#const.Reshape<[3, 1, 1, 1]>]
    // CHECK:       %[[BIAS_1:.*]] = const.Declare tensor<1x3x1x1xf16> = dense<7.843020e-03> : tensor<1x3x1x1xf16>
    // CHECK:       %[[BIAS_2:.*]] = const.Declare tensor<1x3x1x1xf16> = dense<-1.000000e+00> : tensor<1x3x1x1xf16>
    // CHECK:       %[[WEIGHTS_2:.*]] = const.Declare tensor<3x32x1x1xf16> = dense<7.843020e-03> : tensor<3x32x1x1xf16>
