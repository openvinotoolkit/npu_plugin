...
func @ConvAssignedSOK(%arg0: tensor<1x32x3x3xf16, {order = #NHWC}>) -> tensor<1x64x3x3xf16, {order = #NHWC}> {
    ...
    %cst_0 = const.Declare tensor<64x32x1x1xf16, {order = #NHWC}> = #const.Content<dense<1.000000e+00> : tensor<64x32x1x1xf16>, [#const.Reorder<#NHWC>]>
    ...
    //CHECK:        [[WEIGHTS:%.*]] = const.Declare tensor<64x32x1x1xf16, {order = #NHWC}> = #const.Content<dense<1.000000e+00> : tensor<64x32x1x1xf16>, [#const.Reorder<#NHWC>]>
