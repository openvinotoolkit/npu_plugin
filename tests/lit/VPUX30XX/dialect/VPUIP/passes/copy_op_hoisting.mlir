...
func @CopyToTempBufNoChange(%arg0: memref<1x16x1x1xf16, #NHWC, @CMX_NN>, %arg1: memref<1x16x1x1xf16>) -> memref<1x16x1x1xf16> {
    ...
    %4 = VPUIP.ReLUUPA inputs(%3 : memref<1x16x1x1xf16>) outputs(%arg1 : memref<1x16x1x1xf16>) -> memref<1x16x1x1xf16>
    ...
    // CHECK: [[VAR4:%.+]] = VPUIP.ReLUUPA inputs([[VAR3]] : memref<1x16x1x1xf16>) outputs(%arg1 : memref<1x16x1x1xf16>)
    // CHECK: return [[VAR4]]
}
...
func @CopyToTempBufMoveCopyOnly(%arg0: memref<1x16x1x1xf16, #NHWC, @CMX_NN>, %arg1: memref<1x16x1x1xf16>, %arg2: memref<1x16x1x1xf16>) -> (memref<1x16x1x1xf16>, memref<1x16x1x1xf16>) {
    ...
    %8 = VPUIP.ReLUUPA inputs(%6 : memref<1x16x1x1xf16>) outputs(%arg1 : memref<1x16x1x1xf16>) -> memref<1x16x1x1xf16>
    %9 = VPUIP.ReLUUPA inputs(%7 : memref<1x16x1x1xf16>) outputs(%arg2 : memref<1x16x1x1xf16>) -> memref<1x16x1x1xf16>
    ...
    // CHECK: [[VAR8:%.+]] = VPUIP.ReLUUPA inputs([[VAR5]] : memref<1x16x1x1xf16>) outputs(%arg1 : memref<1x16x1x1xf16>)
    // CHECK: [[VAR9:%.+]] = VPUIP.ReLUUPA inputs([[VAR7]] : memref<1x16x1x1xf16>) outputs(%arg2 : memref<1x16x1x1xf16>)
...
func @CopyToTempBufMoveWithAlloc(%arg0: memref<1x16x1x1xf16, #NHWC, @CMX_NN>, %arg1: memref<1x16x1x1xf16>, %arg2: memref<1x16x1x1xf16>) -> (memref<1x16x1x1xf16>, memref<1x16x1x1xf16>) {
    ...
    %8 = VPUIP.ReLUUPA inputs(%5 : memref<1x16x1x1xf16>) outputs(%arg1 : memref<1x16x1x1xf16>) -> memref<1x16x1x1xf16>
    %9 = VPUIP.ReLUUPA inputs(%7 : memref<1x16x1x1xf16>) outputs(%arg2 : memref<1x16x1x1xf16>) -> memref<1x16x1x1xf16>
    return %8, %9 : memref<1x16x1x1xf16>, memref<1x16x1x1xf16>
    ...
    // CHECK: [[VAR8:%.+]] = VPUIP.ReLUUPA inputs([[VAR3]] : memref<1x16x1x1xf16>) outputs(%arg1 : memref<1x16x1x1xf16>)
    // CHECK: [[VAR9:%.+]] = VPUIP.ReLUUPA inputs([[VAR7]] : memref<1x16x1x1xf16>) outputs(%arg2 : memref<1x16x1x1xf16>)
    // CHECK: return [[VAR8]], [[VAR9]]
}
...
func @CopyToTempBufSubViewMoveCopyOnly(%arg0: memref<1x8x1x1xf16, #NHWC, @CMX_NN>, %arg1: memref<16x1x1xf16>) -> memref<16x1x1xf16> {
    ...
    %10 = VPUIP.ReLUUPA inputs(%9 : memref<16x1x1xf16>) outputs(%arg1 : memref<16x1x1xf16>) -> memref<16x1x1xf16>
    ...
    // CHECK: [[VAR10:%.+]] = VPUIP.ReLUUPA inputs([[VAR9]] : memref<16x1x1xf16>) outputs(%arg1 : memref<16x1x1xf16>)
    // CHECK: return [[VAR10]]
}
