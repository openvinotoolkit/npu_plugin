...
// CHECK:   %2 = VPUIP.NNDMA {port = 0 : i64, set_crit = false, set_ord = true} inputs(%1 : memref<1x1x1x1000xf16, #map>) outputs(%arg1 : memref<1x1x1x1000xf16, #map>) waits(%0 : !VPUIP.Barrier) -> memref<1x1x1x1000xf16, #map>
