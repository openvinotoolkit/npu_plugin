...
func.func @main(%0: memref<1x240x320x1xf16>, %1: memref<1x120x160x2xf16>, %2: memref<1x240x320x3xf16>) -> memref<1x240x320x3xf16> {
    ...
    VPURT.Task updates(%b0 : !VPURT.Barrier) {
        VPUIP.NNDMA {port = 0 : i64} inputs(%0 : memref<1x240x320x1xf16>) outputs(%in_tile0_cmx : memref<1x240x320x1xf16, [@CMX_NN, 0]>) -> memref<1x240x320x1xf16, [@CMX_NN, 0]>
    }

    VPURT.Task waits(%b0 : !VPURT.Barrier) updates(%b1 : !VPURT.Barrier) {
        VPUIP.NNDMA {port = 0 : i64} inputs(%1 : memref<1x120x160x2xf16>) outputs(%in_tile1_cmx : memref<1x120x160x2xf16, [@CMX_NN, 0]>) -> memref<1x120x160x2xf16, [@CMX_NN, 0]>
    }
    ...
    VPURT.Task waits(%b2 : !VPURT.Barrier) {
        VPUIP.NNDMA {port = 0 : i64} inputs(%out_tile0_cmx : memref<1x240x320x3xf16, [@CMX_NN, 0]>) outputs(%2 : memref<1x240x320x3xf16>) -> memref<1x240x320x3xf16>
    }
