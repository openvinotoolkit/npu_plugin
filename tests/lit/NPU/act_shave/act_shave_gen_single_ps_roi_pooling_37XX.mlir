...
func.func @main(%1: memref<2x200x20x20xf16>, %2: memref<1x5xf16>, %3: memref<1x50x2x2xf16>) -> memref<1x50x2x2xf16> {
    ...
    VPURT.Task updates(%b0 : !VPURT.Barrier) {
        VPUIP.NNDMA {port = 0 : i64} inputs(%1 : memref<2x200x20x20xf16>) outputs(%in0_tile0_cmx : memref<2x200x20x20xf16, [@CMX_NN, 0]>) -> memref<2x200x20x20xf16, [@CMX_NN, 0]>
    }
    ...
    VPURT.Task waits(%b1 : !VPURT.Barrier) {
        VPUIP.NNDMA {port = 0 : i64} inputs(%out_tile0_cmx : memref<1x50x2x2xf16, [@CMX_NN, 0]>) outputs(%3 : memref<1x50x2x2xf16>) -> memref<1x50x2x2xf16>
    }
