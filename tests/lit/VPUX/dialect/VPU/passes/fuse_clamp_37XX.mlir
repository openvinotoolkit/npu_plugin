...
func.func @ConvWithMultipleConsumers(%arg0: tensor<1x32x16x16x!qElemType0, {order = #NHWC}>) -> (tensor<1x4608x16x16x!qElemType1, {order = #NHWC}>, tensor<1x9216x16x16x!qElemType1, {order = #NHWC}>) {
    %weights = const.Declare tensor<9216x32x3x3x!qElemType0, {order = #NHWC}> = dense<1.000000e+00> : tensor<9216x32x3x3xf16>, [#const.ConvertElemType<ui8>, #const.QuantCast<!qElemType0>, #const.Reorder<#NHWC>]
    ...
    // CHECK-DAG:  [[WEIGHTS:%.+]] = const.Declare tensor<9216x32x3x3x!qElemType0, {order = #NHWC}> = dense<1.000000e+00> : tensor<9216x32x3x3xf16>, [#const.ConvertElemType<ui8>, #const.QuantCast<!qElemType0>, #const.Reorder<#NHWC>]
    ...
    // CHECK-SAME:  ppe = {clamp_high = 255 : i64,
    ...
    // CHECK-SAME: {pad = {bottom = 1 : i64, left = 1 : i64, right = 1 : i64, top = 1 : i64},
    // CHECK-SAME:  ppe = {clamp_high = 126 : i64,
