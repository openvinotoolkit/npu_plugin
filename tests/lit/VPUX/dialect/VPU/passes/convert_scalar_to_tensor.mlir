...
func @Gather(%arg0: tensor<18x8x72x64xf16>) -> tensor<8x72x64xf16> {
    %cst = const.Declare tensor<si32> = #const.Content<dense<1> : tensor<si32>>
    ...
    // CHECK:       [[CST:%.*]] = const.Declare tensor<si32> = #const.Content<dense<1> : tensor<si32>>
    ...
    // CHECK-SAME:      : tensor<18x8x72x64xf16>, tensor<1xsi32> -> tensor<8x72x64xf16>
    // CHECK:       return [[VAL1]]
}

// CHECK-LABEL: @TopK
func @TopK(%arg0: tensor<6x12x10x24xf16>) -> (tensor<6x3x10x24x16xf16>, tensor<6x3x10x24x16xf16>) {
    ...
    %0:2 = VPU.TopK(%arg0, %cst) {axis = 1 : i64, mode = "MAX", sort = "SORT_VALUES", element_type = i64}
            : tensor<6x12x10x24xf16>, tensor<si32> -> tensor<6x3x10x24x16xf16>, tensor<6x3x10x24x16xf16>

    return %0#0, %0#1 : tensor<6x3x10x24x16xf16>, tensor<6x3x10x24x16xf16>
    ...
    // CHECK-SAME:      : tensor<6x12x10x24xf16>, tensor<1xsi32> -> tensor<6x3x10x24x16xf16>, tensor<6x3x10x24x16xf16>
