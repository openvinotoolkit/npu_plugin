...
func @addMapSingleLayer(%arg0: tensor<1x16x16x16xf16, {order = #NHWC}>) -> tensor<1x16x16x16xf16, {order = #NHWC}> {
...
func @addMapPropagateType(%arg0: tensor<1x16x16x32xf16, {order = #NHWC}>) -> (tensor<1x16x16x16xf16, {order = #NHWC}>, tensor<1x16x16x8xf16, {order = #NHWC}>) {
...
func @propagateTypeConcatMixedConsumers(%arg0: tensor<1x8x16x16xf16, {order = #NHWC}>, %arg1: tensor<16x1x1x4xsi32>, %arg2: tensor<16x16x1x1xf16, {order = #NHWC}>)
...
func @addMapSingleLayerAndCopy(%arg0: tensor<1x16x16x16xf16, {order = #NHWC}>) -> tensor<1x16x16x16xf16, {order = #NHWC}> {
    %0 = VPU.Sparsify(%arg0) : tensor<1x16x16x16xf16, {order = #NHWC}> -> !VPU.SparseTensor<data=tensor<1x16x16x16xf16, {order = #NHWC}>>
    %weights_table = const.Declare tensor<16x1x1x4xsi32, {order = #NCHW}> = dense<10> : tensor<16x1x1x4xsi32>
    %activation_window = const.Declare tensor<1x1x1x16xui8, {order = #NCHW}> = dense<1> : tensor<1x1x1x16xui8>
    %1 = VPU.NCE.MaxPool(%0, %weights_table, %activation_window) {
