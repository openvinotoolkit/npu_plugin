...
// CHECK-LABEL: @Fold
func @Fold(%arg0: memref<1x3x16x16xf32, #NHWC>) -> memref<1x3x16x16xf32, #NHWC> {
    ...
    // CHECK:       [[CST:%.+]] = const.Declare memref<1x3x16x16xf32, #NHWC>
...
func @FuseGenericReshapes(%arg0: memref<1x3x16x2xf32>) -> memref<1x3x16x2xf32> {
    ...
    // CHECK:       [[CST:%.+]] = const.Declare memref<1x3x2x16xf32> = dense<1.000000e+00> : tensor<1x3x2x16xf32>
