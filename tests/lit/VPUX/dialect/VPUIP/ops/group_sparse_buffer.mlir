...
// CHECK:  func @Fold([[ARG0:%.+]]: memref<1x128x16x16xf16>, [[ARG1:%.+]]: memref<1x128x16x16xi1>
func @Fold(%arg0: memref<1x128x16x16xf16>, %arg1: memref<1x128x16x16xi1>) -> (memref<1x128x16x16xf16>, memref<1x128x16x16xi1>) {
