...
func.func @ExceedingVariantCount(%arg0: memref<1x16x32x32xf16, #NHWC>, %arg1: memref<1x16x32x32xf16>) -> memref<1x16x32x32xf16> {
    ...
    // CHECK: VPURT.Task updates([[BAR1]], [[BAR2]] : !VPURT.Barrier, !VPURT.Barrier)
    // CHECK: VPURT.Task updates([[BAR1]], [[BAR2]] : !VPURT.Barrier, !VPURT.Barrier)
    // CHECK: VPURT.Task waits([[BAR1]] : !VPURT.Barrier) updates([[BAR3]], [[BAR4]] : !VPURT.Barrier, !VPURT.Barrier)

    // DPU Conv
    // CHECK: VPURT.Task waits([[BAR1]], [[BAR3]] : !VPURT.Barrier, !VPURT.Barrier) updates([[BAR5]] : !VPURT.Barrier)
    // SW Tanh
    ...
    // DPU
    // CHECK: VPURT.Task waits([[BAR5]], [[BAR6]], [[BAR7]] : !VPURT.Barrier, !VPURT.Barrier, !VPURT.Barrier) updates([[BAR8]] : !VPURT.Barrier)
