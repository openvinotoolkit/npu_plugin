...
func @SparseConvWeights(%arg0: memref<1x32x3x3xf16, #NHWC, [@CMX_NN, 0]>, %arg1: memref<1x64x3x3xf16, #NHWC, [@CMX_NN, 0]>) -> memref<1x64x3x3xf16, #NHWC, [@CMX_NN, 0]> {
  %cst_weights = const.Declare memref<64x32x1x1xf16, {compressionScheme = #VPUIP.CompressionScheme<axis = 0 : i64, numElems = dense<32> : tensor<64xi64>, alignment = 16 : i64>, order = #NHWC}>
  ...
  %3 = VPURT.DeclareBuffer "CMX_NN" [0] <576>-> memref<64x32x1x1xf16, {compressionScheme = #VPUIP.CompressionScheme<axis = 0 : i64, numElems = dense<32> : tensor<64xi64>, alignment = 16 : i64>, order = #NHWC}, [@CMX_NN, 0]>
  ...
  VPURT.Task updates(%0 : !VPURT.Barrier) attributes {cycleBegin = 0 : i64, cycleEnd = 100 : i64, isTrailingSWLayer = false} {
    %6 = VPUIP.NNDMA {port = 0 : i64} inputs(%cst_weights : memref<64x32x1x1xf16, {compressionScheme = #VPUIP.CompressionScheme<axis = 0 : i64, numElems = dense<32> : tensor<64xi64>, alignment = 16 : i64>, order = #NHWC}>)
                                      outputs(%3 : memref<64x32x1x1xf16, {compressionScheme = #VPUIP.CompressionScheme<axis = 0 : i64, numElems = dense<32> : tensor<64xi64>, alignment = 16 : i64>, order = #NHWC}, [@CMX_NN, 0]>)
            -> memref<64x32x1x1xf16, {compressionScheme = #VPUIP.CompressionScheme<axis = 0 : i64, numElems = dense<32> : tensor<64xi64>, alignment = 16 : i64>, order = #NHWC}, [@CMX_NN, 0]>
  }
  ...
  VPURT.Task waits(%0 : !VPURT.Barrier) attributes {cycleBegin = 300 : i64, cycleEnd = 400 : i64, isTrailingSWLayer = false} {
    %6 = VPUIP.NCEClusterTask {kernel_padding = {bottom = 0 : i64, left = 0 : i64, right = 0 : i64, top = 0 : i64}, kernel_size = [1, 1], kernel_strides = [1, 1], task_type = "CONV"}
            input(%1 : memref<1x32x3x3xf16, #NHWC, [@CMX_NN, 0]>)
            weights(%3 : memref<64x32x1x1xf16, {compressionScheme = #VPUIP.CompressionScheme<axis = 0 : i64, numElems = dense<32> : tensor<64xi64>, alignment = 16 : i64>, order = #NHWC}, [@CMX_NN, 0]>)
  ...
  // CHECK-SAME:      {compressionScheme = #VPUIP.CompressionScheme<axis = 0 : i64, numElems = dense<32> : tensor<64xi64>, alignment = 16 : i64>, order = #NHWC}, [@CMX_NN, 0]>
  ...
  // CHECK-SAME:          weights([[WEIGHTS_CMX_DENSE]] : memref<64x32x1x1xf16, {compressionScheme = #VPUIP.CompressionScheme<axis = 0 : i64, numElems = dense<32> : tensor<64xi64>, alignment = 16 : i64>, order = #NHWC}, [@CMX_NN, 0]>)
}
