...
func.func @ShapeCast(%arg0: memref<64x3x7x7xf16, #NHWC>, %arg1: memref<1x64x112x112xf16, #NHWC, [@CMX_NN, 0]>) -> memref<1x64x112x112xf16, #NHWC, [@CMX_NN, 0]> {
    ...
    %1 = VPUIP.NCEClusterTask {
        ...
        variants :
        {
            DPUTask {outEnd = [111, 111, 63], mpe_mode = "VECTOR_FP16", pad = {bottom = 0 : i64, left = 0 : i64, right = 0 : i64, top = 0 : i64}, outStart = [0, 0, 0]}
        }
        PPE :  {
        }
    ...
    //CHECK-SAME:           variants :  {
    //CHECK:       DPUTask {mpe_mode = "VECTOR_FP16", outEnd = [111, 111, 63], outStart = [0, 0, 0], pad = {bottom = 0 : i64, left = 0 : i64, right = 0 : i64, top = 0 : i64}}
