...
func @ConvertAssignAndReadValue(%arg0: tensor<1x768xf32>) -> tensor<1x768xf32> {
    ...
    %1 = IE.Add(%arg0, %0) {auto_broadcast = "NUMPY"} : tensor<1x768xf32>, tensor<1x768xf32> -> tensor<1x768xf32>
    ...
    // CHECK:       [[VAR0:%.*]] = IE.Add(%arg0, %arg1) {auto_broadcast = "NUMPY"} : tensor<1x768xf32>, tensor<1x768xf32> -> tensor<1x768xf32>
