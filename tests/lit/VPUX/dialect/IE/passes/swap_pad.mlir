...
func @SwapTransposeWithPerTensorQuant(%arg0: tensor<1x64x128x8xf16>) -> tensor<1x8x70x134xf16> {
    %0 = IE.Pad(%arg0) {mode = "CONSTANT", pad_value_attr = 0.000000e+00 : f64, pads_begin_attr = [0, 3, 3, 0], pads_end_attr = [0, 3, 3, 0]} : tensor<1x64x128x8xf16> -> tensor<1x70x134x8xf16>
