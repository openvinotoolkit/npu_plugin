...
func @SwapConcatWithEltwise(%arg0: tensor<1x64x8x512xf16>, %arg1: tensor<1x64x1x512xf16>) -> tensor<1x64x9x512xf16> {
    ...
    // CHECK-DAG:   [[CST_FQ_LO:%.*]] = const.Declare tensor<1x1x1x1xf16> = #const.Content<dense<0.000000e+00> : tensor<1x1x1x1xf16>>
    // CHECK-DAG:   [[CST_FQ_HI:%.*]] = const.Declare tensor<1x1x1x1xf16> = #const.Content<dense<1.970210e-01> : tensor<1x1x1x1xf16>>
    // CHECK-DAG:   [[CONV_WEIGHTS:%.*]] = const.Declare tensor<64x64x1x1xf16> = #const.Content<dense<1.000000e+00> : tensor<64x64x1x1xf16>>
