...
func @main(%arg0: tensor<1x1000xf32>, %arg1: tensor<1x224x224xf32>, %arg2: tensor<1x512xf32>, %arg3: tensor<8x1024xf32>) ->
    ...
    // CHECK-DAG: %[[VAL_4:.*]] = const.Declare tensor<1x1x1x1xf32> = #const.Content<dense<2.000000e+00> : tensor<1xf32>, [#const.Reshape<[1, 1, 1, 1]>]>
    // CHECK-DAG: %[[VAL_5:.*]] = const.Declare tensor<1x1x1x1xf32> = #const.Content<dense<6.000000e+00> : tensor<1xf32>, [#const.Reshape<[1, 1, 1, 1]>]>
    ...
    // CHECK:   %[[VAL_12:.*]] = IE.Multiply(%[[VAL_3_4D]], %[[VAL_5]])
...
func@ConvertShapeTo4DFrom5D(%arg0: tensor<1x3x9x16x1xf16>, %arg1: tensor<1x1x1x1x1xf16>) -> (tensor<1x3x9x16x1xf16>) {
    ...
    %1 = IE.Multiply(%0, %arg1) {auto_broadcast = "NUMPY"} : tensor<1x3x9x16x1xf16>, tensor<1x1x1x1x1xf16> -> tensor<1x3x9x16x1xf16>
    ...
    // CHECK:    %[[MULTIPLY:.*]] = IE.Multiply(%[[SIGMOID]], %[[Reshape_1]]) {auto_broadcast = "NUMPY"} : tensor<3x9x16x1xf16>, tensor<1x1x1x1xf16> -> tensor<3x9x16x1xf16>
    // CHECK:    %[[Reshape_2:.*]] = IE.AffineReshape(%[[MULTIPLY]])
