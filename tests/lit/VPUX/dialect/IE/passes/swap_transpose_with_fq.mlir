...
func @SwapTransposeWithPerTensorQuant(%arg0: tensor<1x70x1x28xf16>) -> tensor<1x1x28x70x!qElemType> {
...
func @SwapTransposeWithPerTensorFQ(%arg0: tensor<1x70x1x28xf16>) -> tensor<1x1x28x70xf16> {
    %cst_lo = const.Declare tensor<f32> = #const.Content<dense<0.0> : tensor<f32>>
    %cst_hi = const.Declare tensor<f32> = #const.Content<dense<255.0> : tensor<f32>>
    ...
    // CHECK:   %[[CST_HI:.*]] = const.Declare tensor<f32> = #const.Content<dense<2.550000e+02> : tensor<f32>>
    // CHECK:   %[[CST_LO:.*]] = const.Declare tensor<f32> = #const.Content<dense<0.000000e+00> : tensor<f32>>
    // CHECK:   %[[TRANSPOSE:.*]] = IE.Transpose(%arg0) {order_value = #NHWC}
    // CHECK-SAME:  : tensor<1x70x1x28xf16> -> tensor<1x1x28x70xf16>
...
func @DoNotSwapTransposeWithPerAxisFQ(%arg0: tensor<1x70x1x28xf16>) -> tensor<1x1x28x70xf16> {
    %cst_lo = const.Declare tensor<1x70x1x1xf32> = #const.Content<dense<0.0> : tensor<1x70x1x1xf32>>
    %cst_hi = const.Declare tensor<1x70x1x1xf32> = #const.Content<dense<255.0> : tensor<1x70x1x1xf32>>
    %0 = IE.FakeQuantize(%arg0, %cst_lo, %cst_hi, %cst_lo, %cst_hi)
        { auto_broadcast = "NUMPY", levels = 256 }
    ...
    // CHECK:   %[[CST_HI:.*]] = const.Declare tensor<1x70x1x1xf32> = #const.Content<dense<2.550000e+02> : tensor<1x70x1x1xf32>>
    // CHECK:   %[[CST_LO:.*]] = const.Declare tensor<1x70x1x1xf32> = #const.Content<dense<0.000000e+00> : tensor<1x70x1x1xf32>>
