...
!qElemType0 = type !quant.uniform<u8:f16, 0.0022939644607843138>
!qElemType1 = type !quant.uniform<u8:f16, 0.0011469822303921569>

// CHECK: !qElemType0 = type !quant.uniform<u8:f16, 0.0011469822303921569>
// CHECK: !qElemType1 = type !quant.uniform<u8:f16, 0.0022939644607843138>

// CHECK-LABEL: @SwapQuantizeCast
func @SwapQuantizeCast(%arg0: tensor<1x16x8x8xf16>) -> tensor<1x16x8x8x!qElemType1> {
      %0 = IE.Add(%arg0, %arg0) {auto_broadcast = "NONE_OR_EXPLICIT"} : tensor<1x16x8x8xf16>, tensor<1x16x8x8xf16> -> tensor<1x16x8x8x!qElemType0>
      ...
      // CHECK: [[VAR0:%.+]] = IE.Add(%arg0, %arg0) {auto_broadcast = "NONE_OR_EXPLICIT"}
...
func @NoSwapTwoConsumers(%arg0: tensor<1x16x8x8xf16>) -> (tensor<1x16x8x8x!qElemType1>, tensor<1x16x8x8x!qElemType1>) {
      %0 = IE.Add(%arg0, %arg0) {auto_broadcast = "NONE_OR_EXPLICIT"} : tensor<1x16x8x8xf16>, tensor<1x16x8x8xf16> -> tensor<1x16x8x8x!qElemType0>
      %1 = IE.QuantizeCast(%0) {dstElemType = !qElemType1} : tensor<1x16x8x8x!qElemType0> -> tensor<1x16x8x8x!qElemType1>
      %2 = IE.Clamp(%1) {max = 5.000000e+00, min = 1.000000e+00} : tensor<1x16x8x8x!qElemType1> -> tensor<1x16x8x8x!qElemType1>
...
func @NoSwapIntInput(%arg0: tensor<1x16x8x8xui8>) -> tensor<1x16x8x8x!qElemType0> {
