...
!qElemType0 = type !quant.uniform<u8:f16, 0.2501400218290441>
!qElemType1 = type !quant.uniform<u8:f16, 0.03027489793066885>

// CHECK-LABEL: @FuseQuantParamsIntoSliceUnlessInputFQEqualsOutputFQ
func @FuseQuantParamsIntoSliceUnlessInputFQEqualsOutputFQ(%arg0: tensor<1x128x46x80xf16>) -> tensor<1x128x45x80xf16> {
    ...
    %2 = IE.Slice %1 [0, 0, 0, 0] [1, 1, 0, 0] : tensor<1x128x46x80xf16> to tensor<1x128x45x80xf16>
    ...
    //CHECK: %2 = IE.Slice %1 [0, 0, 0, 0] [1, 1, 0, 0] : tensor<1x128x46x80xf16> to tensor<1x128x45x80xf16>
...
!qElemType0 = type !quant.uniform<u8:f16, 0.39320635328105852:128>
!qElemType1 = type !quant.uniform<u8:f16, 0.39320638320025275:128>
...
func @NoFuseWhenAnyOutputNotQuantized(%arg0: tensor<1x3x16x16xf16>) -> (tensor<1x3x14x14xf16>, tensor<1x3x14x14xf16>) {
  %1 = IE.Quantize(%arg0) {dstElemType = !qElemType1} : tensor<1x3x16x16xf16> -> tensor<1x3x16x16x!qElemType1>
  %2 = IE.Dequantize(%1) {dstElemType = f16} : tensor<1x3x16x16x!qElemType1> -> tensor<1x3x16x16xf16>
  %weights = const.Declare tensor<3x3x3x3x!qElemType0> = #const.Content<dense<1.0> : tensor<3x3x3x3xf16>, [#const.ConvertElemType<ui8>, #const.QuantCast<!qElemType0>]>
  %3 = IE.Dequantize(%weights) {dstElemType = f16} : tensor<3x3x3x3x!qElemType0> -> tensor<3x3x3x3xf16>
