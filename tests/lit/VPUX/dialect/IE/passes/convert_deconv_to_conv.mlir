...
func @ConvertDeconv2DToConv2DFQFilterFQParamsReused(%arg0: tensor<1x32x23x30xf16>) -> tensor<1x16x46x60xf16> {
    %cst = const.Declare tensor<32x16x2x2xf16> = #const.Content<dense<1.000000e+00> : tensor<32x16x2x2xf16>>
...
func @ConvertDeconv2DToConv2DFQFilterFQParamsUnique(%arg0: tensor<1x32x23x30xf16>) -> tensor<1x16x46x60xf16> {
    %filter = const.Declare tensor<32x16x2x2xf16> = #const.Content<dense<1.000000e+00> : tensor<32x16x2x2xf16>>
    %input_low = const.Declare tensor<1x1x1x1xf16> = #const.Content<dense<0.000000e+00> : tensor<1x1x1x1xf16>>
    %input_high = const.Declare tensor<1x1x1x1xf16> = #const.Content<dense<1.000000e+00> : tensor<1x1x1x1xf16>>
    %output_low = const.Declare tensor<1x1x1x1xf16> = #const.Content<dense<10.000000e+00> : tensor<1x1x1x1xf16>>
    %output_high = const.Declare tensor<1x1x1x1xf16> = #const.Content<dense<255.000000e+00> : tensor<1x1x1x1xf16>>
...
// CHECK-LABEL: @ConvertDeconv2DToConv2DNonConstFilter
  func @ConvertDeconv2DToConv2DNonConstFilter(%arg0: tensor<1x16x30x30xf16>, %arg1: tensor<1x16x16x16xf16>) -> tensor<1x16x74x74xf16> {
     // deconv input
    %conv1_filter = const.Declare tensor<16x16x1x1xf16> = #const.Content<dense<1.0> : tensor<16x16x1x1xf16>>
    ...
    %cst_0 = const.Declare tensor<1x1x1x1xf16> = #const.Content<dense<0.000000e+00> : tensor<1x1x1x1xf16>>
    %cst_1 = const.Declare tensor<1x1x1x1xf16> = #const.Content<dense<100.000000e+00> : tensor<1x1x1x1xf16>>
    ...
    // deconv weights
    %conv2_filter = const.Declare tensor<16x16x1x1xf16> = #const.Content<dense<1.000000e+00> : tensor<16x16x1x1xf16>>
    ...
    %cst_2 = const.Declare tensor<1x1x1x1xf16> = #const.Content<dense<0.000000e+00> : tensor<1x1x1x1xf16>>
    %cst_3 = const.Declare tensor<1x1x1x1xf16> = #const.Content<dense<1.000000e+00> : tensor<1x1x1x1xf16>>
