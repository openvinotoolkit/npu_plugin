...
func @MixedPrecisionGroupConv(%arg0: tensor<1x16x3x3xf16>) -> tensor<1x16x1x1xf16> {
    %cst = const.Declare tensor<16x1x3x3x!qElemType> = #const.Content<dense<2.000000e+00> : tensor<16x1x3x3xf16>, [#const.ConvertElemType<ui8>, #const.QuantCast<!qElemType>]>
    ...
    //CHECK-SAME:     #const.Content<dense<2.000000e+00> : tensor<16x1x3x3xf16>, [#const.ConvertElemType<ui8>, #const.QuantCast<!qElemType>]>
