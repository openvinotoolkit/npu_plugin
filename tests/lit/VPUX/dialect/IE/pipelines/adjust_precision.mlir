...
func @main(%arg0: tensor<100xf32>) -> (tensor<1x2x2x2xf64>, tensor<10xf32>) {
    ...
    // CHECK: [[CST:%.+]] = const.Declare tensor<1x2x2x2xf32> = dense<1.000000e+00> : tensor<1x2x2x2xf64>, [#const.ConvertElemType<f32>]
    // CHECK: [[CST_0:%.+]] = const.Declare tensor<10xsi32> = dense<1> : tensor<10xsi64>, [#const.ConvertElemType<si32>]
