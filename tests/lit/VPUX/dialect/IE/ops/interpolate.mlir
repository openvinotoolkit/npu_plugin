...
func.func @ConvertConstToAttr3InputsScales(%arg0: tensor<1x3x10x10xf32>) -> tensor<1x3x20x15xf32> {
    ...
    // CHECK:       %[[VAL0:.*]] = IE.Interpolate(%arg0) {attr = #IE.Interpolate<mode = <NEAREST>, shape_calc_mode = <SCALES>, coord_mode = <HALF_PIXEL>, nearest_mode = <ROUND_PREFER_FLOOR>, antialias = false, pads_begin = [0, 0, 0, 0], pads_end = [0, 0, 0, 0], cube_coeff = -7.500000e-01 : f64>,
    // CHECK-SAME: axes_attr = [0, 1, 2, 3],
    // CHECK-SAME: operand_segment_sizes = dense<[1, 0, 0, 0]> : vector<4xi32>,
...
func.func @ConvertToNearestWithSIZESMode(%arg0: tensor<1x96x1x1xf32>) -> tensor<1x96x33x33xf32> {
    ...
    %0 = IE.Interpolate(%arg0, %cst, %cst_0, %cst_1) {attr = #IE.Interpolate<mode = <LINEAR_ONNX>, shape_calc_mode = <SIZES>, coord_mode = <ALIGN_CORNERS>, nearest_mode = <ROUND_PREFER_FLOOR>, antialias = false, pads_begin = [0, 0, 0, 0], pads_end = [0, 0, 0, 0], cube_coeff = -7.500000e-01 : f64>, operand_segment_sizes = dense<1> : vector<4xi32>} : tensor<1x96x1x1xf32>, tensor<2xsi64>, tensor<2xf32>, tensor<2xsi64> -> tensor<1x96x33x33xf32>
    ...
    // CHECK-SAME:      axes_attr = [2, 3], operand_segment_sizes = dense<[1, 0, 0, 0]> : vector<4xi32>, scales_attr = [3.300000e+01, 3.300000e+01], sizes_attr = [33, 33]} : tensor<1x96x1x1xf32> -> tensor<1x96x33x33xf32>
    // CHECK:       return [[INTERP]]
}
...
func.func @NotConvertToNearestWithSIZESMode(%arg0: tensor<1x96x3x1xf32>) -> tensor<1x96x33x33xf32> {
    ...
    %cst_1 = const.Declare tensor<2xsi64> = dense<[2, 3]> : tensor<2xsi64>
    %0 = IE.Interpolate(%arg0, %cst, %cst_0, %cst_1) {attr = #IE.Interpolate<mode = <LINEAR_ONNX>, shape_calc_mode = <SIZES>, coord_mode = <ALIGN_CORNERS>, nearest_mode = <ROUND_PREFER_FLOOR>, antialias = false, pads_begin = [0, 0, 0, 0], pads_end = [0, 0, 0, 0], cube_coeff = -7.500000e-01 : f64>, operand_segment_sizes = dense<1> : vector<4xi32>} : tensor<1x96x3x1xf32>, tensor<2xsi64>, tensor<2xf32>, tensor<2xsi64> -> tensor<1x96x33x33xf32>
    return %0 : tensor<1x96x33x33xf32>
...
func.func @ConvertToNearestWithSCALESMode(%arg0: tensor<1x96x1x1xf32>) -> tensor<1x96x33x33xf32> {
    ...
    %cst_0 = const.Declare tensor<2xf32> = dense<3.300000e+01> : tensor<2xf32>
    %cst_1 = const.Declare tensor<2xsi64> = dense<[2, 3]> : tensor<2xsi64>
    %0 = IE.Interpolate(%arg0, %cst, %cst_0, %cst_1) {attr = #IE.Interpolate<mode = <LINEAR_ONNX>, shape_calc_mode = <SCALES>, coord_mode = <ALIGN_CORNERS>, nearest_mode = <ROUND_PREFER_FLOOR>, antialias = false, pads_begin = [0, 0, 0, 0], pads_end = [0, 0, 0, 0], cube_coeff = -7.500000e-01 : f64>, operand_segment_sizes = dense<1> : vector<4xi32>} : tensor<1x96x1x1xf32>, tensor<2xsi64>, tensor<2xf32>, tensor<2xsi64> -> tensor<1x96x33x33xf32>
    return %0 : tensor<1x96x33x33xf32>
