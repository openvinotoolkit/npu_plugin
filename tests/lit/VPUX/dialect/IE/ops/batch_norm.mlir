...
func @BatchNormAttr(%arg0: tensor<1x3x256x256xf16>) -> tensor<1x3x256x256xf16> {
  %cst = const.Declare tensor<3xf16> = #const.Content<dense<[0.000000e+00, 4.169920e-01, 1.000000e+00]> : tensor<3xf16>>
  %cst_0 = const.Declare tensor<3xf16> = #const.Content<dense<[0.000000e+00, 4.169920e-01, 1.000000e+00]> : tensor<3xf16>>
  %cst_1 = const.Declare tensor<3xf16> = #const.Content<dense<[0.000000e+00, 4.169920e-01, 1.000000e+00]> : tensor<3xf16>>
  %cst_2 = const.Declare tensor<3xf16> = #const.Content<dense<[7.826080e-05, 1.315430e+00, 7.554680e+00]> : tensor<3xf16>>
