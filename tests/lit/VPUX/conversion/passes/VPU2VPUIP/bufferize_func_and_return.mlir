...
// CHECK: func.func @SingleLayer(%arg0: memref<1x1000xf16>) -> memref<1x1000xf16> {
...
// CHECK: func.func @TwoInputs(%arg0: memref<1x2x3x4xf32>, %arg1: memref<1x2x3x4xf32>) -> memref<1x4x3x4xf32> {
func.func @TwoInputs(%arg0: tensor<1x2x3x4xf32>, %arg1: tensor<1x2x3x4xf32>) -> tensor<1x4x3x4xf32> {
