...
func.func @Conv(%arg0: memref<1x16x16x16xf16, #NHWC, @CMX_NN>, %arg1: memref<16x16x1x1xf16, #NHWC, @CMX_NN>, %arg2 : memref<16x1x1x4xsi32, @CMX_NN>)
    ...
    %3 = VPU.NCE.Convolution(%0, %1, %2) {
        ...
        VPU.DPU.Workload outOffsets [0, 0, 0, 0] outSizes [1, 16, 3, 16] {bottom = 0, left = 0, right = 0, top = 0} "VECTOR_FP16"
        VPU.DPU.Workload outOffsets [0, 0, 3, 0] outSizes [1, 16, 3, 16] {bottom = 0, left = 0, right = 0, top = 0} "VECTOR_FP16"
        VPU.DPU.Workload outOffsets [0, 0, 6, 0] outSizes [1, 16, 3, 16] {bottom = 0, left = 0, right = 0, top = 0} "VECTOR_FP16"
        VPU.DPU.Workload outOffsets [0, 0, 9, 0] outSizes [1, 16, 3, 16] {bottom = 0, left = 0, right = 0, top = 0} "VECTOR_FP16"
        VPU.DPU.Workload outOffsets [0, 0, 12, 0] outSizes [1, 16, 4, 16] {bottom = 0, left = 0, right = 0, top = 0} "VECTOR_FP16"
    }
...
func.func @SparseActConv(%arg0:  !SparseInputActBufferType,
    ...
    %3 = VPU.NCE.Convolution(%0, %1, %2) {
        ...
        VPU.DPU.Workload outOffsets [0, 0, 0, 0] outSizes [1, 32, 56, 112] {bottom = 0 : i64, left = 3 : i64, right = 2 : i64, top = 3 : i64} "CUBOID_16x16" attributes {cluster_id = 0 : i64}
        VPU.DPU.Workload outOffsets [0, 0, 56, 0] outSizes [1, 32, 56, 112] {bottom = 2 : i64, left = 3 : i64, right = 2 : i64, top = 0 : i64} "CUBOID_16x16" attributes {cluster_id = 1 : i64}
    }
...
func.func @SparseWeightsConv(%arg0: !InputActBufferType,
    ...
    %3 = VPU.NCE.Convolution(%0, %1, %2) {
        ...
        VPU.DPU.Workload outOffsets [0, 0, 0, 0] outSizes [1, 64, 28, 56] {bottom = 0 : i64, left = 0 : i64, right = 0 : i64, top = 0 : i64} "CUBOID_16x16" attributes {cluster_id = 0 : i64}
        VPU.DPU.Workload outOffsets [0, 0, 28, 0] outSizes [1, 64, 28, 56] {bottom = 0 : i64, left = 0 : i64, right = 0 : i64, top = 0 : i64} "CUBOID_16x16" attributes {cluster_id = 1 : i64}
    }
...
func.func @MaxPool(%arg0: memref<1x16x1x4xf16, #NHWC, @CMX_NN>, %arg1 : memref<16x1x1x4xsi32, @CMX_NN>, %arg2 : memref<1x1x1x16xui8, @CMX_NN>)
    ...
    %3 = VPU.NCE.MaxPool(%0, %1, %2) {
        ...
        VPU.DPU.Workload outOffsets [0, 0, 0, 0] outSizes [1, 16, 1, 4] {bottom = 0, left = 0, right = 0, top = 0} "VECTOR_FP16"
    }
...
func.func @DepthConv(%arg0: memref<1x16x40x80xf16, #NHWC, @CMX_NN>, %arg1: memref<16x1x4x8xf16, #NHWC, @CMX_NN>,
    ...
    %4 = VPU.NCE.DepthConvolution(%0, %1, %2, %3) {
        ...
        VPU.DPU.Workload outOffsets [0, 0, 0, 0] outSizes [1, 16, 7, 73] {bottom = 0, left = 0, right = 0, top = 0} "VECTOR_FP16"
        VPU.DPU.Workload outOffsets [0, 0, 7, 0] outSizes [1, 16, 7, 73] {bottom = 0, left = 0, right = 0, top = 0} "VECTOR_FP16"
        VPU.DPU.Workload outOffsets [0, 0, 14, 0] outSizes [1, 16, 7, 73] {bottom = 0, left = 0, right = 0, top = 0} "VECTOR_FP16"
        VPU.DPU.Workload outOffsets [0, 0, 21, 0] outSizes [1, 16, 7, 73] {bottom = 0, left = 0, right = 0, top = 0} "VECTOR_FP16"
        VPU.DPU.Workload outOffsets [0, 0, 28, 0] outSizes [1, 16, 9, 73] {bottom = 0, left = 0, right = 0, top = 0} "VECTOR_FP16"
    }
...
func.func @EltwiseAdd(%arg0: memref<1x64x28x28xf16, #NHWC, @CMX_NN>, %arg1: memref<1x64x28x28xf16, #NHWC, @CMX_NN>)
    ...
    %2 = VPU.NCE.Eltwise(%0, %1) {
        ...
        VPU.DPU.Workload outOffsets [0, 0, 0, 0] outSizes [1, 64, 5, 28] {bottom = 0, left = 0, right = 0, top = 0} "VECTOR_FP16"
        VPU.DPU.Workload outOffsets [0, 0, 5, 0] outSizes [1, 64, 5, 28] {bottom = 0, left = 0, right = 0, top = 0} "VECTOR_FP16"
        VPU.DPU.Workload outOffsets [0, 0, 10, 0] outSizes [1, 64, 5, 28] {bottom = 0, left = 0, right = 0, top = 0} "VECTOR_FP16"
        VPU.DPU.Workload outOffsets [0, 0, 15, 0] outSizes [1, 64, 5, 28] {bottom = 0, left = 0, right = 0, top = 0} "VECTOR_FP16"
        VPU.DPU.Workload outOffsets [0, 0, 20, 0] outSizes [1, 64, 8, 28] {bottom = 0, left = 0, right = 0, top = 0} "VECTOR_FP16"
    }
...
func.func @ConvWithClusterIdAttr(%arg0: memref<1x32x16x16xf16, #NHWC, @CMX_NN>, %arg1: memref<64x32x3x3xf16, #NHWC, @CMX_NN>, %arg2 : memref<64x1x1x4xsi32, @CMX_NN>) -> memref<1x64x16x16xf16, #NHWC, @CMX_NN> {
    ...
    %3 = VPU.NCE.Convolution(%0, %1, %2) {
                ...
                strides = [1, 1]
                 ...
                 VPU.DPU.Workload outOffsets [0, 0, 0, 0] outSizes [1, 64, 1, 16] {bottom = 0 : i64, left = 1 : i64, right = 1 : i64, top = 1 : i64} "VECTOR_FP16" attributes {cluster_id = 0 : i64}
                 VPU.DPU.Workload outOffsets [0, 0, 1, 0] outSizes [1, 64, 1, 16] {bottom = 0 : i64, left = 1 : i64, right = 1 : i64, top = 0 : i64} "VECTOR_FP16" attributes {cluster_id = 0 : i64}
                 VPU.DPU.Workload outOffsets [0, 0, 2, 0] outSizes [1, 64, 1, 16] {bottom = 0 : i64, left = 1 : i64, right = 1 : i64, top = 0 : i64} "VECTOR_FP16" attributes {cluster_id = 0 : i64}
                 VPU.DPU.Workload outOffsets [0, 0, 3, 0] outSizes [1, 64, 1, 16] {bottom = 0 : i64, left = 1 : i64, right = 1 : i64, top = 0 : i64} "VECTOR_FP16" attributes {cluster_id = 0 : i64}
                 VPU.DPU.Workload outOffsets [0, 0, 4, 0] outSizes [1, 64, 1, 16] {bottom = 0 : i64, left = 1 : i64, right = 1 : i64, top = 0 : i64} "VECTOR_FP16" attributes {cluster_id = 1 : i64}
                 VPU.DPU.Workload outOffsets [0, 0, 5, 0] outSizes [1, 64, 1, 16] {bottom = 0 : i64, left = 1 : i64, right = 1 : i64, top = 0 : i64} "VECTOR_FP16" attributes {cluster_id = 1 : i64}
                 VPU.DPU.Workload outOffsets [0, 0, 6, 0] outSizes [1, 64, 1, 16] {bottom = 0 : i64, left = 1 : i64, right = 1 : i64, top = 0 : i64} "VECTOR_FP16" attributes {cluster_id = 1 : i64}
                 VPU.DPU.Workload outOffsets [0, 0, 7, 0] outSizes [1, 64, 1, 16] {bottom = 0 : i64, left = 1 : i64, right = 1 : i64, top = 0 : i64} "VECTOR_FP16" attributes {cluster_id = 1 : i64}
                 VPU.DPU.Workload outOffsets [0, 0, 8, 0] outSizes [1, 64, 1, 16] {bottom = 0 : i64, left = 1 : i64, right = 1 : i64, top = 0 : i64} "VECTOR_FP16" attributes {cluster_id = 2 : i64}
                 VPU.DPU.Workload outOffsets [0, 0, 9, 0] outSizes [1, 64, 1, 16] {bottom = 0 : i64, left = 1 : i64, right = 1 : i64, top = 0 : i64} "VECTOR_FP16" attributes {cluster_id = 2 : i64}
                 VPU.DPU.Workload outOffsets [0, 0, 10, 0] outSizes [1, 64, 1, 16] {bottom = 0 : i64, left = 1 : i64, right = 1 : i64, top = 0 : i64} "VECTOR_FP16" attributes {cluster_id = 2 : i64}
                 VPU.DPU.Workload outOffsets [0, 0, 11, 0] outSizes [1, 64, 1, 16] {bottom = 0 : i64, left = 1 : i64, right = 1 : i64, top = 0 : i64} "VECTOR_FP16" attributes {cluster_id = 2 : i64}
                 VPU.DPU.Workload outOffsets [0, 0, 12, 0] outSizes [1, 64, 1, 16] {bottom = 0 : i64, left = 1 : i64, right = 1 : i64, top = 0 : i64} "VECTOR_FP16" attributes {cluster_id = 3 : i64}
                 VPU.DPU.Workload outOffsets [0, 0, 13, 0] outSizes [1, 64, 1, 16] {bottom = 0 : i64, left = 1 : i64, right = 1 : i64, top = 0 : i64} "VECTOR_FP16" attributes {cluster_id = 3 : i64}
                 VPU.DPU.Workload outOffsets [0, 0, 14, 0] outSizes [1, 64, 1, 16] {bottom = 0 : i64, left = 1 : i64, right = 1 : i64, top = 0 : i64} "VECTOR_FP16" attributes {cluster_id = 3 : i64}
                 VPU.DPU.Workload outOffsets [0, 0, 15, 0] outSizes [1, 64, 1, 16] {bottom = 1 : i64, left = 1 : i64, right = 1 : i64, top = 0 : i64} "VECTOR_FP16" attributes {cluster_id = 3 : i64}
    }
...
func.func @ConvWithInputOffsets(%arg0: memref<1x16x16x16xf16, #NHWC, @CMX_NN>, %arg1: memref<32x16x1x1xf16, #NHWC, @CMX_NN>, %arg2 : memref<32x1x1x4xsi32, @CMX_NN>)
    ...
    %3 = VPU.NCE.Convolution(%0, %1, %2) {
        ...
        VPU.DPU.Workload inOffsets [0, 0, 0, 0] inSizes [1, 16, 16, 16] outOffsets [0, 0, 0, 0] outSizes [1, 16, 16, 16] {bottom = 0, left = 0, right = 0, top = 0} "VECTOR_FP16"
        VPU.DPU.Workload inOffsets [0, 0, 0, 0] inSizes [1, 16, 16, 16] outOffsets [0, 16, 0, 0] outSizes [1, 16, 16, 16] {bottom = 0, left = 0, right = 0, top = 0} "VECTOR_FP16"
    }
...
func.func @DWConvWithInputOffsets(%arg0: !Input_CMX, %arg1: !Weights_CMX, %arg2: !WeightsTable_CMX, %arg3: !ActWindow_CMX) -> !Output_CMX {
    ...
    %4 = VPU.NCE.DepthConvolution(%0, %1, %2, %3) {
        ...
        VPU.DPU.Workload inOffsets [0, 0, 0, 0] inSizes [1, 16, 62, 62] outOffsets [0, 0, 0, 0] outSizes [1, 16, 31, 31] {bottom = 0, left = 1, right = 1, top = 1} "VECTOR_FP16"
        VPU.DPU.Workload inOffsets [0, 16, 0, 0] inSizes [1, 16, 62, 62] outOffsets [0, 16, 0, 0] outSizes [1, 16, 31, 31] {bottom = 1, left = 1, right = 1, top = 0} "VECTOR_FP16"
    }
...
func.func @CompressConv(%input: !in_CMX_tensor, %weights: !weight_CMX_tensor, %weight_table: !weight_table_CMX_tensor) -> !OTensorDistributed {
    %ClusterTiling = VPU.NCE.ClusterTiling
      ...
      %CompressConv = VPU.NCE.CompressConvolution(%arg2, %arg3, %arg4)
        ...
        VPU.DPU.Workload outOffsets [0, 0, 0, 0] outSizes [1, 64, 56, 112] {bottom = 0 : i64, left = 3 : i64, right = 2 : i64, top = 3 : i64} "CUBOID_16x16" attributes {cluster_id = 0 : i64}
        VPU.DPU.Workload outOffsets [0, 0, 56, 0] outSizes [1, 64, 56, 112] {bottom = 2 : i64, left = 3 : i64, right = 2 : i64, top = 0 : i64} "CUBOID_16x16" attributes {cluster_id = 1 : i64}
      }
