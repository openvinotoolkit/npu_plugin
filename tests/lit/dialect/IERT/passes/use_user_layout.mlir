...
IE.CNNNetwork
    entryPoint : @main
    inputsInfo : {
        IE.DataInfo "data" : memref<1x8x4x2xf16, #map>
    }
    outputsInfo : {
        IE.DataInfo "prob" : memref<1x8x4x2xf16, #map>
    }

// CHECK: func @main([[ARG0:%.*]]: memref<1x8x4x2xf16, #map>, [[ARG1:%.*]]: memref<1x8x4x2xf16, #map>) -> memref<1x8x4x2xf16, #map> {
func @main(%arg0: memref<1x8x4x2xf16>, %arg1: memref<1x8x4x2xf16>) -> memref<1x8x4x2xf16> {
    ...
    // CHECK: [[VAR1:%.*]] = IERT.Reorder inputs([[ARG0]] : memref<1x8x4x2xf16, #map>) outputs([[VAR0]] : memref<1x8x4x2xf16>) -> memref<1x8x4x2xf16>
    ...
    // CHECK: [[VAR4:%.*]] = IERT.Reorder inputs([[VAR3]] : memref<1x8x4x2xf16>) outputs([[ARG1]] : memref<1x8x4x2xf16, #map>) -> memref<1x8x4x2xf16, #map>
    // CHECK: return [[VAR4]] : memref<1x8x4x2xf16, #map>
}
...
// CHECK: func @main([[ARG0:%.*]]: memref<1x8x4x2xf16, #map>, [[ARG1:%.*]]: memref<1x8x4x2xf16>) -> memref<1x8x4x2xf16> {
func @main(%arg0: memref<1x8x4x2xf16>, %arg1: memref<1x8x4x2xf16>) -> memref<1x8x4x2xf16> {
    %0 = IERT.SoftMax {axisInd = 1 : i32} inputs(%arg0 : memref<1x8x4x2xf16>) outputs(%arg1 : memref<1x8x4x2xf16>) -> memref<1x8x4x2xf16>
...
IE.CNNNetwork
    ...
    outputsInfo : {
        IE.DataInfo "output1" : memref<1x8x4x2xf16, #map>
        IE.DataInfo "output2" : memref<1x20x8x4xf16, #map>
    }

// CHECK: func @main([[ARG0:%.*]]: memref<1x8x4x2xf16>, [[ARG1:%.*]]: memref<1x8x4x2xf16, #map>, [[ARG2:%.*]]: memref<1x20x8x4xf16, #map>) -> (memref<1x8x4x2xf16, #map>, memref<1x20x8x4xf16, #map>) {
func @main(%arg0: memref<1x8x4x2xf16>, %arg1: memref<1x8x4x2xf16>, %arg2: memref<1x20x8x4xf16>) -> (memref<1x8x4x2xf16>, memref<1x20x8x4xf16>) {
    ...
    // CHECK: [[VAR7:%.*]] = IERT.Reorder inputs([[VAR2]] : memref<1x8x4x2xf16>) outputs([[ARG1]] : memref<1x8x4x2xf16, #map>) -> memref<1x8x4x2xf16, #map>
    // CHECK: [[VAR8:%.*]] = IERT.Reorder inputs([[VAR6]] : memref<1x20x8x4xf16>) outputs([[ARG2]] : memref<1x20x8x4xf16, #map>) -> memref<1x20x8x4xf16, #map>

    // CHECK: return [[VAR7]], [[VAR8]] : memref<1x8x4x2xf16, #map>, memref<1x20x8x4xf16, #map>
}
