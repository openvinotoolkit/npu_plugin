...
func @PerTensor(%arg0 : tensor<1x4xf32>) -> tensor<1x4xf32> {
    ...
    // CHECK:  %0 = IE.And(%arg0, %arg0) {auto_broadcast = "NONE_OR_EXPLICIT"} : tensor<1x4xf32>, tensor<1x4xf32> -> tensor<1x4x!qElemType>
    // CHECK:  %1 = IE.And(%0, %0) {auto_broadcast = "NONE_OR_EXPLICIT"} : tensor<1x4x!qElemType>, tensor<1x4x!qElemType> -> tensor<1x4xf32>
