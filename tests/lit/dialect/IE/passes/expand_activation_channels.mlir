...
func @ExpandMaxPoolChannels(%arg0: tensor<1x3x30x30xf16>) -> tensor<1x3x15x13xf16> {
  ...
  // CHECK:       %[[PAD:.*]] = IE.Pad(%arg0) {mode = "CONSTANT", operand_segment_sizes = dense<[1, 0, 0, 0]> : vector<4xi32>, pad_value_attr = 0.000000e+00 : f32, pads_begin_attr = [0 : i32, 0 : i32, 0 : i32, 0 : i32], pads_end_attr = [0 : i32, 5 : i32, 0 : i32, 0 : i32]} : tensor<1x3x30x30xf16> -> tensor<1x8x30x30xf16>
...
func @ExpandConvolutionChannels(%arg0: tensor<1x3x30x30xf16>) -> tensor<1x5x24x9xf16> {
  ...
  // CHECK:       %[[EXTENDED_INPUT:.*]] = IE.Pad(%arg0)
