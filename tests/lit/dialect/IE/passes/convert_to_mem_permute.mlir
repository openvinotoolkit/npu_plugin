// RUN: vpux-opt --split-input-file --convert-to-mem-permute %s | FileCheck %s
...
func @ConvertToMemPermute(%arg0: tensor<1x2x3x4xf32>,
    ...
    %0 = IE.Transpose(%arg0) {order_value = #map} : tensor<1x2x3x4xf32> -> tensor<1x4x2x3xf32>
    ...
    // CHECK-NOT: IE.Reorder
    // CHECK:     %[[VAL0:.*]] = IE.MemPermute(%arg0) {dst_order = #NCHW, mem_perm = #map} : tensor<1x2x3x4xf32> -> tensor<1x4x2x3xf32>
    // CHECK:     %[[VAL1:.*]] = IE.MemPermute(%arg1) {dst_order = #NCHW, mem_perm = #map} : tensor<1x2x3x4xf32, {order = #NHWC}> -> tensor<1x2x3x4xf32>
