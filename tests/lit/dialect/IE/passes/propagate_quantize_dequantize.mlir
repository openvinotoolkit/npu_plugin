...
func @PropagateDequantReshape(%arg0: tensor<1x256x!qElemType>) -> (tensor<1x256x1x1xf16>, tensor<1x1x1x256xf16>) {
  ...
  %3 = IE.AffineReshape(%1) {shape_value = [1, 1, 1, 256], dim_mapping = [[0, 1, 2], [3]]} : tensor<1x256xf16> -> tensor<1x1x1x256xf16>

  return %2, %3 : tensor<1x256x1x1xf16>, tensor<1x1x1x256xf16>
  ...
  //CHECK: return [[DEQUANT1]], [[DEQUANT0]] : tensor<1x256x1x1xf16>, tensor<1x1x1x256xf16> 
}
