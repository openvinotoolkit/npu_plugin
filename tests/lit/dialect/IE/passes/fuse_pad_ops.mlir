// RUN: vpux-opt --split-input-file --fuse-pad-ops %s | FileCheck %s
...
func @fusePadIntoConv(%arg0: tensor<1x8x13x29xf16>) -> tensor<1x16x12x28xf16> {
    ...
    %1 = const.Declare tensor<16x8x5x5xf16> = #const.Content<dense<1.0> : tensor<16x8x5x5xf16>>
    ...
    // CHEAK-NOT:      IE.Pad
    // CHECK-DAG:      [[CST0:%.*]] = const.Declare tensor<16x8x5x5xf16> = #const.Content<dense<1.000000e+00> : tensor<16x8x5x5xf16>>
...
func @fusePadIntoGroupConv(%arg0: tensor<1x8x13x29xf16>) -> tensor<1x8x12x28xf16> {
    %0 = IE.Pad(%arg0) {mode = "CONSTANT", pad_value_attr = 0.000000e+00 : f64, pads_begin_attr = [0, 0, 1, 2], pads_end_attr = [0, 0, 2, 1]}
                        : tensor<1x8x13x29xf16> -> tensor<1x8x16x32xf16>
    %WEIGHT = const.Declare tensor<8x1x5x5xf16> = #const.Content<dense<1.0> : tensor<8x1x5x5xf16>>
    %BIAS = const.Declare tensor<1x8x1x1xf16> = #const.Content<dense<0.0> : tensor<1x8x1x1xf16>>
    ...
    // CHEAK-NOT:      IE.Pad
    // CHECK-DAG:      [[CST0:%.*]] = const.Declare tensor<1x8x1x1xf16> = #const.Content<dense<0.000000e+00> : tensor<1x8x1x1xf16>>
    // CHECK-DAG:      [[CST1:%.*]] = const.Declare tensor<8x1x5x5xf16> = #const.Content<dense<1.000000e+00> : tensor<8x1x5x5xf16>>
