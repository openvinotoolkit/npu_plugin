...
func @main(%arg0: tensor<1x8x4x2xf16>) -> tensor<1x8x4x2xf16> {
    %0 = IE.SoftMax(%arg0) {axisInd = 1 : i32} : tensor<1x8x4x2xf16> -> tensor<1x8x4x2xf16>
    return %0 : tensor<1x8x4x2xf16>

    // CHECK: [[VAR0:%.+]] = IE.Reorder([[ARG0]]) {dstOrder = #NCHW} : tensor<1x8x4x2xf16, {order = #NHWC}> -> tensor<1x8x4x2xf16>
    // CHECK: [[VAR1:%.+]] = IE.SoftMax([[VAR0]]) {axisInd = 1 : i32} : tensor<1x8x4x2xf16> -> tensor<1x8x4x2xf16>
...
func @main(%arg0: tensor<1x8x4x2xf16>) -> (tensor<1x8x4x2xf16>, tensor<1x20x8x4xf16>) {
    ...
    %1 = IE.SoftMax(%arg0) {axisInd = 1 : i32} : tensor<1x8x4x2xf16> -> tensor<1x8x4x2xf16>
    %2 = IE.SoftMax(%0) {axisInd = 1 : i32} : tensor<1x4x8x20xf16> -> tensor<1x4x8x20xf16>
    ...
    // CHECK: [[VAR1:%.+]] = IE.SoftMax([[ARG0]]) {axisInd = 1 : i32} : tensor<1x8x4x2xf16> -> tensor<1x8x4x2xf16>
    // CHECK: [[VAR2:%.+]] = IE.SoftMax([[VAR0]]) {axisInd = 1 : i32} : tensor<1x4x8x20xf16> -> tensor<1x4x8x20xf16>
