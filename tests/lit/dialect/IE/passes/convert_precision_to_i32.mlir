...
func @GatherConvertIndices(%arg0: tensor<100xf16>) -> tensor<10xf16> {
  ...
  %prob = IE.Gather(%arg0, %0) {axis_value = 0} : tensor<100xf16>,tensor<10xsi64> -> tensor<10xf16>
  ...
  //CHECK: [[VAL1:%.*]] = IE.Gather(%arg0, [[VAL0]]) {axis_value = 0 : i64} : tensor<100xf16>, tensor<10xsi32> -> tensor<10xf16>
  //CHECK: return [[VAL1]]
}
