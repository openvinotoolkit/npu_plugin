...
func @main(%arg0: tensor<100xf32>) -> (tensor<1x2x2x2xf64>, tensor<10xf32>) {
    ...
    %2 = IE.Gather(%arg0, %1) {axis_value = 0} : tensor<100xf32>,tensor<10xsi64> -> tensor<10xf32>
    ...
    // CHECK: [[VAR1:%.+]] = IE.Gather([[VAR0]], [[CST_0]]) {axis_value = 0 : i64} : tensor<100xf16>, tensor<10xsi32> -> tensor<10xf16>
