...
func @FoldPermuteCast(%arg0: tensor<1x1000x1x1xf32>) -> tensor<1x1000x1x1xf32> {
...
func @FusePermuteCasts(%arg0: tensor<1x1000x1x1xf32>, %arg1: tensor<1x1000x1x1xf32, {order = #NHWC}>) ->
        (tensor<1x1x1x1000xf32>, tensor<1x1x1000x1xf32>) {
    %0 = IE.PermuteCast(%arg0) {dst_order = #NCHW, mem_perm = #map1} :
        tensor<1x1000x1x1xf32> -> tensor<1x1x1000x1xf32>
    %1 = IE.PermuteCast(%0) {dst_order = #NCHW, mem_perm = #map2} :
        tensor<1x1x1000x1xf32> -> tensor<1x1x1x1000xf32>

    %2 = IE.PermuteCast(%arg1) {dst_order = #NHWC, mem_perm = #map1} :
        tensor<1x1000x1x1xf32, {order = #NHWC}> -> tensor<1x1x1000x1xf32, {order = #NHWC}>
    %3 = IE.PermuteCast(%2) {dst_order = #NCHW, mem_perm = #map1} :
        tensor<1x1x1000x1xf32, {order = #NHWC}> -> tensor<1x1x1000x1xf32>
    return %1, %3 : tensor<1x1x1x1000xf32>, tensor<1x1x1000x1xf32>

    // CHECK-NOT: IE.PermuteCast
    // CHECK-NOT: IE.PermuteCast
    // CHECK:     %[[VAL_0:.*]] = IE.PermuteCast(%arg0) {dst_order = #NCHW, mem_perm = #map} : tensor<1x1000x1x1xf32> -> tensor<1x1x1x1000xf32>
...
func @FuseMemPermAndPermCast(%arg0: tensor<1x1000x1x1xf32, {order = #NHWC}>) -> tensor<1x1x1000x1xf32> {
    %0 = IE.MemPermute(%arg0) {dst_order = #NHWC, mem_perm = #map1} :
            tensor<1x1000x1x1xf32, {order = #NHWC}> -> tensor<1x1x1000x1xf32, {order = #NHWC}>
    %1 = IE.PermuteCast(%0) {dst_order = #NCHW, mem_perm = #map1} :
        tensor<1x1x1000x1xf32, {order = #NHWC}> -> tensor<1x1x1000x1xf32>
