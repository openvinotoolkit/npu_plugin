...
func @ConstantTensor(%arg0: memref<1x1x28x28xf32>) -> memref<1x1x28x28xf32> {
    // CHECK: VPUIP.DeclareConstantTensor[0] memref<1x1x28x28xf16> = dense<0.000000e+00> : tensor<1x1x28x28xf32>
    %0 = VPUIP.DeclareConstantTensor [0] memref<1x1x28x28xf16> = dense<0.000000e+00> : tensor<1x1x28x28xf32>
