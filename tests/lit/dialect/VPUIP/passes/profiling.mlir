// RUN: vpux-opt --set-compile-params="vpu-arch=KMB" --upa-profiling %s | FileCheck %s
...
module @UpaProfiling {
    ...
    func @main(%arg0: memref<1x48x30x30xf16>, %arg1: memref<1x48x30x30xf32>) -> memref<1x48x30x30xf32> {
        %2 = VPURT.DeclareBuffer "VPU_DDR_Heap" [0] <0> -> memref<1x48x30x30xf16, "DDR">
        ...
        VPURT.Task {isTrailingSWLayer = false} waits(%3 : !VPURT.Barrier) updates(%4 : !VPURT.Barrier) op :  {
