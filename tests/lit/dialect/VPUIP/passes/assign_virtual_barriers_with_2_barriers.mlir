...
func @ParallelGraph(%arg0: memref<1x16x32x32xf16, #NHWC>, %arg1: memref<1x16x32x32xf16>) -> memref<1x16x32x32xf16> {
    ...
    // CHECK:       VPURT.Task
    // CHECK-SAME:       waits(%0 : !VPURT.Barrier) updates(%1 : !VPURT.Barrier)
    // CHECK:       VPURT.Task
    // CHECK-SAME:       waits(%1 : !VPURT.Barrier) updates(%2 : !VPURT.Barrier)
    // CHECK:       VPURT.Task
    // CHECK-SAME:       waits(%2 : !VPURT.Barrier) updates(%3 : !VPURT.Barrier)
    // CHECK:       VPURT.Task
    // CHECK-SAME:       waits(%3 : !VPURT.Barrier) updates(%4 : !VPURT.Barrier)
    // CHECK:       VPURT.Task
    // CHECK-SAME:       waits(%4 : !VPURT.Barrier) updates(%5 : !VPURT.Barrier)
    // CHECK:       VPURT.Task
    // CHECK-SAME:       waits(%5 : !VPURT.Barrier) updates(%6 : !VPURT.Barrier)
    // CHECK:       VPURT.Task
    // CHECK-SAME:       waits(%6 : !VPURT.Barrier) updates(%7 : !VPURT.Barrier)
    // CHECK:       VPURT.Task
    // CHECK-SAME:       waits(%7 : !VPURT.Barrier) updates(%8 : !VPURT.Barrier)
    // CHECK:       VPURT.Task
    // CHECK-SAME:       waits(%8 : !VPURT.Barrier) updates(%9 : !VPURT.Barrier)
    // CHECK:       VPURT.Task
    // CHECK-SAME:       waits(%9 : !VPURT.Barrier) updates(%10 : !VPURT.Barrier)
    // CHECK:       VPURT.Task
    // CHECK-SAME:       waits(%10 : !VPURT.Barrier) updates(%11 : !VPURT.Barrier)
    // CHECK:       VPURT.Task
    // CHECK-SAME:       waits(%11 : !VPURT.Barrier) updates(%12 : !VPURT.Barrier)
    // CHECK:       VPURT.Task
    // CHECK-SAME:       waits(%12 : !VPURT.Barrier) updates(%13 : !VPURT.Barrier)
    // CHECK:       VPURT.Task
    // CHECK-SAME:       waits(%13 : !VPURT.Barrier) updates(%14 : !VPURT.Barrier)
    // CHECK:       VPURT.Task
    // CHECK-SAME:       waits(%14 : !VPURT.Barrier)
}
