// RUN: vpux-opt --split-input-file --default-hw-mode="vpu-arch=VPUX37XX" %s | FileCheck %s
...
module @Convolution {
    ...
    // CHECK-DAG:       IE.ExecutorResource 1 of @SHAVE_ACT
    // CHECK-DAG:       IE.ExecutorResource 1 of @SHAVE_NN
    // CHECK-DAG:       IE.ExecutorResource {VPU.processorFrequency = 7.000000e+02 : f64} 2 of @NCE
