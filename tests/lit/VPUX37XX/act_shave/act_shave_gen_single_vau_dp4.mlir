...
//
// This file generates a blob with vau_dp4 activation shave
...
IE.CNNNetwork
    ...
    outputsInfo : {
        IE.DataInfo "vau_dp4" : tensor<1x252x1x1xsi32>
    }
...
module @VPU.SW {
    ...
    func private @builtin_vau_dp4(%input0 : memref<*xsi8>, %input1 : memref<*xsi8>, %output : memref<*xsi32>)
        attributes {
...
func @main(%1: memref<1x1008x1x1xsi8>, %2: memref<1x1008x1x1xsi8>, %3: memref<1x252x1x1xsi32>) -> memref<1x252x1x1xsi32> {
    ...
    VPURT.Task waits(%b0 : !VPURT.Barrier) updates(%b1 : !VPURT.Barrier) {
        VPUIP.SW.Kernel
                    ...
                    @VPU.SW::@builtin_vau_dp4           // The reference to the Kernel function.
