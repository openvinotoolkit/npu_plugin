...
//
// This file generates a blob with vau_dp4a activation shave
...
IE.CNNNetwork
    ...
    outputsInfo : {
        IE.DataInfo "vau_dp4a" : tensor<1x252x1x1xsi32>
    }
...
module @VPU.SW {
    ...
    func private @builtin_vau_dp4_a(%input0 : memref<*xsi8>, %input1 : memref<*xsi8>, %output : memref<*xsi32>)
        attributes {
            VPU.kernel_code = "vau_dp4a.cpp",
            VPU.kernel_entry = "vau_dp4a"        
        }
...
func @main(%1: memref<1x1008x1x1xsi8>, %2: memref<1x1008x1x1xsi8>, %3: memref<1x252x1x1xsi32>) -> memref<1x252x1x1xsi32> {
    ...
    VPURT.Task waits(%b0 : !VPURT.Barrier) updates(%b1 : !VPURT.Barrier) {
        VPUIP.SW.Kernel
                    ...
                    @VPU.SW::@builtin_vau_dp4_a           // The reference to the Kernel function.
                    inputs(%in0_tile0_cmx, %in1_tile0_cmx : memref<1x1008x1x1xsi8, [@CMX_NN, 0]>, memref<1x1008x1x1xsi8, [@CMX_NN, 0]>)     // Inputs/outputs buffers for generic operation interface
                    outputs(%out_tile0_cmx : memref<1x252x1x1xsi32, [@CMX_NN, 0]>)   //
                    on tile 0                           // The tile index to execute on.
        -> memref<1x252x1x1xsi32, [@CMX_NN, 0]> {

            ^bb0(%arg0 : memref<1x1008x1x1xsi8, [@CMX_NN, 0]>, %arg1 : memref<1x1008x1x1xsi8, [@CMX_NN, 0]>, %arg2 : memref<1x252x1x1xsi32, [@CMX_NN, 0]>):
