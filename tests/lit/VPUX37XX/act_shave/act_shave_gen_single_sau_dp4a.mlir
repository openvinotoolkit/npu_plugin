...
//
// This file generates a blob with sau_dp4a activation shave
...
IE.CNNNetwork
    ...
    outputsInfo : {
        IE.DataInfo "sau_dp4a" : tensor<1x1x1x1000xsi32>
    }
...
module @VPU.SW {
    ...
    func private @builtin_sau_dp4_a(%input0 : memref<*xsi32>, %input1 : memref<*xsi32>, %output : memref<*xsi32>)
        attributes {
            VPU.kernel_code = "sau_dp4a.cpp",
            VPU.kernel_entry = "sau_dp4a"        
        }
...
func @main(%1: memref<1x1x1x1000xsi32>, %2: memref<1x1x1x1000xsi32>, %3: memref<1x1x1x1000xsi32>) -> memref<1x1x1x1000xsi32> {
    ...
    VPURT.Task waits(%b0 : !VPURT.Barrier) updates(%b1 : !VPURT.Barrier) {
        VPUIP.SW.Kernel
                    ...
                    @VPU.SW::@builtin_sau_dp4_a           // The reference to the Kernel function.
                    inputs(%in0_tile0_cmx, %in1_tile0_cmx : memref<1x1x1x1000xsi32, [@CMX_NN, 0]>, memref<1x1x1x1000xsi32, [@CMX_NN, 0]>)     // Inputs/outputs buffers for generic operation interface
                    outputs(%out_tile0_cmx : memref<1x1x1x1000xsi32, [@CMX_NN, 0]>)   //
                    on tile 0                           // The tile index to execute on.
        -> memref<1x1x1x1000xsi32, [@CMX_NN, 0]> {

            ^bb0(%arg0 : memref<1x1x1x1000xsi32, [@CMX_NN, 0]>, %arg1 : memref<1x1x1x1000xsi32, [@CMX_NN, 0]>, %arg2 : memref<1x1x1x1000xsi32, [@CMX_NN, 0]>):
                // Inner region, isolated from above, which holds the information about arguments mapping.

                // The arguments mapping, the order must match the kernel parameter structure.
                VPUIP.SW.Kernel.run {attrs = []}(%arg0, %arg1, %arg2)
                    : memref<1x1x1x1000xsi32, [@CMX_NN, 0]>
                    , memref<1x1x1x1000xsi32, [@CMX_NN, 0]>
                    , memref<1x1x1x1000xsi32, [@CMX_NN, 0]>
        }
