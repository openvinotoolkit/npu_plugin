...
//
// This file generates a blob with dummy activation shave
...
IE.CNNNetwork
    ...
    outputsInfo : {
        IE.DataInfo "dummy" : tensor<1x1000xf16>
    }
...
module @VPU.SW {
    ...
    func.func private @builtin_dummy(%input : memref<*xf16>, %output : memref<*xf16>, %ins : i64, %outs : i64)
        attributes {
...
func.func @main(%1: memref<1x1x1x1000xf16>, %2: memref<1x1x1x1000xf16>) -> memref<1x1x1x1000xf16> {
    ...
    VPURT.Task waits(%b0 : !VPURT.Barrier) updates(%b1 : !VPURT.Barrier) {
        VPUIP.SW.Kernel {result_segment_sizes = dense<[1, 0]> : vector<2xi32>}
                    @VPU.SW::@builtin_dummy            // The reference to the Kernel function.
