...
//
// This file generates a blob with vau_log activation shave
...
IE.CNNNetwork
    ...
    outputsInfo : {
        IE.DataInfo "vau_log" : tensor<1x1000xf16>
    }
...
module @VPU.SW {
    ...
    func.func private @builtin_vau_log_fp16(%input : memref<*xf16>, %output : memref<*xf16>)
        attributes {
            VPU.kernel_code = "vau_log_fp16.cpp",
            VPU.kernel_entry = "vau_log_fp16"
        }
...
func.func @main(%1: memref<1x1x1x1000xf16>, %2: memref<1x1x1x1000xf16>) -> memref<1x1x1x1000xf16> {
    ...
    VPURT.Task waits(%b0 : !VPURT.Barrier) updates(%b1 : !VPURT.Barrier) {
        VPUIP.SW.Kernel
                    ...
                    @VPU.SW::@builtin_vau_log_fp16            // The reference to the Kernel function.
