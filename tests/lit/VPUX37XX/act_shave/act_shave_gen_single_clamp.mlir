...
//
// This file generates a blob with clamp activation shave
...
IE.CNNNetwork
    ...
    outputsInfo : {
        IE.DataInfo "clamp" : tensor<1x1000xf16>
    }
...
module @VPU.SW {
    ...
    func private @builtin_clamp(%input : memref<*xf16>, %output : memref<*xf16>, %min : f16, %max : f16)
        attributes {
