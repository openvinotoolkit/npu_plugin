...
//
// This file generates a blob with round activation shave
...
IE.CNNNetwork
    ...
    outputsInfo : {
        IE.DataInfo "round" : tensor<1x1000xf16>
    }
...
module @VPU.SW {
    ...
    func.func private @builtin_Round(%input : memref<*xf16>, %output : memref<*xf16>)
        attributes {
            VPU.kernel_code = "round_fp16.cpp",
            VPU.kernel_entry = "round_fp16"
        }
...
func.func @main(%1: memref<1x1x1x1000xf16>, %2: memref<1x1x1x1000xf16>) -> memref<1x1x1x1000xf16> {
    ...
    VPURT.Task waits(%b0 : !VPURT.Barrier) updates(%b1 : !VPURT.Barrier) {
        VPUIP.SW.Kernel
                    ...
                    @VPU.SW::@builtin_Round          // The reference to the Kernel function.
        ...
        -> memref<1x1x1x1000xf16, [@CMX_NN, 0]> {
                ...
                VPUIP.SW.Kernel.run {mode = [1]}(%arg0, %arg1)
                    : memref<1x1x1x1000xf16, [@CMX_NN, 0]>
                    , memref<1x1x1x1000xf16, [@CMX_NN, 0]>
        }
    }
