...
module @VPU.SW {
    ...
    func private @builtin_SpaceToDepthOp(%inputs : memref<*xf16>, %output : memref<*xf16>)
        attributes {
...
func @main(%1: memref<1x2x12x12xf16>, %2: memref<1x8x6x6xf16>) -> memref<1x8x6x6xf16> {
    ...
    VPURT.Task updates(%b0 : !VPURT.Barrier) {
        VPUIP.NNDMA inputs(%1 : memref<1x2x12x12xf16>) outputs(%in_tile0_cmx : memref<1x2x12x12xf16, [@CMX_NN, 0]>) -> memref<1x2x12x12xf16, [@CMX_NN, 0]>
    }
    ...
    VPURT.Task waits(%b1 : !VPURT.Barrier) {
        VPUIP.NNDMA inputs(%out_tile0_cmx : memref<1x8x6x6xf16, [@CMX_NN, 0]>) outputs(%2 : memref<1x8x6x6xf16>) -> memref<1x8x6x6xf16>
    }
