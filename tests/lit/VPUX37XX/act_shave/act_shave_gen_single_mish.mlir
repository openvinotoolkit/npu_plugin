...
//
// This file generates a blob with mish activation shave
...
IE.CNNNetwork
    ...
    outputsInfo : {
        IE.DataInfo "mish" : tensor<1x1000xf16>
    }
...
module @VPU.SW {
    ...
    func.func private @builtin_mish(%input : memref<*xf16>, %output : memref<*xf16>)
        attributes {
            VPU.kernel_code = "mish_fp16.c",
            VPU.kernel_entry = "mish_fp16"
        }
...
func.func @main(%1: memref<1x1x1x1000xf16>, %2: memref<1x1x1x1000xf16>) -> memref<1x1x1x1000xf16> {
    ...
    VPURT.Task waits(%b0  : !VPURT.Barrier) updates(%b1  : !VPURT.Barrier) {
        VPUIP.SW.Kernel {result_segment_sizes = dense<[1, 0]> : vector<2xi32>}
                    @VPU.SW::@builtin_mish            // The reference to the Kernel function.
