...
//
// This file generates a blob with sau_dp4 activation shave
...
IE.CNNNetwork
    ...
    outputsInfo : {
        IE.DataInfo "sau_dp4" : tensor<1x1x1x1000xsi32>
    }
...
module @VPU.SW {
    ...
    func private @builtin_sau_dp4(%input0 : memref<*xsi32>, %input1 : memref<*xsi32>, %output : memref<*xsi32>)
        attributes {
            VPU.kernel_code = "sau_dp4.cpp",
            VPU.kernel_entry = "sau_dp4"        
        }
...
func @main(%1: memref<1x1x1x1000xsi32>, %2: memref<1x1x1x1000xsi32>, %3: memref<1x1x1x1000xsi32>) -> memref<1x1x1x1000xsi32> {
    ...
    VPURT.Task waits(%b0 : !VPURT.Barrier) updates(%b1 : !VPURT.Barrier) {
        VPUIP.SW.Kernel
                    ...
                    @VPU.SW::@builtin_sau_dp4           // The reference to the Kernel function.
