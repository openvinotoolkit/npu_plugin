...
//
// This file generates a blob with selu activation shave
...
IE.CNNNetwork
    ...
    outputsInfo : {
        IE.DataInfo "selu" : tensor<1x1000xf16>
    }
...
module @VPU.SW {
    ...
    func.func private @builtin_selu(%input : memref<*xf16>, %output : memref<*xf16>, %alpha : f16, %lambda : f16)
        attributes {
            VPU.kernel_code = "selu_fp16.cpp",
            VPU.kernel_entry = "selu_fp16"
        }
...
func.func @main(%1: memref<1x1x1x1000xf16>, %2: memref<1x1x1x1000xf16>) -> memref<1x1x1x1000xf16> {
    ...
    VPURT.Task waits(%b0  : !VPURT.Barrier) updates(%b1  : !VPURT.Barrier) {
        VPUIP.SW.Kernel {result_segment_sizes = dense<[1, 0]> : vector<2xi32>}
                    @VPU.SW::@builtin_selu            // The reference to the Kernel function.
