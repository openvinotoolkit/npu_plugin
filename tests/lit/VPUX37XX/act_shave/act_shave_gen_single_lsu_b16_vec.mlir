...
//
// This file generates a blob with lsu_b16_vec activation shave
...
IE.CNNNetwork
    ...
    outputsInfo : {
        IE.DataInfo "lsu_b16_vec" : tensor<1x1000xf16>
    }
...
module @VPU.SW {
    ...
    func.func private @builtin_lsu_b16_vec(%input : memref<*xf16>, %output : memref<*xf16>)
        attributes {
            VPU.kernel_code = "lsu_b16_vec.cpp",
            VPU.kernel_entry = "lsu_b16_vec"
        }
...
func.func @main(%1: memref<1x1x1x1000xf16>, %2: memref<1x1x1x1000xf16>) -> memref<1x1x1x1000xf16> {
    ...
    VPURT.Task waits(%b0 : !VPURT.Barrier) updates(%b1 : !VPURT.Barrier) {
        VPUIP.SW.Kernel
                    ...
                    @VPU.SW::@builtin_lsu_b16_vec           // The reference to the Kernel function.
