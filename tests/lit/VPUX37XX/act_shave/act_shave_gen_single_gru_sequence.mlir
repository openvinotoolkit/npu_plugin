...
func.func @main(%arg0: memref<2x1x10xf16, @DDR>, %arg1: memref<2x1x4xf16, @DDR>, %arg2: memref<2x1x1x4xf16, @DDR>, %arg3: memref<2x1x4xf16, @DDR>) -> (memref<2x1x1x4xf16, @DDR>, memref<2x1x4xf16, @DDR>) {
    ...
    VPURT.Task attributes {cycleBegin = 0 : i64, cycleEnd = 962 : i64, isTrailingSWLayer = false} {
    ...
    VPURT.Task attributes {cycleBegin = 952 : i64, cycleEnd = 1904 : i64, isTrailingSWLayer = false} {
        %13 = VPUIP.NNDMA {port = 0 : i64} inputs(%cst_1 : memref<1x16xf16>) outputs(%10 : memref<1x16xf16, [@CMX_NN, 0]>) -> memref<1x16xf16, [@CMX_NN, 0]>
    }
    VPURT.Task updates(%0 : !VPURT.Barrier) attributes {cycleBegin = 962 : i64, cycleEnd = 1914 : i64, isTrailingSWLayer = false} {
        %13 = VPUIP.NNDMA {port = 1 : i64} inputs(%3 : memref<2x1x4xf16, @DDR>) outputs(%7 : memref<2x1x4xf16, [@CMX_NN, 0]>) -> memref<2x1x4xf16, [@CMX_NN, 0]>
    }
    VPURT.Task updates(%0 : !VPURT.Barrier) attributes {cycleBegin = 1904 : i64, cycleEnd = 2859 : i64, isTrailingSWLayer = false} {
        %13 = VPUIP.NNDMA {port = 0 : i64} inputs(%cst_0 : memref<1x12x4xf16>) outputs(%9 : memref<1x12x4xf16, [@CMX_NN, 0]>) -> memref<1x12x4xf16, [@CMX_NN, 0]>
    }

    VPURT.Task waits(%0 : !VPURT.Barrier) updates(%1 : !VPURT.Barrier) attributes {cycleBegin = 2859 : i64, cycleEnd = 2861 : i64, isTrailingSWLayer = false} {
    ...
    VPURT.Task waits(%1 : !VPURT.Barrier) attributes {cycleBegin = 2861 : i64, cycleEnd = 3813 : i64, isTrailingSWLayer = false} {
