...
//
// This file generates a blob with ceil activation shave
...
IE.CNNNetwork
    ...
    outputsInfo : {
        IE.DataInfo "ceil" : tensor<1x1000xf16>
    }
...
module @VPU.SW {
    ...
    func.func private @builtin_ceil(%input : memref<*xf16>, %output : memref<*xf16>, %min : f16, %max : f16)
        attributes {
            VPU.kernel_code = "ceil_fp16.cpp",
            VPU.kernel_entry = "ceil_fp16"
        }
...
func.func @main(%1: memref<1x1x1x1000xf16>, %2: memref<1x1x1x1000xf16>) -> memref<1x1x1x1000xf16> {
    ...
    %out_tile0_cmx = VPURT.DeclareBuffer "CMX_NN" [0] <2048> -> memref<1x1x1x1000xf16, [@CMX_NN, 0]>
    ...
    VPURT.Task waits(%b0  : !VPURT.Barrier) updates(%b1  : !VPURT.Barrier) {
        VPUIP.SW.Kernel {result_segment_sizes = dense<[1, 0]> : vector<2xi32>}
                    @VPU.SW::@builtin_ceil            // The reference to the Kernel function.
