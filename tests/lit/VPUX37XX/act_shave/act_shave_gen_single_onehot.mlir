...
func.func @main(%arg0: memref<4xsi32, @DDR>, %arg1: memref<4x3xf16, @DDR>) -> memref<4x3xf16, @DDR> {
    ...
    VPURT.Task updates(%b0 : !VPURT.Barrier) attributes {cycleBegin = 0 : i64, cycleEnd = 952 : i64, isTrailingSWLayer = false} {
    ...
    VPURT.Task waits(%b0  : !VPURT.Barrier) updates(%b1  : !VPURT.Barrier) attributes {cycleBegin = 952 : i64, cycleEnd = 954 : i64, isTrailingSWLayer = false} {
    ...
    VPURT.Task waits(%b1 : !VPURT.Barrier) {
        %0 = VPUIP.NNDMA inputs(%out_tile0_cmx : memref<4x3xf16, [@CMX_NN, 0]>) outputs(%arg1 : memref<4x3xf16, @DDR>) -> memref<4x3xf16, @DDR>
    }
