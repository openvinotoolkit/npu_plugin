...
module @VPU.SW {
    ...
    func private @builtin_RegionYolo(%input : memref<*xf16>, %output : memref<*xf16>)
        attributes {
...
func @main(%1: memref<1x255x26x26xf16>, %2: memref<1x255x26x26xf16>) -> memref<1x255x26x26xf16> {
    ...
    VPURT.Task updates(%b0 : !VPURT.Barrier) {
        VPUIP.NNDMA inputs(%1 : memref<1x255x26x26xf16>) outputs(%in_tile0_cmx : memref<1x255x26x26xf16, [@CMX_NN, 0]>) -> memref<1x255x26x26xf16, [@CMX_NN, 0]>
    }
    ...
    VPURT.Task waits(%b1 : !VPURT.Barrier) {
        %0 = VPUIP.NNDMA inputs(%out_tile0_cmx : memref<1x255x26x26xf16, [@CMX_NN, 0]>) outputs(%2 : memref<1x255x26x26xf16>) -> memref<1x255x26x26xf16>
    }
