...
//
// This file generates a blob with negative activation shave
...
IE.CNNNetwork
    ...
    outputsInfo : {
        IE.DataInfo "negative" : tensor<1x1000xf16>
    }
...
module @VPU.SW {
    ...
    func.func private @builtin_Negative(%input : memref<*xf16>, %output : memref<*xf16>)
        attributes {
            VPU.kernel_code = "single_shave_negative.cpp",
            VPU.kernel_entry = "single_shave_negative"
        }
...
func.func @main(%1: memref<1x1x1x1000xf16>, %2: memref<1x1x1x1000xf16>) -> memref<1x1x1x1000xf16> {
    ...
    VPURT.Task waits(%b0 : !VPURT.Barrier) updates(%b1 : !VPURT.Barrier) {
        VPUIP.SW.Kernel
                    ...
                    @VPU.SW::@builtin_Negative          // The reference to the Kernel function.
...
// CHECK:                  },
// CHECK:                  dataSection: {
// CHECK:                    name: "builtin_Negative_invo",
// CHECK:                    locale: "GFEmbeddedKernel",
// CHECK:                  },
