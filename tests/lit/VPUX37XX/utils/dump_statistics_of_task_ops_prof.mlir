...
// RUN: env IE_VPUX_LOG_FILTER=dump-statistics-of-task-ops vpux-opt --dump-statistics-of-task-ops -o /dev/null %s | FileCheck %s
...
module @age_gender attributes {VPU.arch = "VPUX37XX", VPU.compilationMode = "DefaultHW"} {
  ...
  func.func @main(%arg0: memref<1x3x62x62xf32, @DDR> loc(unknown), %arg1: memref<1x48x30x30xf32, @DDR> loc(unknown), %arg2: memref<76xui32> loc("profiling_result")) -> (memref<1x48x30x30xf32, @DDR>, memref<76xui32>) {
    ...
    %53 = VPURT.DeclareBuffer "CMX_NN" [0] <65280> -> memref<1x1x1x16xui8, [@CMX_NN, 0]> loc(#loc31)
    %54 = VPURT.DeclareBuffer "CMX_NN" [1] <65280> -> memref<1x1x1x16xui8, [@CMX_NN, 1]> loc(#loc32)
    ...
    VPURT.Task attributes {isTrailingSWLayer = false} {
      %109 = VPUIP.NNDMA {port = 0 : i64} inputs(%58 : memref<1xui64, @Register>) outputs(%59 : memref<1xui64, [@CMX_NN, 0]>) -> memref<1xui64, [@CMX_NN, 0]> loc(#loc36)
    } loc(#loc36)
    VPURT.Task attributes {cycleBegin = 0 : i64, cycleEnd = 2061 : i64, isTrailingSWLayer = false} {
      %109 = VPUIP.NNDMA {port = 0 : i64} inputs(%8 : memref<1x3x62x62xf32, @DDR>) outputs(%16 : memref<1x3x62x62xf32, [@CMX_NN, 0]>) -> memref<1x3x62x62xf32, [@CMX_NN, 0]> loc(#loc4)
    } loc(#loc4)
    VPURT.Task updates(%0 : !VPURT.Barrier) attributes {isTrailingSWLayer = false} {
      %109 = VPUIP.NNDMA {port = 0 : i64} inputs(%60 : memref<1xui64, @Register>) outputs(%61 : memref<1xui64, [@CMX_NN, 0]>) -> memref<1xui64, [@CMX_NN, 0]> loc(#loc37)
    } loc(#loc37)
    VPURT.Task attributes {isTrailingSWLayer = false} {
      %109 = VPUIP.NNDMA {port = 1 : i64} inputs(%62 : memref<1xui64, @Register>) outputs(%63 : memref<1xui64, [@CMX_NN, 0]>) -> memref<1xui64, [@CMX_NN, 0]> loc(#loc38)
    } loc(#loc38)
    ...
    VPURT.Task attributes {isTrailingSWLayer = false} {
      %109 = VPUIP.NNDMA {port = 1 : i64} inputs(%64 : memref<1xui64, @Register>) outputs(%65 : memref<1xui64, [@CMX_NN, 0]>) -> memref<1xui64, [@CMX_NN, 0]> loc(#loc39)
    } loc(#loc39)
    VPURT.Task attributes {isTrailingSWLayer = false} {
      %109 = VPUIP.NNDMA {port = 1 : i64} inputs(%66 : memref<1xui64, @Register>) outputs(%67 : memref<1xui64, [@CMX_NN, 0]>) -> memref<1xui64, [@CMX_NN, 0]> loc(#loc40)
    } loc(#loc40)
    ...
    VPURT.Task updates(%1 : !VPURT.Barrier) attributes {isTrailingSWLayer = false} {
      %109 = VPUIP.NNDMA {port = 1 : i64} inputs(%68 : memref<1xui64, @Register>) outputs(%69 : memref<1xui64, [@CMX_NN, 0]>) -> memref<1xui64, [@CMX_NN, 0]> loc(#loc41)
    } loc(#loc41)
    VPURT.Task waits(%0 : !VPURT.Barrier) updates(%2 : !VPURT.Barrier) attributes {cycleBegin = 2061 : i64, cycleEnd = 2063 : i64, isTrailingSWLayer = false} {
      %results, %profiling_output = VPUIP.SW.Kernel {result_segment_sizes = dense<1> : vector<2xi32>} @VPU.SW::@builtin_Convert inputs(%16 as %arg3: memref<1x3x62x62xf32, [@CMX_NN, 0]>) outputs(%17 as %arg4: memref<1x3x62x62xf16, [@CMX_NN, 0]>) profiling_data(%45 : memref<4xui32, [@CMX_NN, 0]>) on tile 0 -> (memref<1x3x62x62xf16, [@CMX_NN, 0]>, memref<4xui32, [@CMX_NN, 0]>){
    ...
    VPURT.Task waits(%2 : !VPURT.Barrier) attributes {isTrailingSWLayer = false} {
      %109 = VPUIP.NNDMA {port = 0 : i64} inputs(%70 : memref<1xui64, @Register>) outputs(%71 : memref<1xui64, [@CMX_NN, 0]>) -> memref<1xui64, [@CMX_NN, 0]> loc(#loc36)
    } loc(#loc36)
    VPURT.Task attributes {cycleBegin = 2063 : i64, cycleEnd = 4124 : i64, isTrailingSWLayer = false} {
      %109 = VPUIP.NNDMA {port = 0 : i64} inputs(%17 : memref<1x3x62x62xf16, [@CMX_NN, 0]>) outputs(%46 : memref<1x3x62x62xf16, {order = #NCHW, strides = [61504, 3844, 62, 1]}, @DDR>) -> memref<1x3x62x62xf16, {order = #NCHW, strides = [61504, 3844, 62, 1]}, @DDR> loc(#loc4)
    } loc(#loc4)
    VPURT.Task updates(%1 : !VPURT.Barrier) attributes {isTrailingSWLayer = false} {
      %109 = VPUIP.NNDMA {port = 0 : i64} inputs(%72 : memref<1xui64, @Register>) outputs(%73 : memref<1xui64, [@CMX_NN, 0]>) -> memref<1xui64, [@CMX_NN, 0]> loc(#loc42)
    } loc(#loc42)
    VPURT.Task waits(%1 : !VPURT.Barrier) attributes {isTrailingSWLayer = false} {
      %109 = VPUIP.NNDMA {port = 0 : i64} inputs(%74 : memref<1xui64, @Register>) outputs(%75 : memref<1xui64, [@CMX_NN, 0]>) -> memref<1xui64, [@CMX_NN, 0]> loc(#loc43)
    } loc(#loc43)
    VPURT.Task attributes {cycleBegin = 6838 : i64, cycleEnd = 13711 : i64, isTrailingSWLayer = false} {
      %109 = VPUIP.PermuteDMA {dma_descriptor = {dstPlaneStride = 2 : i64, dstStride = 32 : i64, dstWidth = 2 : i64, len = 3968 : i64, numPlanes = 16 : i64, srcPlaneStride = 7688 : i64, srcStride = 2 : i64, srcWidth = 3968 : i64}, port = 0 : i64} inputs(%18 : memref<16x1984xf16, @DDR>) outputs(%21 : memref<1984x16xf16, [@CMX_NN, 0]>) -> memref<1984x16xf16, [@CMX_NN, 0]> loc(#loc62)
    } loc(#loc62)
    VPURT.Task attributes {isTrailingSWLayer = false} {
      %109 = VPUIP.NNDMA {port = 0 : i64} inputs(%76 : memref<1xui64, @Register>) outputs(%77 : memref<1xui64, [@CMX_NN, 0]>) -> memref<1xui64, [@CMX_NN, 0]> loc(#loc44)
    } loc(#loc44)
    VPURT.Task waits(%1 : !VPURT.Barrier) attributes {isTrailingSWLayer = false} {
      %109 = VPUIP.NNDMA {port = 1 : i64} inputs(%78 : memref<1xui64, @Register>) outputs(%79 : memref<1xui64, [@CMX_NN, 0]>) -> memref<1xui64, [@CMX_NN, 0]> loc(#loc45)
    } loc(#loc45)
    VPURT.Task attributes {cycleBegin = 6838 : i64, cycleEnd = 13711 : i64, isTrailingSWLayer = false} {
      %109 = VPUIP.PermuteDMA {dma_descriptor = {dstPlaneStride = 2 : i64, dstStride = 32 : i64, dstWidth = 2 : i64, len = 3720 : i64, numPlanes = 16 : i64, srcPlaneStride = 7688 : i64, srcStride = 2 : i64, srcWidth = 3720 : i64}, port = 1 : i64} inputs(%19 : memref<16x1860xf16, @DDR>) outputs(%22 : memref<1860x16xf16, [@CMX_NN, 1]>) -> memref<1860x16xf16, [@CMX_NN, 1]> loc(#loc63)
    } loc(#loc63)
    VPURT.Task updates(%3 : !VPURT.Barrier) attributes {isTrailingSWLayer = false} {
      %109 = VPUIP.NNDMA {port = 1 : i64} inputs(%80 : memref<1xui64, @Register>) outputs(%81 : memref<1xui64, [@CMX_NN, 0]>) -> memref<1xui64, [@CMX_NN, 0]> loc(#loc46)
    } loc(#loc46)
    VPURT.Task attributes {isTrailingSWLayer = false} {
      %109 = VPUIP.NNDMA {port = 0 : i64} inputs(%82 : memref<1xui64, @Register>) outputs(%83 : memref<1xui64, [@CMX_NN, 0]>) -> memref<1xui64, [@CMX_NN, 0]> loc(#loc38)
    } loc(#loc38)
    VPURT.Task attributes {cycleBegin = 13711 : i64, cycleEnd = 14680 : i64, isTrailingSWLayer = false} {
      %109 = VPUIP.NNDMA {port = 0 : i64} inputs(%cst_1 : memref<48x1x1x4xsi32>) outputs(%27 : !VPUIP.DistributedBuffer<48x1x1x4xsi32, #NCHW, @CMX_NN, {mode = "DUPLICATED", num_clusters = 2 : i64}>) -> !VPUIP.DistributedBuffer<48x1x1x4xsi32, #NCHW, @CMX_NN, {mode = "DUPLICATED", num_clusters = 2 : i64}> loc(#loc59)
    } loc(#loc59)
    VPURT.Task updates(%3 : !VPURT.Barrier) attributes {isTrailingSWLayer = false} {
      %109 = VPUIP.NNDMA {port = 0 : i64} inputs(%84 : memref<1xui64, @Register>) outputs(%85 : memref<1xui64, [@CMX_NN, 0]>) -> memref<1xui64, [@CMX_NN, 0]> loc(#loc47)
    } loc(#loc47)
    VPURT.Task attributes {isTrailingSWLayer = false} {
      %109 = VPUIP.NNDMA {port = 1 : i64} inputs(%86 : memref<1xui64, @Register>) outputs(%87 : memref<1xui64, [@CMX_NN, 0]>) -> memref<1xui64, [@CMX_NN, 0]> loc(#loc48)
    } loc(#loc48)
    ...
    VPURT.Task updates(%4 : !VPURT.Barrier) attributes {isTrailingSWLayer = false} {
      %109 = VPUIP.NNDMA {port = 1 : i64} inputs(%88 : memref<1xui64, @Register>) outputs(%89 : memref<1xui64, [@CMX_NN, 0]>) -> memref<1xui64, [@CMX_NN, 0]> loc(#loc49)
    } loc(#loc49)
    VPURT.Task waits(%3 : !VPURT.Barrier) updates(%4 : !VPURT.Barrier) attributes {cycleBegin = 14680 : i64, cycleEnd = 28277 : i64, isTrailingSWLayer = false} {
      %109:2 = VPUIP.NCEClusterTask {cm_sp_pattern = 7 : i64, is_segmented, kernel_padding = {bottom = 0 : i64, left = 0 : i64, right = 0 : i64, top = 0 : i64}, kernel_size = [3, 3], kernel_strides = [1, 1], task_type = "CONV"} input(%23 : memref<1x16x32x62xf16, #NHWC, [@CMX_NN, 0]>) weights(%47 : memref<48x16x3x3xf16, #NHWC, [@CMX_NN, 0]>) weight_table(%25 : memref<48x1x1x4xsi32, [@CMX_NN, 0]>) parent_input(%20 : !VPUIP.DistributedBuffer<1x16x62x62xf16, #NHWC, @CMX_NN, {mode = "SEGMENTED", num_tiles = [1, 1, 2, 1], num_clusters = 2 : i64, alignment = [1, 1, 2, 1]}>) parent_output(%28 : !VPUIP.DistributedBuffer<1x48x60x60xf16, #NHWC, @CMX_NN, {mode = "SEGMENTED", num_tiles = [1, 1, 2, 1], num_clusters = 2 : i64}>) outputs(%31 : memref<1x48x30x60xf16, #NHWC, [@CMX_NN, 0]>) profiling_data(%49 : memref<2xui64, [@CMX_NN, 0]>) -> memref<1x48x30x60xf16, #NHWC, [@CMX_NN, 0]>, memref<2xui64, [@CMX_NN, 0]> variants : {
        DPUTask {cluster_id = 0 : i64, mpe_mode = "CUBOID_16x16", outEnd = [59, 29, 47], outStart = [0, 0, 0], pad = {bottom = 0 : i64, left = 0 : i64, right = 0 : i64, top = 0 : i64}} loc(#loc4)
      } PPE : {
        PPETask "LRELU" {clamp_high = 2147483647 : i64, clamp_low = -2147483648 : i64, fp_prelu_alpha = 1.000000e+00 : f64, lrelu_mult = 1 : i64, lrelu_shift = 0 : i64} loc(#loc4)
      } loc(#loc65)
    } loc(#loc65)
    VPURT.Task waits(%3 : !VPURT.Barrier) updates(%4 : !VPURT.Barrier) attributes {cycleBegin = 14680 : i64, cycleEnd = 28277 : i64, isTrailingSWLayer = false} {
      %109:2 = VPUIP.NCEClusterTask {cm_sp_pattern = 7 : i64, is_segmented, kernel_padding = {bottom = 0 : i64, left = 0 : i64, right = 0 : i64, top = 0 : i64}, kernel_size = [3, 3], kernel_strides = [1, 1], task_type = "CONV"} input(%24 : memref<1x16x30x62xf16, #NHWC, [@CMX_NN, 1]>) weights(%48 : memref<48x16x3x3xf16, #NHWC, [@CMX_NN, 1]>) weight_table(%26 : memref<48x1x1x4xsi32, [@CMX_NN, 1]>) parent_input(%20 : !VPUIP.DistributedBuffer<1x16x62x62xf16, #NHWC, @CMX_NN, {mode = "SEGMENTED", num_tiles = [1, 1, 2, 1], num_clusters = 2 : i64, alignment = [1, 1, 2, 1]}>) parent_output(%28 : !VPUIP.DistributedBuffer<1x48x60x60xf16, #NHWC, @CMX_NN, {mode = "SEGMENTED", num_tiles = [1, 1, 2, 1], num_clusters = 2 : i64}>) outputs(%32 : memref<1x48x30x60xf16, #NHWC, [@CMX_NN, 1]>) profiling_data(%50 : memref<2xui64, [@CMX_NN, 1]>) -> memref<1x48x30x60xf16, #NHWC, [@CMX_NN, 1]>, memref<2xui64, [@CMX_NN, 1]> variants : {
        DPUTask {cluster_id = 1 : i64, mpe_mode = "CUBOID_16x16", outEnd = [59, 59, 47], outStart = [0, 30, 0], pad = {bottom = 0 : i64, left = 0 : i64, right = 0 : i64, top = 0 : i64}} loc(#loc4)
      } PPE : {
        PPETask "LRELU" {clamp_high = 2147483647 : i64, clamp_low = -2147483648 : i64, fp_prelu_alpha = 1.000000e+00 : f64, lrelu_mult = 1 : i64, lrelu_shift = 0 : i64} loc(#loc4)
      } loc(#loc66)
    } loc(#loc66)
    VPURT.Task waits(%4 : !VPURT.Barrier) updates(%5 : !VPURT.Barrier) attributes {cycleBegin = 28277 : i64, cycleEnd = 33607 : i64, isTrailingSWLayer = false} {
      %109:2 = VPUIP.NCEClusterTask {activation_window_channel_length = 27 : i64, is_segmented, is_superdense, kernel_padding = {bottom = 1 : i64, left = 0 : i64, right = 1 : i64, top = 0 : i64}, kernel_size = [3, 3], kernel_strides = [2, 2], task_type = "MAXPOOL"} input(%29 : memref<1x48x30x60xf16, #NHWC, [@CMX_NN, 0]>) weight_table(%51 : memref<48x1x1x4xsi32, [@CMX_NN, 0]>) activation_window(%53 : memref<1x1x1x16xui8, [@CMX_NN, 0]>) parent_input(%28 : !VPUIP.DistributedBuffer<1x48x60x60xf16, #NHWC, @CMX_NN, {mode = "SEGMENTED", num_tiles = [1, 1, 2, 1], num_clusters = 2 : i64}>) parent_output(%34 : !VPUIP.DistributedBuffer<1x48x30x30xf16, #NCHW, @CMX_NN, {mode = "SEGMENTED", num_tiles = [1, 1, 2, 1], num_clusters = 2 : i64}>) outputs(%37 : memref<1x48x15x30xf16, [@CMX_NN, 0]>) profiling_data(%55 : memref<4xui64, [@CMX_NN, 0]>) -> memref<1x48x15x30xf16, [@CMX_NN, 0]>, memref<4xui64, [@CMX_NN, 0]> variants : {
        DPUTask {cluster_id = 0 : i64, mpe_mode = "CUBOID_16x16", outEnd = [29, 14, 31], outStart = [0, 0, 0], pad = {bottom = 0 : i64, left = 0 : i64, right = 1 : i64, top = 0 : i64}} loc(#loc18)
        DPUTask {cluster_id = 0 : i64, mpe_mode = "CUBOID_16x16", outEnd = [29, 14, 47], outStart = [0, 0, 32], pad = {bottom = 0 : i64, left = 0 : i64, right = 1 : i64, top = 0 : i64}} loc(#loc18)
      } PPE : {
        PPETask "NOOP" {clamp_high = 2147483647 : i64, clamp_low = -2147483648 : i64, fp_prelu_alpha = 1.000000e+00 : f64, lrelu_mult = 1 : i64, lrelu_shift = 0 : i64} loc(#loc18)
      } loc(#loc67)
    } loc(#loc67)
    VPURT.Task waits(%4 : !VPURT.Barrier) updates(%5 : !VPURT.Barrier) attributes {cycleBegin = 28277 : i64, cycleEnd = 33607 : i64, isTrailingSWLayer = false} {
      %109:2 = VPUIP.NCEClusterTask {activation_window_channel_length = 27 : i64, is_segmented, is_superdense, kernel_padding = {bottom = 1 : i64, left = 0 : i64, right = 1 : i64, top = 0 : i64}, kernel_size = [3, 3], kernel_strides = [2, 2], task_type = "MAXPOOL"} input(%30 : memref<1x48x30x60xf16, #NHWC, [@CMX_NN, 1]>) weight_table(%52 : memref<48x1x1x4xsi32, [@CMX_NN, 1]>) activation_window(%54 : memref<1x1x1x16xui8, [@CMX_NN, 1]>) parent_input(%28 : !VPUIP.DistributedBuffer<1x48x60x60xf16, #NHWC, @CMX_NN, {mode = "SEGMENTED", num_tiles = [1, 1, 2, 1], num_clusters = 2 : i64}>) parent_output(%34 : !VPUIP.DistributedBuffer<1x48x30x30xf16, #NCHW, @CMX_NN, {mode = "SEGMENTED", num_tiles = [1, 1, 2, 1], num_clusters = 2 : i64}>) outputs(%38 : memref<1x48x15x30xf16, [@CMX_NN, 1]>) profiling_data(%56 : memref<4xui64, [@CMX_NN, 1]>) -> memref<1x48x15x30xf16, [@CMX_NN, 1]>, memref<4xui64, [@CMX_NN, 1]> variants : {
        DPUTask {cluster_id = 1 : i64, mpe_mode = "CUBOID_16x16", outEnd = [29, 29, 31], outStart = [0, 15, 0], pad = {bottom = 1 : i64, left = 0 : i64, right = 1 : i64, top = 0 : i64}} loc(#loc18)
        DPUTask {cluster_id = 1 : i64, mpe_mode = "CUBOID_16x16", outEnd = [29, 29, 47], outStart = [0, 15, 32], pad = {bottom = 1 : i64, left = 0 : i64, right = 1 : i64, top = 0 : i64}} loc(#loc18)
      } PPE : {
        PPETask "NOOP" {clamp_high = 2147483647 : i64, clamp_low = -2147483648 : i64, fp_prelu_alpha = 1.000000e+00 : f64, lrelu_mult = 1 : i64, lrelu_shift = 0 : i64} loc(#loc18)
      } loc(#loc68)
    } loc(#loc68)
    VPURT.Task waits(%5 : !VPURT.Barrier) attributes {cycleBegin = 33607 : i64, cycleEnd = 34559 : i64, isTrailingSWLayer = false} {
      %109 = VPUIP.NNDMA {port = 0 : i64} inputs(%14 : memref<6xui64, [@CMX_NN, 0]>) outputs(%10 : memref<6xui64, @DDR>) -> memref<6xui64, @DDR> loc(#loc69)
    } loc(#loc69)
    VPURT.Task waits(%5 : !VPURT.Barrier) attributes {cycleBegin = 33607 : i64, cycleEnd = 34559 : i64, isTrailingSWLayer = false} {
      %109 = VPUIP.NNDMA {port = 1 : i64} inputs(%15 : memref<6xui64, [@CMX_NN, 1]>) outputs(%11 : memref<6xui64, @DDR>) -> memref<6xui64, @DDR> loc(#loc70)
    } loc(#loc70)
    VPURT.Task attributes {isTrailingSWLayer = false} {
      %109 = VPUIP.NNDMA {port = 0 : i64} inputs(%90 : memref<1xui64, @Register>) outputs(%91 : memref<1xui64, [@CMX_NN, 0]>) -> memref<1xui64, [@CMX_NN, 0]> loc(#loc50)
    } loc(#loc50)
    VPURT.Task attributes {cycleBegin = 34559 : i64, cycleEnd = 39669 : i64, isTrailingSWLayer = false} {
      %109 = VPUIP.NNDMA {port = 0 : i64} inputs(%35 : memref<1x48x15x30xf16, [@CMX_NN, 0]>) outputs(%41 : memref<1x48x15x30xf16, {order = #NCHW, strides = [43200, 900, 30, 1]}, [@CMX_NN, 0]>) -> memref<1x48x15x30xf16, {order = #NCHW, strides = [43200, 900, 30, 1]}, [@CMX_NN, 0]> loc(#loc71)
    } loc(#loc71)
    VPURT.Task attributes {isTrailingSWLayer = false} {
      %109 = VPUIP.NNDMA {port = 0 : i64} inputs(%92 : memref<1xui64, @Register>) outputs(%93 : memref<1xui64, [@CMX_NN, 0]>) -> memref<1xui64, [@CMX_NN, 0]> loc(#loc51)
    } loc(#loc51)
    VPURT.Task updates(%6 : !VPURT.Barrier) attributes {isTrailingSWLayer = false} {
      %109 = VPUIP.NNDMA {port = 0 : i64} inputs(%94 : memref<10xui64, [@CMX_NN, 0]>) outputs(%95 : memref<10xui64>) -> memref<10xui64> loc(#loc52)
    } loc(#loc52)
    VPURT.Task attributes {isTrailingSWLayer = false} {
      %109 = VPUIP.NNDMA {port = 1 : i64} inputs(%96 : memref<1xui64, @Register>) outputs(%97 : memref<1xui64, [@CMX_NN, 0]>) -> memref<1xui64, [@CMX_NN, 0]> loc(#loc53)
    } loc(#loc53)
    VPURT.Task attributes {cycleBegin = 34559 : i64, cycleEnd = 39669 : i64, isTrailingSWLayer = false} {
    ...
    VPURT.Task updates(%6 : !VPURT.Barrier) attributes {isTrailingSWLayer = false} {
      %109 = VPUIP.NNDMA {port = 1 : i64} inputs(%98 : memref<1xui64, @Register>) outputs(%99 : memref<1xui64, [@CMX_NN, 0]>) -> memref<1xui64, [@CMX_NN, 0]> loc(#loc54)
    } loc(#loc54)
    VPURT.Task waits(%6 : !VPURT.Barrier) updates(%7 : !VPURT.Barrier) attributes {cycleBegin = 39669 : i64, cycleEnd = 39671 : i64, isTrailingSWLayer = false} {
      %results, %profiling_output = VPUIP.SW.Kernel {result_segment_sizes = dense<1> : vector<2xi32>} @VPU.SW::@builtin_Convert inputs(%40 as %arg3: memref<1x48x30x30xf16, [@CMX_NN, 0]>) outputs(%43 as %arg4: memref<1x48x30x30xf32, [@CMX_NN, 0]>) profiling_data(%57 : memref<4xui32, [@CMX_NN, 0]>) on tile 0 -> (memref<1x48x30x30xf32, [@CMX_NN, 0]>, memref<4xui32, [@CMX_NN, 0]>){
        VPUIP.SW.Kernel.run(%arg3, %arg4) : memref<1x48x30x30xf16, [@CMX_NN, 0]>, memref<1x48x30x30xf32, [@CMX_NN, 0]> loc(#loc0)
      } loc(#loc73)
    } loc(#loc73)
    VPURT.Task waits(%7 : !VPURT.Barrier) attributes {cycleBegin = 39671 : i64, cycleEnd = 40623 : i64, isTrailingSWLayer = false} {
      %109 = VPUIP.NNDMA {port = 0 : i64} inputs(%13 : memref<8xui32, [@CMX_NN, 0]>) outputs(%12 : memref<8xui32>) -> memref<8xui32> loc(#loc74)
    } loc(#loc74)
    VPURT.Task waits(%7 : !VPURT.Barrier) attributes {isTrailingSWLayer = false} {
      %109 = VPUIP.NNDMA {port = 1 : i64} inputs(%100 : memref<1xui64, @Register>) outputs(%101 : memref<1xui64, [@CMX_NN, 0]>) -> memref<1xui64, [@CMX_NN, 0]> loc(#loc55)
    } loc(#loc55)
    ...
    VPURT.Task attributes {isTrailingSWLayer = false} {
      %109 = VPUIP.NNDMA {port = 1 : i64} inputs(%102 : memref<1xui64, @Register>) outputs(%103 : memref<1xui64, [@CMX_NN, 0]>) -> memref<1xui64, [@CMX_NN, 0]> loc(#loc56)
    } loc(#loc56)
    VPURT.Task attributes {isTrailingSWLayer = false} {
...
#loc31 = loc(fused["pool1", "_PROF_1_0_2_2-2,2,", "_activationWindow_cluster_0"])
#loc32 = loc(fused["pool1", "_PROF_1_0_2_2-2,2,", "_activationWindow_cluster_1"])
...
#loc36 = loc("conv1/WithoutBiases_PROFTASKBEGIN")
#loc37 = loc("conv1/WithoutBiases_PROFTASKEND_0")
#loc38 = loc("conv1/WithoutBiases/_broadcast_copy_to_CMX[0,1]_PROFTASKBEGIN")
#loc39 = loc("conv1/WithoutBiases/_broadcast_copy_to_CMX[0,1]_PROFTASKEND_5")
#loc40 = loc("conv1/WithoutBiases/_expand_copy_1_13_PROFTASKBEGIN")
#loc41 = loc("conv1/WithoutBiases/_expand_copy_1_13_PROFTASKEND_6")
#loc42 = loc("conv1/WithoutBiases_PROFTASKEND_1")
#loc43 = loc("conv1/WithoutBiases/_cluster_0/_unrolled_permuteDMA_PROFTASKBEGIN")
#loc44 = loc("conv1/WithoutBiases/_cluster_0/_unrolled_permuteDMA_PROFTASKEND_2")
#loc45 = loc("conv1/WithoutBiases/_cluster_1/_unrolled_permuteDMA_PROFTASKBEGIN")
#loc46 = loc("conv1/WithoutBiases/_cluster_1/_unrolled_permuteDMA_PROFTASKEND_7")
#loc47 = loc("conv1/WithoutBiases/_broadcast_copy_to_CMX[0,1]_PROFTASKEND_3")
#loc48 = loc("pool1/_fused_constant/_fused_tile/_broadcast_copy_to_CMX[0,1]_PROFTASKBEGIN")
#loc49 = loc("pool1/_fused_constant/_fused_tile/_broadcast_copy_to_CMX[0,1]_PROFTASKEND_8")
#loc50 = loc("pool1/_cluster_0_PROFTASKBEGIN")
#loc51 = loc("pool1/_cluster_0_PROFTASKEND_4")
#loc52 = loc("dmaProfilingCMX2DDR0")
#loc53 = loc("pool1/_cluster_1_PROFTASKBEGIN")
#loc54 = loc("pool1/_cluster_1_PROFTASKEND_9")
#loc55 = loc("output_PROFTASKBEGIN")
#loc56 = loc("output_PROFTASKEND_10")
...
//CHECK: [dump-statistics-of-task-ops]Run on Function 'main'
//CHECK: [dump-statistics-of-task-ops]  VPUIP tasks statistics:
//CHECK: [dump-statistics-of-task-ops]  VPUIP Tasks - 44 ops
//CHECK: [dump-statistics-of-task-ops]    VPUIP.NNDMA - 36 ops
//CHECK: [dump-statistics-of-task-ops]      CMX2CMX - 2 ops
//CHECK: [dump-statistics-of-task-ops]      CMX2DDR - 7 ops
//CHECK: [dump-statistics-of-task-ops]        Profiling buffer management - 5 ops
//CHECK: [dump-statistics-of-task-ops]          DMA - 2 ops
//CHECK: [dump-statistics-of-task-ops]          DPU - 2 ops
//CHECK: [dump-statistics-of-task-ops]          ActShave - 1 ops
//CHECK: [dump-statistics-of-task-ops]      DDR2CMX - 4 ops
//CHECK: [dump-statistics-of-task-ops]      DDR2DDR - 1 ops
//CHECK: [dump-statistics-of-task-ops]      REG2CMX - 22 ops
//CHECK: [dump-statistics-of-task-ops]        Profiling Timestamp DMA - 22 ops
//CHECK: [dump-statistics-of-task-ops]    VPUIP.PermuteDMA - 2 ops
//CHECK: [dump-statistics-of-task-ops]      DDR2CMX - 2 ops
//CHECK: [dump-statistics-of-task-ops]    VPUIP.SW.Kernel - 2 ops
//CHECK: [dump-statistics-of-task-ops]      builtin_Convert - 2 ops
//CHECK: [dump-statistics-of-task-ops]    VPUIP.NCEClusterTask - 4 ops
