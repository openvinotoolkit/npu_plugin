...
// RUN: env IE_NPU_LOG_FILTER=dump-statistics-of-task-ops vpux-opt --dump-statistics-of-task-ops -o /dev/null %s | FileCheck %s
...
module @age_gender attributes {VPU.arch = #VPU.arch_kind<VPUX37XX>, VPU.compilationMode = #VPU.compilation_mode<DefaultHW>} {
  ...
  func.func @main(%arg0: memref<1x3x62x62xf32, @DDR> loc(unknown), %arg1: memref<1x48x30x30xf32, @DDR> loc(unknown), %arg2: memref<76xui32> loc("profiling_result")) -> (memref<1x48x30x30xf32, @DDR>, memref<76xui32>) {
    ...
    VPURT.Task attributes {cycleBegin = 6838 : i64, cycleEnd = 13711 : i64, isTrailingSWLayer = false} {
      %109 = VPUIP.PermuteDMA {dma_descriptor = #VPUIP.DMADescriptorAttr<numPlanes = 16 : i64, len = 3968 : i64, srcWidth = 3968 : i64, srcStride = 2 : i64, srcPlaneStride = 7688 : i64, dstWidth = 2 : i64, dstStride = 32 : i64, dstPlaneStride = 2 : i64>, port = 0 : i64} inputs(%18 : memref<16x1984xf16, @DDR>) outputs(%21 : memref<1984x16xf16, [@CMX_NN, 0]>) -> memref<1984x16xf16, [@CMX_NN, 0]> loc(#loc62)
    } loc(#loc62)
    VPURT.Task attributes {isTrailingSWLayer = false} {
