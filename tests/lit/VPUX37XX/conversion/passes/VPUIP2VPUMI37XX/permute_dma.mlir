...
module @permuteDMA {
  func.func @main(%arg0: memref<16x256xf16, @DDR>, %arg1: memref<16x256xf16, @DDR>) -> memref<16x256xf16, @DDR> {
    ...
    VPURT.Task attributes {cycleBegin = 0 : i64, cycleEnd = 342 : i64, isTrailingSWLayer = false} {
      %5 = VPUIP.PermuteDMA {dma_descriptor = {dstPlaneStride = 2 : i64, dstStride = 32 : i64, dstWidth = 2 : i64, len = 512 : i64, numPlanes = 16 : i64, srcPlaneStride = 512 : i64, srcStride = 2 : i64, srcWidth = 512 : i64}, port = 0 : i64} inputs(%0 : memref<16x256xf16, @DDR>) outputs(%1 : memref<256x16xf16, @DDR>) -> memref<256x16xf16, @DDR>
    }

    // CHECK-NOT: VPUIP.PermuteDMA
    // CHECK: %[[VAL2:.*]] = VPUMI37XX.NNDMA {dma_descriptor = {dstPlaneStride = 2 : i64, dstStride = 32 : i64, dstWidth = 2 : i64, len = 512 : i64, numPlanes = 16 : i64, srcPlaneStride = 512 : i64, srcStride = 2 : i64, srcWidth = 512 : i64}, port = 0 : i64} inputs(%0 : memref<16x256xf16, @DDR>) outputs(%1 : memref<256x16xf16, @DDR>) previousDMA(%[[VAL1]] : !VPURegMapped.Index<0:0:1>) start_after(0) clean_after(0) -> !VPURegMapped.Index<0:0:2>

    VPURT.Task attributes {cycleBegin = 0 : i64, cycleEnd = 342 : i64, isTrailingSWLayer = false} {
      %6 = VPUIP.PermuteDMA {dma_descriptor = {dstPlaneStride = 2 : i64, dstStride = 32 : i64, dstWidth = 2 : i64, len = 512 : i64, numPlanes = 16 : i64, srcPlaneStride = 512 : i64, srcStride = 2 : i64, srcWidth = 512 : i64}, port = 0 : i64} inputs(%0 : memref<16x256xf16, @DDR>) outputs(%1 : memref<256x16xf16, @DDR>) -> memref<256x16xf16, @DDR>
    }

    // CHECK-NOT: VPUIP.PermuteDMA
    // CHECK: %[[VAL3:.*]] = VPUMI37XX.NNDMA {dma_descriptor = {dstPlaneStride = 2 : i64, dstStride = 32 : i64, dstWidth = 2 : i64, len = 512 : i64, numPlanes = 16 : i64, srcPlaneStride = 512 : i64, srcStride = 2 : i64, srcWidth = 512 : i64}, port = 0 : i64} inputs(%0 : memref<16x256xf16, @DDR>) outputs(%1 : memref<256x16xf16, @DDR>) previousDMA(%[[VAL2]] : !VPURegMapped.Index<0:0:2>) start_after(0) clean_after(0) -> !VPURegMapped.Index<0:0:3>
...
module @permuteDMA {
  func.func @main(%arg0: memref<16x256xf16, @DDR>, %arg1: memref<16x256xf16, @DDR>) -> memref<16x256xf16, @DDR> {
    ...
    VPURT.Task attributes {cycleBegin = 0 : i64, cycleEnd = 342 : i64, isTrailingSWLayer = false} {
      %2 = VPUIP.PermuteDMA {dma_descriptor = {dstPlaneStride = 2 : i64, dstStride = 32 : i64, dstWidth = 2 : i64, len = 512 : i64, numPlanes = 16 : i64, srcPlaneStride = 512 : i64, srcStride = 2 : i64, srcWidth = 512 : i64}, port = 0 : i64} inputs(%0 : memref<16x256xf16, @DDR>) outputs(%1 : memref<256x16xf16, @DDR>) -> memref<256x16xf16, @DDR>
    }

    // CHECK-NOT: VPUIP.PermuteDMA
    // CHECK: %[[VAL0:.*]] = VPUMI37XX.NNDMA {dma_descriptor = {dstPlaneStride = 2 : i64, dstStride = 32 : i64, dstWidth = 2 : i64, len = 512 : i64, numPlanes = 16 : i64, srcPlaneStride = 512 : i64, srcStride = 2 : i64, srcWidth = 512 : i64}, port = 0 : i64} inputs(%0 : memref<16x256xf16, @DDR>) outputs(%1 : memref<256x16xf16, @DDR>) start_after(0) clean_after(0) -> !VPURegMapped.Index<0:0:0>

    VPURT.Task attributes {cycleBegin = 0 : i64, cycleEnd = 342 : i64, isTrailingSWLayer = false} {
      %3 = VPUIP.PermuteDMA {dma_descriptor = {dstPlaneStride = 2 : i64, dstStride = 32 : i64, dstWidth = 2 : i64, len = 512 : i64, numPlanes = 16 : i64, srcPlaneStride = 512 : i64, srcStride = 2 : i64, srcWidth = 512 : i64}, port = 0 : i64} inputs(%0 : memref<16x256xf16, @DDR>) outputs(%1 : memref<256x16xf16, @DDR>) -> memref<256x16xf16, @DDR>
    }

    // CHECK-NOT: VPUIP.PermuteDMA
    // CHECK: %[[VAL1:.*]] = VPUMI37XX.NNDMA {dma_descriptor = {dstPlaneStride = 2 : i64, dstStride = 32 : i64, dstWidth = 2 : i64, len = 512 : i64, numPlanes = 16 : i64, srcPlaneStride = 512 : i64, srcStride = 2 : i64, srcWidth = 512 : i64}, port = 0 : i64} inputs(%0 : memref<16x256xf16, @DDR>) outputs(%1 : memref<256x16xf16, @DDR>) previousDMA(%[[VAL0]] : !VPURegMapped.Index<0:0:0>) start_after(0) clean_after(0) -> !VPURegMapped.Index<0:0:1>
    ...
    // CHECK-NOT: VPUIP.PermuteDMA
    // CHECK: %[[VAL4:.*]] = VPUMI37XX.NNDMA {dma_descriptor = {dstPlaneStride = 2 : i64, dstStride = 32 : i64, dstWidth = 2 : i64, len = 512 : i64, numPlanes = 16 : i64, srcPlaneStride = 512 : i64, srcStride = 2 : i64, srcWidth = 512 : i64}, port = 0 : i64} inputs(%0 : memref<16x256xf16, @DDR>) outputs(%1 : memref<256x16xf16, @DDR>) previousDMA(%[[VAL3]] : !VPURegMapped.Index<0:0:3>) start_after(0) clean_after(0) -> !VPURegMapped.Index<0:0:4>

    VPURT.Task attributes {cycleBegin = 0 : i64, cycleEnd = 342 : i64, isTrailingSWLayer = false} {
      %7 = VPUIP.PermuteDMA {dma_descriptor = {dstPlaneStride = 2 : i64, dstStride = 32 : i64, dstWidth = 2 : i64, len = 512 : i64, numPlanes = 16 : i64, srcPlaneStride = 512 : i64, srcStride = 2 : i64, srcWidth = 512 : i64}, port = 0 : i64} inputs(%0 : memref<16x256xf16, @DDR>) outputs(%1 : memref<256x16xf16, @DDR>) -> memref<256x16xf16, @DDR>
    }

    // CHECK-NOT: VPUIP.PermuteDMA
    // CHECK: %[[VAL5:.*]] = VPUMI37XX.NNDMA {dma_descriptor = {dstPlaneStride = 2 : i64, dstStride = 32 : i64, dstWidth = 2 : i64, len = 512 : i64, numPlanes = 16 : i64, srcPlaneStride = 512 : i64, srcStride = 2 : i64, srcWidth = 512 : i64}, port = 0 : i64} inputs(%0 : memref<16x256xf16, @DDR>) outputs(%1 : memref<256x16xf16, @DDR>) previousDMA(%[[VAL4]] : !VPURegMapped.Index<0:0:4>) start_after(0) clean_after(0) -> !VPURegMapped.Index<0:0:5>
...
func.func @UnrollDistributedPermuteDMAOutput(%arg0: memref<1x16x16x16xf16, @DDR>, %arg1: memref<64x32x1x1xf16, @DDR>) -> memref<64x32x1x1xf16, @DDR> {
  ...
  // CHECK: %[[DMA0:.*]] = VPUMI37XX.NNDMA {dma_descriptor = {dstPlaneStride = 2 : i64, dstStride = 32 : i64, dstWidth = 2 : i64, len = 512 : i64, numPlanes = 16 : i64, srcPlaneStride = 512 : i64, srcStride = 2 : i64, srcWidth = 512 : i64}, port = 0 : i64} inputs(%[[CST]] : memref<16x256xf16, @DDR>) outputs(%[[BUFF_TILE_0]], %[[BUFF_TILE_1]] : memref<16x256xf16, [@CMX_NN, 0]>, memref<16x256xf16, [@CMX_NN, 1]>) start_after(0) clean_after(0) -> !VPURegMapped.Index<0:0:0>
