...
module @expandDMA {
  func.func @main(%arg0: memref<1x1x16x256xf16, @DDR>, %arg1: memref<1x1x16x256xf16, #NHWC, @DDR>) -> memref<1x1x16x256xf16, #NHWC, @DDR> {
    ...
    // CHECK-NOT: VPUIP.ExpandDMA
    // CHECK: %[[VAL0:.*]] = VPUMI37XX.NNDMA {dma_descriptor = {dstPlaneStride = 0 : i64, dstStride = 2048 : i64, dstWidth = 896 : i64, len = 6272 : i64, numPlanes = 1 : i64, srcPlaneStride = 0 : i64, srcStride = 6272 : i64, srcWidth = 6272 : i64}, port = 0 : i64} inputs(%0 : memref<1x64x7x7xf16, #NHWC, @DDR>) outputs(%1 : memref<1x64x7x16xf16, #NHWC, @DDR>) start_after(0) clean_after(0) -> !VPURegMapped.Index<0:0:0>
