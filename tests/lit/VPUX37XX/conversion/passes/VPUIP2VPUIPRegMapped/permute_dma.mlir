...
module @permuteDMA attributes {VPU.compilationMode = "DefaultHW"} {
...
module @permuteDMA {
func @UnrollDistributedPermuteDMAOutput(%arg0: memref<1x16x16x16xf16, @DDR>, %arg1: memref<64x32x1x1xf16, @DDR>) -> memref<64x32x1x1xf16, @DDR> {
