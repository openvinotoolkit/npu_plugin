...
// CHECK-LABEL: @oneDma
  func @oneDma(%arg0: memref<1x1x1x1000xf16>, %arg1: memref<1x1x1x1000xf16>) -> memref<1x1x1x1000xf16> {
    %0 = VPUIPRegMapped.NNDMA inputs(%arg0 : memref<1x1x1x1000xf16>) outputs(%arg1 : memref<1x1x1x1000xf16>) start_after(0) -> !VPUIPRegMapped.Index<0>
    %1 = VPUIPRegMapped.MappedInference dmas(%0 : !VPUIPRegMapped.Index<0>) dmaCount(1) invariantCount(0) variantCount(0) actKernelRangesCount(0) actKernelInvocationsCount(0) barrierCount(0) -> !VPUIPRegMapped.Index<0>
