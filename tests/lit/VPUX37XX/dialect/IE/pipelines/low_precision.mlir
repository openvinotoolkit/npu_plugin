...
// RUN: vpux-opt --split-input-file --init-compiler="vpu-arch=VPUX37XX" --low-precision %s | FileCheck %s

!qElemType0 = !quant.uniform<u8<0:254>:f32:0, {0.0078740157480314959:127,0.0086614175105658095:127,0.0094488192731001247:127,0.010236220096978615:127}>
