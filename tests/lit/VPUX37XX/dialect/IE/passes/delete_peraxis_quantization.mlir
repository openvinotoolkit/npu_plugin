...
!qElemType = !quant.uniform<u8:f32:1, {1.000000e-01:128,2.000000e-01:128,3.000000e-01:128}>

module @DeleteQuantizationPerAxis {

func.func @main(%arg0 : tensor<1x3x7x7xf32>) -> tensor<1x3x7x7xf32> {
...
func.func @main(%arg0 : tensor<1x3x7x7xf16>) -> tensor<1x3x7x7xf16> {
