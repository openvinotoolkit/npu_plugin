...
!qElemType0 = !quant.uniform<u8:f32, 2.000000e+00>
...
func.func @PerTensor(%arg0 : tensor<1x4xf32>) -> tensor<1x4xf32> {
    ...
    // CHECK:  %[[VAL0:.*]] = IE.Add(%arg0, %arg0) {auto_broadcast = #IE.auto_broadcast_type<NONE_OR_EXPLICIT>} : tensor<1x4xf32>, tensor<1x4xf32> -> tensor<1x4x!qElemType0>
