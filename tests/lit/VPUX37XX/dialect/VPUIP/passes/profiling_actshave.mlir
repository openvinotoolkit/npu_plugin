...
module @ActShaveProfiling {
    ...
    func @main(%arg0: memref<1x3x224x224xf32>, %arg1: memref<1x150528xf32>) -> memref<1x150528xf32> {
        ...
        %results = VPUIP.SW.Kernel {result_segment_sizes = dense<[1, 0]> : vector<2xi32>} @VPU.SW::@builtin_Convert inputs(%2 as %arg2: memref<1x3x224x224xf32, [@CMX_NN, 0]>) outputs(%3 as %arg3: memref<1x3x224x224xf16, [@CMX_NN, 0]>) on tile 0 -> memref<1x3x224x224xf16, [@CMX_NN, 0]>  {
        ...
        %results_0 = VPUIP.SW.Kernel {result_segment_sizes = dense<[1, 0]> : vector<2xi32>} @VPU.SW::@builtin_SoftMax inputs(%7 as %arg2: memref<1x150528xf16, [@CMX_NN, 0]>) outputs(%8 as %arg3: memref<1x150528xf16, [@CMX_NN, 0]>) on tile 0 -> memref<1x150528xf16, [@CMX_NN, 0]>  {
        ...
        %results_1 = VPUIP.SW.Kernel {result_segment_sizes = dense<[1, 0]> : vector<2xi32>} @VPU.SW::@builtin_Convert inputs(%results_0 as %arg2: memref<1x150528xf16, [@CMX_NN, 0]>) outputs(%9 as %arg3: memref<1x150528xf32, [@CMX_NN, 0]>) on tile 0 -> memref<1x150528xf32, [@CMX_NN, 0]>  {
...
module @ActShaveProfilingMultitile {
    ...
    func @main(%arg0: !type_DDR, %arg5: !type_DDR) -> !type_DDR {
        ...
        %results:2 = VPUIP.SW.Kernel {result_segment_sizes = dense<[2, 0]> : vector<2xi32>} @VPU.SW::@builtin_MVN inputs(%3 as %arg1: !type_CMX_subview, %5 as %arg2: !type_CMX_subview) outputs(%4 as %arg3: !type_CMX_subview, %6 as %arg4: !type_CMX_subview) on tile 0 -> (!type_CMX_subview, !type_CMX_subview){
    ...
    //CHECK:        [[PROF_BUF_COPY:%.+]] = VPUIP.Copy inputs(%10 : memref<8xui32, [@CMX_NN, 0]>) outputs(%9 : memref<8xui32>) -> memref<8xui32>
...
module @ActShaveProfilingMulticluster {
    ...
    func @main(%arg0: !type_DDR, %arg5: !type_DDR) -> !type_DDR {
        ...
        %5 = VPUIP.NCEClusterTiling inputs(%2 as %arg1: !type_CMX_memref) outputs(%4 as %arg2: !type_CMX_memref) -> !typeCmxDistributed {
            %results = VPUIP.SW.Kernel {result_segment_sizes = dense<[1, 0]> : vector<2xi32>} @VPU.SW::@builtin_MVN inputs(%arg1 as %arg3: !type_CMX_memref) outputs(%arg2 as %arg4: !type_CMX_memref) on tile 0 ->!type_CMX_memref {
...
module @ActShaveProfilingMulticlusterMultitile {
    ...
    func @main(%arg0: !type_DDR, %arg9: !type_DDR) -> !type_DDR {
        ...
        %7:2 = VPUIP.NCEClusterTiling inputs(%3 as %arg1: !type_CMX_subview, %2 as %arg2: !type_CMX_subview) outputs(%6 as %arg3: !type_CMX_subview, %5 as %arg4: !type_CMX_subview) -> (!type_CMX_Distributed_subview, !type_CMX_Distributed_subview) {
            %results:2 = VPUIP.SW.Kernel {result_segment_sizes = dense<[2, 0]> : vector<2xi32>} @VPU.SW::@builtin_MVN inputs(%arg1 as %arg5: !type_CMX_subview, %arg2 as %arg6: !type_CMX_subview) outputs(%arg3 as %arg7: !type_CMX_subview, %arg4 as %arg8: !type_CMX_subview) on tile 0 -> (!type_CMX_subview, !type_CMX_subview){
