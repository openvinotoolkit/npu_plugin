...
// CHECK-NEXT:      DataInfo "pll" : tensor<2xui32>
...
// CHECK-SAME:      %arg3: memref<2xui32>) -> (
// CHECK-SAME:      memref<1x16x4x4xf16, #NHWC, [@CMX_NN, 0]>,
// CHECK-SAME:      memref<2xui64>, memref<2xui32>) {
...
// CHECK:    return %arg1, %arg2, %arg3 : memref<1x16x4x4xf16, #NHWC, [@CMX_NN, 0]>, memref<2xui64>, memref<2xui32>
...
// CHECK-SAME:      memref<1x16x4x4xf16, #NHWC, [@CMX_NN, 0]>, memref<1x16x4x4xf16, #NHWC, [@CMX_NN, 0]>, memref<2xui64>, memref<2xui32>
