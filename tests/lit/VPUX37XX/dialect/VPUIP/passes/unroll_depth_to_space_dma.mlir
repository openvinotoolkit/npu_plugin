...
func.func @UnrollDepthToSpaceWithBlockFirstLargeH() -> memref<1x1x534x34xf16, #NHWC, [@CMX_NN, 0]> {
    ...
    VPURT.Task waits(%bar0 : !VPURT.Barrier) updates(%bar1 : !VPURT.Barrier) attributes {cycleBegin = 2699 : i64, cycleEnd = 4263 : i64, isTrailingSWLayer = false} {
    ...
    //CHECK:        VPURT.Task waits([[BAR0]] : !VPURT.Barrier) updates([[BAR1]] : !VPURT.Barrier) attributes {cycleBegin = 2699 : i64, cycleEnd = 4263 : i64, isTrailingSWLayer = false} {
