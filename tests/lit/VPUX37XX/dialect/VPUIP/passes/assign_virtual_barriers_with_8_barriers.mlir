...
//
// RUN: vpux-opt --split-input-file --init-compiler="vpu-arch=VPUX37XX" --assign-virtual-barriers="num-barriers=8 num-slots-per-barrier=256" %s | FileCheck %s
...
func @ParallelGraph(%arg0: memref<1x16x32x32xf16, #NHWC>, %arg1: memref<1x16x32x32xf16>) -> memref<1x16x32x32xf16> {
    ...
    // CHECK:       VPURT.Task waits([[BAR3]], [[BAR4]] : !VPURT.Barrier, !VPURT.Barrier) updates([[BAR6]] : !VPURT.Barrier)
    // CHECK:       VPUIP.NNDMA
    ...
    // CHECK:       VPURT.Task waits([[BAR9]] : !VPURT.Barrier) updates([[BAR6]] : !VPURT.Barrier)
    // CHECK:       VPUIP.NNDMA

    // CHECK:       VPURT.Task waits([[BAR11]] : !VPURT.Barrier) updates([[BAR6]] : !VPURT.Barrier)
    // CHECK:       VPUIP.NNDMA
