...
// CHECK-SAME:          [[INPUT:%arg[0-9]]]: tensor<1x16x360x640xf16, {order = #NHWC}>
  func @ConcatSliceOptimization(
    ...
    %weights = const.Declare tensor<16x16x1x1xf16, {order = #NHWC}> = #const.Content<dense<1.000000e+00>
    ...
    %output = VPU.Slice %14 [0, 0, 0, 0] [1, 16, 360, 640] : tensor<1x16x360x640xf16, {order = #NHWC}> to tensor<1x1x360x640xf16, {order = #NHWC}>
