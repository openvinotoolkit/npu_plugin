...
func @DepthConv(%arg0: tensor<1x96x40x40xf16, {order = #NHWC}>) -> tensor<1x96x37x37xf16, {order = #NHWC}> {
...
func @DepthConvLarge(%arg0: tensor<1x512x40x40xf16, {order = #NHWC}>) -> tensor<1x512x37x37xf16, {order = #NHWC}> {
...
func @DepthConvMultipleSplits(%arg0: tensor<1x512x40x40xf16, {order = #NHWC}>) -> tensor<1x512x37x37xf16, {order = #NHWC}> {
    %cst0 = const.Declare tensor<512x1x4x4xf16, {order = #NHWC}> =
        dense<1.000000e+00> : tensor<512x1x4x4xf16>, [#const.Reorder<#NHWC>]
    %wt = const.Declare tensor<512x1x1x4xsi32, {order = #NHWC}> =
        dense<10> : tensor<512x1x1x4xsi32>, [#const.Reorder<#NHWC>]
...
func @ConvLargeNoChange(%arg0: tensor<1x64x40x40xf16, {order = #NHWC}>) -> tensor<1x384x37x37xf16, {order = #NHWC}> {
    ...
    %4 = VPU.NCE.Convolution(%0, %1, %2) {
            ...
            strides = [1, 1]
                ...
                VPU.DPU.Workload [0, 0, 0, 0] [1, 384, 40, 80] {bottom = 0 : i64, left = 0 : i64, right = 0 : i64, top = 0 : i64} "CUBOID_4x16"
            }
    ...
    // CHECK:       [[CST:%.+]] = const.Declare tensor<384x64x4x4xf16, {order = #NHWC}>
    // CHECK:       [[CST0:%.+]] = const.Declare tensor<384x1x1x4xsi32, {order = #NHWC}>
    ...
    // CHECK:               VPU.DPU.Workload [0, 0, 0, 0] [1, 384, 40, 80] {bottom = 0 : i64, left = 0 : i64, right = 0 : i64, top = 0 : i64} "CUBOID_4x16"
    // CHECK:           }
...
func @ConvLargeSparseOutput(%arg0: tensor<1x64x40x40xf16, {order = #NHWC}>) -> !VPU.SparseTensor<data=tensor<1x384x37x37xf16, {order = #NHWC}>, sparsity_map=tensor<1x384x37x37xi1, {order = #NHWC}>> {
    %cst0 = const.Declare tensor<384x64x4x4xf16, {order = #NHWC}> = dense<1.000000e+00> : tensor<384x64x4x4xf16>, [#const.Reorder<#NHWC>]
    %wt = const.Declare tensor<384x1x1x4xsi32, {order = #NHWC}> = dense<10> : tensor<384x1x1x4xsi32>, [#const.Reorder<#NHWC>]
    ...
    // CHECK:               VPU.DPU.Workload [0, 0, 0, 0] [1, 128, 40, 80] {bottom = 0 : i64, left = 0 : i64, right = 0 : i64, top = 0 : i64} "CUBOID_4x16"
    // CHECK:               VPU.DPU.Workload [0, 128, 0, 0] [1, 128, 40, 80] {bottom = 0 : i64, left = 0 : i64, right = 0 : i64, top = 0 : i64} "CUBOID_4x16"
    // CHECK:               VPU.DPU.Workload [0, 256, 0, 0] [1, 128, 40, 80] {bottom = 0 : i64, left = 0 : i64, right = 0 : i64, top = 0 : i64} "CUBOID_4x16"
    // CHECK:           }
...
func @DepthConvSparseOutput(%arg0: tensor<1x96x40x40xf16, {order = #NHWC}>) -> !VPU.SparseTensor<data=tensor<1x96x37x37xf16, {order = #NHWC}>, sparsity_map=tensor<1x96x37x37xi1, {order = #NHWC}>> {
    ...
    // CHECK:               VPU.DPU.Workload [0, 0, 0, 0] [1, 32, 40, 80] {bottom = 0 : i64, left = 0 : i64, right = 0 : i64, top = 0 : i64} "CUBOID_4x16"
    // CHECK:               VPU.DPU.Workload [0, 32, 0, 0] [1, 32, 40, 80] {bottom = 0 : i64, left = 0 : i64, right = 0 : i64, top = 0 : i64} "CUBOID_4x16"
    // CHECK:               VPU.DPU.Workload [0, 64, 0, 0] [1, 32, 40, 80] {bottom = 0 : i64, left = 0 : i64, right = 0 : i64, top = 0 : i64} "CUBOID_4x16"
    // CHECK:           }
...
func @MultipleSparseProducers(%arg0: tensor<1x64x40x40xf16, {order = #NHWC}>) -> (tensor<1x1024x40x40xf16, {mem_space = @CMX_NN, order = #NHWC}>, tensor<1x1024x40x40xf16, {mem_space = @CMX_NN, order = #NHWC}>) {
    ...
    %conv2 = VPU.NCE.Convolution(%input, %weights_0, %weights_table_0) {
            ...
            strides = [1, 1]
                ...
                VPU.DPU.Workload [0, 0, 0, 0] [1, 128, 40, 80] {bottom = 0 : i64, left = 0 : i64, right = 0 : i64, top = 0 : i64} "CUBOID_4x16"
                VPU.DPU.Workload [0, 128, 0, 0] [1, 128, 40, 80] {bottom = 0 : i64, left = 0 : i64, right = 0 : i64, top = 0 : i64} "CUBOID_4x16"
                VPU.DPU.Workload [0, 256, 0, 0] [1, 64, 40, 80] {bottom = 0 : i64, left = 0 : i64, right = 0 : i64, top = 0 : i64} "CUBOID_4x16"
                VPU.DPU.Workload [0, 320, 0, 0] [1, 64, 40, 80] {bottom = 0 : i64, left = 0 : i64, right = 0 : i64, top = 0 : i64} "CUBOID_4x16"
            }
    ...
    %conv3 = VPU.NCE.Convolution(%concat0, %weights_1, %weights_table_1) {
            ...
            strides = [1, 1]
                ...
                VPU.DPU.Workload [0, 0, 0, 0] [1, 1024, 40, 80] {bottom = 0 : i64, left = 0 : i64, right = 0 : i64, top = 0 : i64} "CUBOID_4x16"
            }
    ...
    // CHECK-NEXT:      VPU.DPU.Workload [0, 0, 0, 0] [1, 64, 40, 80] {bottom = 0 : i64, left = 0 : i64, right = 0 : i64, top = 0 : i64} "CUBOID_4x16"
    // CHECK-NEXT:      VPU.DPU.Workload [0, 64, 0, 0] [1, 64, 40, 80] {bottom = 0 : i64, left = 0 : i64, right = 0 : i64, top = 0 : i64} "CUBOID_4x16"
    // CHECK-NEXT:      VPU.DPU.Workload [0, 128, 0, 0] [1, 64, 40, 80] {bottom = 0 : i64, left = 0 : i64, right = 0 : i64, top = 0 : i64} "CUBOID_4x16"
    // CHECK-NEXT:      VPU.DPU.Workload [0, 192, 0, 0] [1, 64, 40, 80] {bottom = 0 : i64, left = 0 : i64, right = 0 : i64, top = 0 : i64} "CUBOID_4x16"
    // CHECK-NEXT:      VPU.DPU.Workload [0, 256, 0, 0] [1, 64, 40, 80] {bottom = 0 : i64, left = 0 : i64, right = 0 : i64, top = 0 : i64} "CUBOID_4x16"
    // CHECK-NEXT:      VPU.DPU.Workload [0, 320, 0, 0] [1, 64, 40, 80] {bottom = 0 : i64, left = 0 : i64, right = 0 : i64, top = 0 : i64} "CUBOID_4x16"
...
func @MixedSparseProducers(%arg0: tensor<1x64x40x40xf16, {order = #NHWC}>) -> tensor<1x1024x37x37xf16, {mem_space = @CMX_NN, order = #NHWC}> {
    ...
    %depth_conv0 = VPU.NCE.DepthConvolution(%input, %weights_1, %weights_table_0, %activation_window_0) {
            ...
            strides = [1, 1]
                ...
                VPU.DPU.Workload [0, 128, 0, 0] [1, 128, 40, 80] {bottom = 0 : i64, left = 0 : i64, right = 0 : i64, top = 0 : i64} "CUBOID_4x16"
                VPU.DPU.Workload [0, 256, 0, 0] [1, 64, 40, 80] {bottom = 0 : i64, left = 0 : i64, right = 0 : i64, top = 0 : i64} "CUBOID_4x16"
                VPU.DPU.Workload [0, 320, 0, 0] [1, 32, 40, 80] {bottom = 0 : i64, left = 0 : i64, right = 0 : i64, top = 0 : i64} "CUBOID_4x16"
                VPU.DPU.Workload [0, 352, 0, 0] [1, 32, 40, 80] {bottom = 0 : i64, left = 0 : i64, right = 0 : i64, top = 0 : i64} "CUBOID_4x16"
            }
    ...
    // CHECK:       [[VAL1:%.+]] = VPU.NCE.Convolution([[VAL0]]
    // CHECK-NEXT:      VPU.DPU.Workload [0, 0, 0, 0] [1, 32, 40, 80] {bottom = 0 : i64, left = 0 : i64, right = 0 : i64, top = 0 : i64} "CUBOID_4x16"
    // CHECK-NEXT:      VPU.DPU.Workload [0, 32, 0, 0] [1, 32, 40, 80] {bottom = 0 : i64, left = 0 : i64, right = 0 : i64, top = 0 : i64} "CUBOID_4x16"
    // CHECK-NEXT:      VPU.DPU.Workload [0, 64, 0, 0] [1, 32, 40, 80] {bottom = 0 : i64, left = 0 : i64, right = 0 : i64, top = 0 : i64} "CUBOID_4x16"
    // CHECK-NEXT:      VPU.DPU.Workload [0, 96, 0, 0] [1, 32, 40, 80] {bottom = 0 : i64, left = 0 : i64, right = 0 : i64, top = 0 : i64} "CUBOID_4x16"
    // CHECK-NEXT:      VPU.DPU.Workload [0, 128, 0, 0] [1, 32, 40, 80] {bottom = 0 : i64, left = 0 : i64, right = 0 : i64, top = 0 : i64} "CUBOID_4x16"
    // CHECK-NEXT:      VPU.DPU.Workload [0, 160, 0, 0] [1, 32, 40, 80] {bottom = 0 : i64, left = 0 : i64, right = 0 : i64, top = 0 : i64} "CUBOID_4x16"
    // CHECK-NEXT:      VPU.DPU.Workload [0, 192, 0, 0] [1, 32, 40, 80] {bottom = 0 : i64, left = 0 : i64, right = 0 : i64, top = 0 : i64} "CUBOID_4x16"
    // CHECK-NEXT:      VPU.DPU.Workload [0, 224, 0, 0] [1, 32, 40, 80] {bottom = 0 : i64, left = 0 : i64, right = 0 : i64, top = 0 : i64} "CUBOID_4x16"
    // CHECK-NEXT:      VPU.DPU.Workload [0, 256, 0, 0] [1, 32, 40, 80] {bottom = 0 : i64, left = 0 : i64, right = 0 : i64, top = 0 : i64} "CUBOID_4x16"
    // CHECK-NEXT:      VPU.DPU.Workload [0, 288, 0, 0] [1, 32, 40, 80] {bottom = 0 : i64, left = 0 : i64, right = 0 : i64, top = 0 : i64} "CUBOID_4x16"
    // CHECK-NEXT:      VPU.DPU.Workload [0, 320, 0, 0] [1, 32, 40, 80] {bottom = 0 : i64, left = 0 : i64, right = 0 : i64, top = 0 : i64} "CUBOID_4x16"
    // CHECK-NEXT:      VPU.DPU.Workload [0, 352, 0, 0] [1, 32, 40, 80] {bottom = 0 : i64, left = 0 : i64, right = 0 : i64, top = 0 : i64} "CUBOID_4x16"
