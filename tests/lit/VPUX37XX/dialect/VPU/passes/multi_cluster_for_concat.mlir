...
func.func @CMXConcatWithSplitOverHeight(%arg0: tensor<1x16x4x8xf16, {order = #NHWC}>, %arg1: tensor<1x16x4x8xf16, {order = #NHWC}>) -> tensor<1x16x2x4xf16, {order = #NHWC}> {
    ...
    %0 = VPU.NCE.Convolution(%arg0, %cst_0, %cst) {pad = {bottom = 0 : i64, left = 1 : i64, right = 0 : i64, top = 1 : i64}, rawFilterShape = [32, 16, 3, 3], strides = [2, 2]} -> tensor<1x32x2x4xf16, {order = #NHWC}>
    ...
    %1 = VPU.NCE.Convolution(%arg1, %cst_1, %cst1) {pad = {bottom = 0 : i64, left = 1 : i64, right = 0 : i64, top = 1 : i64}, rawFilterShape = [32, 16, 3, 3], strides = [2, 2]} -> tensor<1x32x2x4xf16, {order = #NHWC}>
    ...
    %3 = VPU.NCE.Convolution(%2, %cst_2, %cst2) {pad = {bottom = 1 : i64, left = 1 : i64, right = 1 : i64, top = 1 : i64}, rawFilterShape = [16, 64, 3, 3], strides = [1, 1]} -> tensor<1x16x2x4xf16, {order = #NHWC}>
...
func.func @CMXConcatWithClustering(%arg0: tensor<1x16x4x4xf16, {order = #NHWC}>, %arg1: tensor<1x16x4x4xf16, {order = #NHWC}>) -> tensor<1x32x2x2xf16, {order = #NHWC}> {
    ...
    %0 = VPU.NCE.Convolution(%arg0, %cst_0, %cst) {pad = {bottom = 1 : i64, left = 1 : i64, right = 1 : i64, top = 1 : i64}, rawFilterShape = [16, 16, 3, 3], strides = [1, 1]} -> tensor<1x16x4x4xf16, {order = #NHWC}>
    ...
    %1 = VPU.NCE.Convolution(%arg1, %cst_1, %cst1) {pad = {bottom = 1 : i64, left = 1 : i64, right = 1 : i64, top = 1 : i64}, rawFilterShape = [16, 16, 3, 3], strides = [1, 1]} -> tensor<1x16x4x4xf16, {order = #NHWC}>
    ...
    %3 = VPU.NCE.Convolution(%2, %cst_2, %cst2) {pad = {bottom = 0 : i64, left = 0 : i64, right = 0 : i64, top = 0 : i64}, rawFilterShape = [32, 32, 3, 3], strides = [1, 1]} -> tensor<1x32x2x2xf16, {order = #NHWC}>
...
func.func @CMXConcatWithClusteringWithHKSwitchConvs(%arg0: tensor<1x16x8x8xf16, {order = #NHWC}>, %arg1: tensor<1x16x8x8xf16, {order = #NHWC}>) -> tensor<1x32x4x4xf16, {order = #NHWC}> {
    %cst = const.Declare tensor<16x1x1x4xsi32> = dense<10> : tensor<16x1x1x4xsi32>
    %cst_0 = const.Declare tensor<16x16x3x3xf16, {order = #NHWC}> = dense<1.000000e+00> : tensor<16x16x3x3xf16>, [#const.Reorder<#NHWC>]
    %0 = VPU.NCE.Convolution(%arg0, %cst_0, %cst) {pad = {bottom = 1 : i64, left = 1 : i64, right = 1 : i64, top = 1 : i64}, rawFilterShape = [16, 16, 3, 3], strides = [1, 1]} -> tensor<1x16x8x8xf16, {order = #NHWC}>

    %cst1 = const.Declare tensor<16x1x1x4xsi32> = dense<10> : tensor<16x1x1x4xsi32>
    %cst_1 = const.Declare tensor<16x16x3x3xf16, {order = #NHWC}> = dense<1.000000e+00> : tensor<16x16x3x3xf16>, [#const.Reorder<#NHWC>]
    %1 = VPU.NCE.Convolution(%arg1, %cst_1, %cst1) {pad = {bottom = 1 : i64, left = 1 : i64, right = 1 : i64, top = 1 : i64}, rawFilterShape = [16, 16, 3, 3], strides = [1, 1]} -> tensor<1x16x8x8xf16, {order = #NHWC}>
    ...
    %cst2 = const.Declare tensor<32x1x1x4xsi32> = dense<10> : tensor<32x1x1x4xsi32>
    %cst_2 = const.Declare tensor<32x32x3x3xf16, {order = #NHWC}> = dense<1.000000e+00> : tensor<32x32x3x3xf16>, [#const.Reorder<#NHWC>]
    %3 = VPU.NCE.Convolution(%2, %cst_2, %cst2) {pad = {bottom = 0 : i64, left = 1 : i64, right = 0 : i64, top = 1 : i64}, rawFilterShape = [32, 32, 3, 3], strides = [2, 2]} -> tensor<1x32x4x4xf16, {order = #NHWC}>
    ...
    //CHECK:        [[VAL0:%.+]] = VPU.NCE.Convolution(%arg0, [[WEIGHTS0]], [[WEIGHTSTABLE0]])
    //CHECK-SAME:    multiClusterStrategy = "HKSwitch"
...
func.func @CMXConcatWithMultipleUsers(%arg0: tensor<1x16x8x8xf16, {order = #NHWC}>, %arg1: tensor<1x16x8x8xf16, {order = #NHWC}>) -> (tensor<1x32x4x4xf16, {order = #NHWC}>, tensor<1x48x8x8xf16, {order = #NHWC}>) {
    ...
    %cst2 = const.Declare tensor<32x1x1x4xsi32> = dense<10> : tensor<32x1x1x4xsi32>
    %cst_2 = const.Declare tensor<32x32x3x3xf16, {order = #NHWC}> = dense<1.000000e+00> : tensor<32x32x3x3xf16>, [#const.Reorder<#NHWC>]
    %3 = VPU.NCE.Convolution(%2, %cst_2, %cst2) {pad = {bottom = 1 : i64, left = 1 : i64, right = 1 : i64, top = 1 : i64}, rawFilterShape = [32, 32, 3, 3], strides = [2, 2]} -> tensor<1x32x4x4xf16, {order = #NHWC}>
    ...
    %4 = VPU.NCE.Convolution(%2, %cst_3, %cst3) {pad = {bottom = 1 : i64, left = 1 : i64, right = 1 : i64, top = 1 : i64}, rawFilterShape = [48, 32, 3, 3], strides = [1, 1]} -> tensor<1x48x8x8xf16, {order = #NHWC}>
...
func.func @CMXConcatWithShortcut(%arg0: tensor<1x16x8x8xf16, {order = #NHWC}>) -> tensor<1x32x4x4xf16, {order = #NHWC}> {
    ...
    %cst1 = const.Declare tensor<32x1x1x4xsi32> = dense<10> : tensor<32x1x1x4xsi32>
    %cst_1 = const.Declare tensor<32x16x3x3xf16, {order = #NHWC}> = dense<1.000000e+00> : tensor<32x16x3x3xf16>, [#const.Reorder<#NHWC>]
    %1 = VPU.NCE.Convolution(%0, %cst_1, %cst1) {pad = {bottom = 1 : i64, left = 1 : i64, right = 1 : i64, top = 1 : i64}, rawFilterShape = [32, 16, 3, 3], strides = [1, 1]} -> tensor<1x32x8x8xf16, {order = #NHWC}>
    ...
    %3 = VPU.NCE.Convolution(%2, %cst_2, %cst2) {pad = {bottom = 1 : i64, left = 1 : i64, right = 1 : i64, top = 1 : i64}, rawFilterShape = [32, 48, 3, 3], strides = [2, 2]} -> tensor<1x32x4x4xf16, {order = #NHWC}>
...
func.func @CMXConcatWithoutSplitOverHeight(%arg0: tensor<1x16x132x120xf16, {order = #NHWC}>, %arg1: tensor<1x16x132x120xf16, {order = #NHWC}>) -> tensor<1x240x64x33xf16, {order = #NHWC}> {
    ...
    %0 = VPU.NCE.DepthConvolution(%arg0, %cst_0, %cst_1, %cst_2) {activation_window_channel_length = 4 : i64, pad = {bottom = 0 : i64, left = 0 : i64, right = 0 : i64, top = 0 : i64}, ppe = {clamp_high = 2147483647 : i64, clamp_low = -2147483648 : i64, fp_prelu_alpha = 1.000000e+00 : f64, lrelu_mult = 1 : i64, lrelu_shift = 0 : i64, mode = "NOOP"}, rawFilterShape = [16, 1, 1, 1], strides = [1, 1]} -> tensor<1x16x132x120xf16, {order = #NHWC}>
    ...
    %3 = VPU.NCE.DepthConvolution(%arg1, %cst_0, %cst_1, %cst_2) {activation_window_channel_length = 4 : i64, pad = {bottom = 0 : i64, left = 0 : i64, right = 0 : i64, top = 0 : i64}, ppe = {clamp_high = 2147483647 : i64, clamp_low = -2147483648 : i64, fp_prelu_alpha = 1.000000e+00 : f64, lrelu_mult = 1 : i64, lrelu_shift = 0 : i64, mode = "NOOP"}, rawFilterShape = [16, 1, 1, 1], strides = [1, 1]} -> tensor<1x16x132x120xf16, {order = #NHWC}>
    ...
    %14 = VPU.NCE.Convolution(%13, %cst_3, %cst_4) {pad = {bottom = 0 : i64, left = 0 : i64, right = 0 : i64, top = 0 : i64}, ppe = {clamp_high = 2147483647 : i64, clamp_low = -2147483648 : i64, fp_prelu_alpha = 1.000000e+00 : f64, lrelu_mult = 1 : i64, lrelu_shift = 0 : i64, mode = "LRELU"}, rawFilterShape = [240, 240, 1, 1], strides = [1, 1]} -> tensor<1x240x64x33xf16, {order = #NHWC}>
