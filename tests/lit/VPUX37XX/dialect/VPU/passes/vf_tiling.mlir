...
func.func @VfTilingDepthConvAndConv(%arg0: tensor<1x576x65x65xf16, {order = #NHWC}>) -> tensor<1x160x65x65xf16, {order = #NHWC}>   {
    ...
    %0 = VPU.VerticalFusion (%arg0 as %arg1: tensor<1x576x65x65xf16, {order = #NHWC}>, %cst_0 as %arg2: tensor<576x32x1x1xf16, {order = #NHWC}>, %cst_1 as %arg3: tensor<576x1x1x4xsi32>, %cst_2 as %arg4: tensor<1x1x1x16xui8>, %cst_3 as %arg5: tensor<160x576x1x1xf16, {order = #NHWC}>, %cst_4 as %arg6: tensor<160x1x1x4xsi32>) attributes {tilingStrategy = [1, 1, 6, 1]} -> tensor<1x160x65x65xf16, {order = #NHWC}> {
      %1 = VPU.NCE.DepthConvolution(%arg1, %arg2, %arg3, %arg4)
         {activation_window_channel_length = 40 : i64, multiClusterStrategy = "SplitOverKernel",
         pad = {bottom = 2 : i64, left = 2 : i64, right = 2 : i64, top = 2 : i64},
         ppe = {clamp_high = 255 : i64, clamp_low = 0 : i64, fp_prelu_alpha = 1.000000e+00 : f64, lrelu_mult = 1 : i64, lrelu_shift = 0 : i64, mode = "LRELUX"}, rawFilterShape = [576, 1, 5, 5], strides = [1, 1]}
    ...
    // CHECK-SAME: {activation_window_channel_length = 40 : i64, multiClusterStrategy = "SplitOverKernel", pad = {bottom = 0 : i64, left = 2 : i64, right = 2 : i64, top = 2 : i64}, ppe = {clamp_high = 255 : i64, clamp_low = 0 : i64, fp_prelu_alpha = 1.000000e+00 : f64, lrelu_mult = 1 : i64, lrelu_shift = 0 : i64, mode = "LRELUX"}, rawFilterShape = [576, 1, 5, 5], strides = [1, 1]} -> tensor<1x576x11x65xf16, {order = #NHWC}>
    // CHECK: [[CONVTILE0:%.+]] = VPU.NCE.Convolution([[DEPTHCONVTILE0]], %cst_2, %cst_3)
    // CHECK-SAME: {multiClusterStrategy = "SplitOverKernel", pad = {bottom = 0 : i64, left = 0 : i64, right = 0 : i64, top = 0 : i64}, ppe = {clamp_high = 255 : i64, clamp_low = 0 : i64, fp_prelu_alpha = 1.000000e+00 : f64, lrelu_mult = 1 : i64, lrelu_shift = 0 : i64, mode = "NOOP"}, rawFilterShape = [160, 576, 1, 1], strides = [1, 1]} -> tensor<1x160x11x65xf16, {order = #NHWC}>
    ...
    // CHECK-SAME: {activation_window_channel_length = 40 : i64, multiClusterStrategy = "SplitOverKernel", pad = {bottom = 0 : i64, left = 2 : i64, right = 2 : i64, top = 0 : i64}, ppe = {clamp_high = 255 : i64, clamp_low = 0 : i64, fp_prelu_alpha = 1.000000e+00 : f64, lrelu_mult = 1 : i64, lrelu_shift = 0 : i64, mode = "LRELUX"}, rawFilterShape = [576, 1, 5, 5], strides = [1, 1]} -> tensor<1x576x11x65xf16, {order = #NHWC}>
    ...
    // CHECK-SAME: {activation_window_channel_length = 40 : i64, multiClusterStrategy = "SplitOverKernel", pad = {bottom = 2 : i64, left = 2 : i64, right = 2 : i64, top = 0 : i64}, ppe = {clamp_high = 255 : i64, clamp_low = 0 : i64, fp_prelu_alpha = 1.000000e+00 : f64, lrelu_mult = 1 : i64, lrelu_shift = 0 : i64, mode = "LRELUX"}, rawFilterShape = [576, 1, 5, 5], strides = [1, 1]} -> tensor<1x576x10x65xf16, {order = #NHWC}>
    // CHECK: [[CONVTILE5:%.+]] = VPU.NCE.Convolution([[DEPTHCONVTILE5]], %cst_2, %cst_3)
    // CHECK-SAME: {multiClusterStrategy = "SplitOverKernel", pad = {bottom = 0 : i64, left = 0 : i64, right = 0 : i64, top = 0 : i64}, ppe = {clamp_high = 255 : i64, clamp_low = 0 : i64, fp_prelu_alpha = 1.000000e+00 : f64, lrelu_mult = 1 : i64, lrelu_shift = 0 : i64, mode = "NOOP"}, rawFilterShape = [160, 576, 1, 1], strides = [1, 1]} -> tensor<1x160x10x65xf16, {order = #NHWC}>
...
func.func @VfTilingBetweenEltwise(%input: tensor<1x64x256x256xf16, {order = #NHWC}>, %cst_1: tensor<256x64x1x1xf16, {order = #NHWC}>, %cst_2: tensor<256x1x1x4xsi32>, %cst_3: tensor<1x256x256x256xf16, {order = #NHWC}>, %cst_4: tensor<64x256x1x1xf16, {order = #NHWC}>, %cst_5: tensor<64x1x1x4xsi32>, %cst_6: tensor<64x64x3x3xf16, {order = #NHWC}>, %cst_7: tensor<64x1x1x4xsi32>, %cst_8: tensor<256x64x1x1xf16, {order = #NHWC}>, %cst_9: tensor<256x1x1x4xsi32>) -> tensor<1x256x256x256xf16>  {
  ...
  %1 = VPU.VerticalFusion (%0 as %arg1: tensor<1x256x256x256xf16, {order = #NHWC}>, %cst_4 as %arg2: tensor<64x256x1x1xf16, {order = #NHWC}>, %cst_5 as %arg3: tensor<64x1x1x4xsi32>, %cst_6 as %arg4: tensor<64x64x3x3xf16, {order = #NHWC}>, %cst_7 as %arg5: tensor<64x1x1x4xsi32>, %cst_8 as %arg6: tensor<256x64x1x1xf16, {order = #NHWC}>, %cst_9 as %arg7: tensor<256x1x1x4xsi32>) attributes {tilingStrategy = [1, 1, 32, 1]} -> tensor<1x256x256x256xf16> {
    ...
    %3 = VPU.NCE.Convolution(%2, %arg4, %arg5) {multiClusterStrategy = "SplitOverHeight",
