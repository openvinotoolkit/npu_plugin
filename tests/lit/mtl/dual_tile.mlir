...
module @dual_tile attributes {VPUIP.arch = "MTL", VPUIP.compilationMode = "DefaultHW"} {
  VPUIP.Graph
    options : "NONE"
    version : {
  ...
  func @main(
        %input_arg: memref<1x16x16x16x!qtype, #NHWC, "ProgrammableInput">,
        %output_arg: memref<2x16x16x16xf16, #NHWC, "ProgrammableOutput">
