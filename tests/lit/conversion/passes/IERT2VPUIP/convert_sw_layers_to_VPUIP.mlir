...
// CHECK:       }
// CHECK: [[VAR6:%.*]] = IERT.Copy inputs([[VAR5]] : memref<1x1x1x2000xf16, "CMX_NN">) outputs(%0 : memref<1x1x1x2000xf16>) -> memref<1x1x1x2000xf16>
...
// CHECK:  }
// CHECK: [[VAR11:%.*]] = IERT.Copy inputs([[VAR10]] : memref<1x1x1x2000xf16, "CMX_NN">) outputs(%1 : memref<1x1x1x2000xf16>) -> memref<1x1x1x2000xf16>
