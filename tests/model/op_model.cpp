...
TEST(op_model, op_removal)
{
    ...
    auto input = om.input({32, 32, 1}, mv::DTypeType::Float16, mv::Order(mv::Order::getColMajorID(3)));
    ...
    auto weights1 = om.constant(weightsData, {3, 3, 1, 3}, mv::DTypeType::Float16, mv::Order(mv::Order::getColMajorID(3)));
