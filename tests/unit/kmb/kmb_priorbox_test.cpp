...
class KmbComputePriorboxTest : public testing::TestWithParam<vpu::KmbPlugin::utils::priorBoxParam> {
...
INSTANTIATE_TEST_SUITE_P(
        DISABLED_KmbTestsPriorBox, KmbComputePriorboxTest,
        ::testing::Values(vpu::KmbPlugin::utils::priorBoxParam(0.5, 16, {76.8}, {153.6}, true, false, true, {}, {}, {},
                                                               {2, 3}, {0.1, 0.1, 0.2, 0.2}, {1, 1024, 32, 32},
                                                               {1, 3, 512, 512}, {2, 1, 24576}),
                          vpu::KmbPlugin::utils::priorBoxParam(0.5, 32, {153.6}, {230.4}, true, false, true, {}, {}, {},
                                                               {2, 3}, {0.1, 0.1, 0.2, 0.2}, {1, 512, 16, 16},
                                                               {1, 3, 512, 512}, {2, 1, 6144}),
                          vpu::KmbPlugin::utils::priorBoxParam(0.5, 64, {230.4}, {307.2}, true, false, true, {}, {}, {},
                                                               {2, 3}, {0.1, 0.1, 0.2, 0.2}, {1, 256, 8, 8},
                                                               {1, 3, 512, 512}, {2, 1, 1536}),
                          vpu::KmbPlugin::utils::priorBoxParam(0.5, 128, {307.2}, {384.0}, true, false, true, {}, {},
                                                               {}, {2, 3}, {0.1, 0.1, 0.2, 0.2}, {1, 256, 4, 4},
                                                               {1, 3, 512, 512}, {2, 1, 384}),
                          vpu::KmbPlugin::utils::priorBoxParam(0.5, 256, {384.0}, {460.8}, true, false, true, {}, {},
                                                               {}, {2}, {0.1, 0.1, 0.2, 0.2}, {1, 256, 2, 2},
                                                               {1, 3, 512, 512}, {2, 1, 64}),
                          vpu::KmbPlugin::utils::priorBoxParam(0.5, 512, {460.8}, {537.6}, true, false, true, {}, {},
                                                               {}, {2}, {0.1, 0.1, 0.2, 0.2}, {1, 256, 1, 1},
                                                               {1, 3, 512, 512}, {2, 1, 16})));
#endif
