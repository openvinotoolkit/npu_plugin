...
struct xmlPriorBoxClusteredParam {
    xmlPriorBoxClusteredParam(float offset, int clip, float step, float step_w, float step_h, int img_size, int img_w,
                              ...
                              const InferenceEngine::SizeVector& image_dims,
...
class KmbComputePriorboxClusteredTest : public testing::TestWithParam<xmlPriorBoxClusteredParam> {
...
<Net Name="PriorBoxClustered_Only" version="2" precision="FP32" batch="1">
    ...
    std::vector<double> kmbComputePriorboxClustered(const xmlPriorBoxClusteredParam& p) {
        ...
        vpu::KmbPlugin::utils::priorBoxClusteredParam param{offset,
                                                            clip,
                                                            step_w,
                                                            step_h,
                                                            layer_width,
...
INSTANTIATE_TEST_SUITE_P(
        DISABLED_KmbTestsPriorBoxClustered, KmbComputePriorboxClusteredTest,
        ::testing::Values(xmlPriorBoxClusteredParam(0.5, 0, 16.0, 0.0, 0.0, 0, 0, 0, 1,
                                                    {9.400000, 25.100000, 14.700000, 34.700001, 143.000000, 77.400002,
                                                     128.800003, 51.099998, 75.599998},
                                                    {15.000000, 39.599998, 25.500000, 63.200001, 227.500000, 162.899994,
                                                     124.500000, 105.099998, 72.599998},
                                                    {0.100000, 0.100000, 0.200000, 0.200000}, {1, 384, 19, 19},
                                                    {1, 3, 300, 300}, {1, 2, 12996}),
