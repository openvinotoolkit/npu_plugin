...
TEST(MLIR_IE_FrontEndTest, ReshapeLayerTest_ImportNetwork) {
...
TEST(MLIR_IE_FrontEndTest, ReshapeLayerTest_OneSpecialZeroWithNegative) {
    std::shared_ptr<ngraph::Function> f;
    {
...
TEST(MLIR_IE_FrontEndTest, ReshapeLayerTest_TwoSpecialZeroWithNegative) {
    std::shared_ptr<ngraph::Function> f;
    {
...
TEST(MLIR_IE_FrontEndTest, ReshapeLayerTest_OneSpecialZeroLastWithNegative) {
    std::shared_ptr<ngraph::Function> f;
    {
...
TEST(MLIR_IE_FrontEndTest, ReshapeLayerTest_OneSpecialZeroFirstWithNegative) {
    std::shared_ptr<ngraph::Function> f;
    {
        auto data = std::make_shared<ngraph::opset1::Parameter>(ngraph::element::f32, ngraph::Shape{3, 1, 1});
