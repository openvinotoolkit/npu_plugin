...
class MLIR_IE_FrontEndTest_Conv : public testing::TestWithParam<convLayerTestParamsSet> {};

TEST_P(MLIR_IE_FrontEndTest_Conv, ConvLayer) {
...
INSTANTIATE_TEST_CASE_P(smoke_Convolution2D_ExplicitPadding, MLIR_IE_FrontEndTest_Conv,
...
INSTANTIATE_TEST_CASE_P(smoke_Convolution2D_AutoPadValid, MLIR_IE_FrontEndTest_Conv,
...
INSTANTIATE_TEST_CASE_P(smoke_Convolution3D_ExplicitPadding, MLIR_IE_FrontEndTest_Conv,
...
INSTANTIATE_TEST_CASE_P(smoke_Convolution3D_AutoPadValid, MLIR_IE_FrontEndTest_Conv,
