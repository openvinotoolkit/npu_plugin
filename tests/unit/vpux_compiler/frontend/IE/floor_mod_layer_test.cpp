...
TEST(IE_FrontEndTest, FloorModLayer) {
    std::shared_ptr<ngraph::Function> f;
    {
        ...
        auto floor_mod = std::make_shared<ngraph::opset1::FloorMod>(param1, param2, autob);
        floor_mod->set_friendly_name("FloorMod");
        auto result = std::make_shared<ngraph::op::Result>(floor_mod);
...
TEST(IE_FrontEndTest, FloorModLayer_AutoBroadcastType_NUMPY) {
    std::shared_ptr<ngraph::Function> f;
    {
        ...
        auto floor_mod = std::make_shared<ngraph::opset1::FloorMod>(param1, param2);
        floor_mod->set_friendly_name("FloorMod");
        auto result = std::make_shared<ngraph::op::Result>(floor_mod);
        f = std::make_shared<ngraph::Function>(ngraph::ResultVector{result}, ngraph::ParameterVector{param1, param2});
