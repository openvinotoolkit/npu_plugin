...
// Test code copied and simplified from: kmb-plugin/tests/functional/shared_tests_instances/single_layer_tests/pooling.cpp
enum PoolingTypes {
    MAX,
    AVG
};
typedef std::tuple<
        std::vector<size_t>,            // Input size
...
TEST_P(IE_FrontEndTest, MaxPoolLayer) {
    std::shared_ptr<ngraph::Function> f;
    {
        ...
        std::tie(inputSize, poolType, kernel, stride, padBegin, padEnd, roundingType, padType, excludePad) = this->GetParam();
        ...
        auto maxpool = std::make_shared<ngraph::opset1::MaxPool>(param1, strides, pads_begin, pads_end, kernel_shape, rounding_mode, auto_pad);
...
const auto maxPool_ExplicitPad_FloorRounding_Params =
    ::testing::Combine(::testing::Values(inputSize), ::testing::Values(PoolingTypes::MAX), ::testing::ValuesIn(kernels), ::testing::ValuesIn(strides),
...
const auto maxPool_ExplicitPad_CeilRounding_Params =
    ::testing::Combine(::testing::Values(inputSize), ::testing::Values(PoolingTypes::MAX), ::testing::ValuesIn(kernels),
...
const auto allPools_ValidPad_Params = ::testing::Combine(::testing::Values(inputSize), ::testing::Values(PoolingTypes::MAX /*, PoolingTypes::AVG */),
