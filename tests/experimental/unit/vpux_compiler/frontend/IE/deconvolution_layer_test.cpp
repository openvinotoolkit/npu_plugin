...
class IE_FrontEndTest_Decovolution : public testing::TestWithParam<convBackpropDataLayerTestParamsSet> {};

TEST_P(IE_FrontEndTest_Decovolution, DecovolutionLayer) {
...
INSTANTIATE_TEST_CASE_P(DeconvolutionOp2D_ExplicitPadding, IE_FrontEndTest_Decovolution,
...
INSTANTIATE_TEST_CASE_P(DeconvolutionOp2D_AutoPadValid, IE_FrontEndTest_Decovolution,
...
INSTANTIATE_TEST_CASE_P(DeconvolutionOp2D_AutoPadValid_OutputShape, IE_FrontEndTest_Decovolution,
...
INSTANTIATE_TEST_CASE_P(DeconvolutionOp3D_ExplicitPadding, IE_FrontEndTest_Decovolution,
...
INSTANTIATE_TEST_CASE_P(DeconvolutionOp3D_AutoPadValid, IE_FrontEndTest_Decovolution,
...
INSTANTIATE_TEST_CASE_P(DeconvolutionOp3D_ExplicitPadding_OutputShape, IE_FrontEndTest_Decovolution,
