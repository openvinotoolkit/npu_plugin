...
TEST(ops, concat)
{
    ...
    auto input1 = om.constant(input1Data, {8, 8, 16}, mv::DTypeType::Float16, mv::OrderType::ColumnMajor);
    auto input2 = om.constant(input2Data, {8, 8, 16}, mv::DTypeType::Float16, mv::OrderType::ColumnMajor);
