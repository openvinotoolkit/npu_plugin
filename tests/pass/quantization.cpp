...
TEST(quantization, case_conv)
{
    ...
    mv::pass::PassRegistry::instance().find("Quantization")->run(om, dummyTargDesc, dummyCompDesc, compOutput);
    ...
    auto resData = dm.getTensor(convOp->get<std::string>("weights_table"))->getData();
