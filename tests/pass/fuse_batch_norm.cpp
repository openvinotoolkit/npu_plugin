...
TEST(fuse_batch_norm_pass, case_ndim_conv)
{
    ...
    auto input = om.input({64, 64, 3}, mv::DType("Float16"), mv::Order("CHW"));
    ...
    double eps = 1e-3;
    auto bnmean = om.constant(meanData, convShape, mv::DType("Float16"), mv::Order("CHW"), "mean");
    auto bnmeanOp = om.getSourceOp(bnmean);
    auto bnvariance = om.constant(varianceData, convShape, mv::DType("Float16"), mv::Order("CHW"), "variance");
    auto bnvarianceOp = om.getSourceOp(bnvariance);
    auto bnoffset = om.constant(offsetData, convShape, mv::DType("Float16"), mv::Order("CHW"), "offset");
    auto bnoffsetOp = om.getSourceOp(bnoffset);
    auto bnscale = om.constant(scaleData, convShape, mv::DType("Float16"), mv::Order("CHW"), "scale");
    ...
    // Check fusing
    mv::Tensor mean("mean", convShape, mv::DType("Float16"), mv::Order("CHW"), meanData);
    mv::Tensor variance("variance", convShape, mv::DType("Float16"), mv::Order("CHW"), varianceData);
    mv::Tensor offset("offset", convShape, mv::DType("Float16"), mv::Order("CHW"), offsetData);
...
{
    mv::OpModel om("testModel");
    auto input = om.input({64, 64, 16}, mv::DType("Float16"), mv::Order("CHW"));
    ...
    double eps = 1e-3;
    auto bnmean = om.constant(meanData, {convShape[-1]}, mv::DType("Float16"), mv::Order("W"), "mean");
    auto bnmeanOp = om.getSourceOp(bnmean);
    auto bnvariance = om.constant(varianceData, {convShape[-1]}, mv::DType("Float16"), mv::Order("W"), "variance");
    auto bnvarianceOp = om.getSourceOp(bnvariance);
    auto bnoffset = om.constant(offsetData, {convShape[-1]}, mv::DType("Float16"), mv::Order("W"), "offset");
    auto bnoffsetOp = om.getSourceOp(bnoffset);
    auto bnscale = om.constant(scaleData, {convShape[-1]}, mv::DType("Float16"), mv::Order("W"), "scale");
    auto bnscaleOp = om.getSourceOp(bnscale);
    auto batchnorm = om.batchNormalization(conv, bnmean, bnvariance, bnoffset, bnscale, eps);
    auto batchnormOp = om.getSourceOp(batchnorm);
    ...
    // Check fusing
    mv::Tensor mean("mean", {convShape[-1]}, mv::DType("Float16"), mv::Order("W"), meanData);
    mv::Tensor variance("variance", {convShape[-1]}, mv::DType("Float16"), mv::Order("W"), varianceData);
    mv::Tensor offset("offset", {convShape[-1]}, mv::DType("Float16"), mv::Order("W"), offsetData);
    mv::Tensor scale("scale", {convShape[-1]}, mv::DType("Float16"), mv::Order("W"), scaleData);
...
TEST(fuse_batch_norm_pass, case_ndim_nonconv)
{
    ...
    double eps = 1e-3;
    auto bnmean = om.constant(meanData, poolShape, mv::DType("Float16"), mv::Order("CHW"), "mean");
    auto bnmeanOp = om.getSourceOp(bnmean);
    auto bnvariance = om.constant(varianceData, poolShape, mv::DType("Float16"), mv::Order("CHW"), "variance");
    auto bnvarianceOp = om.getSourceOp(bnvariance);
    auto bnoffset = om.constant(offsetData, poolShape, mv::DType("Float16"), mv::Order("CHW"), "offset");
    auto bnoffsetOp = om.getSourceOp(bnoffset);
    auto bnscale = om.constant(scaleData, poolShape, mv::DType("Float16"), mv::Order("CHW"), "scale");
    auto bnscaleOp = om.getSourceOp(bnscale);
    ...
    // Check fusing
    mv::Tensor mean("mean", poolShape, mv::DType("Float16"), mv::Order("CHW"), meanData);
    mv::Tensor variance("variance", poolShape, mv::DType("Float16"), mv::Order("CHW"), varianceData);
    mv::Tensor offset("offset", poolShape, mv::DType("Float16"), mv::Order("CHW"), offsetData);
...
TEST(fuse_batch_norm_pass, case_1dim_nonconv)
{
    ...
    double eps = 1e-3;
    auto bnmean = om.constant(meanData, {poolShape[-1]}, mv::DType("Float16"), mv::Order("W"), "mean");
    auto bnmeanOp = om.getSourceOp(bnmean);
    auto bnvariance = om.constant(varianceData, {poolShape[-1]}, mv::DType("Float16"), mv::Order("W"), "variance");
    auto bnvarianceOp = om.getSourceOp(bnvariance);
    auto bnoffset = om.constant(offsetData, {poolShape[-1]}, mv::DType("Float16"), mv::Order("W"), "offset");
    auto bnoffsetOp = om.getSourceOp(bnoffset);
    auto bnscale = om.constant(scaleData, {poolShape[-1]}, mv::DType("Float16"), mv::Order("W"), "scale");
    auto bnscaleOp = om.getSourceOp(bnscale);
    auto batchnorm = om.batchNormalization(pool, bnmean, bnvariance, bnoffset, bnscale, eps);
    auto batchnormOp = om.getSourceOp(batchnorm);
    ...
    // Check fusing
    mv::Tensor mean("mean", {poolShape[-1]}, mv::DType("Float16"), mv::Order("W"), meanData);
    mv::Tensor variance("variance", {poolShape[-1]}, mv::DType("Float16"), mv::Order("W"), varianceData);
    mv::Tensor offset("offset", {poolShape[-1]}, mv::DType("Float16"), mv::Order("W"), offsetData);
