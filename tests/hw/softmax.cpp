...
TEST(mvtensor_serialization, blob_softmax1)
{
    ...
    std::string outputName = "test_softmax1";
...
TEST(mvtensor_serialization, blob_softmax2)
{
    ...
    std::string outputName = "test_softmax2";
    unit.compilationDescriptor()["GenerateBlob"]["fileName"] = std::string(outputName+".blob");
    unit.compilationDescriptor()["GenerateBlob"]["enableFileOutput"] = true;
    unit.compilationDescriptor()["GenerateBlob"]["enableRAMOutput"] = false;
    unit.compilationDescriptor()["GenerateDot"]["output"] = std::string(outputName+".dot");
...
TEST(mvtensor_serialization, blob_softmax3)
{
    ...
    std::string outputName = "test_softmax3";
    unit.compilationDescriptor()["GenerateBlob"]["fileName"] = std::string(outputName+".blob");
    unit.compilationDescriptor()["GenerateBlob"]["enableFileOutput"] = true;
    unit.compilationDescriptor()["GenerateBlob"]["enableRAMOutput"] = false;
    unit.compilationDescriptor()["GenerateDot"]["output"] = std::string(outputName+".dot");
