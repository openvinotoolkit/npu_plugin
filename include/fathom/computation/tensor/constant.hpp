...
namespace mv
{
    ...
    class ConstantTensor : public Tensor
    {
        ...
        allocator::vector<float_type> data_;

    public:

        ConstantTensor(const Shape &shape, DType dType, Order order, allocator::vector<float_type> data) : 
        ...
        allocator::vector<float_type> getData() const
        {
            return data_;
        }
