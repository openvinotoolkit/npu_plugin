...
namespace mv
{
    ...
    class RuntimeModel
    {
        ...
        public:
            ...
            static void alignTensor(mv::ComputationModel& cm, std::unique_ptr<MVCNN::TensorReferenceT>& tensorT, Tensor &tensor, bool padFinalOutput = false, bool padWidth = false);
