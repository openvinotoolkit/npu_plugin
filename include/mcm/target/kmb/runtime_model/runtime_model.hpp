...
namespace mv
{
    ...
    class RuntimeModel
    {
        ...
        public:
            ...
            static void alignTensor(mv::ComputationModel& cm, std::unique_ptr<MVCNN::TensorReferenceT>& tensorT, Tensor &tensor, std::string dimension, bool padFinalOutput = false);
