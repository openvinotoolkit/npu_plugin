...
const std::vector<PrivateConfigTestParams> privateConfigParams {
    ...
    PrivateConfigTestParams()
        ...
        .preProc(false)
        .checkSIPP(false)
        .privateConfig({{"VPU_KMB_FORCE_NCHW_TO_NHWC", CONFIG_VALUE(YES)}, {"VPU_KMB_USE_CORE_NN", CONFIG_VALUE(YES)}})
        .inputWidth(224)
        .inputHeight(224)
        .nClasses(2),
    PrivateConfigTestParams()
        ...
        .preProc(false)
        .checkSIPP(false)
        .privateConfig({{"VPU_KMB_FORCE_NCHW_TO_NHWC", CONFIG_VALUE(YES)}, {"EXCLUSIVE_ASYNC_REQUESTS", CONFIG_VALUE(NO)}, {"VPU_KMB_EXECUTOR_STREAMS", "3"}})
        .inputWidth(224)
        .inputHeight(224)
        .nClasses(2)};
