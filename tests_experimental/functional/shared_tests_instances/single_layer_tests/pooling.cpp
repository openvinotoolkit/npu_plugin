...
poolSpecificParams defaulParams(Pooling::PoolingTypes::MAX, {3, 3}, {1, 1}, {0, 0}, {0, 0},
    ngraph::op::RoundingType::FLOOR, ngraph::op::PadType::EXPLICIT, false);

INSTANTIATE_TEST_CASE_P(Reshape, PoolingLayerTest,
    ::testing::Combine(::testing::Values(defaulParams), ::testing::Values(InferenceEngine::Precision::FP32),
