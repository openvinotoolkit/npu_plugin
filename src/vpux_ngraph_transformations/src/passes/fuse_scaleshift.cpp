...
bool FuseScaleShift::run_on_node(std::shared_ptr<ngraph::Node> node) {
    ...
    std::shared_ptr<ngraph::Node> convolution_node = std::dynamic_pointer_cast<ngraph::op::v1::Convolution>(
            convolution_add_node->input_value(0).get_node_shared_ptr());
    if (convolution_node == nullptr) {
        convolution_node = std::dynamic_pointer_cast<ngraph::op::v1::GroupConvolution>(
                convolution_add_node->input_value(0).get_node_shared_ptr());
        if (convolution_node == nullptr)
            return false;
    }

    const auto input_fq_node = std::dynamic_pointer_cast<ngraph::op::v0::FakeQuantize>(
    ...
    std::shared_ptr<ngraph::op::Op> scaleshift_bias_node =
            std::dynamic_pointer_cast<ngraph::op::v1::Add>(input_fq_node->input_value(0).get_node_shared_ptr());
    if (scaleshift_bias_node == nullptr) {
        scaleshift_bias_node = std::dynamic_pointer_cast<ngraph::op::v1::Subtract>(
    ...
    auto scaleshift_shifts =
            std::dynamic_pointer_cast<ngraph::op::Constant>(scaleshift_bias_node->input_value(1).get_node_shared_ptr());
    if (!scaleshift_shifts) {
        scaleshift_shifts = std::dynamic_pointer_cast<ngraph::op::Constant>(
    ...
    auto scaleshift_scale_node = std::dynamic_pointer_cast<ngraph::op::v1::Multiply>(
            scaleshift_bias_node->input_value(0).get_node_shared_ptr());
    auto scaleshift_parameter_node = std::dynamic_pointer_cast<ngraph::op::v0::Parameter>(
            scaleshift_bias_node->input_value(0).get_node_shared_ptr());
    auto scaleshift_convert_node = std::dynamic_pointer_cast<ngraph::op::v0::Convert>(
            scaleshift_bias_node->input_value(0).get_node_shared_ptr());
    auto scaleshift_transpose_node = std::dynamic_pointer_cast<ngraph::op::v1::Transpose>(
            scaleshift_bias_node->input_value(0).get_node_shared_ptr());
    if (!scaleshift_scale_node && !scaleshift_parameter_node && !scaleshift_convert_node &&
        ...
        scaleshift_scale_node = std::dynamic_pointer_cast<ngraph::op::v1::Multiply>(
                scaleshift_bias_node->input_value(1).get_node_shared_ptr());
        scaleshift_parameter_node = std::dynamic_pointer_cast<ngraph::op::v0::Parameter>(
                scaleshift_bias_node->input_value(1).get_node_shared_ptr());
        scaleshift_convert_node = std::dynamic_pointer_cast<ngraph::op::v0::Convert>(
                scaleshift_bias_node->input_value(1).get_node_shared_ptr());
        scaleshift_transpose_node = std::dynamic_pointer_cast<ngraph::op::v1::Transpose>(
                scaleshift_bias_node->input_value(1).get_node_shared_ptr());
        if (!scaleshift_scale_node && !scaleshift_parameter_node && !scaleshift_convert_node &&
            !scaleshift_transpose_node)
            return false;
    ...
    if (scaleshift_scale_node != nullptr) {
        auto scaleshift_scale_first_const = std::dynamic_pointer_cast<ngraph::op::Constant>(
                scaleshift_scale_node->input_value(0).get_node_shared_ptr());
        auto scaleshift_scale_second_const = std::dynamic_pointer_cast<ngraph::op::Constant>(
    ...
    if (scaleshift_scale_node != nullptr) {
        scaleshift_scales = std::dynamic_pointer_cast<ngraph::op::Constant>(
                scaleshift_scale_node->input_value(1).get_node_shared_ptr());
    ...
    auto input_fq_node1 =
            std::dynamic_pointer_cast<ngraph::op::v0::Constant>(input_fq_node->input_value(1).get_node_shared_ptr());
    auto input_fq_node2 =
            std::dynamic_pointer_cast<ngraph::op::v0::Constant>(input_fq_node->input_value(2).get_node_shared_ptr());
    auto input_fq_node3 =
            std::dynamic_pointer_cast<ngraph::op::v0::Constant>(input_fq_node->input_value(3).get_node_shared_ptr());
    auto input_fq_node4 =
            std::dynamic_pointer_cast<ngraph::op::v0::Constant>(input_fq_node->input_value(4).get_node_shared_ptr());
    if (input_fq_node1 == nullptr || input_fq_node2 == nullptr || input_fq_node3 == nullptr ||
        input_fq_node4 == nullptr)
        return false;

    auto weights_fq_node = std::dynamic_pointer_cast<ngraph::op::v0::FakeQuantize>(
            convolution_node->input_value(1).get_node_shared_ptr());
    if (weights_fq_node == nullptr) {
        const auto convolution_weights_reshape_node = std::dynamic_pointer_cast<ngraph::op::v1::Reshape>(
                convolution_node->input_value(1).get_node_shared_ptr());
        if (convolution_weights_reshape_node == nullptr)
            return false;
        weights_fq_node = std::dynamic_pointer_cast<ngraph::op::v0::FakeQuantize>(
    ...
    auto convolution_weights_node =
            std::dynamic_pointer_cast<ngraph::op::Constant>(weights_fq_node->input_value(0).get_node_shared_ptr());
    if (convolution_weights_node == nullptr) {
        const auto convolution_weights_convert_node =
                std::dynamic_pointer_cast<ngraph::op::Convert>(weights_fq_node->input_value(0).get_node_shared_ptr());
        if (convolution_weights_convert_node == nullptr)
            return false;
        convolution_weights_node = std::dynamic_pointer_cast<ngraph::op::Constant>(
    ...
    auto weights_fq_node1 =
            std::dynamic_pointer_cast<ngraph::op::v0::Constant>(weights_fq_node->input_value(1).get_node_shared_ptr());
    auto weights_fq_node2 =
            std::dynamic_pointer_cast<ngraph::op::v0::Constant>(weights_fq_node->input_value(2).get_node_shared_ptr());
    auto weights_fq_node3 =
            std::dynamic_pointer_cast<ngraph::op::v0::Constant>(weights_fq_node->input_value(3).get_node_shared_ptr());
    auto weights_fq_node4 =
            std::dynamic_pointer_cast<ngraph::op::v0::Constant>(weights_fq_node->input_value(4).get_node_shared_ptr());
    ...
    auto convolution_biases_node =
            std::dynamic_pointer_cast<ngraph::op::Constant>(convolution_add_node->input_value(1).get_node_shared_ptr());
        ...
        for (size_t ic = 0; ic < IC; ++ic) {
            for (size_t h = 0; h < H; ++h) {
                for (size_t w = 0; w < W; ++w) {
                    ...
                    double real_weight =
                            (stored_weight - weights_fq_ilo) * weights_fq_orange / weights_fq_irange + weights_fq_olo;
