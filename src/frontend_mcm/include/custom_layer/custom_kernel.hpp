...
public:
    ...
    SmallVector<std::string> argumentNames() const { return _kernelArguments; }
    SmallVector<KernelParam> bindings() const { return _bindings; }
