...
void mv::HWTest(mv::CompilationUnit& unit, std::string outputName)
{
    ...
    //1) Compile generated prototext with fathom
    ...
    //2) Compare python and cpp
    std::cout << "COMPARING FATHOM AND MCMCOMPILER BLOBS" << std::endl;
    std::string command2("python3 " + mv::utils::projectRootPath() + "/python/tools/compare_blobs.py " + outputName + ".blob graph");
