...
class KmbNNFlicExecutor : public vpux::Executor {
public:
    using Ptr = std::shared_ptr<KmbNNFlicExecutor>;

    virtual ~KmbNNFlicExecutor();
    KmbNNFlicExecutor(const vpux::NetworkDescription::Ptr& networkDescription,
