...
int64_t getBitPatternSize(vpux::VPUIP::NCETaskType taskType, ShapeRef kernelSize, int64_t SX, mlir::Type elemType,  int64_t IC);

int64_t getActivationWindowSize(vpux::VPUIP::NCETaskType taskType, ShapeRef kernelSize, int64_t SX, mlir::Type elemType, int64_t IC);

std::vector<uint8_t> getFakeSparsity(vpux::VPUIP::NCETaskType taskType, ShapeRef kernelSize, int64_t SX, mlir::Type elemType, int64_t IC, int64_t OC);
