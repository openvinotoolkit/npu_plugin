...
mlir::Attribute getDMAEngine(uint32_t& numUnits, mlir::MLIRContext* ctx, VPUIPRegMapped::DMAEngine engine);
mlir::Attribute getPhysicalProcessor(uint32_t& numUnits, mlir::Operation* op, VPUIPRegMapped::PhysicalProcessor proc,
