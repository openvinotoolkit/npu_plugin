...
> Before adding the layer to the MLIR compiler, you should implement it in runtime first.  
[Adding (porting from mdk/MvTensor) software layers and ICV tests](https://wiki.ith.intel.com/pages/viewpage.action?pageId=1625378180)
...
[Debug - FAQ](https://wiki.ith.intel.com/display/VPUWIKI/Debug+-+FAQ)  
[MLIR FAQ](https://wiki.ith.intel.com/display/VPUWIKI/MLIR+FAQ)  
