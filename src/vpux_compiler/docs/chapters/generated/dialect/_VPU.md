...
| Operand | Description |
| :-----: | ----------- |
`operands` | 4D tensor of 16-bit float or bfloat16 type or 32-bit signed integer or QuantizedType or 8-bit unsigned integer values or VPU tensor type to describe the tensor tiling
...
| Operand | Description |
| :-----: | ----------- |
`operands` | 4D tensor of 16-bit float or bfloat16 type or 32-bit signed integer or QuantizedType or 8-bit unsigned integer values
