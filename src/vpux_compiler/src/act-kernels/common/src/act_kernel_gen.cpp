...
static void compileAndLinkSHAVE(const movitools::MoviCompileParams& params,
...
ActKernelDesc compileKernelForACTShave(const CompilationListDesc & listDesc,
    ...
    result.text = {listDesc.name.data(), buildKernelData(fbb, textBinary), textBinary.size() - 1024};
