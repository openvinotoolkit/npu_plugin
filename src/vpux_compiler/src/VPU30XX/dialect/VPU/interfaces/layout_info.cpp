...
//
// ConvolutionDimsOrderOpModelForSW30XX
//

class ConvolutionDimsOrderOpModelForSW30XX final :
        public IE::LayoutInfoOpInterface::FallbackModel<ConvolutionDimsOrderOpModelForSW30XX> {
public:
...
//
// NCEConvolutionWithCMajorDimsOrderOpModelForHW30XX
//

class NCEConvolutionWithCMajorDimsOrderOpModelForHW30XX final :
        public IE::LayoutInfoOpInterface::FallbackModel<NCEConvolutionWithCMajorDimsOrderOpModelForHW30XX> {
public:
    static void inferLayoutInfo(mlir::Operation* op, IE::LayerLayoutInfo& info, const bool /*seOpsEnabled*/) {
...
void redirectLayoutOpInterfacesForVPU(mlir::DialectRegistry& registry) {
    ...
    registry.addExtension(+[](mlir::MLIRContext* ctx, VPU::VPUDialect*) {
        ...
        VPU::ConvolutionOp::attachInterface<ConvolutionDimsOrderOpModelForSW30XX>(*ctx);
        VPU::GroupConvolutionOp::attachInterface<ConvolutionDimsOrderOpModelForSW30XX>(*ctx);

        VPU::NCEConvolutionOp::attachInterface<NCEConvolutionWithCMajorDimsOrderOpModelForHW30XX>(*ctx);
...
void redirectLayoutOpInterfacesForIE(mlir::DialectRegistry& registry) {
    registry.addExtension(+[](mlir::MLIRContext* ctx, IE::IEDialect*) {
        ...
        IE::ConvolutionOp::attachInterface<
                ...
                /*FallbackSWImplOpType=*/ConvolutionDimsOrderOpModelForSW30XX,
                /*FallbackHWImplOpType=*/NCEConvolutionWithCMajorDimsOrderOpModelForHW30XX>>(*ctx);
