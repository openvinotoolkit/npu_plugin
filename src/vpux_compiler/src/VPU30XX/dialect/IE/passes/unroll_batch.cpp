...
class UnrollBatchPass final : public IE::arch30xx::UnrollBatchBase<UnrollBatchPass> {
public:
...
std::unique_ptr<mlir::Pass> vpux::IE::arch30xx::createUnrollBatchPass(Logger log) {
