...
void TokenBasedBarrierScheduler::barrierTransitionStructure::add_scheduled_op_to_producer_list(const BarrierScheduleGenerator::schedule_info_t& sinfo) {
...
mlir::Operation* TokenBasedBarrierScheduler::barrierTransitionStructure::create_new_barrier_task(const BarrierScheduleGenerator::schedule_info_t& sinfo,
