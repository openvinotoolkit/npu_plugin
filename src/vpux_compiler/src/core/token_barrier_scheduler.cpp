...
//         : _ctx(ctx),
//           _func(func),
//           _builder(_func.getBody()),
//           _barrierCount(numBarriers),
...
//         BarrierScheduleGenerator scheduler_begin(_log, _ctx, _func, _barrierCount, _slotCount);
//         BarrierScheduleGenerator scheduler_end(_log, _ctx, _func);
