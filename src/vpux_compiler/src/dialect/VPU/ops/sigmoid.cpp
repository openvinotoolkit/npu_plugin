...
mlir::LogicalResult vpux::VPU::SigmoidOp::inferReturnTypes(mlir::MLIRContext* ctx,
    ...
    const auto inType = sigmoid.input().getType();
...
EMU::BlobWriter::SpecificTask vpux::VPU::SigmoidOp::serialize(EMU::BlobWriter& writer) {
