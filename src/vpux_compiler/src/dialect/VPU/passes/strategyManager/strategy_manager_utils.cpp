...
// It returns a hardware efficiency constant for a given stride and kernel size
static std::map<int64_t, std::map<int64_t, double>> channelMajorEfficiencyTable = {{
...
// It returns a hardware efficiency constant for a given stride and kernel size
static std::map<int64_t, std::map<int64_t, double>> depthwiseEfficiencyTable = {{
