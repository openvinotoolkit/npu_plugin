...
SmallVector<VPU::DistributedTypeInterface> DepthConvolutionStrategy::getDistributedTensorType(
...
bool DepthConvolutionStrategy::isOperationSplitOverHeightCompatible(VPU::ClusteredOpInterface nceOp,
