...
void MultiClusterStrategyAssignmentPass::safeRunOnFunc() {
    ...
    patterns.insert<GenericNCEtoNCEClusterTiling<NCEConvolutionOp>>(&ctx, strategyManager, _log);
    patterns.insert<GenericNCEtoNCEClusterTiling<NCEDepthConvolutionOp>>(&ctx, strategyManager, _log);
    patterns.insert<GenericNCEtoNCEClusterTiling<NCEMaxPoolOp>>(&ctx, strategyManager, _log);
    patterns.insert<GenericNCEtoNCEClusterTiling<NCEEltwiseOp>>(&ctx, strategyManager, _log);
