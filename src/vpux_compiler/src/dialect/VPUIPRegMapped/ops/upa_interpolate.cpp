...
void vpux::VPUIPRegMapped::InterpolateUPAOp::build(mlir::OpBuilder& builder, mlir::OperationState& state,
...
// vpux::VPUIPRegMapped::InterpolateUPAOp::serialize(VPUIPRegMapped::BlobWriter& writer) {
void vpux::VPUIPRegMapped::InterpolateUPAOp::serialize(std::vector<char>& buffer) {
    /*
