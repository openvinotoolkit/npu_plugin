...
/*
// Alex
std::pair<VPUIPRegMapped::BlobWriter::Vector<uint16_t>, VPUIPRegMapped::BlobWriter::Vector<uint16_t>>
serializeScalesAndZeroPoints(mlir::Value input, mlir::Value output, VPUIPRegMapped::BlobWriter& writer) {
...
mlir::LogicalResult vpux::VPUIPRegMapped::verifyOp(QuantCastUPAOp op) {
...
void vpux::VPUIPRegMapped::QuantCastUPAOp::inferLayoutInfo(mlir::Operation* origOp, IE::LayerLayoutInfo& info) {
...
void vpux::VPUIPRegMapped::QuantCastUPAOp::build(mlir::OpBuilder& builder, mlir::OperationState& state,
                                                 mlir::Value input, mlir::Value output) {
    build(builder, state, input, output, mlir::ValueRange{}, mlir::ValueRange{}, nullptr, false);
}

// VPUIPRegMapped::BlobWriter::SpecificTask vpux::VPUIPRegMapped::QuantCastUPAOp::serialize(BlobWriter& writer) {
void vpux::VPUIPRegMapped::QuantCastUPAOp::serialize(std::vector<char>& buffer) {
    /*
...
/*
// Alex
mlir::Operation* vpux::VPUIPRegMapped::BlobReader::parseQuantCast(mlir::OpBuilder& builder,
    ...
    return builder.create<VPUIPRegMapped::QuantCastUPAOp>(mlir::UnknownLoc::get(_ctx), inputs[0], outputs[0]);
}
*/
