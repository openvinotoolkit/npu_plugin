...
mlir::LogicalResult vpux::VPUIPRegMapped::verifyOp(PadUPAOp op) {
...
void vpux::VPUIPRegMapped::PadUPAOp::build(mlir::OpBuilder& builder, mlir::OperationState& state, mlir::Value input,
...
// VPUIPRegMapped::BlobWriter::SpecificTask vpux::VPUIPRegMapped::PadUPAOp::serialize(VPUIPRegMapped::BlobWriter&
// writer) {
void vpux::VPUIPRegMapped::PadUPAOp::serialize(std::vector<char>& buffer) {
    /*
...
/*
// Alex
mlir::Operation* vpux::VPUIPRegMapped::BlobReader::parsePad(mlir::OpBuilder& builder, ArrayRef<mlir::Value> inputs,
    ...
    return builder.create<VPUIPRegMapped::PadUPAOp>(mlir::UnknownLoc::get(_ctx), inputs[0], outputs[0],
                                                    getIntArrayAttr(_ctx, padBegin), getIntArrayAttr(_ctx, padEnd),
