...
mlir::LogicalResult vpux::VPUIPRegMapped::verifyOp(PerAxisTileUPAOp op) {
...
void vpux::VPUIPRegMapped::PerAxisTileUPAOp::build(::mlir::OpBuilder& odsBuilder, ::mlir::OperationState& odsState,
...
void vpux::VPUIPRegMapped::PerAxisTileUPAOp::serialize(std::vector<char>& buffer) {
    /*
...
/*
// Alex
mlir::Operation* vpux::VPUIPRegMapped::BlobReader::parseTile(mlir::OpBuilder& builder, ArrayRef<mlir::Value> inputs,
    ...
    return builder.create<VPUIPRegMapped::PerAxisTileUPAOp>(mlir::UnknownLoc::get(_ctx), inputs[0], outputs[0], axis,
                                                            tiles);
}
*/