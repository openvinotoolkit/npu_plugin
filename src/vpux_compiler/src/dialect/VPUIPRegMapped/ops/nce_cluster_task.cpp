...
int64_t vpux::VPUIPRegMapped::NCEClusterTaskOp::getNumVariants() {
...
mlir::LogicalResult verifyNCEConv(VPUIPRegMapped::NCEClusterTaskOp op) {
    VPUX_THROW_UNLESS(op.task_type() == VPUIPRegMapped::NCETaskType::CONV, "Expected task type '{0}', but got '{1}'",
                      VPUIPRegMapped::NCETaskType::CONV, op.task_type());
    ...
    if (mlir::failed(VPUIPRegMapped::NCEInvariant::verifyKernel(op->getLoc(), KY, KX, SY, SX, padTop, padBottom,
                                                                padLeft, padRight))) {
        return mlir::failure();
    }
    ...
    if (OC * VPUIPRegMapped::NCEInvariant::WEIGHT_TABLE_NUM_ELEMENTS_PER_OC != weightTableNumElements) {
        return errorAt(op, "Weight table must have '{0}' elements, got '{1}'",
                       OC * VPUIPRegMapped::NCEInvariant::WEIGHT_TABLE_NUM_ELEMENTS_PER_OC, weightTableNumElements);
    }
...
mlir::LogicalResult verifyNCEPool(VPUIPRegMapped::NCEClusterTaskOp op) {
    VPUX_THROW_UNLESS(op.task_type() == VPUIPRegMapped::NCETaskType::AVEPOOL ||
                              op.task_type() == VPUIPRegMapped::NCETaskType::MAXPOOL,
                      "Expected task type '{0}' or '{1}', but got '{2}'", VPUIPRegMapped::NCETaskType::AVEPOOL,
                      VPUIPRegMapped::NCETaskType::MAXPOOL, op.task_type());
...
mlir::LogicalResult verifyNCEDWConv(VPUIPRegMapped::NCEClusterTaskOp op) {
    VPUX_THROW_UNLESS(op.task_type() == VPUIPRegMapped::NCETaskType::DWCONV, "Expected task type '{0}', but got '{1}'",
                      VPUIPRegMapped::NCETaskType::CONV, op.task_type());
...
/*
// Alex
MVCNN::MPE_Mode getMPEMode(VPUIPRegMapped::MPEMode mpeMode) {
    switch (mpeMode) {
    case VPUIPRegMapped::MPEMode::VECTOR:
        return MVCNN::MPE_Mode_VECTOR;
    case VPUIPRegMapped::MPEMode::MATRIX:
        return MVCNN::MPE_Mode_MATRIX;
    case VPUIPRegMapped::MPEMode::VECTOR_FP16:
        return MVCNN::MPE_Mode_VECTOR_FP16;
    case VPUIPRegMapped::MPEMode::CUBOID_16x16:
        return MVCNN::MPE_Mode_CUBOID_16x16;
    case VPUIPRegMapped::MPEMode::CUBOID_8x16:
        return MVCNN::MPE_Mode_CUBOID_8x16;
    case VPUIPRegMapped::MPEMode::NOP:
...
MVCNN::DPULayerType getDPULayerType(VPUIPRegMapped::NCETaskType taskType) {
    switch (taskType) {
    case VPUIPRegMapped::NCETaskType::CONV:
        return MVCNN::DPULayerType_CONV;
    case VPUIPRegMapped::NCETaskType::DWCONV:
        return MVCNN::DPULayerType_DWCONV;
    case VPUIPRegMapped::NCETaskType::MAXPOOL:
        return MVCNN::DPULayerType_MAXPOOL;
    case VPUIPRegMapped::NCETaskType::AVEPOOL:
        return MVCNN::DPULayerType_AVEPOOL;
    case VPUIPRegMapped::NCETaskType::FCL:
        return MVCNN::DPULayerType_FCL;
    case VPUIPRegMapped::NCETaskType::ELTWISE:
        return MVCNN::DPULayerType_ELTWISE;
    case VPUIPRegMapped::NCETaskType::IDENTITY:
        return MVCNN::DPULayerType_IDENTITY;
    case VPUIPRegMapped::NCETaskType::CMCONV:
...
MVCNN::PPELayerType getPPELayerType(VPUIPRegMapped::PPELayerType ppeType) {
    switch (ppeType) {
    case VPUIPRegMapped::PPELayerType::STORE:
        return MVCNN::PPELayerType_STORE;
    case VPUIPRegMapped::PPELayerType::LOAD:
        return MVCNN::PPELayerType_LOAD;
    case VPUIPRegMapped::PPELayerType::CLEAR:
        return MVCNN::PPELayerType_CLEAR;
    case VPUIPRegMapped::PPELayerType::NOOP:
        return MVCNN::PPELayerType_NOOP;
    case VPUIPRegMapped::PPELayerType::HALT:
        return MVCNN::PPELayerType_HALT;
    case VPUIPRegMapped::PPELayerType::ADD:
        return MVCNN::PPELayerType_ADD;
    case VPUIPRegMapped::PPELayerType::SUB:
        return MVCNN::PPELayerType_SUB;
    case VPUIPRegMapped::PPELayerType::MULT:
        return MVCNN::PPELayerType_MULT;
    case VPUIPRegMapped::PPELayerType::MAXIMUM:
        return MVCNN::PPELayerType_MAXIMUM;
    case VPUIPRegMapped::PPELayerType::MINIMUM:
        return MVCNN::PPELayerType_MINIMUM;
    case VPUIPRegMapped::PPELayerType::AND:
        return MVCNN::PPELayerType_AND;
    case VPUIPRegMapped::PPELayerType::OR:
        return MVCNN::PPELayerType_OR;
    case VPUIPRegMapped::PPELayerType::XOR:
        return MVCNN::PPELayerType_XOR;
    case VPUIPRegMapped::PPELayerType::LRELU:
        return MVCNN::PPELayerType_LRELU;
    case VPUIPRegMapped::PPELayerType::LRELUX:
        return MVCNN::PPELayerType_LRELUX;
    case VPUIPRegMapped::PPELayerType::LPRELU:
        return MVCNN::PPELayerType_LPRELU;
    case VPUIPRegMapped::PPELayerType::CEIL:
        return MVCNN::PPELayerType_CEIL;
    case VPUIPRegMapped::PPELayerType::FLOOR:
        return MVCNN::PPELayerType_FLOOR;
    case VPUIPRegMapped::PPELayerType::EXP:
        return MVCNN::PPELayerType_EXP;
    case VPUIPRegMapped::PPELayerType::SIGMOID:
        return MVCNN::PPELayerType_SIGMOID;
    case VPUIPRegMapped::PPELayerType::TANH:
        return MVCNN::PPELayerType_TANH;
    case VPUIPRegMapped::PPELayerType::SQRT:
        return MVCNN::PPELayerType_SQRT;
    case VPUIPRegMapped::PPELayerType::RSQRT:
        return MVCNN::PPELayerType_RSQRT;
    case VPUIPRegMapped::PPELayerType::FLEXARB:
        return MVCNN::PPELayerType_FLEXARB;
    case VPUIPRegMapped::PPELayerType::NOT:
        return MVCNN::PPELayerType_NOT;
    case VPUIPRegMapped::PPELayerType::ABS:
        return MVCNN::PPELayerType_ABS;
    case VPUIPRegMapped::PPELayerType::NEG:
...
/*
VPUIPRegMapped::MPEMode getMPEFrequentModeFromDPUTasks(mlir::Region& dpuTaskOps) {
    std::unordered_map<VPUIPRegMapped::MPEMode, size_t> umap;
    for (auto dpuTaskOp : dpuTaskOps.getOps<VPUIPRegMapped::DPUTaskOp>()) {
...
vpux::VPUIPRegMapped::BlobWriter::TensorReference getTensorReferenceWithUpdatedQuantParams(
        vpux::VPUIPRegMapped::NCEClusterTaskOp* nceTask, VPUIPRegMapped::BlobWriter& writer,
        ArrayRef<uint16_t> ppeQuantMult, ArrayRef<uint8_t> ppeQuantShift, int8_t ppeQuantPostShift) {
    ...
    // new TensorReference
    VPUIPRegMapped::DeclareTensorOp tensorOp;
    if (mlir::isa<VPUIPRegMapped::DeclareTensorOp>(nceTask->output_buff().getDefiningOp())) {
        tensorOp = nceTask->output_buff().getDefiningOp<VPUIPRegMapped::DeclareTensorOp>();
    } else if (mlir::isa<VPUIPRegMapped::DeclareTensorOp>(nceTask->parent_output().getDefiningOp())) {
        tensorOp = nceTask->parent_output().getDefiningOp<VPUIPRegMapped::DeclareTensorOp>();
    }
...
// VPUIPRegMapped::BlobWriter::SpecificTask vpux::VPUIPRegMapped::NCEClusterTaskOp::serialize(
//        VPUIPRegMapped::BlobWriter& writer) {
void vpux::VPUIPRegMapped::NCEClusterTaskOp::serialize(std::vector<char>& buffer) {
    ...
    for (auto dpuTaskOp : variants().getOps<VPUIPRegMapped::DPUTaskOp>()) {
    ...
    for (auto ppeOp : ppe().getOps<VPUIPRegMapped::PPETaskOp>()) {
