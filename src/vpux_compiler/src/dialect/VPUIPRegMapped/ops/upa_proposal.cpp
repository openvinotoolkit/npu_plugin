...
mlir::LogicalResult vpux::VPUIPRegMapped::verifyOp(ProposalUPAOp op) {
...
void vpux::VPUIPRegMapped::ProposalUPAOp::build(::mlir::OpBuilder& odsBuilder, ::mlir::OperationState& odsState,
                                                mlir::Value class_probs, mlir::Value bbox_deltas,
                                                mlir::Value image_shape, mlir::Value output,
                                                IE::ProposalAttr proposal_attrs) {
...
// VPUIPRegMapped::BlobWriter::SpecificTask vpux::VPUIPRegMapped::ProposalUPAOp::serialize(VPUIPRegMapped::BlobWriter&
// writer) {
void vpux::VPUIPRegMapped::ProposalUPAOp::serialize(std::vector<char>& buffer) {
    /*
    MVCNN::ProposalParamsBuilder builder(writer);

    IE::ProposalAttr attr = proposal_attrs();
    VPUIPRegMapped::BlobWriter::String framework = writer.createString(attr.framework().getValue());
