...
void vpux::VPUIPRegMapped::LSTMCellUPAOp::build(mlir::OpBuilder& builder, mlir::OperationState& state,
...
// vpux::VPUIPRegMapped::BlobWriter::SpecificTask
// vpux::VPUIPRegMapped::LSTMCellUPAOp::serialize(VPUIPRegMapped::BlobWriter& writer) {
void vpux::VPUIPRegMapped::LSTMCellUPAOp::serialize(std::vector<char>& buffer) {
    /*
...
#if 0
mlir::Operation* vpux::VPUIPRegMapped::BlobReader::parseLSTMCell(mlir::OpBuilder& builder, ArrayRef<mlir::Value> inputs,
    ...
    return builder.create<VPUIPRegMapped::LSTMCellUPAOp>(mlir::UnknownLoc::get(_ctx), inputs[0], inputs[1], inputs[2],
                                                         inputs[3], inputs[4], outputs[1], outputs[2]);
}
#endif