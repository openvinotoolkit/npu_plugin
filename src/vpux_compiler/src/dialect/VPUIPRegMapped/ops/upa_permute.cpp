...
mlir::LogicalResult vpux::VPUIPRegMapped::verifyOp(PermuteUPAOp op) {
...
void vpux::VPUIPRegMapped::PermuteUPAOp::build(::mlir::OpBuilder& odsBuilder, ::mlir::OperationState& odsState,
...
// VPUIPRegMapped::BlobWriter::SpecificTask vpux::VPUIPRegMapped::PermuteUPAOp::serialize(VPUIPRegMapped::BlobWriter&
// writer) {
void vpux::VPUIPRegMapped::PermuteUPAOp::serialize(std::vector<char>& buffer) {
    /*
    DimsOrder order;
...
void vpux::VPUIPRegMapped::PermuteUPAOp::inferLayoutInfo(mlir::Operation* origOp, IE::LayerLayoutInfo& info) {
...
/*
mlir::Operation* vpux::VPUIPRegMapped::BlobReader::parsePermute(mlir::OpBuilder& builder, ArrayRef<mlir::Value> inputs,
    ...
    return builder.create<VPUIPRegMapped::PermuteUPAOp>(mlir::UnknownLoc::get(_ctx), inputs[0], outputs[0],
