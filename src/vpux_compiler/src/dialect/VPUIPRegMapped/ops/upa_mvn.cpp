...
void vpux::VPUIPRegMapped::MVNUPAOp::build(mlir::OpBuilder& builder, mlir::OperationState& state, mlir::Value input,
...
// VPUIPRegMapped::BlobWriter::SpecificTask vpux::VPUIPRegMapped::MVNUPAOp::serialize(VPUIPRegMapped::BlobWriter&
// writer) {
void vpux::VPUIPRegMapped::MVNUPAOp::serialize(std::vector<char>& buffer) {
    /*
...
mlir::LogicalResult vpux::VPUIPRegMapped::verifyOp(MVNUPAOp op) {
