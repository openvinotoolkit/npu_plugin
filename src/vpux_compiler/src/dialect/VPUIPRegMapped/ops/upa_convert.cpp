...
mlir::LogicalResult vpux::VPUIPRegMapped::verifyOp(ConvertUPAOp op) {
...
void vpux::VPUIPRegMapped::ConvertUPAOp::build(mlir::OpBuilder& builder, mlir::OperationState& state, mlir::Value input,
                                               mlir::Value output) {
    build(builder, state, input, output, mlir::ValueRange{}, mlir::ValueRange{}, nullptr, nullptr, false, false,
          nullptr, nullptr, false);
}

// VPUIPRegMapped::BlobWriter::SpecificTask vpux::VPUIPRegMapped::ConvertUPAOp::serialize(VPUIPRegMapped::BlobWriter&
// writer) {
void vpux::VPUIPRegMapped::ConvertUPAOp::serialize(std::vector<char>& buffer) {
    /*
...
/*
mlir::Operation* vpux::VPUIPRegMapped::BlobReader::parseConvert(mlir::OpBuilder& builder, ArrayRef<mlir::Value> inputs,
    ...
    return builder.create<VPUIPRegMapped::ConvertUPAOp>(mlir::UnknownLoc::get(_ctx), inputs[0], outputs[0]);
}
*/