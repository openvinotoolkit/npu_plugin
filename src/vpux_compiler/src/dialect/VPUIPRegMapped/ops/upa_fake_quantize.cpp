...
mlir::LogicalResult vpux::VPUIPRegMapped::verifyOp(FakeQuantizeUPAOp op) {
...
void vpux::VPUIPRegMapped::FakeQuantizeUPAOp::build(mlir::OpBuilder& builder, mlir::OperationState& state,
                                                    mlir::Value input, mlir::Value output, uint32_t levels,
                                                    Const::ContentAttr input_low, Const::ContentAttr input_high,
                                                    Const::ContentAttr output_low, Const::ContentAttr output_high) {
...
// vpux::VPUIPRegMapped::FakeQuantizeUPAOp::serialize(VPUIPRegMapped::BlobWriter& writer) {
void vpux::VPUIPRegMapped::FakeQuantizeUPAOp::serialize(std::vector<char>& buffer) {
    /*
...
/*
mlir::Operation* vpux::VPUIPRegMapped::BlobReader::parseFakeQuantize(mlir::OpBuilder& builder,
    ...
    return builder.create<VPUIPRegMapped::FakeQuantizeUPAOp>(
...
void vpux::VPUIPRegMapped::FakeQuantizeUPAOp::inferLayoutInfo(mlir::Operation*, IE::LayerLayoutInfo& info) {
