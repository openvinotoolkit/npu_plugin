...
void vpux::VPUIPRegMapped::DetectionOutputUPAOp::build(mlir::OpBuilder& builder, mlir::OperationState& state,
...
// vpux::VPUIPRegMapped::DetectionOutputUPAOp::serialize(VPUIPRegMapped::BlobWriter& writer) {
void vpux::VPUIPRegMapped::DetectionOutputUPAOp::serialize(std::vector<char>& buffer) {
    /*
...
/*
mlir::Operation* vpux::VPUIPRegMapped::BlobReader::parseDetectionOutput(mlir::OpBuilder& builder,
    ...
    return builder.create<VPUIPRegMapped::DetectionOutputUPAOp>(mlir::UnknownLoc::get(_ctx), inputs[0], inputs[1],
                                                                inputs[2], inputs[3], inputs[4], outputs[0],
                                                                detectionOutputAttr);
}
*/
