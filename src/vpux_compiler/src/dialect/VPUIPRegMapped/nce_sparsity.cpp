...
const vpux::EnumMap<vpux::VPUIPRegMapped::ArchKind, vpux::VPUIPRegMapped::NCESparsity::PPEConverterCb>
        vpux::VPUIPRegMapped::NCESparsity::ppeConvertersMap = {
                {vpux::VPUIPRegMapped::ArchKind::KMB, getKMBScale},
                {vpux::VPUIPRegMapped::ArchKind::TBH, getKMBScale},
                {vpux::VPUIPRegMapped::ArchKind::MTL, getMTLScale},
};

const vpux::EnumMap<vpux::VPUIPRegMapped::ArchKind, vpux::VPUIPRegMapped::NCESparsity::BiasConverterCb>
        vpux::VPUIPRegMapped::NCESparsity::biasConvertersMap = {
                {vpux::VPUIPRegMapped::ArchKind::KMB, toFixedPoint},
                {vpux::VPUIPRegMapped::ArchKind::TBH, toFixedPoint},
                {vpux::VPUIPRegMapped::ArchKind::MTL, toHex},
};

int64_t vpux::VPUIPRegMapped::NCESparsity::getBitPatternSize(mlir::ArrayRef<int64_t> kernelSize, int64_t strideW,
                                                             mlir::Type elemType) {
...
int64_t vpux::VPUIPRegMapped::NCESparsity::getActivationWindowSize(mlir::ArrayRef<int64_t> kernelSize, int64_t strideW,
...
std::vector<uint8_t> vpux::VPUIPRegMapped::NCESparsity::getFakeSparsity(mlir::ArrayRef<int64_t> kernelSize,
...
std::vector<std::int32_t> vpux::VPUIPRegMapped::NCESparsity::getWeightsTable(
        std::int64_t OC, vpux::VPUIPRegMapped::NCESparsity::GetBiasCb getBiasFP, std::int32_t weightPtrOffset,
        std::int32_t weightPtrStep, std::int32_t sparsityPtrOffset, vpux::VPUIPRegMapped::ArchKind arch,
        mlir::Type inputType, mlir::Type weightsType, mlir::Type outputType) {
    const auto getMultShift = [inputType, weightsType,
                               outputType](vpux::VPUIPRegMapped::ArchKind architecture) -> std::int32_t {
        ...
        if (architecture == vpux::VPUIPRegMapped::ArchKind::MTL) {
    ...
    const std::int32_t sparsityPtr = arch == vpux::VPUIPRegMapped::ArchKind::MTL ? MTL_SPARSITY : sparsityPtrOffset;
    ...
    std::vector<std::int32_t> weightsTableVals(
            OC * vpux::VPUIPRegMapped::NCEInvariant::WEIGHT_TABLE_NUM_ELEMENTS_PER_OC, 0);

    for (auto oc : irange(checked_cast<std::size_t>(OC))) {
        const auto wtInd =
                oc * static_cast<std::size_t>(vpux::VPUIPRegMapped::NCEInvariant::WEIGHT_TABLE_NUM_ELEMENTS_PER_OC);
