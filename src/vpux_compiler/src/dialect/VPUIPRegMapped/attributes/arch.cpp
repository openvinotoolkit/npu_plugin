...
double vpux::VPUIPRegMapped::getMemoryDerateFactor(IERT::MemoryResourceOp mem) {
    VPUX_THROW_UNLESS(mem.kindAttr() != nullptr, "Unsupported memory resource kind '{0}'", mem.kind());
    VPUX_THROW_UNLESS(mem.kindAttr().isa<VPUIPRegMapped::PhysicalMemoryAttr>(),
                      "Unsupported memory resource kind '{0}'", mem.kind());
...
uint32_t vpux::VPUIPRegMapped::getMemoryBandwidth(IERT::MemoryResourceOp mem) {
    VPUX_THROW_UNLESS(mem.kindAttr() != nullptr, "Unsupported memory resource kind '{0}'", mem.kind());
    VPUX_THROW_UNLESS(mem.kindAttr().isa<VPUIPRegMapped::PhysicalMemoryAttr>(),
                      "Unsupported memory resource kind '{0}'", mem.kind());
