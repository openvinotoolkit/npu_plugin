...
#include "vpux/compiler/dialect/VPUIPRegMapped/dpu_tiler.hpp"

#include "vpux/compiler/core/tiling.hpp"

using namespace vpux;

SmallVector<VPUIPRegMapped::DpuTile> vpux::VPUIPRegMapped::DpuTiler::tileOverH(int64_t numDPU, ShapeRef outShape,
