...
mlir::SideEffects::Resource* vpux::VPUIPRegMapped::getMemoryResource(PhysicalMemory mem) {
    switch (mem) {
...
mlir::FailureOr<mlir::SideEffects::Resource*> vpux::VPUIPRegMapped::getMemoryResource(mlir::MemRefType memref) {
