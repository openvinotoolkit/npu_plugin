...
using namespace VPUIPRegMapped;

//
// verifyConvChannels
//

int64_t vpux::VPUIPRegMapped::NCEInvariant::getChannelAlignment(mlir::Type elemType) {
    const Bit typeSizeInBits = getElemTypeSize(elemType);
    return std::max<int64_t>(128 / typeSizeInBits.count(), 16);
}

mlir::LogicalResult vpux::VPUIPRegMapped::NCEInvariant::verifyConvChannels(mlir::Location loc,
...
mlir::LogicalResult vpux::VPUIPRegMapped::NCEInvariant::verifyChannels(IE::ConvolutionOp origOp, Logger log) {
    return verifyConvChannels(origOp->getLoc(), origOp.filter().getType().cast<mlir::ShapedType>(), log);
}

mlir::LogicalResult vpux::VPUIPRegMapped::NCEInvariant::verifyChannels(IERT::ConvolutionOp origOp, Logger log) {
    return verifyConvChannels(origOp->getLoc(), origOp.filter().getType().cast<mlir::ShapedType>(), log);
}
...
mlir::LogicalResult vpux::VPUIPRegMapped::NCEInvariant::verifyPoolChannels(mlir::Location loc,
                                                                           mlir::ShapedType inputType, Logger log) {
    log.setName("NCEInvariant");
...
mlir::LogicalResult vpux::VPUIPRegMapped::NCEInvariant::verifyChannels(IE::MaxPoolOp origOp, Logger log) {
    return verifyPoolChannels(origOp->getLoc(), origOp.input().getType().cast<mlir::ShapedType>(), log);
}

mlir::LogicalResult vpux::VPUIPRegMapped::NCEInvariant::verifyChannels(IERT::MaxPoolOp origOp, Logger log) {
    return verifyPoolChannels(origOp->getLoc(), origOp.input().getType().cast<mlir::ShapedType>(), log);
}
...
mlir::LogicalResult vpux::VPUIPRegMapped::NCEInvariant::verifyEltwiseChannels(mlir::Location loc,
...
mlir::LogicalResult vpux::VPUIPRegMapped::NCEInvariant::verifyChannels(IE::AddOp origOp, Logger log) {
...
mlir::LogicalResult vpux::VPUIPRegMapped::NCEInvariant::verifyChannels(IERT::AddOp origOp, Logger log) {
    auto input1Type = origOp.input1().getType().cast<mlir::ShapedType>();
    auto input2Type = origOp.input2().getType().cast<mlir::ShapedType>();
    return verifyEltwiseChannels(origOp->getLoc(), input1Type, input2Type, log);
}

mlir::LogicalResult vpux::VPUIPRegMapped::NCEInvariant::verifyChannels(IE::MultiplyOp origOp, Logger log) {
    auto input1Type = origOp.input1().getType().cast<mlir::ShapedType>();
    auto input2Type = origOp.input2().getType().cast<mlir::ShapedType>();
    return verifyEltwiseChannels(origOp->getLoc(), input1Type, input2Type, log);
}

mlir::LogicalResult vpux::VPUIPRegMapped::NCEInvariant::verifyChannels(IERT::MultiplyOp origOp, Logger log) {
    auto input1Type = origOp.input1().getType().cast<mlir::ShapedType>();
    auto input2Type = origOp.input2().getType().cast<mlir::ShapedType>();
    return verifyEltwiseChannels(origOp->getLoc(), input1Type, input2Type, log);
}

mlir::LogicalResult vpux::VPUIPRegMapped::NCEInvariant::verifyChannels(IE::SubtractOp origOp, Logger log) {
    auto input1Type = origOp.input1().getType().cast<mlir::ShapedType>();
    auto input2Type = origOp.input2().getType().cast<mlir::ShapedType>();
    return verifyEltwiseChannels(origOp->getLoc(), input1Type, input2Type, log);
}

mlir::LogicalResult vpux::VPUIPRegMapped::NCEInvariant::verifyChannels(IERT::SubtractOp origOp, Logger log) {
    auto input1Type = origOp.input1().getType().cast<mlir::ShapedType>();
    auto input2Type = origOp.input2().getType().cast<mlir::ShapedType>();
    return verifyEltwiseChannels(origOp->getLoc(), input1Type, input2Type, log);
}

mlir::LogicalResult vpux::VPUIPRegMapped::NCEInvariant::verifyChannels(IE::AndOp origOp, Logger log) {
    auto input1Type = origOp.input1().getType().cast<mlir::ShapedType>();
    auto input2Type = origOp.input2().getType().cast<mlir::ShapedType>();
    return verifyEltwiseChannels(origOp->getLoc(), input1Type, input2Type, log);
}

mlir::LogicalResult vpux::VPUIPRegMapped::NCEInvariant::verifyChannels(IERT::AndOp origOp, Logger log) {
    auto input1Type = origOp.input1().getType().cast<mlir::ShapedType>();
    auto input2Type = origOp.input2().getType().cast<mlir::ShapedType>();
    return verifyEltwiseChannels(origOp->getLoc(), input1Type, input2Type, log);
}
...
mlir::LogicalResult vpux::VPUIPRegMapped::NCEInvariant::verifyGroupConvChannels(mlir::Location loc,
...
mlir::LogicalResult vpux::VPUIPRegMapped::NCEInvariant::verifyChannels(IE::GroupConvolutionOp origOp, Logger log) {
...
mlir::LogicalResult vpux::VPUIPRegMapped::NCEInvariant::verifyChannels(IERT::GroupConvolutionOp origOp, Logger log) {
    return verifyGroupConvChannels(origOp->getLoc(), origOp.input().getType().cast<mlir::ShapedType>(),
                                   origOp.filter().getType().cast<mlir::ShapedType>(), log);
}
...
Byte getCMXSize(mlir::ModuleOp module) {
    ...
    const auto cmxAttr =
            VPUIPRegMapped::PhysicalMemoryAttr::get(module->getContext(), VPUIPRegMapped::PhysicalMemory::CMX_NN);

    auto cmxRes = resOp.getAvailableMemory(cmxAttr);
    VPUX_THROW_UNLESS(cmxRes != nullptr, "Can't get information about {0} memory",
                      VPUIPRegMapped::PhysicalMemory::CMX_NN);
...
mlir::LogicalResult vpux::VPUIPRegMapped::NCEInvariant::verifyConvCMX(mlir::Location loc, mlir::ModuleOp module,
                                                                      mlir::ShapedType inputType,
                                                                      mlir::ShapedType filterType,
...
mlir::LogicalResult vpux::VPUIPRegMapped::NCEInvariant::verifyCMX(IE::ConvolutionOp origOp, Logger log) {
...
mlir::LogicalResult vpux::VPUIPRegMapped::NCEInvariant::verifyCMX(IERT::ConvolutionOp origOp, Logger log) {
    return verifyConvCMX(origOp->getLoc(), origOp->getParentOfType<mlir::ModuleOp>(),
                         origOp.input().getType().cast<mlir::ShapedType>(),
                         origOp.filter().getType().cast<mlir::ShapedType>(),
                         origOp.output().getType().cast<mlir::ShapedType>(), log);
...
mlir::LogicalResult vpux::VPUIPRegMapped::NCEInvariant::verifyPoolCMX(mlir::Location loc, mlir::ModuleOp module,
                                                                      mlir::ShapedType inputType,
    ...
    const auto activationWindowSize = VPUIPRegMapped::NCESparsity::getActivationWindowSize(
            kernelSizeVals, kernelStridesVals[0], inputType.getElementType(), IC);
...
mlir::LogicalResult vpux::VPUIPRegMapped::NCEInvariant::verifyCMX(IE::MaxPoolOp origOp, Logger log) {
...
mlir::LogicalResult vpux::VPUIPRegMapped::NCEInvariant::verifyCMX(IERT::MaxPoolOp origOp, Logger log) {
    return verifyPoolCMX(origOp->getLoc(), origOp->getParentOfType<mlir::ModuleOp>(),
                         origOp.input().getType().cast<mlir::ShapedType>(),
                         origOp.output().getType().cast<mlir::ShapedType>(), origOp.kernel_size(), origOp.strides(),
                         log);
...
mlir::LogicalResult vpux::VPUIPRegMapped::NCEInvariant::verifyEltwiseCMX(mlir::Location loc, mlir::ModuleOp module,
                                                                         mlir::ShapedType firstInputType,
                                                                         mlir::ShapedType secondInputType,
                                                                         mlir::ShapedType outputType, Logger log) {
    log.setName("NCEInvariant");
...
mlir::LogicalResult vpux::VPUIPRegMapped::NCEInvariant::verifyCMX(IE::AddOp origOp, Logger log) {
...
mlir::LogicalResult vpux::VPUIPRegMapped::NCEInvariant::verifyCMX(IE::MultiplyOp origOp, Logger log) {
    return verifyEltwiseCMX(origOp->getLoc(), origOp->getParentOfType<mlir::ModuleOp>(),
                            origOp.input1().getType().cast<mlir::ShapedType>(),
                            origOp.input2().getType().cast<mlir::ShapedType>(),
                            origOp.output().getType().cast<mlir::ShapedType>(), log);
...
mlir::LogicalResult vpux::VPUIPRegMapped::NCEInvariant::verifyCMX(IE::SubtractOp origOp, Logger log) {
    return verifyEltwiseCMX(origOp->getLoc(), origOp->getParentOfType<mlir::ModuleOp>(),
                            origOp.input1().getType().cast<mlir::ShapedType>(),
                            origOp.input2().getType().cast<mlir::ShapedType>(),
                            origOp.output().getType().cast<mlir::ShapedType>(), log);
...
mlir::LogicalResult vpux::VPUIPRegMapped::NCEInvariant::verifyCMX(IE::AndOp origOp, Logger log) {
    return verifyEltwiseCMX(origOp->getLoc(), origOp->getParentOfType<mlir::ModuleOp>(),
                            origOp.input1().getType().cast<mlir::ShapedType>(),
                            origOp.input2().getType().cast<mlir::ShapedType>(),
                            origOp.output().getType().cast<mlir::ShapedType>(), log);
...
mlir::LogicalResult vpux::VPUIPRegMapped::NCEInvariant::verifyCMX(IERT::AddOp origOp, Logger log) {
    return verifyEltwiseCMX(origOp->getLoc(), origOp->getParentOfType<mlir::ModuleOp>(),
                            origOp.input1().getType().cast<mlir::ShapedType>(),
                            origOp.input2().getType().cast<mlir::ShapedType>(),
                            origOp.output().getType().cast<mlir::ShapedType>(), log);
...
mlir::LogicalResult vpux::VPUIPRegMapped::NCEInvariant::verifyCMX(IERT::MultiplyOp origOp, Logger log) {
    return verifyEltwiseCMX(origOp->getLoc(), origOp->getParentOfType<mlir::ModuleOp>(),
                            origOp.input1().getType().cast<mlir::ShapedType>(),
                            origOp.input2().getType().cast<mlir::ShapedType>(),
                            origOp.output().getType().cast<mlir::ShapedType>(), log);
...
mlir::LogicalResult vpux::VPUIPRegMapped::NCEInvariant::verifyCMX(IERT::SubtractOp origOp, Logger log) {
    return verifyEltwiseCMX(origOp->getLoc(), origOp->getParentOfType<mlir::ModuleOp>(),
                            origOp.input1().getType().cast<mlir::ShapedType>(),
                            origOp.input2().getType().cast<mlir::ShapedType>(),
                            origOp.output().getType().cast<mlir::ShapedType>(), log);
...
mlir::LogicalResult vpux::VPUIPRegMapped::NCEInvariant::verifyCMX(IERT::AndOp origOp, Logger log) {
    return verifyEltwiseCMX(origOp->getLoc(), origOp->getParentOfType<mlir::ModuleOp>(),
                            origOp.input1().getType().cast<mlir::ShapedType>(),
                            origOp.input2().getType().cast<mlir::ShapedType>(),
                            origOp.output().getType().cast<mlir::ShapedType>(), log);
...
mlir::LogicalResult vpux::VPUIPRegMapped::NCEInvariant::verifyGroupConvCMX(mlir::Location loc, mlir::ModuleOp module,
                                                                           mlir::ShapedType inputType,
                                                                           mlir::ShapedType filterType,
                                                                           mlir::ShapedType outputType,
                                                                           mlir::ArrayAttr kernelStrides, Logger log) {
    ...
    const auto depthwiseOutChanCount = VPUIPRegMapped::NCEInvariant::getChannelAlignment(outputType.getElementType());
    ...
    const auto activationWindowSize = VPUIPRegMapped::NCESparsity::getActivationWindowSize(
            kernelSizeVals, kernelStridesVals[0], inputType.getElementType(), OC);

    // consider alignment when calculating required CMX
    const auto depthwiseConvAlignment = VPUIPRegMapped::NCEInvariant::getChannelAlignment(outputType.getElementType());
...
mlir::LogicalResult vpux::VPUIPRegMapped::NCEInvariant::verifyCMX(IE::GroupConvolutionOp origOp, Logger log) {
...
mlir::LogicalResult vpux::VPUIPRegMapped::NCEInvariant::verifyCMX(IERT::GroupConvolutionOp origOp, Logger log) {
    return verifyGroupConvCMX(origOp->getLoc(), origOp->getParentOfType<mlir::ModuleOp>(),
                              origOp.input().getType().cast<mlir::ShapedType>(),
                              origOp.filter().getType().cast<mlir::ShapedType>(),
                              origOp.output().getType().cast<mlir::ShapedType>(), origOp.strides(), log);
...
mlir::LogicalResult vpux::VPUIPRegMapped::NCEInvariant::verifyKernel(mlir::Location loc, int64_t KY, int64_t KX,
                                                                     int64_t SY, int64_t SX, int64_t padTop,
                                                                     int64_t padBottom, int64_t padLeft,
                                                                     int64_t padRight, Logger log) {
    log.setName("NCEInvariant");
...
mlir::LogicalResult vpux::VPUIPRegMapped::NCEInvariant::verifyKernel(IE::ConvolutionOp origOp, Logger log) {
    log.setName("NCEInvariant");
...
mlir::LogicalResult vpux::VPUIPRegMapped::NCEInvariant::verifyKernel(IERT::ConvolutionOp origOp, Logger log) {
    log.setName("NCEInvariant");
...
mlir::LogicalResult vpux::VPUIPRegMapped::NCEInvariant::verifyKernel(IE::MaxPoolOp origOp, Logger log) {
    log.setName("NCEInvariant");
...
mlir::LogicalResult vpux::VPUIPRegMapped::NCEInvariant::verifyKernel(IERT::MaxPoolOp origOp, Logger log) {
    log.setName("NCEInvariant");
...
mlir::LogicalResult vpux::VPUIPRegMapped::NCEInvariant::verifyKernel(IE::AddOp origOp, Logger) {
    auto input1Type = origOp.input1().getType().cast<mlir::ShapedType>();
    auto input2Type = origOp.input2().getType().cast<mlir::ShapedType>();
...
mlir::LogicalResult vpux::VPUIPRegMapped::NCEInvariant::verifyKernel(IERT::AddOp origOp, Logger) {
    auto input1Type = origOp.input1().getType().cast<mlir::ShapedType>();
    auto input2Type = origOp.input2().getType().cast<mlir::ShapedType>();
    auto outputType = origOp.output().getType().cast<mlir::ShapedType>();
    return verifyEltwiseKernel(input1Type, input2Type, outputType);
...
mlir::LogicalResult vpux::VPUIPRegMapped::NCEInvariant::verifyKernel(IE::MultiplyOp origOp, Logger) {
    auto input1Type = origOp.input1().getType().cast<mlir::ShapedType>();
    auto input2Type = origOp.input2().getType().cast<mlir::ShapedType>();
    auto outputType = origOp.output().getType().cast<mlir::ShapedType>();
    return verifyEltwiseKernel(input1Type, input2Type, outputType);
...
mlir::LogicalResult vpux::VPUIPRegMapped::NCEInvariant::verifyKernel(IERT::MultiplyOp origOp, Logger) {
    auto input1Type = origOp.input1().getType().cast<mlir::ShapedType>();
    auto input2Type = origOp.input2().getType().cast<mlir::ShapedType>();
    auto outputType = origOp.output().getType().cast<mlir::ShapedType>();
    return verifyEltwiseKernel(input1Type, input2Type, outputType);
...
mlir::LogicalResult vpux::VPUIPRegMapped::NCEInvariant::verifyKernel(IE::SubtractOp origOp, Logger) {
    auto input1Type = origOp.input1().getType().cast<mlir::ShapedType>();
    auto input2Type = origOp.input2().getType().cast<mlir::ShapedType>();
    auto outputType = origOp.output().getType().cast<mlir::ShapedType>();
    return verifyEltwiseKernel(input1Type, input2Type, outputType);
...
mlir::LogicalResult vpux::VPUIPRegMapped::NCEInvariant::verifyKernel(IERT::SubtractOp origOp, Logger) {
    auto input1Type = origOp.input1().getType().cast<mlir::ShapedType>();
    auto input2Type = origOp.input2().getType().cast<mlir::ShapedType>();
    auto outputType = origOp.output().getType().cast<mlir::ShapedType>();
    return verifyEltwiseKernel(input1Type, input2Type, outputType);
...
mlir::LogicalResult vpux::VPUIPRegMapped::NCEInvariant::verifyKernel(IE::AndOp origOp, Logger) {
    auto input1Type = origOp.input1().getType().cast<mlir::ShapedType>();
    auto input2Type = origOp.input2().getType().cast<mlir::ShapedType>();
    auto outputType = origOp.output().getType().cast<mlir::ShapedType>();
    return verifyEltwiseKernel(input1Type, input2Type, outputType);
...
mlir::LogicalResult vpux::VPUIPRegMapped::NCEInvariant::verifyKernel(IERT::AndOp origOp, Logger) {
    auto input1Type = origOp.input1().getType().cast<mlir::ShapedType>();
    auto input2Type = origOp.input2().getType().cast<mlir::ShapedType>();
    auto outputType = origOp.output().getType().cast<mlir::ShapedType>();
    return verifyEltwiseKernel(input1Type, input2Type, outputType);
...
mlir::LogicalResult vpux::VPUIPRegMapped::NCEInvariant::verifyKernel(IE::GroupConvolutionOp origOp, Logger log) {
    log.setName("NCEInvariant");
...
mlir::LogicalResult vpux::VPUIPRegMapped::NCEInvariant::verifyKernel(IERT::GroupConvolutionOp origOp, Logger log) {
    log.setName("NCEInvariant");
...
mlir::LogicalResult verifyConcreteOp(ConcreteOp origOp, Logger log) {
    if (mlir::failed(VPUIPRegMapped::NCEInvariant::verifyKernel(origOp, log))) {
        return mlir::failure();
    }

    if (mlir::failed(VPUIPRegMapped::NCEInvariant::verifyChannels(origOp, log))) {
        return mlir::failure();
    }

    if (mlir::failed(VPUIPRegMapped::NCEInvariant::verifyCMX(origOp, log))) {
        return mlir::failure();
    }
...
mlir::LogicalResult vpux::VPUIPRegMapped::NCEInvariant::verifyOp(mlir::Operation* op, Logger log) {
