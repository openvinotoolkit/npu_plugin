...
//
// SetCompileParamsPass2
//

class SetCompileParamsPass2 final : public VPUIPRegMapped::SetCompileParamsBase<SetCompileParamsPass2> {
public:
    SetCompileParamsPass2() = default;
    SetCompileParamsPass2(VPUIPRegMapped::ArchKind arch, VPUIPRegMapped::CompilationMode compilationMode,
...
SetCompileParamsPass2::SetCompileParamsPass2(VPUIPRegMapped::ArchKind arch,
...
mlir::LogicalResult SetCompileParamsPass2::initializeOptions(StringRef options) {
...
void SetCompileParamsPass2::safeRunOnModule() {
    ...
    VPUIPRegMapped::setArch(module, _arch, _numOfDPUGroups);
...
//
// createSetCompileParamsPass2
//

std::unique_ptr<mlir::Pass> vpux::VPUIPRegMapped::createSetCompileParamsPass2() {
    return std::make_unique<SetCompileParamsPass2>();
}

std::unique_ptr<mlir::Pass> vpux::VPUIPRegMapped::createSetCompileParamsPass2(ArchKind arch,
                                                                              CompilationMode compilationMode,
                                                                              Optional<int> numOfDPUGroups,
                                                                              Logger log) {
    return std::make_unique<SetCompileParamsPass2>(arch, compilationMode, numOfDPUGroups, log);
}
