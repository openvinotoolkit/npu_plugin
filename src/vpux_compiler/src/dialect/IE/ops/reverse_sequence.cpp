...
mlir::LogicalResult vpux::IE::ReverseSequenceOp::inferReturnTypeComponents(
    ...
    const auto batch_axis = rev.batch_axis().getInt();
    ...
    const auto seq_axis = rev.seq_axis().getInt();
...
void vpux::IE::ReverseSequenceOp::getCanonicalizationPatterns(mlir::OwningRewritePatternList& patterns,
