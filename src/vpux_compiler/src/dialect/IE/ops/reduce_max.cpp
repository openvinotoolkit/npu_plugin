...
std::unique_ptr<ngraph::Node> vpux::IE::ReduceMaxOp::toNgraph(ngraph::OutputVector &outputs)
{
    return std::make_unique<opset_latest::ReduceMax>(outputs.at(0), outputs.at(1), keep_dims());
}
