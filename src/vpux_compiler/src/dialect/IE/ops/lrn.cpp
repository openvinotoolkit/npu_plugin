...
std::unique_ptr<ngraph::Node> vpux::IE::LRNOp::toNgraph(ngraph::OutputVector &outputs)
{
    return std::make_unique<opset_latest::LRN>(outputs.at(0), outputs.at(1), alpha().convertToDouble(),
