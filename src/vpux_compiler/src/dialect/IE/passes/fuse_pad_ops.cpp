...
void FusePadOpsPass::safeRunOnFunc() {
    ...
    patterns.insert<FuseConstantPadWithConv>(&ctx, _log);
    patterns.insert<FuseConstantPadWithGroupConv>(&ctx, _log);
    patterns.insert<FuseConstantPadWithMaxpool>(&ctx, _log);
