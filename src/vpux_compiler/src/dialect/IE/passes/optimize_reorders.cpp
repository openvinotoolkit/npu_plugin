...
private:
    mlir::DenseSet<llvm::StringRef> getReadValueAndAssignPairs(mlir::FuncOp func, Logger log);
};

mlir::DenseSet<llvm::StringRef> OptimizeReordersPass::getReadValueAndAssignPairs(mlir::FuncOp func, Logger log) {
