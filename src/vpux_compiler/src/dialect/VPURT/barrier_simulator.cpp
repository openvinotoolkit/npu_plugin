...
mlir::LogicalResult vpux::VPURT::BarrierSimulator::simulateBarriers(Logger log) {
    log.trace("Simulating barrier flow ({0})",
              _isDynamicBarriers ? "physical ID assignment" : "physical ID validation");
