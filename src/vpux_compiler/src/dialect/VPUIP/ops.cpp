...
void redirectOpInterfacesForIE(mlir::DialectRegistry& registry) {
    ...
    registry.addOpInterface<IE::MaxMinOp, OpModelForSW<VPUIP::EltwiseUPAOp>>();
...
void vpux::VPUIP::VPUIPDialect::setupExtraInterfaces(mlir::DialectRegistry& registry) {
    ...
    registry.addOpInterface<IERT::MaximumOp, SoftwareLayerOpModel>();
    registry.addOpInterface<IERT::MinimumOp, SoftwareLayerOpModel>();
