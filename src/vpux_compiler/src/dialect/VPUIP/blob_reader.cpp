...
void vpux::VPUIP::BlobReader::buildMainFunc() {
    ...
    static const SoftLayersDispatchMap softLayersDispatchMap = {
            ...
            {MVCNN::SoftwareLayerParams::SoftwareLayerParams_ScatterUpdateParams, &BlobReader::parseScatterUpdate},
            {MVCNN::SoftwareLayerParams::SoftwareLayerParams_ScatterElementsUpdateParams,
             &BlobReader::parseScatterElementsUpdate},
