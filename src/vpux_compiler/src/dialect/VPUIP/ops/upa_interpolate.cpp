...
const std::map<vpux::IE::InterpolateMode, int> supportedInterpModeMap = {
        {IE::InterpolateMode::nearest, 0},
        {IE::InterpolateMode::linear, 1},
        {IE::InterpolateMode::linear_onnx, 3},
};

const std::map<vpux::IE::InterpolateNearestMode, int> nearestModeMap = {
...
const std::map<vpux::IE::InterpolateCoordMode, int> coordTransformModeMap = {
        {IE::InterpolateCoordMode::half_pixel, 0},    {IE::InterpolateCoordMode::pytorch_half_pixel, 1},
        {IE::InterpolateCoordMode::asymmetric, 2},    {IE::InterpolateCoordMode::tf_half_pixel_for_nn, 3},
...
VPUIP::BlobWriter::SpecificTask vpux::VPUIP::InterpolateUPAOp::serialize(VPUIP::BlobWriter& writer) {
    ...
    VPUX_THROW_UNLESS(coordModeIter != coordTransformModeMap.end(), "Unsupported coordinate transformation mode {0}",
                      coord_mode());
    int coordTransformMode = coordModeIter->second;
    builder.add_coordTransformMode(coordTransformMode);
    ...
    builder.add_align_corners(coordTransformMode ==
                              coordTransformModeMap.find(vpux::IE::InterpolateCoordMode::align_corners)->second);
