...
void buildAvgpool(const nb::TestCaseJsonDescriptor& testDesc, mlir::ModuleOp module, mlir::OpBuilder builder,
    ...
    auto nceTask = funcbuilder.create<VPUIP::NCEClusterTaskOp>(
            loc, outputcmx_type, inputcmx.getOperation()->getResult(0), mlir::Value(), mlir::Value(), mlir::Value(),
            ...
            mlir::ValueRange(barrier1.barrier()), VPUIP::NCETaskType::AVEPOOL, filtersize, strides, kernel_padding,
