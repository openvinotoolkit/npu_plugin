...
void buildActKernelTest(const nb::TestCaseJsonDescriptor& testDesc, mlir::ModuleOp module, mlir::OpBuilder builder,
    ...
    auto constantOp = builder.create<mlir::arith::ConstantOp>(builder.getUnknownLoc(), /* type, */ elements);
    ...
    auto cnnOp = builder.create<IE::CNNNetworkOp>(builder.getUnknownLoc(), mainFuncName, false);
