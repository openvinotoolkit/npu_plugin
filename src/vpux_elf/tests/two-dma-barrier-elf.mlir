...
func @main(%arg0: memref<1x1x2x1000xf16>, %arg1: memref<1x1x2x1000xf16>) -> memref<1x1x2x1000xf16> {
    ...
    %sym_for_barrierSection = ELF.Symbol %barriersSection : !ELF.Section
    %sym_for_mappedInfSec = ELF.Symbol %mappedInfSec : !ELF.Section
    %sym_for_scratchSection = ELF.Symbol %scratchSection : !ELF.Section

    %symArg0 = ELF.Symbol %arg0 size(2000 ) : memref<1x1x2x1000xf16>
    %symArg1 = ELF.Symbol %arg1 size(2000 ) : memref<1x1x2x1000xf16>
