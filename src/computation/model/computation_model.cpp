...
std::shared_ptr<mv::RuntimeBinary>  mv::ComputationModel::allocateBinaryBuffer(std::string newName, int newSize)
{
...
std::shared_ptr<mv::RuntimeBinary>  mv::ComputationModel::allocateBinaryBuffer(int newSize)
{
