...
inline const char *EnumNameControllerSubTask(ControllerSubTask e) {
  if (flatbuffers::IsOutRange(e, ControllerSubTask_NONE, ControllerSubTask_EmptyTask)) return "";
...
struct ControllerSubTaskUnion {
  ...
  ControllerSubTaskUnion(const ControllerSubTaskUnion &);
  ControllerSubTaskUnion &operator=(const ControllerSubTaskUnion &u)
  ...
  MVCNN::TimerTaskT *AsTimerTask() {
    return type == ControllerSubTask_TimerTask ?
      reinterpret_cast<MVCNN::TimerTaskT *>(value) : nullptr;
  }
  const MVCNN::TimerTaskT *AsTimerTask() const {
    return type == ControllerSubTask_TimerTask ?
      reinterpret_cast<const MVCNN::TimerTaskT *>(value) : nullptr;
  }
  MVCNN::BarrierConfigurationTaskT *AsBarrierConfigurationTask() {
    return type == ControllerSubTask_BarrierConfigurationTask ?
      reinterpret_cast<MVCNN::BarrierConfigurationTaskT *>(value) : nullptr;
  }
  const MVCNN::BarrierConfigurationTaskT *AsBarrierConfigurationTask() const {
    return type == ControllerSubTask_BarrierConfigurationTask ?
      reinterpret_cast<const MVCNN::BarrierConfigurationTaskT *>(value) : nullptr;
  }
  MVCNN::AddToNCE2CMXBacklogTaskT *AsAddToNCE2CMXBacklogTask() {
    return type == ControllerSubTask_AddToNCE2CMXBacklogTask ?
      reinterpret_cast<MVCNN::AddToNCE2CMXBacklogTaskT *>(value) : nullptr;
  }
  const MVCNN::AddToNCE2CMXBacklogTaskT *AsAddToNCE2CMXBacklogTask() const {
    return type == ControllerSubTask_AddToNCE2CMXBacklogTask ?
      reinterpret_cast<const MVCNN::AddToNCE2CMXBacklogTaskT *>(value) : nullptr;
  }
  MVCNN::AddToNNDMABacklogTaskT *AsAddToNNDMABacklogTask() {
    return type == ControllerSubTask_AddToNNDMABacklogTask ?
      reinterpret_cast<MVCNN::AddToNNDMABacklogTaskT *>(value) : nullptr;
  }
  const MVCNN::AddToNNDMABacklogTaskT *AsAddToNNDMABacklogTask() const {
    return type == ControllerSubTask_AddToNNDMABacklogTask ?
      reinterpret_cast<const MVCNN::AddToNNDMABacklogTaskT *>(value) : nullptr;
  }
  MVCNN::UPAStartSHVTaskT *AsUPAStartSHVTask() {
    return type == ControllerSubTask_UPAStartSHVTask ?
      reinterpret_cast<MVCNN::UPAStartSHVTaskT *>(value) : nullptr;
  }
  const MVCNN::UPAStartSHVTaskT *AsUPAStartSHVTask() const {
    return type == ControllerSubTask_UPAStartSHVTask ?
      reinterpret_cast<const MVCNN::UPAStartSHVTaskT *>(value) : nullptr;
  }
  MVCNN::UPAEndSHVTaskT *AsUPAEndSHVTask() {
    return type == ControllerSubTask_UPAEndSHVTask ?
      reinterpret_cast<MVCNN::UPAEndSHVTaskT *>(value) : nullptr;
  }
  const MVCNN::UPAEndSHVTaskT *AsUPAEndSHVTask() const {
    return type == ControllerSubTask_UPAEndSHVTask ?
      reinterpret_cast<const MVCNN::UPAEndSHVTaskT *>(value) : nullptr;
  }
  MVCNN::NNStartSHVTaskT *AsNNStartSHVTask() {
    return type == ControllerSubTask_NNStartSHVTask ?
      reinterpret_cast<MVCNN::NNStartSHVTaskT *>(value) : nullptr;
  }
  const MVCNN::NNStartSHVTaskT *AsNNStartSHVTask() const {
    return type == ControllerSubTask_NNStartSHVTask ?
      reinterpret_cast<const MVCNN::NNStartSHVTaskT *>(value) : nullptr;
  }
  MVCNN::NNEndSHVTaskT *AsNNEndSHVTask() {
    return type == ControllerSubTask_NNEndSHVTask ?
      reinterpret_cast<MVCNN::NNEndSHVTaskT *>(value) : nullptr;
  }
  const MVCNN::NNEndSHVTaskT *AsNNEndSHVTask() const {
    return type == ControllerSubTask_NNEndSHVTask ?
      reinterpret_cast<const MVCNN::NNEndSHVTaskT *>(value) : nullptr;
  }
  MVCNN::EmptyTaskT *AsEmptyTask() {
    return type == ControllerSubTask_EmptyTask ?
      reinterpret_cast<MVCNN::EmptyTaskT *>(value) : nullptr;
  }
  const MVCNN::EmptyTaskT *AsEmptyTask() const {
    return type == ControllerSubTask_EmptyTask ?
      reinterpret_cast<const MVCNN::EmptyTaskT *>(value) : nullptr;
  }
};
...
struct TimerTaskT : public flatbuffers::NativeTable {
  ...
  uint32_t id;
  std::unique_ptr<MVCNN::TensorReferenceT> write_location;
  TimerTaskT()
      : id(0) {
  }
};
...
struct TimerTask FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const MVCNN::TensorReference *write_location() const {
    return GetPointer<const MVCNN::TensorReference *>(VT_WRITE_LOCATION);
  }
...
struct TimerTaskBuilder {
  ...
  void add_write_location(flatbuffers::Offset<MVCNN::TensorReference> write_location) {
...
inline flatbuffers::Offset<TimerTask> CreateTimerTask(
    ...
    uint32_t id = 0,
    flatbuffers::Offset<MVCNN::TensorReference> write_location = 0) {
...
struct BarrierConfigurationTaskT : public flatbuffers::NativeTable {
  ...
  std::unique_ptr<MVCNN::BarrierT> target;
...
struct BarrierConfigurationTask FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  typedef BarrierConfigurationTaskBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_TARGET = 4
  };
  const MVCNN::Barrier *target() const {
    return GetPointer<const MVCNN::Barrier *>(VT_TARGET);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct BarrierConfigurationTaskBuilder {
  typedef BarrierConfigurationTask Table;
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_target(flatbuffers::Offset<MVCNN::Barrier> target) {
...
inline flatbuffers::Offset<BarrierConfigurationTask> CreateBarrierConfigurationTask(
    flatbuffers::FlatBufferBuilder &_fbb,
    flatbuffers::Offset<MVCNN::Barrier> target = 0) {
...
struct AddToNCE2CMXBacklogTask FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  typedef AddToNCE2CMXBacklogTaskBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_ID = 4,
    VT_TASKS = 6
  };
...
struct AddToNCE2CMXBacklogTaskBuilder {
  typedef AddToNCE2CMXBacklogTask Table;
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_id(uint32_t id) {
...
struct AddToNNDMABacklogTask FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  typedef AddToNNDMABacklogTaskBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_ID = 4,
    VT_TASKS = 6
  };
...
struct AddToNNDMABacklogTaskBuilder {
  typedef AddToNNDMABacklogTask Table;
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_id(uint32_t id) {
...
struct EmptyTask FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  typedef EmptyTaskBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_ID = 4
  };
  uint32_t id() const {
...
struct UPAStartSHVTask FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  typedef UPAStartSHVTaskBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_ID = 4
  };
  uint32_t id() const {
...
struct UPAEndSHVTask FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  typedef UPAEndSHVTaskBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_ID = 4
  };
  uint32_t id() const {
...
struct NNStartSHVTask FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  typedef NNStartSHVTaskBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_ID = 4
  };
  uint32_t id() const {
...
struct NNEndSHVTask FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  typedef NNEndSHVTaskBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_ID = 4
  };
  uint32_t id() const {
...
struct ControllerTaskT : public flatbuffers::NativeTable {
  ...
  MVCNN::ControllerSubTaskUnion task;
  ControllerTaskT() {
  }
};
...
struct ControllerTask FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  typedef ControllerTaskBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_TASK_TYPE = 4,
    VT_TASK = 6
  };
  MVCNN::ControllerSubTask task_type() const {
    return static_cast<MVCNN::ControllerSubTask>(GetField<uint8_t>(VT_TASK_TYPE, 0));
  }
  const void *task() const {
    return GetPointer<const void *>(VT_TASK);
  }
  template<typename T> const T *task_as() const;
  const MVCNN::TimerTask *task_as_TimerTask() const {
    return task_type() == MVCNN::ControllerSubTask_TimerTask ? static_cast<const MVCNN::TimerTask *>(task()) : nullptr;
  }
  const MVCNN::BarrierConfigurationTask *task_as_BarrierConfigurationTask() const {
    return task_type() == MVCNN::ControllerSubTask_BarrierConfigurationTask ? static_cast<const MVCNN::BarrierConfigurationTask *>(task()) : nullptr;
  }
  const MVCNN::AddToNCE2CMXBacklogTask *task_as_AddToNCE2CMXBacklogTask() const {
    return task_type() == MVCNN::ControllerSubTask_AddToNCE2CMXBacklogTask ? static_cast<const MVCNN::AddToNCE2CMXBacklogTask *>(task()) : nullptr;
  }
  const MVCNN::AddToNNDMABacklogTask *task_as_AddToNNDMABacklogTask() const {
    return task_type() == MVCNN::ControllerSubTask_AddToNNDMABacklogTask ? static_cast<const MVCNN::AddToNNDMABacklogTask *>(task()) : nullptr;
  }
  const MVCNN::UPAStartSHVTask *task_as_UPAStartSHVTask() const {
    return task_type() == MVCNN::ControllerSubTask_UPAStartSHVTask ? static_cast<const MVCNN::UPAStartSHVTask *>(task()) : nullptr;
  }
  const MVCNN::UPAEndSHVTask *task_as_UPAEndSHVTask() const {
    return task_type() == MVCNN::ControllerSubTask_UPAEndSHVTask ? static_cast<const MVCNN::UPAEndSHVTask *>(task()) : nullptr;
  }
  const MVCNN::NNStartSHVTask *task_as_NNStartSHVTask() const {
    return task_type() == MVCNN::ControllerSubTask_NNStartSHVTask ? static_cast<const MVCNN::NNStartSHVTask *>(task()) : nullptr;
  }
  const MVCNN::NNEndSHVTask *task_as_NNEndSHVTask() const {
    return task_type() == MVCNN::ControllerSubTask_NNEndSHVTask ? static_cast<const MVCNN::NNEndSHVTask *>(task()) : nullptr;
  }
  const MVCNN::EmptyTask *task_as_EmptyTask() const {
    return task_type() == MVCNN::ControllerSubTask_EmptyTask ? static_cast<const MVCNN::EmptyTask *>(task()) : nullptr;
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
template<> inline const MVCNN::TimerTask *ControllerTask::task_as<MVCNN::TimerTask>() const {
  return task_as_TimerTask();
}

template<> inline const MVCNN::BarrierConfigurationTask *ControllerTask::task_as<MVCNN::BarrierConfigurationTask>() const {
  return task_as_BarrierConfigurationTask();
}

template<> inline const MVCNN::AddToNCE2CMXBacklogTask *ControllerTask::task_as<MVCNN::AddToNCE2CMXBacklogTask>() const {
  return task_as_AddToNCE2CMXBacklogTask();
}

template<> inline const MVCNN::AddToNNDMABacklogTask *ControllerTask::task_as<MVCNN::AddToNNDMABacklogTask>() const {
  return task_as_AddToNNDMABacklogTask();
}

template<> inline const MVCNN::UPAStartSHVTask *ControllerTask::task_as<MVCNN::UPAStartSHVTask>() const {
  return task_as_UPAStartSHVTask();
}

template<> inline const MVCNN::UPAEndSHVTask *ControllerTask::task_as<MVCNN::UPAEndSHVTask>() const {
  return task_as_UPAEndSHVTask();
}

template<> inline const MVCNN::NNStartSHVTask *ControllerTask::task_as<MVCNN::NNStartSHVTask>() const {
  return task_as_NNStartSHVTask();
}

template<> inline const MVCNN::NNEndSHVTask *ControllerTask::task_as<MVCNN::NNEndSHVTask>() const {
  return task_as_NNEndSHVTask();
}

template<> inline const MVCNN::EmptyTask *ControllerTask::task_as<MVCNN::EmptyTask>() const {
  return task_as_EmptyTask();
}

struct ControllerTaskBuilder {
  typedef ControllerTask Table;
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_task_type(MVCNN::ControllerSubTask task_type) {
...
inline flatbuffers::Offset<ControllerTask> CreateControllerTask(
    flatbuffers::FlatBufferBuilder &_fbb,
    MVCNN::ControllerSubTask task_type = MVCNN::ControllerSubTask_NONE,
...
inline TimerTaskT *TimerTask::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<MVCNN::TimerTaskT> _o = std::unique_ptr<MVCNN::TimerTaskT>(new TimerTaskT());
...
inline void TimerTask::UnPackTo(TimerTaskT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  (void)_resolver;
  { auto _e = id(); _o->id = _e; }
  { auto _e = write_location(); if (_e) _o->write_location = std::unique_ptr<MVCNN::TensorReferenceT>(_e->UnPack(_resolver)); }
}
...
inline BarrierConfigurationTaskT *BarrierConfigurationTask::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<MVCNN::BarrierConfigurationTaskT> _o = std::unique_ptr<MVCNN::BarrierConfigurationTaskT>(new BarrierConfigurationTaskT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline void BarrierConfigurationTask::UnPackTo(BarrierConfigurationTaskT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = target(); if (_e) _o->target = std::unique_ptr<MVCNN::BarrierT>(_e->UnPack(_resolver)); }
}
...
inline AddToNCE2CMXBacklogTaskT *AddToNCE2CMXBacklogTask::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<MVCNN::AddToNCE2CMXBacklogTaskT> _o = std::unique_ptr<MVCNN::AddToNCE2CMXBacklogTaskT>(new AddToNCE2CMXBacklogTaskT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline AddToNNDMABacklogTaskT *AddToNNDMABacklogTask::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<MVCNN::AddToNNDMABacklogTaskT> _o = std::unique_ptr<MVCNN::AddToNNDMABacklogTaskT>(new AddToNNDMABacklogTaskT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline EmptyTaskT *EmptyTask::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<MVCNN::EmptyTaskT> _o = std::unique_ptr<MVCNN::EmptyTaskT>(new EmptyTaskT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline UPAStartSHVTaskT *UPAStartSHVTask::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<MVCNN::UPAStartSHVTaskT> _o = std::unique_ptr<MVCNN::UPAStartSHVTaskT>(new UPAStartSHVTaskT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline UPAEndSHVTaskT *UPAEndSHVTask::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<MVCNN::UPAEndSHVTaskT> _o = std::unique_ptr<MVCNN::UPAEndSHVTaskT>(new UPAEndSHVTaskT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline NNStartSHVTaskT *NNStartSHVTask::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<MVCNN::NNStartSHVTaskT> _o = std::unique_ptr<MVCNN::NNStartSHVTaskT>(new NNStartSHVTaskT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline NNEndSHVTaskT *NNEndSHVTask::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<MVCNN::NNEndSHVTaskT> _o = std::unique_ptr<MVCNN::NNEndSHVTaskT>(new NNEndSHVTaskT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline ControllerTaskT *ControllerTask::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<MVCNN::ControllerTaskT> _o = std::unique_ptr<MVCNN::ControllerTaskT>(new ControllerTaskT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline void ControllerTask::UnPackTo(ControllerTaskT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = task(); if (_e) _o->task.value = MVCNN::ControllerSubTaskUnion::UnPack(_e, task_type(), _resolver); }
}
...
inline bool VerifyControllerSubTask(flatbuffers::Verifier &verifier, const void *obj, ControllerSubTask type) {
  switch (type) {
    ...
    case ControllerSubTask_TimerTask: {
      auto ptr = reinterpret_cast<const MVCNN::TimerTask *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case ControllerSubTask_BarrierConfigurationTask: {
      auto ptr = reinterpret_cast<const MVCNN::BarrierConfigurationTask *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case ControllerSubTask_AddToNCE2CMXBacklogTask: {
      auto ptr = reinterpret_cast<const MVCNN::AddToNCE2CMXBacklogTask *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case ControllerSubTask_AddToNNDMABacklogTask: {
      auto ptr = reinterpret_cast<const MVCNN::AddToNNDMABacklogTask *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case ControllerSubTask_UPAStartSHVTask: {
      auto ptr = reinterpret_cast<const MVCNN::UPAStartSHVTask *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case ControllerSubTask_UPAEndSHVTask: {
      auto ptr = reinterpret_cast<const MVCNN::UPAEndSHVTask *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case ControllerSubTask_NNStartSHVTask: {
      auto ptr = reinterpret_cast<const MVCNN::NNStartSHVTask *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case ControllerSubTask_NNEndSHVTask: {
      auto ptr = reinterpret_cast<const MVCNN::NNEndSHVTask *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case ControllerSubTask_EmptyTask: {
      auto ptr = reinterpret_cast<const MVCNN::EmptyTask *>(obj);
      return verifier.VerifyTable(ptr);
    }
    default: return true;
  }
...
inline flatbuffers::Offset<void> ControllerSubTaskUnion::Pack(flatbuffers::FlatBufferBuilder &_fbb, const flatbuffers::rehasher_function_t *_rehasher) const {
  switch (type) {
    case ControllerSubTask_TimerTask: {
      auto ptr = reinterpret_cast<const MVCNN::TimerTaskT *>(value);
      return CreateTimerTask(_fbb, ptr, _rehasher).Union();
    }
    case ControllerSubTask_BarrierConfigurationTask: {
      auto ptr = reinterpret_cast<const MVCNN::BarrierConfigurationTaskT *>(value);
      return CreateBarrierConfigurationTask(_fbb, ptr, _rehasher).Union();
    }
    case ControllerSubTask_AddToNCE2CMXBacklogTask: {
      auto ptr = reinterpret_cast<const MVCNN::AddToNCE2CMXBacklogTaskT *>(value);
      return CreateAddToNCE2CMXBacklogTask(_fbb, ptr, _rehasher).Union();
    }
    case ControllerSubTask_AddToNNDMABacklogTask: {
      auto ptr = reinterpret_cast<const MVCNN::AddToNNDMABacklogTaskT *>(value);
      return CreateAddToNNDMABacklogTask(_fbb, ptr, _rehasher).Union();
    }
    case ControllerSubTask_UPAStartSHVTask: {
      auto ptr = reinterpret_cast<const MVCNN::UPAStartSHVTaskT *>(value);
      return CreateUPAStartSHVTask(_fbb, ptr, _rehasher).Union();
    }
    case ControllerSubTask_UPAEndSHVTask: {
      auto ptr = reinterpret_cast<const MVCNN::UPAEndSHVTaskT *>(value);
      return CreateUPAEndSHVTask(_fbb, ptr, _rehasher).Union();
    }
    case ControllerSubTask_NNStartSHVTask: {
      auto ptr = reinterpret_cast<const MVCNN::NNStartSHVTaskT *>(value);
      return CreateNNStartSHVTask(_fbb, ptr, _rehasher).Union();
    }
    case ControllerSubTask_NNEndSHVTask: {
      auto ptr = reinterpret_cast<const MVCNN::NNEndSHVTaskT *>(value);
      return CreateNNEndSHVTask(_fbb, ptr, _rehasher).Union();
    }
    case ControllerSubTask_EmptyTask: {
      auto ptr = reinterpret_cast<const MVCNN::EmptyTaskT *>(value);
...
inline ControllerSubTaskUnion::ControllerSubTaskUnion(const ControllerSubTaskUnion &u) : type(u.type), value(nullptr) {
  switch (type) {
    case ControllerSubTask_TimerTask: {
      FLATBUFFERS_ASSERT(false);  // MVCNN::TimerTaskT not copyable.
      break;
    }
    case ControllerSubTask_BarrierConfigurationTask: {
      FLATBUFFERS_ASSERT(false);  // MVCNN::BarrierConfigurationTaskT not copyable.
      break;
    }
    case ControllerSubTask_AddToNCE2CMXBacklogTask: {
      value = new MVCNN::AddToNCE2CMXBacklogTaskT(*reinterpret_cast<MVCNN::AddToNCE2CMXBacklogTaskT *>(u.value));
      break;
    }
    case ControllerSubTask_AddToNNDMABacklogTask: {
      value = new MVCNN::AddToNNDMABacklogTaskT(*reinterpret_cast<MVCNN::AddToNNDMABacklogTaskT *>(u.value));
      break;
    }
    case ControllerSubTask_UPAStartSHVTask: {
      value = new MVCNN::UPAStartSHVTaskT(*reinterpret_cast<MVCNN::UPAStartSHVTaskT *>(u.value));
      break;
    }
    case ControllerSubTask_UPAEndSHVTask: {
      value = new MVCNN::UPAEndSHVTaskT(*reinterpret_cast<MVCNN::UPAEndSHVTaskT *>(u.value));
      break;
    }
    case ControllerSubTask_NNStartSHVTask: {
      value = new MVCNN::NNStartSHVTaskT(*reinterpret_cast<MVCNN::NNStartSHVTaskT *>(u.value));
      break;
    }
    case ControllerSubTask_NNEndSHVTask: {
      value = new MVCNN::NNEndSHVTaskT(*reinterpret_cast<MVCNN::NNEndSHVTaskT *>(u.value));
      break;
    }
    case ControllerSubTask_EmptyTask: {
      value = new MVCNN::EmptyTaskT(*reinterpret_cast<MVCNN::EmptyTaskT *>(u.value));
      break;
    }
    default:
      break;
...
inline void ControllerSubTaskUnion::Reset() {
  switch (type) {
    case ControllerSubTask_TimerTask: {
      auto ptr = reinterpret_cast<MVCNN::TimerTaskT *>(value);
      delete ptr;
      break;
    }
    case ControllerSubTask_BarrierConfigurationTask: {
      auto ptr = reinterpret_cast<MVCNN::BarrierConfigurationTaskT *>(value);
      delete ptr;
      break;
    }
    case ControllerSubTask_AddToNCE2CMXBacklogTask: {
      auto ptr = reinterpret_cast<MVCNN::AddToNCE2CMXBacklogTaskT *>(value);
      delete ptr;
      break;
    }
    case ControllerSubTask_AddToNNDMABacklogTask: {
      auto ptr = reinterpret_cast<MVCNN::AddToNNDMABacklogTaskT *>(value);
      delete ptr;
      break;
    }
    case ControllerSubTask_UPAStartSHVTask: {
      auto ptr = reinterpret_cast<MVCNN::UPAStartSHVTaskT *>(value);
      delete ptr;
      break;
    }
    case ControllerSubTask_UPAEndSHVTask: {
      auto ptr = reinterpret_cast<MVCNN::UPAEndSHVTaskT *>(value);
      delete ptr;
      break;
    }
    case ControllerSubTask_NNStartSHVTask: {
      auto ptr = reinterpret_cast<MVCNN::NNStartSHVTaskT *>(value);
      delete ptr;
      break;
    }
    case ControllerSubTask_NNEndSHVTask: {
      auto ptr = reinterpret_cast<MVCNN::NNEndSHVTaskT *>(value);
      delete ptr;
      break;
    }
    case ControllerSubTask_EmptyTask: {
      auto ptr = reinterpret_cast<MVCNN::EmptyTaskT *>(value);
      delete ptr;
      break;
    }
    default: break;
