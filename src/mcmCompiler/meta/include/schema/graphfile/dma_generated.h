...
struct UPADMATaskT : public flatbuffers::NativeTable {
  ...
  std::unique_ptr<MVCNN::TensorReferenceT> src;
  std::unique_ptr<MVCNN::TensorReferenceT> dst;
  UPADMATaskT() {
  }
};
...
struct UPADMATask FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  typedef UPADMATaskBuilder Builder;
  ...
  const MVCNN::TensorReference *src() const {
    return GetPointer<const MVCNN::TensorReference *>(VT_SRC);
  }
  const MVCNN::TensorReference *dst() const {
    return GetPointer<const MVCNN::TensorReference *>(VT_DST);
  }
...
struct UPADMATaskBuilder {
  typedef UPADMATask Table;
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_src(flatbuffers::Offset<MVCNN::TensorReference> src) {
    fbb_.AddOffset(UPADMATask::VT_SRC, src);
  }
  void add_dst(flatbuffers::Offset<MVCNN::TensorReference> dst) {
...
inline flatbuffers::Offset<UPADMATask> CreateUPADMATask(
    ...
    flatbuffers::Offset<MVCNN::TensorReference> src = 0,
    flatbuffers::Offset<MVCNN::TensorReference> dst = 0) {
...
struct NNDMATask FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  typedef NNDMATaskBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_SRC = 4,
    VT_DST = 6,
    VT_COMPRESSION = 8,
...
inline UPADMATaskT *UPADMATask::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<MVCNN::UPADMATaskT> _o = std::unique_ptr<MVCNN::UPADMATaskT>(new UPADMATaskT());
...
inline void UPADMATask::UnPackTo(UPADMATaskT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = src(); if (_e) _o->src = std::unique_ptr<MVCNN::TensorReferenceT>(_e->UnPack(_resolver)); }
  { auto _e = dst(); if (_e) _o->dst = std::unique_ptr<MVCNN::TensorReferenceT>(_e->UnPack(_resolver)); }
}
...
inline NNDMATaskT *NNDMATask::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<MVCNN::NNDMATaskT> _o = std::unique_ptr<MVCNN::NNDMATaskT>(new NNDMATaskT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
