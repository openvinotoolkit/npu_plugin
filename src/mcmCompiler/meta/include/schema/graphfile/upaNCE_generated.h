...
inline const char *EnumNameNCE1Layer(NCE1Layer e) {
  if (flatbuffers::IsOutRange(e, NCE1Layer_NONE, NCE1Layer_NCE1FCL)) return "";
...
template<> struct NCE1LayerTraits<MVCNN::NCE1Conv> {
  static const NCE1Layer enum_value = NCE1Layer_NCE1Conv;
};

template<> struct NCE1LayerTraits<MVCNN::NCE1Pool> {
  static const NCE1Layer enum_value = NCE1Layer_NCE1Pool;
};

template<> struct NCE1LayerTraits<MVCNN::NCE1FCL> {
...
struct NCE1LayerUnion {
  ...
  NCE1LayerUnion(const NCE1LayerUnion &);
  NCE1LayerUnion &operator=(const NCE1LayerUnion &u)
  ...
  MVCNN::NCE1ConvT *AsNCE1Conv() {
    return type == NCE1Layer_NCE1Conv ?
      reinterpret_cast<MVCNN::NCE1ConvT *>(value) : nullptr;
  }
  const MVCNN::NCE1ConvT *AsNCE1Conv() const {
    return type == NCE1Layer_NCE1Conv ?
      reinterpret_cast<const MVCNN::NCE1ConvT *>(value) : nullptr;
  }
  MVCNN::NCE1PoolT *AsNCE1Pool() {
    return type == NCE1Layer_NCE1Pool ?
      reinterpret_cast<MVCNN::NCE1PoolT *>(value) : nullptr;
  }
  const MVCNN::NCE1PoolT *AsNCE1Pool() const {
    return type == NCE1Layer_NCE1Pool ?
      reinterpret_cast<const MVCNN::NCE1PoolT *>(value) : nullptr;
  }
  MVCNN::NCE1FCLT *AsNCE1FCL() {
    return type == NCE1Layer_NCE1FCL ?
      reinterpret_cast<MVCNN::NCE1FCLT *>(value) : nullptr;
  }
  const MVCNN::NCE1FCLT *AsNCE1FCL() const {
    return type == NCE1Layer_NCE1FCL ?
      reinterpret_cast<const MVCNN::NCE1FCLT *>(value) : nullptr;
  }
};
...
struct NCE1Task FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  typedef NCE1TaskBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_LAYER_TYPE = 4,
    VT_LAYER = 6
  };
  MVCNN::NCE1Layer layer_type() const {
    return static_cast<MVCNN::NCE1Layer>(GetField<uint8_t>(VT_LAYER_TYPE, 0));
  }
  const void *layer() const {
    return GetPointer<const void *>(VT_LAYER);
  }
  template<typename T> const T *layer_as() const;
  const MVCNN::NCE1Conv *layer_as_NCE1Conv() const {
    return layer_type() == MVCNN::NCE1Layer_NCE1Conv ? static_cast<const MVCNN::NCE1Conv *>(layer()) : nullptr;
  }
  const MVCNN::NCE1Pool *layer_as_NCE1Pool() const {
    return layer_type() == MVCNN::NCE1Layer_NCE1Pool ? static_cast<const MVCNN::NCE1Pool *>(layer()) : nullptr;
  }
  const MVCNN::NCE1FCL *layer_as_NCE1FCL() const {
    return layer_type() == MVCNN::NCE1Layer_NCE1FCL ? static_cast<const MVCNN::NCE1FCL *>(layer()) : nullptr;
  }
...
template<> inline const MVCNN::NCE1Conv *NCE1Task::layer_as<MVCNN::NCE1Conv>() const {
  return layer_as_NCE1Conv();
}

template<> inline const MVCNN::NCE1Pool *NCE1Task::layer_as<MVCNN::NCE1Pool>() const {
  return layer_as_NCE1Pool();
}

template<> inline const MVCNN::NCE1FCL *NCE1Task::layer_as<MVCNN::NCE1FCL>() const {
  return layer_as_NCE1FCL();
}

struct NCE1TaskBuilder {
  typedef NCE1Task Table;
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_layer_type(MVCNN::NCE1Layer layer_type) {
...
inline flatbuffers::Offset<NCE1Task> CreateNCE1Task(
    ...
    MVCNN::NCE1Layer layer_type = MVCNN::NCE1Layer_NONE,
...
struct NCE1ConvT : public flatbuffers::NativeTable {
  ...
  std::unique_ptr<MVCNN::TensorT> input;
  std::unique_ptr<MVCNN::TensorT> output;
  std::unique_ptr<MVCNN::TensorT> weight;
  std::unique_ptr<MVCNN::TensorT> bias;
  NCE1ConvT()
      : streamingMask(0),
        inputSize(0),
        outputSize(0),
...
struct NCE1Conv FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  typedef NCE1ConvBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_STREAMINGMASK = 4,
    VT_INPUTSIZE = 6,
    VT_OUTPUTSIZE = 8,
  ...
  const MVCNN::Tensor *input() const {
    return GetPointer<const MVCNN::Tensor *>(VT_INPUT);
  }
  const MVCNN::Tensor *output() const {
    return GetPointer<const MVCNN::Tensor *>(VT_OUTPUT);
  }
  const MVCNN::Tensor *weight() const {
    return GetPointer<const MVCNN::Tensor *>(VT_WEIGHT);
  }
  const MVCNN::Tensor *bias() const {
    return GetPointer<const MVCNN::Tensor *>(VT_BIAS);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct NCE1ConvBuilder {
  ...
  void add_input(flatbuffers::Offset<MVCNN::Tensor> input) {
    fbb_.AddOffset(NCE1Conv::VT_INPUT, input);
  }
  void add_output(flatbuffers::Offset<MVCNN::Tensor> output) {
    fbb_.AddOffset(NCE1Conv::VT_OUTPUT, output);
  }
  void add_weight(flatbuffers::Offset<MVCNN::Tensor> weight) {
    fbb_.AddOffset(NCE1Conv::VT_WEIGHT, weight);
  }
  void add_bias(flatbuffers::Offset<MVCNN::Tensor> bias) {
...
inline flatbuffers::Offset<NCE1Conv> CreateNCE1Conv(
    ...
    flatbuffers::Offset<MVCNN::Tensor> input = 0,
    flatbuffers::Offset<MVCNN::Tensor> output = 0,
    flatbuffers::Offset<MVCNN::Tensor> weight = 0,
    flatbuffers::Offset<MVCNN::Tensor> bias = 0) {
...
struct NCE1Pool FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  typedef NCE1PoolBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_STREAMINGMASK = 4,
    VT_INPUTSIZE = 6,
    VT_OUTPUTSIZE = 8,
...
struct NCE1FCL FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  typedef NCE1FCLBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_STREAMINGMASK = 4,
    VT_INPUTSIZE = 6,
    VT_OUTPUTSIZE = 8,
...
inline NCE1TaskT *NCE1Task::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<MVCNN::NCE1TaskT> _o = std::unique_ptr<MVCNN::NCE1TaskT>(new NCE1TaskT());
...
inline void NCE1Task::UnPackTo(NCE1TaskT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = layer(); if (_e) _o->layer.value = MVCNN::NCE1LayerUnion::UnPack(_e, layer_type(), _resolver); }
}
...
inline NCE1ConvT *NCE1Conv::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<MVCNN::NCE1ConvT> _o = std::unique_ptr<MVCNN::NCE1ConvT>(new NCE1ConvT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline void NCE1Conv::UnPackTo(NCE1ConvT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = input(); if (_e) _o->input = std::unique_ptr<MVCNN::TensorT>(_e->UnPack(_resolver)); }
  { auto _e = output(); if (_e) _o->output = std::unique_ptr<MVCNN::TensorT>(_e->UnPack(_resolver)); }
  { auto _e = weight(); if (_e) _o->weight = std::unique_ptr<MVCNN::TensorT>(_e->UnPack(_resolver)); }
  { auto _e = bias(); if (_e) _o->bias = std::unique_ptr<MVCNN::TensorT>(_e->UnPack(_resolver)); }
}
...
inline NCE1PoolT *NCE1Pool::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<MVCNN::NCE1PoolT> _o = std::unique_ptr<MVCNN::NCE1PoolT>(new NCE1PoolT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline NCE1FCLT *NCE1FCL::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<MVCNN::NCE1FCLT> _o = std::unique_ptr<MVCNN::NCE1FCLT>(new NCE1FCLT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline bool VerifyNCE1Layer(flatbuffers::Verifier &verifier, const void *obj, NCE1Layer type) {
  switch (type) {
    ...
    case NCE1Layer_NCE1Conv: {
      auto ptr = reinterpret_cast<const MVCNN::NCE1Conv *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case NCE1Layer_NCE1Pool: {
      auto ptr = reinterpret_cast<const MVCNN::NCE1Pool *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case NCE1Layer_NCE1FCL: {
      auto ptr = reinterpret_cast<const MVCNN::NCE1FCL *>(obj);
      return verifier.VerifyTable(ptr);
    }
    default: return true;
  }
...
inline flatbuffers::Offset<void> NCE1LayerUnion::Pack(flatbuffers::FlatBufferBuilder &_fbb, const flatbuffers::rehasher_function_t *_rehasher) const {
  switch (type) {
    case NCE1Layer_NCE1Conv: {
      auto ptr = reinterpret_cast<const MVCNN::NCE1ConvT *>(value);
      return CreateNCE1Conv(_fbb, ptr, _rehasher).Union();
    }
    case NCE1Layer_NCE1Pool: {
      auto ptr = reinterpret_cast<const MVCNN::NCE1PoolT *>(value);
      return CreateNCE1Pool(_fbb, ptr, _rehasher).Union();
    }
    case NCE1Layer_NCE1FCL: {
      auto ptr = reinterpret_cast<const MVCNN::NCE1FCLT *>(value);
...
inline NCE1LayerUnion::NCE1LayerUnion(const NCE1LayerUnion &u) : type(u.type), value(nullptr) {
  switch (type) {
    case NCE1Layer_NCE1Conv: {
      FLATBUFFERS_ASSERT(false);  // MVCNN::NCE1ConvT not copyable.
      break;
    }
    case NCE1Layer_NCE1Pool: {
      FLATBUFFERS_ASSERT(false);  // MVCNN::NCE1PoolT not copyable.
      break;
    }
    case NCE1Layer_NCE1FCL: {
      FLATBUFFERS_ASSERT(false);  // MVCNN::NCE1FCLT not copyable.
      break;
    }
    default:
      break;
...
inline void NCE1LayerUnion::Reset() {
  switch (type) {
    case NCE1Layer_NCE1Conv: {
      auto ptr = reinterpret_cast<MVCNN::NCE1ConvT *>(value);
      delete ptr;
      break;
    }
    case NCE1Layer_NCE1Pool: {
      auto ptr = reinterpret_cast<MVCNN::NCE1PoolT *>(value);
      delete ptr;
      break;
    }
    case NCE1Layer_NCE1FCL: {
      auto ptr = reinterpret_cast<MVCNN::NCE1FCLT *>(value);
      delete ptr;
      break;
    }
    default: break;
