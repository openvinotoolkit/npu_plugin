...
int main()
{
    ...
    auto cls_pred = om.input("cls_pred0", {14,14,24,1}, mv::DType("Float16"), mv::Order::getZMajorID(4));
    auto weights = om.constantInt("weights", weightsData_converted, {14, 14, 48, 1}, mv::DType("Float16"), mv::Order::getZMajorID(4));
    auto im_info = om.constantInt("im_info0", imInfoData_converted, {1,3,1,1}, mv::DType("Float16"), mv::Order::getZMajorID(4));
