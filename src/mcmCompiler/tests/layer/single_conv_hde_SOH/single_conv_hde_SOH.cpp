...
#include "single_conv_hde_SOH.data.inc"
...
void build_pySwigCU(mv::OpModel& model)
{
    ...
    const auto input_3_0 = model.input("input#3", {224, 224, 3, 1}, mv::DType("UInt8"), mv::Order::getZMajorID(4));
    const auto conv1_conv1_0_weights_1_0 = model.constantInt("conv1/conv1#0_weights#1", conv1_conv1_0_weights_1_0_data, {7, 7, 3, 32}, mv::DType("UInt8"), mv::Order("NCHW"));
    const auto conv1_conv1_4_0 = model.conv("conv1/conv1#4", input_3_0, conv1_conv1_0_weights_1_0, {2, 2}, {2, 3, 2, 3}, 1, 1);
    const auto conv1_conv1_0_bias_2weights_0 = model.constantInt("conv1/conv1#0_bias#2weights", conv1_conv1_0_bias_2weights_0_data, {32}, mv::DType("UInt8"), mv::Order::getColMajorID(1));
    ...
    conv1_conv1_0_weights_1_0->setQuantParams({{115},{0.0028280930127948523},{-0.32530343532562256},{0.3958602845668793}});
    conv1_conv1_4_0->setQuantParams({{0},{0.003921568859368563},{0.0},{1.0}});
    conv1_conv1_0_bias_2weights_0->setQuantParams({{0},{2.2181122403708287e-05},{-inf},{inf}});
