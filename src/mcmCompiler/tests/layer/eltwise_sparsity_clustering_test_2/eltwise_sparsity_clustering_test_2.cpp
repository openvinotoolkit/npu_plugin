...
void build_pySwigCU(mv::OpModel& model)
{
    ...
    const auto input_7_0 = model.input("input#7", {32, 32, 16, 1}, mv::DType("UInt8"), mv::Order("NHWC"));
    ...
    const auto conv1a_8_0 = model.conv("conv1a#8", input_7_0, conv1a_0_weights_1_0, {1, 1}, {1, 1, 1, 1}, 1, 1);
    ...
    const auto conv1a_0_bias_2_0 = model.bias("conv1a#0_bias#2", conv1a_8_0, conv1a_0_bias_2weights_0);
    ...
    const auto conv1b_9_0 = model.conv("conv1b#9", input_7_0, conv1b_3_weights_4_0, {1, 1}, {1, 1, 1, 1}, 1, 1);
    ...
    const auto conv1b_3_bias_5_0 = model.bias("conv1b#3_bias#5", conv1b_9_0, conv1b_3_bias_5weights_0);
    const auto eltwise_FakeQuantWithMinMaxArgs_10_0 = model.eltwise("eltwise/FakeQuantWithMinMaxArgs#10", {conv1a_0_bias_2_0, conv1b_3_bias_5_0}, "Add");
    const auto output = model.output("", eltwise_FakeQuantWithMinMaxArgs_10_0, mv::DType("Default"), true);

    input_7_0->setQuantParams({{128},{0.007843137718737},{-1.000000000000000},{1.000000000000000},{0},{1}});
    conv1a_0_weights_1_0->setQuantParams({{115},{0.002828093012795},{-0.325303435325623},{0.395860284566879},{0},{1}});
    conv1a_8_0->setQuantParams({{0},{0.003921568859369},{0.000000000000000},{1.000000000000000},{0},{1}});
    ...
    conv1b_9_0->setQuantParams({{0},{0.003921568859369},{0.000000000000000},{1.000000000000000},{0},{1}});
    ...
    eltwise_FakeQuantWithMinMaxArgs_10_0->setQuantParams({{0},{0.003921568859369},{0.000000000000000},{1.000000000000000},{0},{1}});
}
