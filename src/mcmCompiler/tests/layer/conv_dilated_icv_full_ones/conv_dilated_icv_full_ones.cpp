...
int main()
{
    ...
    auto data_0 = om.input("input", {16,16,16,1}, mv::DType("UInt8"), mv::Order::getZMajorID(4) /*NHWC*/);
    ...
    auto conv0 = om.conv("conv", data_0, weights0, {1, 1}, {2, 2, 2, 2}, 2, 1);
    conv0->setQuantParams({{0},{0.5647058823529412},{0},{144},{0},{1}});

    std::vector<int64_t> biasData0 = mv::utils::generateSequence<int64_t> (16, 0, 0);
    auto bias0 = om.constantInt("", biasData0, {16}, mv::DType("Int32"), mv::Order::getRowMajorID(1));
    bias0->setQuantParams({{0}, {std::pow(0.00392156862745098,2)}, {}, {}});
    auto bias = om.bias("", conv0, bias0);
