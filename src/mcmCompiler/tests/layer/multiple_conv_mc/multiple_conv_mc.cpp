...
{
    std::string filePath = mv::utils::projectRootPath() + "/tests/layer/multiple_conv_mc/" + input_file;
...
int main()
{
    ...
    auto input = om.input("", {16,80,784,1}, mv::DType("UInt8"), mv::Order::getZMajorID(4));
