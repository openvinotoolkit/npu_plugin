...
int main()
{
    ...
    auto input0 = om.input({2,1,16,1}, mv::DType("UInt8"), mv::Order::getZMajorID(4),  {{0},{0.005},{},{}}, "input#170");
    ...
    auto conv0 = om.conv(input0, weights0, {1, 1}, {0, 0, 0, 0}, 1, 1,  mv::DType("Default"),{{0},{1.0},{},{}} , "conv");
