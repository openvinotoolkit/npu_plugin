...
class FakeQuantize(Layer):
    ...
    def loadMinMax(self, mini, maxi):
        self.min = PopulatedTensor(mini, name=str(self.name) + "_mini")
        self.max = PopulatedTensor(maxi, name=str(self.name) + "_maxi")
