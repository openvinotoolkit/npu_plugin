...
#pragma comment(linker, "/include:__MCM_REGISTER__OpEntry__PaddingConcat")
...
#pragma comment(linker, "/include:__MCM_REGISTER__PassEntry_RecomputePaddingConcatMemoryLocations")
...
#pragma comment(linker, "/include:__MCM_REGISTER__PassEntry_ReorderPaddingConcatDMAs")
