...
#include    "src/base/attribute_def/std_vector_mv_tensor_info.cpp"
#include    "src/base/attribute_def/std_vector_unsigned_short.cpp"
...
#include    "src/base/attribute_def/tensor_info.cpp"
