...
#include    "src/computation/op/def/custom_ocl.cpp"
#include    "src/computation/op/def/custom_cpp.cpp"
...
#include    "src/computation/op/def/strided_slice.cpp"
...
#include    "src/computation/op/def/log.cpp"
