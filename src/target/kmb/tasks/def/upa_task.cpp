...
namespace mv
{
    ...
    namespace op
    {
        ...
        .setBaseOperation({"Dummy", "Identity", "Softmax", "Proposal", "ROIPooling", "Quantize", "Reshape", "RegionYolo", "ReorgYolo", "Normalize", "Permute", "Interp", "DetectionOutput", "Priorbox", "Argmax"})
        .setExtraInputs(true);
    }
