...
class DataNode final :
    ...
    VPU_MODEL_ATTRIBUTE_RANGE(StageInputList, consumerEdges)
    ...
    VPU_MODEL_ATTRIBUTE_RANGE(SharedAllocationList, childDataEdges)
...
private:
    inline DataNode() :
        ...
        _posInModelCache(this) {
    }

private:
    DataPtrList::iterator _ptrPosInModel;
    IntrusivePtrListNode<DataNode> _posInModelCache;
