...
//                auto weightsTensorOutputChannelsPadded = mv::round_up(weightsTensorOutputChannels, pad);
            ...
            if(outputChannelsPadded != weightsTensorOutputChannels)
            {
                ...
                mv::Shape newShape = mv::Shape({weightsTensorWidth, weightsTensorHeight, weightsTensorInputChannels, outputChannelsPadded});
//                    if(taskOp == "DepthwiseConv")
